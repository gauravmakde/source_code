...
def check_project_id_for_NZ(log_result,filename,project_id_result_for_NZ):
...
def check_datatype_for_NZ(log_result,filename,Datatype_result_for_NZ):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def check_cluster_and_partition_for_NZ(log_result,filename,Cluster_and_partition_result_for_NZ):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def check_comments_for_NZ(log_result,filename,Check_comment_result_for_NZ):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def no_of_statements_for_NZ(log_result,filename,no_of_statements_result_for_NZ,fun_project_id_for_NZ):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def check_cross_join_for_NZ(log_result,filename,cross_join_result_for_NZ,fun_project_id_for_NZ):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def check_not_like_for_NZ(log_result,filename,not_like_result_for_NZ):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def check_now_for_NZ(log_result,filename,now_result_for_NZ):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def check_default_schema_for_NZ(log_result,filename,default_schema_result_for_NZ):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def check_Case_when_for_NZ(log_result,filename,Case_when_result_for_NZ):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def check_lower_case_for_NZ(log_result,filename,lower_case_result_for_NZ,fun_project_id_for_NZ):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def check_alice_in_lower_case_for_NZ(log_result,filename,alice_in_lower_case_for_NZ):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def Check_BQ_Project_For_Virgin_Media(log_result,filename,result_Check_BQ_ProjectID_For_Virgin_Media):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def Check_BEGIN_TRANSACTION_And_Commit_TRANSACTION(log_result,filename,result_Check_BEGIN_TRANSACTION_And_Commit_TRANSACTION):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
#MemSQL
def Check_No_Of_Statements_For_MemSQL(log_result,filename,result_check_no_of_statement_for_memsql):
    # print(filename)
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def Check_Count_Of_Case_Statement(log_result,filename,result_count_of_case_statement_for_memsql):
    # print(filename)
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def Check_Count_Of_Doller_Parameters(log_result,filename,result_count_of_doller_parameter_for_memsql):
    # print(filename)
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def Check_Count_Of_Coalesce_Function(log_result,filename,resut_count_of_coalesce_fun_for_memsql):
    # print(filename)
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
