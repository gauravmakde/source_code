...
dag_id = "gcp_ast_prod_main_rp_ant_spend_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "ast_prod_main_rp_ant_spend_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    open_to_buy_ast_pipeline_prod_main_rp_ant_spend = open(
        os.path.join(sql_path, "open_to_buy/ast_pipeline_prod_main_rp_ant_spend.sql"),
        "r",
    ).read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": open_to_buy_ast_pipeline_prod_main_rp_ant_spend,
                "useLegacySql": False,
            }
        },
