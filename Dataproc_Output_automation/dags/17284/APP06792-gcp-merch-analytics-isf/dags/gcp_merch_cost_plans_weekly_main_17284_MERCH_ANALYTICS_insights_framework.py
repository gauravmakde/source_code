...
dag_id = 'gcp_merch_cost_plans_weekly_main_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_cost_plans_weekly_main_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    cost_plans_ast_apt_cost_plans_weekly_main = open( os.path.join(sql_path, 'cost_plans/ast_apt_cost_plans_weekly_main.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": cost_plans_ast_apt_cost_plans_weekly_main,
                "useLegacySql": False
            }
        },
