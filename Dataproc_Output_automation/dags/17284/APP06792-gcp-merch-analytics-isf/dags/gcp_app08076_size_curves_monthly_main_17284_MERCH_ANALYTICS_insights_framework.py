...
dag_id = 'gcp_app08076_size_curves_monthly_main_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'app08076_size_curves_monthly_main_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
# TODO: Add sql file
    size_curves_inputs = open( os.path.join(sql_path, 'size_curves_inputs/APP08076_size_sku_groupid_main.sql'),"r").read()
