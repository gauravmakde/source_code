...
dag_id = 'gcp_merch_main_sel_cat_plan_hist_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_sel_cat_plan_hist_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    category_supplier_plans_ast_pipeline_prod_main_sel_cat_plan_history = open( os.path.join(sql_path, 'category_supplier_plans/ast_pipeline_prod_main_sel_cat_plan_history.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": category_supplier_plans_ast_pipeline_prod_main_sel_cat_plan_history,
                "useLegacySql": False
            }
        },
