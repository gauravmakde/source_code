...
dag_id = "gcp_merch_main_mfp_on_order_hist_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "merch_main_mfp_on_order_hist_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    MFP_History_report_ast_pipeline_prod_main_mfp_on_order_hist = open(
        os.path.join(
            sql_path, "MFP_History_report/ast_pipeline_prod_main_mfp_on_order_hist.sql"
        ),
        "r",
    ).read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": MFP_History_report_ast_pipeline_prod_main_mfp_on_order_hist,
                "useLegacySql": False,
            }
        },
