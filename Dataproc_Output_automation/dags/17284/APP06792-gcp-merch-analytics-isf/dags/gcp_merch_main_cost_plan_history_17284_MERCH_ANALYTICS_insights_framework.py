...
dag_id = 'gcp_merch_main_cost_plan_history_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_cost_plan_history_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    cost_plans_ast_pipeline_prod_main_apt_cost_plan_history = open( os.path.join(sql_path, 'cost_plans/ast_pipeline_prod_main_apt_cost_plan_history.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0_split_1 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": cost_plans_ast_pipeline_prod_main_apt_cost_plan_history  ,
                "useLegacySql": False
            }
        },
    ...
    cost_plans_ast_pipeline_prod_main_apt_cost_plan_history_weekly = open( os.path.join(sql_path, 'cost_plans/ast_pipeline_prod_main_apt_cost_plan_history_weekly.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0_split_2 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": cost_plans_ast_pipeline_prod_main_apt_cost_plan_history_weekly ,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    apt_plan_version_ast_pipeline_prod_main_apt_plan_version_month_fact = open( os.path.join(sql_path, 'apt_plan_version/ast_pipeline_prod_main_apt_plan_version_month_fact.sql'),"r").read()

    launch_run_teradata_sql_stg_0_job_1 = BigQueryInsertJobOperator(
        task_id = "run_teradata_sql_stg_0_job_1",
        configuration = 
        {
            "query": 
            {
                "query": apt_plan_version_ast_pipeline_prod_main_apt_plan_version_month_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    apt_plan_version_ast_pipeline_prod_main_apt_category_plan_version_month_fact = open( os.path.join(sql_path, 'apt_plan_version/ast_pipeline_prod_main_apt_category_plan_version_month_fact.sql'),"r").read()

    launch_run_teradata_sql_stg_0_job_2 = BigQueryInsertJobOperator(
        task_id = "run_teradata_sql_stg_0_job_2",
        configuration = 
        {
            "query": 
            {
                "query": apt_plan_version_ast_pipeline_prod_main_apt_category_plan_version_month_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> launch_run_teradata_sql_stg_0_job_0_split_1 >> launch_run_teradata_sql_stg_0_job_0_split_2 >> launch_run_teradata_sql_stg_0_job_1
    launch_run_teradata_sql_stg_0_job_1 >> launch_run_teradata_sql_stg_0_job_2
    launch_run_teradata_sql_stg_0_job_2 >> pelican_validator >> pelican_sensor