...
dag_id = 'gcp_ast_main_receipt_recon_daily_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'ast_main_receipt_recon_daily_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    ast_report_prod_main_receipt_recon_daily = open( os.path.join(sql_path, 'receipt_recon/ast_report_prod_main_receipt_recon_daily.sql'),"r").read()
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": ast_report_prod_main_receipt_recon_daily,
                "useLegacySql": False
            }
        },
