...
dag_id = "gcp_merch_se_an_prep_sku_date_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "merch_se_an_prep_sku_date_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    scaled_events_merch_se_an_prep_sku_date_17284_MERCH_ANALYTICS_insights_framework_run_terdata_sql_00 = open(
        os.path.join(
            sql_path, "scaled_events/ma_pipeline_prod_main_se_an_prep_sku_date.sql"
        ),
        "r",
    ).read()

    launch_run_terdata_sql_00_job_0 = BigQueryInsertJobOperator(
        task_id="run_terdata_sql_00_job_0",
        configuration={
            "query": {
                "query": scaled_events_merch_se_an_prep_sku_date_17284_MERCH_ANALYTICS_insights_framework_run_terdata_sql_00,
                "useLegacySql": False,
            }
        },
...
creds_setup >> launch_run_terdata_sql_00_job_0 >> pelican_validator >> pelican_sensor
