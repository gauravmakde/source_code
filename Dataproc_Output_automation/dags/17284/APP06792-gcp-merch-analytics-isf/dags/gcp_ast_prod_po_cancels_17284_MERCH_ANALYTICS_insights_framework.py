# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        f8f0f672ef09e3e0109f022dd2c05a73747647a5
# CI pipeline URL:      https://git.jwn.app/TM01310/app06792-gcp-merch-analytics-isf/-/pipelines/6971223
# CI commit timestamp:  2024-09-13T19:32:12+00:00
...
dag_id = "gcp_ast_prod_po_cancels_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "ast_prod_po_cancels_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    open_to_buy_pipeline_prod_main_po_cancels = open(
        os.path.join(
            sql_path, "open_to_buy/ast_pipeline_prod_main_po_cancels.sql"
        ),
        "r",
    ).read()
    ...
    launch_run_create_stg_tbl_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": open_to_buy_pipeline_prod_main_po_cancels,
                "useLegacySql": False,
            }
        },
    ...
    # creds_setup >> fetch_batch_run_id_task >> launch_run_create_stg_tbl_0_job_0 >> pelican_validator >> pelican_sensor
    (
        creds_setup
