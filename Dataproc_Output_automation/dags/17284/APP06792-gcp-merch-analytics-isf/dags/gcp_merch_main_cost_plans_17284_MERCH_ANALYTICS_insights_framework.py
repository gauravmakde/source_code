...
dag_id = 'gcp_merch_main_cost_plans_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_cost_plans_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    cost_plans_ast_pipeline_prod_main_apt_cost_plan_fact = open( os.path.join(sql_path, 'cost_plans/ast_pipeline_prod_main_apt_cost_plan_fact.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": cost_plans_ast_pipeline_prod_main_apt_cost_plan_fact,
                "useLegacySql": False
            }
        },
