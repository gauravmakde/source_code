...
dag_id = 'gcp_ast_rp_ant_spend_report_main_daily_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'ast_rp_ant_spend_report_main_daily_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    rp_ant_spend_rp_ant_spend_main = open( os.path.join(sql_path, 'rp_ant_spend/rp_ant_spend_main.sql'),"r").read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": rp_ant_spend_rp_ant_spend_main,
                "useLegacySql": False
            }
        },
