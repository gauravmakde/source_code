...
dag_id = 'gcp_merch_main_markdowns_analysis_single_week_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_markdowns_analysis_single_week_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    markdowns_ma_pipeline_prod_main_markdowns_analysis_single_week = open( os.path.join(sql_path, 'markdowns/ma_pipeline_prod_main_markdowns_analysis_single_week.sql'),"r").read()

    launch_run_bigquery_sql_stg_0_job_0_populate_table = BigQueryInsertJobOperator(
        task_id = "run_bigquery_sql_stg_0_job_0_populate_table",
        configuration = 
        {
            "query": 
            {
                "query": markdowns_ma_pipeline_prod_main_markdowns_analysis_single_week,
                "useLegacySql": False
            }
        },
    ...
    # launch_run_bigquery_sql_stg_0_job_1_refresh_tableau_extract = launch_k8s_api_job_operator(
    # dag=dag,
    # connection_id='TECH_ISF_ACE_MCH_SECURITY_K8S_GUMBO_CONN_PROD',
    # namespace='app06792',
    # task_id='run_bigquery_sql_stg_0_job_1_refresh_tableau_extract',
    # job_name='run-teradata-sql-stg-0-job-1-refresh-tableau-extract-merch-main',
    # macros=None,
    # container_image='artifactory.nordstrom.com/docker/app08499/insights-framework/tableau-agent:0.1.7',
    # container_command=['python', '/home/nonroot/agent/main.py', '--source_type', 'datasource', '--project_name', 'Data Sources', '--site', 'AS', '--datasource_name', 'Markdowns Analysis Single Week', '--vault_path', 'data/application/APP06792/9850/merch_analytics/prod/db/tableau/tableau_credentials', '--vault_host', 'https://vpce-01f9458aff654a035-ng0ubact.vpce-svc-00627e41a40fb1e3c.us-west-2.vpce.amazonaws.com:8200'],
    # resources={'limits': {'cpu': 5, 'memory': '6Gi' },'requests': {'cpu': 3, 'memory': '2Gi'}},
    # common_envs=[],
    # task_envs=[{'name': 'TIER', 'value': '3'}, {'name': 'STATSD_HOST', 'value': 'gostatsd.kube-system.svc.cluster.local'}, {'name': 'STATSD_PORT', 'value': '8128'}, {'name': 'APP_ID', 'value': 'APP08499'}, {'name': 'NEW_RELIC_APP_NAME', 'value': 'onehop-insights-framework-APP08499-PROD'}, {'name': 'ENV', 'value': 'PROD'}, {'name': 'VAULT_ROLE_ID', 'valueFrom': {'secretKeyRef': {'key': 'roleid', 'name': 'vault'}}}, {'name': 'VAULT_SECRET', 'valueFrom': {'secretKeyRef': {'key': 'secret', 'name': 'vault'}}}, {'name': 'DAG_ID', 'value': 'merch_main_markdowns_analysis_single_week_17284_MERCH_ANALYTICS_insights_framework'}],
    ...
    launch_run_bigquery_sql_stg_0_job_1_refresh_tableau_extract = DummyOperator(task_id="launch_run_bigquery_sql_stg_0_job_1_refresh_tableau_extract",dag=dag)


    creds_setup >> launch_run_bigquery_sql_stg_0_job_0_populate_table >>launch_run_bigquery_sql_stg_0_job_1_refresh_tableau_extract >> pelican_validator >> pelican_sensor