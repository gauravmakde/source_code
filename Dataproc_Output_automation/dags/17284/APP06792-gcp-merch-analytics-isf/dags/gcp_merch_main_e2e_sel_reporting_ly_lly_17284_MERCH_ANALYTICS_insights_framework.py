...
dag_id = 'gcp_merch_main_e2e_sel_reporting_ly_lly_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_e2e_sel_reporting_ly_lly_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    ast_pipeline_prod_main_e2e_plan_reporting_ly_lly = open( os.path.join(sql_path, 'e2e_selection_dash/ast_pipeline_prod_main_e2e_plan_reporting_ly_lly.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": ast_pipeline_prod_main_e2e_plan_reporting_ly_lly,
                "useLegacySql": False
            }
        },
