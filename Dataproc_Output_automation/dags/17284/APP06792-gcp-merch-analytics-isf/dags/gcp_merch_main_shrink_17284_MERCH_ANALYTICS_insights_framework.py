...
dag_id = "gcp_merch_main_shrink_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "merch_main_shrink_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    shrink_merch_pipeline_main_shrink = open(
        os.path.join(sql_path, "shrink/merch_pipeline_main_shrink.sql"), "r"
    ).read()

    launch_run_teradata_sql_stg_00_job_0 = BigQueryInsertJobOperator(
        task_id="run_teradata_sql_stg_00_job_0",
        configuration={
            "query": {"query": shrink_merch_pipeline_main_shrink, "useLegacySql": False}
        },
