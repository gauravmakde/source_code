...
dag_id = "gcp_merch_main_cust_counts_store_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "merch_main_cust_counts_store_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    store_reporting_store_reporting_merch_main_cust_counts_store_17284_MERCH_ANALYTICS_insights_framework_run_teradata_sql_stg_00_ma_pipeline_prod_main_cust_counts_store = open(
        os.path.join(
            sql_path,
            "store_reporting/ma_pipeline_prod_main_cust_counts_store.sql",
        ),
        "r",
    ).read()

    launch_run_teradata_sql_stg_00_job_0_populate_weekly_table = BigQueryInsertJobOperator(
        task_id="run_teradata_sql_stg_00_job_0_populate_weekly_table",
        configuration={
            "query": {
                "query": store_reporting_store_reporting_merch_main_cust_counts_store_17284_MERCH_ANALYTICS_insights_framework_run_teradata_sql_stg_00_ma_pipeline_prod_main_cust_counts_store,
                "useLegacySql": False,
            }
        },
    ...
    # launch_run_teradata_sql_stg_00_job_1_refresh_tableau_extract = launch_k8s_api_job_operator(
    #     dag=dag,
    #     connection_id="TECH_ISF_ACE_MCH_SECURITY_K8S_GUMBO_CONN_PROD",
    #     namespace="app06792",
    #     task_id="run_teradata_sql_stg_00_job_1_refresh_tableau_extract",
    #     job_name="run-teradata-sql-stg-00-job-1-refresh-tableau-extract-merch-mai",
    #     macros=None,
    ...
    #         {
    #             "name": "DAG_ID",
    #             "value": "merch_main_cust_counts_store_17284_MERCH_ANALYTICS_insights_framework",
    #         },
    #     ],
    #     metadata={
    #         "annotations": {
    ...
    (
        creds_setup
        >> [launch_run_teradata_sql_stg_00_job_0_populate_weekly_table]
    )
    (
        launch_run_teradata_sql_stg_00_job_0_populate_weekly_table
        >> pelican_validator
