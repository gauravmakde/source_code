...
dag_id = "gcp_merch_main_cc_type_realigned_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "merch_main_cc_type_realigned_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    assortment_common_tables_ast_pipeline_prod_main_cc_type_realigned = open(
        os.path.join(
            sql_path,
            "assortment_common_tables/ast_pipeline_prod_main_cc_type_realigned.sql",
        ),
        "r",
    ).read()

    launch_run_bigquery_sql_stg_0_cc_type = BigQueryInsertJobOperator(
        task_id="run_bigquery_sql_stg_0_cc_type",
        configuration={
            "query": {
                "query": assortment_common_tables_ast_pipeline_prod_main_cc_type_realigned,
                "useLegacySql": False,
            }
        },
    ...
    (
        ...
        >> [launch_run_bigquery_sql_stg_0_cc_type]
    )
    launch_run_bigquery_sql_stg_0_cc_type >> pelican_validator >> pelican_sensor
