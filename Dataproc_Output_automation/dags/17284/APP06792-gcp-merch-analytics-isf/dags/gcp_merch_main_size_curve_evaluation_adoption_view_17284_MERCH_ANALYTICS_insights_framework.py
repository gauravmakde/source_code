...
dag_id = 'gcp_merch_main_size_curve_evaluation_adoption_view_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_size_curve_evaluation_adoption_view_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    size_curves_adoption_ast_pipeline_prod_main_size_curve_eval_adoption_query = open( os.path.join(sql_path, 'size_curves_adoption/ast_pipeline_prod_main_size_curve_eval_adoption_query.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": size_curves_adoption_ast_pipeline_prod_main_size_curve_eval_adoption_query,
                "useLegacySql": False
            }
        },
