...
dag_id = 'gcp_app08076_size_curves_eval_metrics_main_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'app08076_size_curves_eval_metrics_main_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    # external_dag_id='gcp_app08076_size_curves_eval_base_tables_main_17284_MERCH_ANALYTICS_insights_framework',
    # timeout=1800,
    ...
    size_evaluation_APP08076_model_recs_main = open( os.path.join(sql_path, 'size_evaluation/APP08076_model_recs_main.sql'),"r").read()

    launch_run_teradata_sql_stg_0_model_recs = BigQueryInsertJobOperator(
        task_id = "run_teradata_sql_stg_0_model_recs",
        configuration = 
        {
            "query": 
            {
                "query": size_evaluation_APP08076_model_recs_main,
                "useLegacySql": False
            }
        },
    ...
    size_evaluation_APP08076_size_eval_actuals_main = open( os.path.join(sql_path, 'size_evaluation/APP08076_size_eval_actuals_main.sql'),"r").read()

    launch_run_teradata_sql_stg_0_actuals = BigQueryInsertJobOperator(
        task_id = "run_teradata_sql_stg_0_actuals",
        configuration = 
        {
            "query": 
            {
                "query": size_evaluation_APP08076_size_eval_actuals_main,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    size_evaluation_APP08076_accuracy_main = open( os.path.join(sql_path, 'size_evaluation/APP08076_accuracy_main.sql'),"r").read()

    launch_run_teradata_sql_stg_0_accuracy = BigQueryInsertJobOperator(
        task_id = "run_teradata_sql_stg_0_accuracy",
        configuration = 
        {
            "query": 
            {
                "query": size_evaluation_APP08076_accuracy_main,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> launch_check_external_upstream_dependencies_sensor_0 >> launch_run_teradata_sql_stg_0_model_recs
    launch_run_teradata_sql_stg_0_model_recs >> launch_run_teradata_sql_stg_0_actuals
    launch_run_teradata_sql_stg_0_actuals >> launch_run_teradata_sql_stg_0_accuracy
    launch_run_teradata_sql_stg_0_accuracy >> pelican_validator >> pelican_sensor