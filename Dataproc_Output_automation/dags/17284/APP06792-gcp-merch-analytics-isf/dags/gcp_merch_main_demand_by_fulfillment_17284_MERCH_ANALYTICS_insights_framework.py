...
dag_id = 'gcp_merch_main_demand_by_fulfillment_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_demand_by_fulfillment_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    merch_pipeline_main_demand_by_fulfillment = open( os.path.join(sql_path, 'demand_by_fulfillment/merch_pipeline_main_demand_by_fulfillment.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": merch_pipeline_main_demand_by_fulfillment,
                "useLegacySql": False
            }
        },
