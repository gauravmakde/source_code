...
dag_id = 'gcp_merch_main_otb_po_detail_base_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_otb_po_detail_base_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    open_to_buy_ast_pipeline_prod_main_otb_po_detail_base = open( os.path.join(sql_path, 'open_to_buy/ast_pipeline_prod_main_otb_po_detail_base.sql'),"r").read()
    ...
    launch_run_create_stg_tbl_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": open_to_buy_ast_pipeline_prod_main_otb_po_detail_base,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >>  launch_run_create_stg_tbl_0_job_0 >> pelican_validator >> pelican_sensor