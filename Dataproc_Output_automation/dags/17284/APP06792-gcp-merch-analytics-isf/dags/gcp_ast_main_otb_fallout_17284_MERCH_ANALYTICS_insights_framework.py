...
dag_id = 'gcp_ast_main_otb_fallout_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'ast_main_otb_fallout_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    receipt_recon_ast_main_otb_fallout = open( os.path.join(sql_path, 'receipt_recon/ast_main_otb_fallout.sql'),"r").read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": receipt_recon_ast_main_otb_fallout,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_check_external_upstream_dependencies_sensor_0 >>[launch_run_bigquery_sql_stg_0_job_0]
    launch_run_bigquery_sql_stg_0_job_0 >> pelican_validator >> pelican_sensor