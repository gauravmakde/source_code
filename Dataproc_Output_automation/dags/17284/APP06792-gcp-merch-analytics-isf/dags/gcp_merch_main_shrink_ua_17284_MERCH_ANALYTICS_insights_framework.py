...
dag_id = "gcp_merch_main_shrink_ua_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "merch_main_shrink_ua_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    shrink_merch_pipeline_main_shrink_ua = open(
        os.path.join(sql_path, "shrink/merch_pipeline_main_shrink_ua.sql"), "r"
    ).read()
    ...
    launch_run_bigquery_sql_stg_00_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": shrink_merch_pipeline_main_shrink_ua,
                "useLegacySql": False,
            }
        },
