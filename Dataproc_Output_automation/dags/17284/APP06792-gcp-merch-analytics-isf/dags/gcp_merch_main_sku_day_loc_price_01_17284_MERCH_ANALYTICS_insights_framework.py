...
dag_id = "gcp_merch_main_sku_day_loc_price_01_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "merch_main_sku_day_loc_price_01_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    ma_pipeline_prod_main_sku_day_loc_price_type_kpi = open(
        os.path.join(sql_path, "ma_pipeline_prod_main_sku_day_loc_price_type_kpi.sql"),
        "r",
    ).read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": ma_pipeline_prod_main_sku_day_loc_price_type_kpi,
                "useLegacySql": False,
            }
        },
