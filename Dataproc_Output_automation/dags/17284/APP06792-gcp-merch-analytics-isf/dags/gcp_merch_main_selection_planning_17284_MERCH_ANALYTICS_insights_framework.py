...
dag_id = 'gcp_merch_main_selection_planning_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_selection_planning_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    # external_dag_id='gcp_merch_main_hierarchy_17284_MERCH_ANALYTICS_insights_framework',
    # timeout=1800,
    ...
    # external_dag_id='gcp_merch_main_cc_type_17284_MERCH_ANALYTICS_insights_framework',
    # timeout=1800,
    # execution_date_fn=get_most_recent_dag_run)

    launch_check_external_upstream_dependencies_sensor_1 = DummyOperator(task_id="dummy_validation_launch_check_external_upstream_dependencies_sensor_1",dag=dag)

    # launch_check_external_upstream_dependencies_sensor_2 = ExternalTaskSensor(
    # dag=dag,
    # task_id='check_external_upstream_dependencies_2',
    # external_dag_id='gcp_merch_main_receipt_sku_loc_week_agg_fact_17284_MERCH_ANALYTICS_insights_framework',
    # timeout=1800,
    # execution_date_fn=get_most_recent_dag_run)

    launch_check_external_upstream_dependencies_sensor_2 = DummyOperator(task_id="dummy_validation_launch_check_external_upstream_dependencies_sensor_2",dag=dag)

    
        
    selection_planning_ma_pipeline_prod_main_selection_planning = open( os.path.join(sql_path, 'selection_planning/ma_pipeline_prod_main_selection_planning.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": selection_planning_ma_pipeline_prod_main_selection_planning,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_check_external_upstream_dependencies_sensor_1 >> launch_run_teradata_sql_stg_0_job_0
    creds_setup >> launch_check_external_upstream_dependencies_sensor_2 >> launch_run_teradata_sql_stg_0_job_0
