...
dag_id = 'gcp_pra_main_cross_shopping_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'pra_main_cross_shopping_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    cross_shopping_pra_report_main_cross_shopping = open( os.path.join(sql_path, 'cross_shopping/pra_report_main_cross_shopping.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": cross_shopping_pra_report_main_cross_shopping,
                "useLegacySql": False
            }
        },
