...
dag_id = (
    "gcp_merch_main_item_performance_rollups_17284_MERCH_ANALYTICS_insights_framework"
)
...
default_args = {
    ...
    "description": "merch_main_item_performance_rollups_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    item_performance_ma_pipeline_prod_main_item_performance_rollups = open(
        os.path.join(
            sql_path,
            "item_performance/ma_pipeline_prod_main_item_performance_rollups.sql",
        ),
        "r",
    ).read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": item_performance_ma_pipeline_prod_main_item_performance_rollups,
                "useLegacySql": False,
            }
        },
    ...
    #     job_name="run-bigquery-sql-stg-0-job-0-refresh-tableau-merch-main-item-pe",
    #     macros=None,
    ...
    #         {
    #             "name": "DAG_ID",
    #             "value": "merch_main_item_performance_rollups_17284_MERCH_ANALYTICS_insights_framework",
    #         },
    #     ],
    #     metadata={
    #         "annotations": {
    ...
    (
        ...
        # >> [launch_run_bigquery_sql_stg_0_job_0_refresh_tableau]
    )
    (
        # launch_run_bigquery_sql_stg_0_job_0_refresh_tableau
        launch_run_bigquery_sql_stg_0_job_0
