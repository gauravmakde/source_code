...
dag_id = 'gcp_merch_main_item_intent_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_item_intent_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    item_performance_ma_pipeline_prod_item_intent = open( os.path.join(sql_path, 'item_performance/ma_pipeline_prod_item_intent.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": item_performance_ma_pipeline_prod_item_intent,
                "useLegacySql": False
            }
        },
