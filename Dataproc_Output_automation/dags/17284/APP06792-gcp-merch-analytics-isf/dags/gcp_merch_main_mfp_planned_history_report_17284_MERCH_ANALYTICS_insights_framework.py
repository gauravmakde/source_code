...
dag_id = 'gcp_merch_main_mfp_planned_history_report_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_mfp_planned_history_report_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    MFP_Hindsight_report_ast_pipeline_prod_main_planned_history_report = open( os.path.join(sql_path, 'MFP_Hindsight_report/ast_pipeline_prod_main_planned_history_report.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": MFP_Hindsight_report_ast_pipeline_prod_main_planned_history_report,
                "useLegacySql": False
            }
        },
