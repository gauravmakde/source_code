...
dag_id = 'gcp_ma_main_selection_productivity_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'ma_main_selection_productivity_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    selection_productivity_ma_pipeline_prod_main_selection_productivity = open( os.path.join(sql_path, 'selection_productivity/ma_pipeline_prod_main_selection_productivity.sql'),"r").read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": selection_productivity_ma_pipeline_prod_main_selection_productivity,
                "useLegacySql": False
            }
        },
