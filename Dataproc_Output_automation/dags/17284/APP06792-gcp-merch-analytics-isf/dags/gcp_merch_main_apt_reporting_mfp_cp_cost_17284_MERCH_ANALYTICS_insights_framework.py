...
dag_id = 'gcp_merch_main_apt_reporting_mfp_cp_cost_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_apt_reporting_mfp_cp_cost_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    apt_summary_plan_ast_pipeline_prod_main_apt_reporting_mfp_cp_cost = open( os.path.join(sql_path, 'apt_summary_plan/ast_pipeline_prod_main_apt_reporting_mfp_cp_cost.sql'),"r").read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": apt_summary_plan_ast_pipeline_prod_main_apt_reporting_mfp_cp_cost,
                "useLegacySql": False
            }
        },
