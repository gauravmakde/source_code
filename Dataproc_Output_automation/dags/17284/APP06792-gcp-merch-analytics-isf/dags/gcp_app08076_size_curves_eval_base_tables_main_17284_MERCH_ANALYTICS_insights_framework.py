...
dag_id = 'gcp_app08076_size_curves_eval_base_tables_main_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'app08076_size_curves_eval_base_tables_main_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    size_evaluation_APP08076_evaluation_base_tables_main = open( os.path.join(sql_path, 'size_evaluation/APP08076_evaluation_base_tables_main.sql'),"r").read()

    launch_run_teradata_sql_stg_0_cal_loc = BigQueryInsertJobOperator(
        task_id = "run_teradata_sql_stg_0_cal_loc",
        configuration = 
        {
            "query": 
            {
                "query": size_evaluation_APP08076_evaluation_base_tables_main,
                "useLegacySql": False
            }
        },
    ...
    size_evaluation_APP08076_size_eval_hierarchy_main = open( os.path.join(sql_path, 'size_evaluation/APP08076_size_eval_hierarchy_main.sql'),"r").read()

    launch_run_teradata_sql_stg_0_hier = BigQueryInsertJobOperator(
        task_id = "run_teradata_sql_stg_0_hier",
        configuration = 
        {
            "query": 
            {
                "query": size_evaluation_APP08076_size_eval_hierarchy_main,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> launch_run_teradata_sql_stg_0_cal_loc >>[launch_run_teradata_sql_stg_0_hier]
    launch_run_teradata_sql_stg_0_hier >> pelican_validator >> pelican_sensor