...
dag_id = "gcp_merch_main_e2e_sel_reporting_cm_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "merch_main_e2e_sel_reporting_cm_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    e2e_selection_dash_ast_pipeline_prod_main_e2e_plan_reporting_cm = open(
        os.path.join(
            sql_path,
            "e2e_selection_dash/ast_pipeline_prod_main_e2e_plan_reporting_cm.sql",
        ),
        "r",
    ).read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": e2e_selection_dash_ast_pipeline_prod_main_e2e_plan_reporting_cm,
                "useLegacySql": False,
            }
        },
