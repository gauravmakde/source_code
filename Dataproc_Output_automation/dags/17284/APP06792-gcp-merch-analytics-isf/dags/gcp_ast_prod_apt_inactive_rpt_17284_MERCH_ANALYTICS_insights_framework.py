...
dag_id = 'gcp_ast_prod_apt_inactive_rpt_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'ast_prod_apt_inactive_rpt_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    ast_pipeline_prod_main_apt_inactive_spent = open( os.path.join(sql_path, 'open_to_buy/ast_pipeline_prod_main_apt_inactive_spent.sql'),"r").read()
    ...
    launch_run_create_stg_tbl_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": ast_pipeline_prod_main_apt_inactive_spent,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_check_external_upstream_dependencies_sensor_0 
    launch_check_external_upstream_dependencies_sensor_0 >> launch_run_create_stg_tbl_0_job_0 
