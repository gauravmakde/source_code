...
dag_id = "gcp_merch_main_item_performance_base_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "merch_main_item_performance_base_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    item_performance_ma_pipeline_prod_main_item_performance_base = open(
        os.path.join(
            sql_path, "item_performance/ma_pipeline_prod_main_item_performance_base.sql"
        ),
        "r",
    ).read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": item_performance_ma_pipeline_prod_main_item_performance_base,
                "useLegacySql": False,
            }
        },
