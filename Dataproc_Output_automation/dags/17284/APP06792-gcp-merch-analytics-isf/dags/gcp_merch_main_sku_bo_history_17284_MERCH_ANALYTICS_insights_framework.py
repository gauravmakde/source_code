...
dag_id = 'gcp_merch_main_sku_bo_history_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_sku_bo_history_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    ma_pipeline_prod_main_sku_bo_history = open(
    os.path.join(sql_path, 'ma_pipeline_prod_main_sku_bo_history.sql'),
    "r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": ma_pipeline_prod_main_sku_bo_history,
                "useLegacySql": False
            }
        },
