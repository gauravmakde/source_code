...
# CI pipeline URL:      https://git.jwn.app/TM01310/app06792-merch-analytics-isf/-/pipelines/6882444
...
dag_id = "gcp_prc_main_apt_is_category_17284_MERCH_ANALYTICS_insights_framework"
...
default_args = {
    ...
    "description": "prc_main_apt_is_category_17284_MERCH_ANALYTICS_insights_framework DAG Description",
...
with DAG(
    ...
    main_apt_is_category = open(
        os.path.join(sql_path, "apt_is/main_apt_is_category.sql"), "r"
    ).read()

    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        task_id="run_teradata_sql_stg_0_job_0",
        configuration={"query": {"query": main_apt_is_category, "useLegacySql": False}},
    ...
    # creds_setup >> fetch_batch_run_id_task >> launch_run_teradata_sql_stg_0_job_0 >>[launch_run_teradata_sql_stg_0_job_0_refresh_tableau]
    # launch_run_teradata_sql_stg_0_job_0_refresh_tableau >> pelican_validation >> pelican_sensor_task
