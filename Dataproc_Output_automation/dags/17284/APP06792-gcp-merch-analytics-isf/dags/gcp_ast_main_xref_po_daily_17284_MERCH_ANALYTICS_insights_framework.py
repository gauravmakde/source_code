...
dag_id = 'gcp_ast_main_xref_po_daily_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'ast_main_xref_po_daily_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    receipt_recon_ast_report_prod_main_xref_po_daily = open( os.path.join(sql_path, 'receipt_recon/ast_report_prod_main_xref_po_daily.sql'),"r").read()
    launch_run_create_stg_tbl_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": receipt_recon_ast_report_prod_main_xref_po_daily,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_check_external_upstream_dependencies_sensor_0 >>[launch_run_create_stg_tbl_0_job_0]
