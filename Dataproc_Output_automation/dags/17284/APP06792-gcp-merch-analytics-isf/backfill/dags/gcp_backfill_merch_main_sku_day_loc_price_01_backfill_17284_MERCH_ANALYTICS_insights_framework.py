# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        d70a416620c7107c5c722295b99246c9ae2525f5
# CI pipeline URL:      https://git.jwn.app/TM01310/app06792-gcp-merch-analytics-isf/-/pipelines/7237423
# CI commit timestamp:  2024-10-11T00:00:00+00:00
...
root_path = path.dirname(__file__).split('APP06792-gcp-merch-analytics-isf/backfill')[0] + 'APP06792-gcp-merch-analytics-isf/backfill/'
...
dag_id = 'gcp_backfill_merch_main_sku_day_loc_price_01_backfill_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'backfill_merch_main_sku_day_loc_price_01_backfill_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
# TODO: Add sql file
    backfill_merch_main_sku_day_loc_price_01_backfill_17284_MERCH_ANALYTICS_insights_framework_run_terdata_sql_stg_0_ma_pipeline_prod_main_sku_day_loc_price_type_kpi_backfill = open(
    os.path.join(sql_path, 'ma_pipeline_prod_main_sku_day_loc_price_type_kpi_backfill.sql'),
    "r").read()
    ...
    launch_run_terdata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration =
        {
            "query":
            {
                "query": backfill_merch_main_sku_day_loc_price_01_backfill_17284_MERCH_ANALYTICS_insights_framework_run_terdata_sql_stg_0_ma_pipeline_prod_main_sku_day_loc_price_type_kpi_backfill,
                "useLegacySql": False
            }
        },
