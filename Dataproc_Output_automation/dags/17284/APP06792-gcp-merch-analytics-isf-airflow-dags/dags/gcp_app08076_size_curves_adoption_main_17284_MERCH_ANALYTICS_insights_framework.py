...
dag_id = 'gcp_app08076_size_curves_adoption_main_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'app08076_size_curves_adoption_main_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    size_curves_adoption_APP08076_size_adoption_main = open( os.path.join(sql_path, 'size_curves_adoption/APP08076_size_adoption_main.sql'),"r").read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": size_curves_adoption_APP08076_size_adoption_main,
                "useLegacySql": False
            }
        },
