...
root_path = path.dirname(__file__).split('APP06792-gcp-merch-analytics-isf-airflow-dags')[0] + 'APP06792-gcp-merch-analytics-isf-airflow-dags/'
...
dag_id = 'gcp_merch_ddl_markdowns_analysis_single_week_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_ddl_markdowns_analysis_single_week_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    markdowns_ma_pipeline_prod_ddl_markdowns_analysis_single_week = open( os.path.join(sql_path, 'markdowns/ma_pipeline_prod_ddl_markdowns_analysis_single_week.sql'),"r").read()

    launch_run_bigquery_sql_stg_0_job_0_create_weekly_table = BigQueryInsertJobOperator(
        task_id = "run_bigquery_sql_stg_0_job_0_create_weekly_table",
        configuration = 
        {
            "query": 
            {
                "query": markdowns_ma_pipeline_prod_ddl_markdowns_analysis_single_week,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_bigquery_sql_stg_0_job_0_create_weekly_table >> pelican_validator >> pelican_sensor