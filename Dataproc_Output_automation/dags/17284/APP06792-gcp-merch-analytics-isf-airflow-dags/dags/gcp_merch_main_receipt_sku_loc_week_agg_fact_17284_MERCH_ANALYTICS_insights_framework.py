...
dag_id = 'gcp_merch_main_receipt_sku_loc_week_agg_fact_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_receipt_sku_loc_week_agg_fact_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    assortment_common_tables_ast_pipeline_prod_main_receipt_sku_loc_week_agg_fact = open( os.path.join(sql_path, 'assortment_common_tables/ast_pipeline_prod_main_receipt_sku_loc_week_agg_fact.sql'),"r").read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": assortment_common_tables_ast_pipeline_prod_main_receipt_sku_loc_week_agg_fact,
                "useLegacySql": False
            }
        },
