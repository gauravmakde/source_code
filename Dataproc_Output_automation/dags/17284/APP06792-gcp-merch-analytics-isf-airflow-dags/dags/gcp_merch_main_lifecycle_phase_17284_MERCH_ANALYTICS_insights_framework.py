...
dag_id = 'gcp_merch_main_lifecycle_phase_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_lifecycle_phase_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    lifecycle_phase_ma_pipeline_prod_main_lifecycle_phase = open( os.path.join(sql_path, 'lifecycle_phase/ma_pipeline_prod_main_lifecycle_phase.sql'),"r").read()

    launch_run_bigquery_sql_stg_00_job_0_populate_tables = BigQueryInsertJobOperator(
        task_id = "run_bigquery_sql_stg_00_job_0_populate_tables",
        configuration = 
        {
            "query": 
            {
                "query": lifecycle_phase_ma_pipeline_prod_main_lifecycle_phase,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_bigquery_sql_stg_00_job_0_populate_tables >> pelican_validator >> pelican_sensor
