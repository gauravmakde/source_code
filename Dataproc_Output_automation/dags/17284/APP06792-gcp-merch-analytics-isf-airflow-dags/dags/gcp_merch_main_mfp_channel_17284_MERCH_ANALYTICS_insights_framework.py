...
dag_id = 'gcp_merch_main_mfp_channel_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_mfp_channel_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    mfp_report_ma_pipeline_main_mfp_channel = open( os.path.join(sql_path, 'mfp_report/ma_pipeline_main_mfp_channel.sql'),"r").read()
    ...
    launch_run_bigquery_sql_stg_00_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": mfp_report_ma_pipeline_main_mfp_channel,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_bigquery_sql_stg_00_job_0 >> pelican_validator >> pelican_sensor