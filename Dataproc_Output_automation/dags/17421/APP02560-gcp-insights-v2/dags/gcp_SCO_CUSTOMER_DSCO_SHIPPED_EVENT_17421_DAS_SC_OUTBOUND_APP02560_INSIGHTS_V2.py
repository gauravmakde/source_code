...
dag_id = (
    "gcp_sco_customer_dsco_shipped_event_17421_DAS_SC_OUTBOUND_APP02560_insights_v2"
)
...
default_args = {
    ...
    "description": "sco_customer_dsco_shipped_event_17421_DAS_SC_OUTBOUND_APP02560_insights_v2 DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="customer-orderlinelifecycle-v1-avro",
        consumer_group_name="onix-customer-orderlinelifecycle-v1-avro_sco_customer_dsco_shipped_event_17421_DAS_SC_OUTBOUND_APP02560_insights_v2_main_job_2_load_avro_td_stg",
    ...
    customer_dsco_shipped_event_batch_start = open(
        os.path.join(sql_path, "customer_dsco_shipped_event/batch_start.sql"), "r"
    ).read()
    ...
    launch_main_job_1_td_batch_start = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": customer_dsco_shipped_event_batch_start,
                "useLegacySql": False,
            }
        },
    ...
    session_name = get_batch_id(dag_id=dag_id, task_id="main_job_2_load_avro_td_stg")
    main_job_2_load_avro_td_stg = DataprocCreateBatchOperator(
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_sco_customer_dsco_shipped_event_17421_DAS_SC_OUTBOUND_APP02560_insights_v2_main_job_2_load_avro_bq_stg.json",
    ...
    customer_dsco_shipped_event_td_stg_to_fact = open(
        os.path.join(sql_path, "customer_dsco_shipped_event/bq_stg_to_fact.sql"), "r"
    ).read()

    launch_main_job_3_td_stg_to_fact = BigQueryInsertJobOperator(
        task_id="main_job_3_td_stg_to_fact",
        configuration={
            "query": {
                "query": customer_dsco_shipped_event_td_stg_to_fact,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    customer_dsco_shipped_event_td_fact_dqc = open(
        os.path.join(sql_path, "customer_dsco_shipped_event/bq_fact_dqc.sql"), "r"
    ).read()

    launch_main_job_4_bigquery_fact_dqc = BigQueryInsertJobOperator(
        task_id="main_job_4_bigquery_fact_dqc",
        configuration={
            "query": {
                "query": customer_dsco_shipped_event_td_fact_dqc,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    customer_dsco_shipped_event_batch_end = open(
        os.path.join(sql_path, "customer_dsco_shipped_event/batch_end.sql"), "r"
    ).read()

    launch_main_job_5_td_batch_end = BigQueryInsertJobOperator(
        task_id="main_job_5_td_batch_end",
        configuration={
            "query": {
                "query": customer_dsco_shipped_event_batch_end,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    (
        ...
        >> launch_main_job_1_td_batch_start
        >> [main_job_2_load_avro_td_stg]
    )
    main_job_2_load_avro_td_stg >> [launch_main_job_3_td_stg_to_fact]
    launch_main_job_3_td_stg_to_fact >> [launch_main_job_4_bigquery_fact_dqc]
    launch_main_job_4_bigquery_fact_dqc >> [launch_main_job_5_td_batch_end]
    launch_main_job_5_td_batch_end >> pelican_validator >> pelican_sensor
