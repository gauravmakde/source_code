...
dag_id = "gcp_booking_load_2656_napstore_insights"
...
with DAG(
    ...
    session_name = get_batch_id(dag_id=dag_id, task_id="booking_load_load_0_stg_table")
    booking_load_load_0_stg_table = DataprocCreateBatchOperator(
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_booking_load_2656_napstore_insights_booking_load_load_0_stg_table.json",
    ...
    booking_load_fact = open(
        os.path.join(sql_path, "booking_load_fact.sql"), "r"
    ).read()

    launch_booking_load_load_1_fct_table = BigQueryInsertJobOperator(
        task_id="booking_load_load_1_fct_table",
        configuration={"query": {"query": booking_load_fact, "useLegacySql": False}},
        project_id=project_id,
        gcp_conn_id=gcp_conn,
    ...
    creds_setup >> fetch_batch_run_id_task >> [booking_load_load_0_stg_table]
    booking_load_load_0_stg_table >> [launch_booking_load_load_1_fct_table]
    launch_booking_load_load_1_fct_table >> pelican_validator >> pelican_sensor
