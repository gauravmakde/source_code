...
dag_id = "gcp_hr_location_events_load_2656_napstore_insights"
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = "humanresources-location-changed-avro",
        consumer_group_name = "onix-humanresources-location-changed-avro_hr_location_events_load_2656_napstore_insights_hr_loc_events_load_0_stg_tables",
    ...
    session_name = get_batch_id(
        dag_id = dag_id, task_id = "hr_loc_events_load_0_stg_tables"
    )
    hr_loc_events_load_0_stg_tables = DataprocCreateBatchOperator(
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_hr_location_events_load_2656_napstore_insights_hr_loc_events_load_0_stg_tables.json",
    ...
    hr_location_load_dim = open(
        os.path.join(sql_path, "hr_location_load_dim.sql"), "r"
    ).read()

    launch_hr_loc_events_load_1_dim_tables = BigQueryInsertJobOperator(
        task_id = "hr_loc_events_load_1_dim_tables",
        configuration={"query": {"query": hr_location_load_dim, "useLegacySql": False}},
        project_id = project_id,
        gcp_conn_id = gcp_conn,
    ...
    creds_setup >> fetch_batch_run_id_task >> [hr_loc_events_load_0_stg_tables]
    hr_loc_events_load_0_stg_tables >> [launch_hr_loc_events_load_1_dim_tables]
    launch_hr_loc_events_load_1_dim_tables >> pelican_validator >> pelican_sensor
