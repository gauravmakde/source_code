...
dag_id = 'gcp_wfm_metric_actual_load_2656_napstore_insights'
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'linear-metric-actual-analytical-avro',
        consumer_group_name = 'onix-linear-metric-actual-analytical-avro_wfm_metric_actual_load_2656_napstore_insights_wfm_metric_actual_load_load_0_stg_table',
    ...
    session_name=get_batch_id(dag_id=dag_id,task_id="wfm_metric_actual_load_load_0_stg_table")   
    wfm_metric_actual_load_load_0_stg_table = DataprocCreateBatchOperator(
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_wfm_metric_actual_load_2656_napstore_insights_wfm_metric_actual_load_load_0_stg_table.json",]
    ...
    wfm_metric_actual_load_fact = open(
    os.path.join(sql_path, 'wfm_metric_actual_load_fact.sql'),
    "r").read()

    launch_wfm_metric_actual_load_load_1_fct_table = BigQueryInsertJobOperator(
        task_id = "wfm_metric_actual_load_load_1_fct_table",
        configuration = 
        {
            "query": 
            {
                "query": wfm_metric_actual_load_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >>[wfm_metric_actual_load_load_0_stg_table]
    wfm_metric_actual_load_load_0_stg_table >>[launch_wfm_metric_actual_load_load_1_fct_table]
    launch_wfm_metric_actual_load_load_1_fct_table >> pelican_validator >> pelican_sensor