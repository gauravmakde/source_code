...
dag_id = 'gcp_wfm_ideal_hours_load_2656_napstore_insights'
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'customer-labor-demand-and-ideal-hours-analytical-avro',
        consumer_group_name = 'onix-customer-labor-demand-and-ideal-hours-analytical-avro_wfm_ideal_hours_load_2656_napstore_insights_wfm_ideal_hours_load_0_stg_table',
    ...
    session_name=get_batch_id(dag_id=dag_id,task_id="wfm_ideal_hours_load_0_stg_table")   
    wfm_ideal_hours_load_0_stg_table = DataprocCreateBatchOperator(
            ...
            batch=
            {    
                "runtime_config": {"version": "1.1","properties":{ 'spark.sql.legacy.avro.datetimeRebaseModeInWrite': 'LEGACY', 'spark.speculation': 'false',
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_wfm_ideal_hours_load_2656_napstore_insights_wfm_ideal_hours_load_0_stg_table.json",
    ...
    wfm_ideal_hours_load_fact = open(
    os.path.join(sql_path, 'wfm_ideal_hours_load_fact.sql'),
    "r").read()

    launch_wfm_ideal_hours_load_1_fct_table = BigQueryInsertJobOperator(
        task_id = "wfm_ideal_hours_load_1_fct_table",
        configuration = 
        {
            "query": 
            {
                "query": wfm_ideal_hours_load_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >>[wfm_ideal_hours_load_0_stg_table]
    wfm_ideal_hours_load_0_stg_table >>[launch_wfm_ideal_hours_load_1_fct_table]
    launch_wfm_ideal_hours_load_1_fct_table >> pelican_validator >> pelican_sensor