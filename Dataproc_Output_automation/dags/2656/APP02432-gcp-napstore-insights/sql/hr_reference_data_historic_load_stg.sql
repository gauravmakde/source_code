...
OPTIONS (path "gs://dm-del-composer-bucket/dags/APP02432-gcp-napstore-insights/2656/sql/hr_reference_data_historic_load/HR_WORKER_ORG_LDG.csv", header "true", delimiter ",");
...
OPTIONS (path "gs://dm-del-composer-bucket/dags/APP02432-gcp-napstore-insights/2656/sql/hr_reference_data_historic_load/HR_WORKER_LOCATION_LDG.csv", header "true", delimiter ",");
...
OPTIONS (path "gs://dm-del-composer-bucket/dags/APP02432-gcp-napstore-insights/2656/sql/hr_reference_data_historic_load/HR_WORKER_JOB_LDG.csv", header "true", delimiter ",");
