...
Task_Name=customer_postal_address_aux_elt_control_deactivate;'
FOR SESSION VOLATILE;
*/

-- Marks ELT as non-active and sets Batch_End timestamp at ELT_CONTROL table
BEGIN


CALL `{{params.gcp_project_id}}`.{{params.dbenv}}_NAP_UTL.ELT_CONTROL_END_LOAD('CUSTOMER_OBJ_POSTAL_ADDRESS_AUX_DIM{{params.tbl_sfx}}');
