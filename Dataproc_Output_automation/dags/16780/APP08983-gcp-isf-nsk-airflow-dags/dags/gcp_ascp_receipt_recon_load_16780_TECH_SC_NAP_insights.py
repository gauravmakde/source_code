...
dag_id = 'gcp_ascp_receipt_recon_load_16780_TECH_SC_NAP_insights'
...
default_args = {
    ...
    'description': 'ascp_receipt_recon_load_16780_TECH_SC_NAP_insights DAG Description',
...
with DAG(
    ...
    ascp_receipt_recon_load_ascp_receipt_recon_load = open( os.path.join(sql_path, 'ascp_receipt_recon_load/receipt_recon_fact_load.sql'),"r").read()

    launch_ascp_receipt_recon_load_load_teradata_02 = BigQueryInsertJobOperator(
        task_id = "ascp_receipt_recon_load_load_teradata_02",
        configuration = 
        {
            "query": 
            {
                "query": ascp_receipt_recon_load_ascp_receipt_recon_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> launch_start_batch_load_start_batch_01 >>[launch_ascp_receipt_recon_load_load_teradata_02]
    launch_ascp_receipt_recon_load_load_teradata_02 >>[launch_end_batch_load_03_end_batch]
