...
dag_id = 'gcp_rms_cost_rtv_v2_kafka_to_teradata_16780_TECH_SC_NAP_insights'
...
default_args = {
    ...
    'description': 'rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights DAG Description',
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'inventory-merchandise-return-to-vendor-v2-analytical-avro',
        consumer_group_name = 'onix1-inventory-merchandise-return-to-vendor-v2-analytical-avro_rms_cost_rtv_v2_kafka_to_teradata_16780_TECH_SC_NAP_insights_kafka_load_02_kafka',
    ...
    rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_metrics_load_metrics = open( os.path.join(sql_path, 'ascp_rms_cost_rtv_v2/load_metrics.sql'),"r").read()
    ...
    launch_metrics_load_metrics = BigQueryInsertJobOperator(
        ...
        configuration =
        {
            "query":
            {
                "query": rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_metrics_load_metrics,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    kafka_load_02_kafka = DataprocCreateBatchOperator(
            ...
            batch=
            {
                "runtime_config": {"version": "1.1","properties":{ 'spark.sql.legacy.avro.datetimeRebaseModeInWrite': 'LEGACY', 'spark.sql.legacy.parquet.datetimeRebaseModeInWrite': 'LEGACY', 'spark.speculation': 'false', 'spark.airflow.run_id':"{{ ti.xcom_pull(task_ids = 'fetch_batch_run_id_task')}}", 'spark.sql.mapKeyDedupPolicy': 'LAST_WIN'}},
                "spark_batch":
                    {
                    ...
                    "args": [f"{user_config_path}/argument_rms_cost_rtv_v2_kafka_to_bq_16780_TECH_SC_NAP_insights_kafka_load_02_kafka.json",
    ...
    rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_kafka_start_cntl_track_kafka_start = open( os.path.join(sql_path, 'common_sql/track_kafka_start.sql'),"r").read()
    ...
    launch_kafka_start_cntl_track_kafka_start = BigQueryInsertJobOperator(
        ...
        configuration =
        {
            "query":
            {
                "query": rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_kafka_start_cntl_track_kafka_start,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_kafka_end_cntl_track_kafka_end = open( os.path.join(sql_path, 'common_sql/track_kafka_end.sql'),"r").read()
    ...
    launch_kafka_end_cntl_track_kafka_end = BigQueryInsertJobOperator(
        ...
        configuration =
        {
            "query":
            {
                "query": rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_kafka_end_cntl_track_kafka_end,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_bigquery_rtv_v2_store_rtv_v2_load_fact_table = open( os.path.join(sql_path, 'ascp_rms_cost_rtv_v2/store_rtv_v2_load_fact_table.sql'),"r").read()

    launch_bigquery_rtv_v2_load_03_bigquery = BigQueryInsertJobOperator(
        task_id = "bigquery_rtv_v2_load_03_bigquery",
        configuration =
        {
            "query":
            {
                "query": rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_bigquery_rtv_v2_store_rtv_v2_load_fact_table,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_bigquery_rtv_v2_cancelled_store_rtv_canceled_details_v2_load_fact_table = open( os.path.join(sql_path, 'ascp_rms_cost_rtv_v2/store_rtv_canceled_details_v2_load_fact_table.sql'),"r").read()

    launch_bigquery_rtv_v2_cancelled_load_04_bigquery = BigQueryInsertJobOperator(
        task_id = "bigquery_rtv_v2_cancelled_load_04_bigquery",
        configuration =
        {
            "query":
            {
                "query": rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_bigquery_rtv_v2_cancelled_store_rtv_canceled_details_v2_load_fact_table,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_bigquery_rtv_v2_shipment_store_rtv_shipment_details_v2_load_fact_table = open( os.path.join(sql_path, 'ascp_rms_cost_rtv_v2/store_rtv_shipment_details_v2_load_fact_table.sql'),"r").read()

    launch_bigquery_rtv_v2_shipment_load_05_bigquery = BigQueryInsertJobOperator(
        task_id = "bigquery_rtv_v2_shipment_load_05_bigquery",
        configuration =
        {
            "query":
            {
                "query": rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_bigquery_rtv_v2_shipment_store_rtv_shipment_details_v2_load_fact_table,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_send_new_relic_metric_send_newrelic_metric = PythonOperator(
        ...
        'metrics_yaml_file': os.path.join(module_path,'yaml\ASCP_RMS_COST_RTV_V2_METRICS.yaml'),
    ...
    rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_end_batch_end_batch = open( os.path.join(sql_path, 'common_sql/end_batch.sql'),"r").read()
    ...
    launch_end_batch_load_06_end_batch = BigQueryInsertJobOperator(
        ...
        configuration =
        {
            "query":
            {
                "query": rms_cost_rtv_v2_kafka_to_bigquery_16780_TECH_SC_NAP_insights_end_batch_end_batch,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >> launch_start_batch_load_01_start_batch >>[launch_metrics_load_metrics]
    launch_metrics_load_metrics >>[ launch_kafka_start_cntl_track_kafka_start, kafka_load_02_kafka]
    kafka_load_02_kafka >>[launch_kafka_end_cntl_track_kafka_end,launch_bigquery_rtv_v2_load_03_bigquery,launch_bigquery_rtv_v2_cancelled_load_04_bigquery, launch_bigquery_rtv_v2_shipment_load_05_bigquery]
    launch_bigquery_rtv_v2_load_03_bigquery >>[launch_send_new_relic_metric_send_newrelic_metric]
    launch_bigquery_rtv_v2_cancelled_load_04_bigquery >>[launch_send_new_relic_metric_send_newrelic_metric]
    launch_bigquery_rtv_v2_shipment_load_05_bigquery >>[launch_send_new_relic_metric_send_newrelic_metric]
    launch_send_new_relic_metric_send_newrelic_metric >>[launch_end_batch_load_06_end_batch]
    launch_end_batch_load_06_end_batch >> pelican_validator >> pelican_sensor
