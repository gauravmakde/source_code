...
dag_id = "gcp_ascp_rtv_logical_16780_TECH_SC_NAP_insights"
...
default_args = {
    ...
    "description": "ascp_rtv_logical_16780_TECH_SC_NAP_insights DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="ascp-rms-rtv-avro",
        consumer_group_name="onix-ascp-rms-rtv-avro_ascp_rtv_logical_16780_TECH_SC_NAP_insights_rtv_logical_load_02_kafka",
    ...
    common_sql_load_metrics_2 = open(
        os.path.join(sql_path, "common_sql/load_metrics_2.sql"), "r"
    ).read()

    launch_metrics_load_metrics = BigQueryInsertJobOperator(
        task_id="metrics_load_metrics",
        configuration={
            "query": {"query": common_sql_load_metrics_2, "useLegacySql": False}
        },
        project_id=project_id,
        gcp_conn_id=gcp_conn,
        params=sql_config_dict,
    ...
    session_name = get_batch_id(dag_id=dag_id, task_id="rtv_logical_load_02_kafka")
    rtv_logical_load_02_kafka = DataprocCreateBatchOperator(
        task_id="rtv_logical_load_02_kafka",
        project_id=project_id,
        region=region,
        gcp_conn_id=gcp_conn,
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_ascp_rtv_logical_16780_TECH_SC_NAP_insights_rtv_logical_load_02_kafka.json",
    ...
    ascp_rtv_logical_rtv_logical_fact_table = open(
        os.path.join(sql_path, "ascp_rtv_logical/rtv_logical_fact_table.sql"), "r"
    ).read()

    launch_bigquery_load_05_bigquery = BigQueryInsertJobOperator(
        task_id="bigquery_load_05_bigquery",
        configuration={
            "query": {
                "query": ascp_rtv_logical_rtv_logical_fact_table,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    launch_send_new_relic_metric_send_newrelic_metric = PythonOperator(
        ...
        op_kwargs={
            ...
            "metrics_yaml_file": os.path.join(
                module_path, "yaml/ASCP_RTV_LOGICAL_METRICS.yaml"
            ),
        },
    )
    ...
    launch_metrics_load_metrics >> rtv_logical_load_02_kafka
    rtv_logical_load_02_kafka >> [
        launch_kafka_end_cntl_track_kafka_end,
        tpt_jdbc_insert_tpt_1_load_03_tpt_control_tbl,
        tpt_jdbc_insert_tpt_2_load_04_tpt_control_tbl,
    ]

    tpt_jdbc_insert_tpt_1_load_03_tpt_control_tbl >> [launch_bigquery_load_05_bigquery]
    tpt_jdbc_insert_tpt_2_load_04_tpt_control_tbl >> [launch_bigquery_load_05_bigquery]
    launch_bigquery_load_05_bigquery >> [
        launch_send_new_relic_metric_send_newrelic_metric
    ]
    launch_send_new_relic_metric_send_newrelic_metric >> [
        launch_end_batch_load_06_end_batch
    ]
