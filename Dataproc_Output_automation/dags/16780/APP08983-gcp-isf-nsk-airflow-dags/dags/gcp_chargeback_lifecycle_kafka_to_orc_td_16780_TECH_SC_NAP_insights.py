...
dag_id = "gcp_chargeback_lifecycle_kafka_to_orc_td_16780_TECH_SC_NAP_insights"
...
default_args = {
    ...
    "description": "chargeback_lifecycle_kafka_to_orc_td_16780_TECH_SC_NAP_insights DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="vendor-chargeback-lifecycle-analytical-avro",
        consumer_group_name="onix-vendor-chargeback-lifecycle-analytical-avro_chargeback_lifecycle_kafka_to_orc_td_16780_TECH_SC_NAP_insights_chargeback_lifecycle_v1_kafka_to_orc",
    ...
    session_name = get_batch_id(
        dag_id=dag_id, task_id="chargeback_lifecycle_v1_kafka_to_orc"
    )
    chargeback_lifecycle_v1_kafka_to_orc = DataprocCreateBatchOperator(
        task_id="chargeback_lifecycle_v1_kafka_to_orc",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_chargeback_lifecycle_kafka_to_orc_td_16780_TECH_SC_NAP_insights_chargeback_lifecycle_v1_kafka_to_orc.json",
    ...
    chargeback_lifecycle_v1_orc_to_ldg = open(
        os.path.join(
            sql_path, "chargeback_lifecycle/chargeback_lifecycle_bq_to_bq_16780.sql"
        ),
        "r",
    ).read()

    launch_chargeback_lifecycle_v1_kafka_to_bq = BigQueryInsertJobOperator(
        task_id="compliance_date_lifecycle_v2_bq_to_bq",
        configuration={
            "query": {
                "query": chargeback_lifecycle_v1_orc_to_ldg,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    chargeback_lifecycle_chargeback_event_to_fact = open(
        os.path.join(sql_path, "chargeback_lifecycle/chargeback_event_to_fact.sql"), "r"
    ).read()

    launch_chargeback_lifecycle_v1_ldg_to_fact = BigQueryInsertJobOperator(
        task_id="chargeback_lifecycle_v1_ldg_to_fact",
        configuration={
            "query": {
                "query": chargeback_lifecycle_chargeback_event_to_fact,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >> [chargeback_lifecycle_v1_kafka_to_orc]
    chargeback_lifecycle_v1_kafka_to_orc >> [launch_chargeback_lifecycle_v1_kafka_to_bq]
    launch_chargeback_lifecycle_v1_kafka_to_bq >> [launch_chargeback_lifecycle_v1_ldg_to_fact]
    launch_chargeback_lifecycle_v1_ldg_to_fact >> pelican_validator >> pelican_sensor
