...
dag_id = "gcp_ascp_rms_cost_rtv_16780_TECH_SC_NAP_insights"
...
default_args = {
    ...
    "description": "ascp_rms_cost_rtv_16780_TECH_SC_NAP_insights DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="inventory-merchandise-return-to-vendor-analytical-avro",
        consumer_group_name="onix-inventory-merchandise-return-to-vendor-analytical-avro_ascp_rms_cost_rtv_16780_TECH_SC_NAP_insights_kafka_load_kafka",
    ...
    common_sql_load_metrics = open(
        os.path.join(sql_path, "common_sql/load_metrics.sql"), "r"
    ).read()

    launch_metrics_load_metrics = BigQueryInsertJobOperator(
        task_id="metrics_load_metrics",
        configuration={
            "query": {"query": common_sql_load_metrics, "useLegacySql": False}
        },
        project_id=project_id,
        gcp_conn_id=gcp_conn,
        params=sql_config_dict,
    ...
    kafka_load_kafka = DataprocCreateBatchOperator(
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_ascp_rms_cost_rtv_16780_TECH_SC_NAP_insights_kafka_load_kafka.json",
    ...
    ascp_rms_cost_rtv_rms_cost_rtv_load_fact_table = open(
        os.path.join(sql_path, "ascp_rms_cost_rtv/rms_cost_rtv_load_fact_table.sql"),
        "r",
    ).read()
    ...
    launch_bigquery_load_bigquery = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": ascp_rms_cost_rtv_rms_cost_rtv_load_fact_table,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    (
        ...
        >> launch_start_batch_load_start_batch
    ...
    kafka_load_kafka >> [
        ...
        tpt_jdbc_insert_tpt_load_tpt_control_tbl,
    ]
    tpt_jdbc_insert_tpt_load_tpt_control_tbl >> [launch_bigquery_load_bigquery]
    ...
    launch_send_new_relic_metric_send_newrelic_metric >> [
        launch_end_batch_load_end_batch
    ]
