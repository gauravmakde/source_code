...
dag_id = "gcp_ascp_rms_cost_transfers_16780_TECH_SC_NAP_insights"
...
default_args = {
    ...
    "description": "ascp_rms_cost_transfers_16780_TECH_SC_NAP_insights DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="inventory-merchandise-transfer-analytical-avro",
        consumer_group_name="onix-inventory-merchandise-transfer-analytical-avro_ascp_rms_cost_transfers_16780_TECH_SC_NAP_insights_kafka_load_02_kafka",
    ...
    kafka_load_02_kafka = DataprocCreateBatchOperator(
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_ascp_rms_cost_transfers_16780_TECH_SC_NAP_insights_kafka_load_02_kafka.json",
    ...
    ascp_rms_cost_transfers_rms_cost_transfers_load_fact_table = open(
        os.path.join(
            sql_path, "ascp_rms_cost_transfers/rms_cost_transfers_load_fact_table.sql"
        ),
        "r",
    ).read()
    ...
    launch_bigquery_load_05_bigquery = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": ascp_rms_cost_transfers_rms_cost_transfers_load_fact_table,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    launch_send_new_relic_metric_send_newrelic_metric = PythonOperator(
        ...
        op_kwargs={
            ...
            "hook": BigQueryHook(
                gcp_conn_id=gcp_conn,
                location=sql_config_dict["region"],
                use_legacy_sql=False,
            ),
            "bigquery_environment": sql_config_dict["dbenv"],
            "metrics_yaml_file": os.path.join(
                module_path, "yaml/ASCP_RMS_COST_TRANFERS_METRICS.yaml"
            ),
        },
    )
