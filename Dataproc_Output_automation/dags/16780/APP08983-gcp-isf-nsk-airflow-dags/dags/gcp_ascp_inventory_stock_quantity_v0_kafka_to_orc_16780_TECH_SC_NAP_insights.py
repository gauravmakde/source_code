...
dag_id = "gcp_ascp_inventory_stock_quantity_v0_kafka_to_orc_16780_TECH_SC_NAP_insights"
...
default_args = {
    ...
    "description": "ascp_inventory_stock_quantity_v0_kafka_to_orc_16780_TECH_SC_NAP_insights DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        consumer_group_name="onix-ascp-inventory-stock-quantity-object-model-avro_ascp_inventory_stock_quantity_v0_kafka_to_orc_16780_TECH_SC_NAP_insights_kafka_to_orc_isq_full_kafka_to_orc",
    ...
    session_name = get_batch_id(
        dag_id=dag_id, task_id="kafka_to_orc_isq_full_kafka_to_orc"
    )
    kafka_to_orc_isq_full_kafka_to_orc = DataprocCreateBatchOperator(
        task_id="kafka_to_orc_isq_full_kafka_to_orc",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_ascp_inventory_stock_quantity_v0_kafka_to_orc_16780_TECH_SC_NAP_insights_kafka_to_orc_isq_full_kafka_to_orc.json",
    ...
    creds_setup >> fetch_batch_run_id_task >> [kafka_to_orc_isq_full_kafka_to_orc]
    kafka_to_orc_isq_full_kafka_to_orc >> pelican_validator >> pelican_sensor
