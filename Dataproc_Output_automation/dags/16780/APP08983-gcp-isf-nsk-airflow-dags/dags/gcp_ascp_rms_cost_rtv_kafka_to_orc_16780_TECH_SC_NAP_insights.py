...
dag_id = 'gcp_ascp_rms_cost_rtv_kafka_to_orc_16780_TECH_SC_NAP_insights'
...
default_args = {
    ...
    'description': 'ascp_rms_cost_rtv_kafka_to_orc_16780_TECH_SC_NAP_insights DAG Description',
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        consumer_group_name = 'onix-inventory-merchandise-return-to-vendor-analytical-avro_ascp_rms_cost_rtv_kafka_to_orc_16780_TECH_SC_NAP_insights_kafka_to_orc_load',
    ...
    session_name=get_batch_id(dag_id=dag_id,task_id="kafka_to_bq_load")   
    kafka_to_bq_load = DataprocCreateBatchOperator(
            task_id = "kafka_to_bq_load",
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_ascp_rms_cost_rtv_kafka_to_orc_16780_TECH_SC_NAP_insights_kafka_to_orc_load.json",
    ...
    ascp_rms_cost_rtv_kafka_to_orc_bq_load = open(
        os.path.join(sql_path, "ascp_rms_cost_rtv_kafka_to_orc/bq_load.sql"), "r"
    ).read()

    launch_read_bigquery_to_bigquery_job_1 = BigQueryInsertJobOperator(
        task_id="bigquery_load",
        configuration={
            "query": {"query": ascp_rms_cost_rtv_kafka_to_orc_bq_load, "useLegacySql": False}
        },
        project_id=project_id,
        gcp_conn_id=gcp_conn,
    ...
    creds_setup >> fetch_batch_run_id_task >>[kafka_to_bq_load]
    kafka_to_bq_load >> launch_read_bigquery_to_bigquery_job_1 >> pelican_validator >> pelican_sensor