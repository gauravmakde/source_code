...
dag_id = 'gcp_ascp_sales_return_logical_16780_TECH_SC_NAP_insights'
...
default_args = {
    ...
    'description': 'ascp_sales_return_logical_16780_TECH_SC_NAP_insights DAG Description',
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'ascp-rms-salereturn-event-avro',
        consumer_group_name = 'onix-ascp-rms-salereturn-event-avro_ascp_sales_return_logical_16780_TECH_SC_NAP_insights_kafka_load_kafka',
    ...
    kafka_load_kafka = DataprocCreateBatchOperator(
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_ascp_sales_return_logical_16780_TECH_SC_NAP_insights_kafka_load_kafka.json",
    ...
    ascp_sales_return_logical_sales_return_logical_fact_table = open( os.path.join(sql_path, 'ascp_sales_return_logical/sales_return_logical_fact_table.sql'),"r").read()
    ...
    launch_teradata_load_teradata = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": ascp_sales_return_logical_sales_return_logical_fact_table,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    kafka_load_kafka >>[launch_kafka_end_cntl_track_kafka_end, tpt_jdbc_insert_tpt_load_tpt_control_tbl]
    tpt_jdbc_insert_tpt_load_tpt_control_tbl >>[launch_teradata_load_teradata]
    launch_teradata_load_teradata >>[launch_send_new_relic_metric_send_newrelic_metric]
