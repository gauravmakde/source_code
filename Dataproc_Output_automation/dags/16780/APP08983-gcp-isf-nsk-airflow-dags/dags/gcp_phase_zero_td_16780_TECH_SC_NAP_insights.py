...
dag_id = "gcp_phase_zero_td_16780_TECH_SC_NAP_insights"
...
default_args = {
    ...
    "description": "phase_zero_td_16780_TECH_SC_NAP_insights DAG Description",
    "retry_delay": timedelta(minutes=10),
    "email": (
        None if config_env == "development" else config.get(dag_id, "email").split(",")
    ),
...
with DAG(
    ...
    # launch_other_appId_upstream_dependencies_sensor_0 = ExternalTaskSensor(
    # dag = dag,
    ...
    # launch_other_appId_upstream_dependencies_sensor_1 = ExternalTaskSensor(
    # dag = dag,
    ...
    # launch_other_appId_upstream_dependencies_sensor_2 = ExternalTaskSensor(
    # dag = dag,
    ...
    phase_zero_po_inbound_tableau_extract_fact_ld = open(
        os.path.join(sql_path, "phase_zero/po_inbound_tableau_extract_fact_ld.sql"), "r"
    ).read()
    ...
    launch_main_load_extract = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": phase_zero_po_inbound_tableau_extract_fact_ld,
                "useLegacySql": False,
            }
        },
    ...
    # creds_setup >> launch_other_appId_upstream_dependencies_sensor_0 >>[launch_main_load_extract]
    # launch_other_appId_upstream_dependencies_sensor_1 >>[launch_main_load_extract]
    # launch_other_appId_upstream_dependencies_sensor_2 >>[launch_main_load_extract]
    # launch_main_load_extract >> pelican_validator >> pelican_sensor

    creds_setup >> launch_main_load_extract >> pelican_validator >> pelican_sensor
