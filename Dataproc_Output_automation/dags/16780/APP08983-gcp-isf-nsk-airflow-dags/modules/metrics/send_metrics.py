...
def send_newrelic_metrics(newrelic_connection, hook, bigquery_environment, metric_file_path):
    ...
    for metric in metric_definitions:
        ...
        metric_value_position = metric['metric_value_position']
        sql_template = metric['sql']
        sql = sql_template.format(DBENV=bigquery_environment,TPT_JOB_NAME='INVENTORY_STOCK_QUANTITY_LDG_TO_BASE',SUBJECT_AREA='NAP_ASCP_INVENTORY_STOCK_QUANTITY',ISF_DAG_NAME='ascp_ihub_refresh_16780_TECH_SC_NAP_insights',LDG_TABLE_NAME='NAP_STG.INVENTORY_STOCK_QUANTITY_LDG')
        ...
        if len(list(query_result)) == 0:
            ...
            for tupleValue in query_result:
                ...
                # posting_new_relic_metric = newrelic.send_metric(metric_name, metric_value, tag_value)
