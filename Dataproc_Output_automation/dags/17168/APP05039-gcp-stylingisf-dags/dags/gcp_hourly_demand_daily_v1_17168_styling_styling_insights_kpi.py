...
dag_id = "gcp_hourly_demand_daily_v1_17168_styling_styling_insights_kpi"
...
default_args = {
    ...
    "description": "hourly_demand_daily_v1_17168_styling_styling_insights_kpi DAG Description",
...
with DAG(
    ...
    hourly_demand_daily = open(
        os.path.join(sql_path, "hourly_demand_daily.sql"), "r"
    ).read()

    launch_run_terdata_sql_stg_1_job_0 = BigQueryInsertJobOperator(
        task_id="run_terdata_sql_stg_1_job_0",
        configuration={
            "query": {
                "query": hourly_demand_daily,
                "useLegacySql": False,
            }
        },
    ...
    (
        creds_setup
        >> launch_run_terdata_sql_stg_1_job_0
        >> pelican_validator
        >> pelican_sensor
    )
