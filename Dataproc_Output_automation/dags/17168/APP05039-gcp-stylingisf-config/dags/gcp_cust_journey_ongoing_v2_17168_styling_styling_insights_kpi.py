...
dag_id = "gcp_cust_journey_ongoing_v2_17168_styling_styling_insights_kpi"
...
default_args = {
    ...
    "description": "cust_journey_ongoing_v2_17168_styling_styling_insights_kpi DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="customer_styleboard_journey_object_model_avro",
        consumer_group_name="onix-customer_styleboard_journey_object_model_avro_cust_journey_ongoing_v2_17168_styling_styling_insights_kpi_read_kafka_to_teradata_cj_kafka_to_stg",
    ...
    session_name = get_batch_id(
        dag_id=dag_id, task_id="read_kafka_to_teradata_cj_kafka_to_stg"
    )
    read_kafka_to_teradata_cj_kafka_to_stg = DataprocCreateBatchOperator(
        task_id="read_kafka_to_teradata_cj_kafka_to_stg",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_cust_journey_ongoing_v2_17168_styling_styling_insights_kpi_read_kafka_to_teradata_cj_kafka_to_stg.json",
    ...
    # cust_journey_ongoing_v2_17168_styling_styling_insights_kpi_read_kafka_to_teradata_cj_stg_to_td = open(
    #     os.path.join(
    #         sql_path,
    #         "cust_journey_ongoing_v2_17168_styling_styling_insights_kpi_read_kafka_to_teradata_cj_stg_to_td.sql",
    #     ),
    #     "r",
    # ).read()

    # launch_read_kafka_to_teradata_cj_stg_to_td = BigQueryInsertJobOperator(
    #     task_id = "read_kafka_to_teradata_cj_stg_to_td",
    #     configuration =
    #     {
    #         "query":
    #         {
    #             "query": cust_journey_ongoing_v2_17168_styling_styling_insights_kpi_read_kafka_to_teradata_cj_stg_to_td,
    #             "useLegacySql": False
    #         }
    #     },
    #     project_id = project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >> [read_kafka_to_teradata_cj_kafka_to_stg]
    read_kafka_to_teradata_cj_kafka_to_stg >> pelican_validator >> pelican_sensor
