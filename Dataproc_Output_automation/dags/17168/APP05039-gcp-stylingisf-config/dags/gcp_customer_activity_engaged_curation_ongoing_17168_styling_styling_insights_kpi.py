...
dag_id = (
    "gcp_customer_activity_engaged_curation_ongoing_17168_styling_styling_insights_kpi"
)
...
default_args = {
    ...
    "description": "customer_activity_engaged_curation_ongoing_17168_styling_styling_insights_kpi DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="customer-activity-engaged-avro",
        consumer_group_name="onix-customer-activity-engaged-avro_customer_activity_engaged_curation_ongoing_17168_styling_styling_insights_kpi_read_kafka_to_teradata_job_0",
    ...
    read_kafka_to_bigquery_job_0 = DataprocCreateBatchOperator(
        ...
        batch={
            "runtime_config": {
                "version": "1.1",
                "properties": { 'spark.sql.legacy.avro.datetimeRebaseModeInWrite': 'LEGACY', 'spark.speculation': 'false', 'spark.airflow.run_id':"{{ ti.xcom_pull(task_ids='fetch_batch_run_id_task')}}", "spark.sql.parquet.int96AsTimestamp": "false",
                "spark.sql.parquet.outputTimestampType": "TIMESTAMP_MICROS", "spark.sql.parquet.binaryAsString": "true"},
            },
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_customer_activity_engaged_curation_ongoing_17168_styling_styling_insights_kpi_read_kafka_to_bq_job_0.json",
    ...
    cae_stg_to_td = open(os.path.join(sql_path, "cae_stg_to_td.sql"), "r").read()

    launch_read_kafka_to_bigquery_job_1 = BigQueryInsertJobOperator(
        task_id="read_kafka_to_bigquery_job_1",
        configuration={"query": {"query": cae_stg_to_td, "useLegacySql": False}},
        project_id=project_id,
        gcp_conn_id=gcp_conn,
    ...
    creds_setup >> fetch_batch_run_id_task >> read_kafka_to_bigquery_job_0 >> [launch_read_kafka_to_bigquery_job_1]
    launch_read_kafka_to_bigquery_job_1 >> pelican_validator >> pelican_sensor
