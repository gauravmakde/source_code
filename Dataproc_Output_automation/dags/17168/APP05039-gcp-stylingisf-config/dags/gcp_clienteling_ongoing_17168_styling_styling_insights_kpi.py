...
dag_id = "gcp_clienteling_ongoing_17168_styling_styling_insights_kpi"
...
default_args = {
    ...
    "description": "clienteling_ongoing_17168_styling_styling_insights_kpi DAG Description",
...
with DAG(
    ...
    # Please add the consumer_group_name , topic_name from json file
    fetch_batch_run_id_task_0 = FetchKafkaBatchRunIdOperator(
        task_id="fetch_batch_run_id_task_0",
        gcp_project_id=project_id,
        gcp_connection_id=gcp_conn,
        gcp_region=region,
        topic_name="customer-clienteling-relationship-started-avro",
        consumer_group_name="gcp-customer-clienteling-relationship-started-avro_clienteling_ongoing_17168_styling_styling_insights_kpi_read_kafka_to_teradata_job_0",
    ...
    fetch_batch_run_id_task_1 = FetchKafkaBatchRunIdOperator(
        task_id="fetch_batch_run_id_task_1",
        gcp_project_id=project_id,
        gcp_connection_id=gcp_conn,
        gcp_region=region,
        topic_name="customer-clienteling-relationship-ended-avro",
        consumer_group_name="onix-customer-clienteling-relationship-ended-avro_clienteling_ongoing_17168_styling_styling_insights_kpi_read_kafka_to_teradata_job_1",
        offsets_table=f"`{dataplex_project_id}.onehop_etl_app_db.kafka_consumer_offset_batch_details`",
        # source_table=f"`{dataplex_project_id}.onehop_etl_app_db.source_kafka_consumer_offset_batch_details`",
        default_latest_run_id=int(
            (datetime.today() - timedelta(days=1)).strftime("%Y%m%d000000")
    ...
    session_name = get_batch_id(dag_id=dag_id, task_id="read_kafka_to_teradata_job_0")
    read_kafka_to_bigquery_job_0 = DataprocCreateBatchOperator(
        task_id="read_kafka_to_bigquery_job_0",
        ...
        batch={
            "runtime_config": {
                ...
                "properties": {
                    ...
                    "spark.airflow.run_id": "{{ ti.xcom_pull(task_ids = 'fetch_batch_run_id_task_0')}}",
                },
            },
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_clienteling_ongoing_17168_styling_styling_insights_kpi_read_kafka_to_bq_job_0.json",
    ...
    session_name = get_batch_id(dag_id=dag_id, task_id="read_kafka_to_teradata_job_1")
    read_kafka_to_bigquery_job_1 = DataprocCreateBatchOperator(
        task_id="read_kafka_to_bigquery_job_1",
        project_id=project_id,
        region=region,
        gcp_conn_id=gcp_conn,
        batch={
            "runtime_config": {
                ...
                "properties": {
                    "spark.sql.legacy.avro.datetimeRebaseModeInWrite": "LEGACY",
                    "spark.speculation": "false",
                    "spark.airflow.run_id": "{{ ti.xcom_pull(task_ids = 'fetch_batch_run_id_task_1')}}",
                },
            },
            "spark_batch": {
                "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                ...
                "args": [
                    f"{user_config_path}/argument_clienteling_ongoing_17168_styling_styling_insights_kpi_read_kafka_to_bq_job_1.json",
                    # "--aws_user_role_external_id",
                    # Variable.get("aws_role_externalid"),
                ],
            },
    ...
    clienteling_stg_to_clienteling_fact = open(
        os.path.join(sql_path, "clienteling_stg_to_clienteling_fact.sql"), "r"
    ).read()

    launch_read_kafka_to_bigquery_job_2 = BigQueryInsertJobOperator(
        task_id="read_kafka_to_bigquery_job_2",
        configuration={
            "query": {
                "query": clienteling_stg_to_clienteling_fact,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    creds_setup >> fetch_batch_run_id_task_0 >> [read_kafka_to_bigquery_job_0]
    (
        read_kafka_to_bigquery_job_0
        >> fetch_batch_run_id_task_1
        >> [read_kafka_to_bigquery_job_1]
    )
    read_kafka_to_bigquery_job_1 >> [launch_read_kafka_to_bigquery_job_2]
    launch_read_kafka_to_bigquery_job_2 >> pelican_validator >> pelican_sensor
