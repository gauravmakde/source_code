...
select
    ...
    cast(bankcard_settlement_results.bankcardresult.transactiontime as string) as transaction_time,
...
select
    ...
    cast(giftcard_note_tender_results.transactiontime as string) as transaction_time,
...
select
    ...
    cast(paypal_billing_agreement_settlement_results.paypalbillingagreementtenderresult.transactiontime as string) as transaction_time,
...
select
    ...
    cast(paypal_settlement_results.tenderresult.transactiontime as string) as transaction_time,
