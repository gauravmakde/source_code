...
default_args = {
    ...
    "description": "payment_bin_v2_bigquery_4638_payments_insights DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="customer-payment-result-bin-v2-analytical-avro",
        consumer_group_name="onix-customer-payment-result-bin-v2-analytical-avro_payment_bin_v2_teradata_4638_payments_insights_payment_bin_v2_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job",
    ...
    session_name = get_batch_id(
        dag_id=dag_id,
        task_id="payment_bin_v2_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job",
    )
    payment_bin_v2_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job = DataprocCreateBatchOperator(
        task_id="payment_bin_v2_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_payment_bin_v2_bigquery_4638_payments_insights_payment_bin_v2_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job.json",
    ...
    bigquery_payment_bin_v2_bigquery_stg_to_bigquery_fct = open(
        os.path.join(
            sql_path, "bigquery/payment_bin_v2_bigquery_stg_to_bigquery_fct.sql"
        ),
        "r",
    ).read()

    launch_payment_bin_v2_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job = BigQueryInsertJobOperator(
        task_id="payment_bin_v2_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job",
        configuration={
            "query": {
                "query": bigquery_payment_bin_v2_bigquery_stg_to_bigquery_fct,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    (
        ...
        >> [payment_bin_v2_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job]
    )
    payment_bin_v2_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job >> [
        launch_payment_bin_v2_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job
    ]
    (
        launch_payment_bin_v2_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job
        >> pelican_validator
