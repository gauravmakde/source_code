...
default_args = {
    ...
    'description': 'payment_auth_res_afterpay_id_bigquery_4638_payments_insights DAG Description',
...
with DAG(
    ...
    bq_payment_auth_result_afterpay_id_bq_stg_to_bq_fct = open( os.path.join(sql_path, 'bigquery/payment_auth_result_afterpay_id_bigquery_stg_to_bigquery_fct.sql'),"r").read()

    launch_payment_auth_res_afterpay_id_bigquery_stg_to_bigquery_fct_stage_0_bigquery_stg_to_bigquery_fct_job = BigQueryInsertJobOperator(
        task_id = "launch_payment_auth_res_afterpay_id_bigquery_stg_to_bigquery_fct_stage_0_bigquery_stg_to_bigquery_fct_job",
        configuration = 
        {
            "query": 
            {
                "query": bq_payment_auth_result_afterpay_id_bq_stg_to_bq_fct,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_payment_auth_res_afterpay_id_bigquery_stg_to_bigquery_fct_stage_0_bigquery_stg_to_bigquery_fct_job >> pelican_validator >> pelican_sensor