...
default_args = {
    ...
    'description': 'afterpay_auth_details_update_bigquery_4638_payments_insights DAG Description',
...
with DAG(
    ...
    bigquery_afterpay_auth_details_update_teradata_fct = open( os.path.join(sql_path, 'bigquery/afterpay_auth_details_update_bigquery_fct.sql'),"r").read()

    launch_afterpay_auth_update_bigquery_stg_stage_0_job_insert_update = BigQueryInsertJobOperator(
        task_id = "launch_afterpay_auth_update_bigquery_stg_stage_0_job_insert_update",
        configuration = 
        {
            "query": 
            {
                "query": bigquery_afterpay_auth_details_update_teradata_fct,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_check_external_upstream_dependencies_sensor_0 >>[launch_afterpay_auth_update_bigquery_stg_stage_0_job_insert_update]
    launch_check_external_upstream_dependencies_sensor_1 >>[launch_afterpay_auth_update_bigquery_stg_stage_0_job_insert_update]
    launch_afterpay_auth_update_bigquery_stg_stage_0_job_insert_update >> pelican_validator >> pelican_sensor