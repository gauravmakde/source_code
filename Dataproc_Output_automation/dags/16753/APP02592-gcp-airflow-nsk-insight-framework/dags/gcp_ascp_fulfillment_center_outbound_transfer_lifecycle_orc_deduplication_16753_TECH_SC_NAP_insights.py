...
dag_id = "gcp_ascp_fulfillment_center_outbound_transfer_lifecycle_orc_deduplication_16753_TECH_SC_NAP_insights"
...
default_args = {
    ...
    "description": "ascp_fulfillment_center_outbound_transfer_lifecycle_orc_deduplication_16753_TECH_SC_NAP_insights DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="inventory-fulfillment-center-outbound-transfer-lifecycle-analytical-avro",
        consumer_group_name="onix-inventory-fulfillment-center-outbound-transfer-lifecycle-analytical-avro_ascp_fulfillment_center_outbound_transfer_lifecycle_orc_deduplication_16753_TECH_SC_NAP_insights_kafka_to_orc_load_data_to_tmp",
    ...
    session_name = get_batch_id(dag_id=dag_id, task_id="kafka_to_orc_load_data_to_tmp")
    kafka_to_orc_load_data_to_tmp = DataprocCreateBatchOperator(
        task_id="kafka_to_orc_load_data_to_tmp",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_ascp_fulfillment_center_outbound_transfer_lifecycle_orc_deduplication_16753_TECH_SC_NAP_insights_kafka_to_orc_load_data_to_tmp.json",
    ...
    creds_setup >> fetch_batch_run_id_task >> [kafka_to_orc_load_data_to_tmp]
    kafka_to_orc_load_data_to_tmp >> pelican_validator >> pelican_sensor
