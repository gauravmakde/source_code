...
dag_id = "gcp_ascp_distribution_center_inbound_carton_deduplication_16753_TECH_SC_NAP_insights"
...
default_args = {
    ...
    "description": "ascp_distribution_center_inbound_carton_deduplication_16753_TECH_SC_NAP_insights DAG Description",
...
with DAG(
    ...
    # Please add the consumer_group_name,topic_name from kafkaa json file and remove if kafka is not present
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        consumer_group_name="onix-inventory-distribution-center-inbound-carton-v2-analytical-avro_ascp_distribution_center_inbound_carton_deduplication_16753_TECH_SC_NAP_insights_kafka_to_orc_v2_load_data",
    ...
    session_name = get_batch_id(dag_id=dag_id, task_id="kafka_to_orc_v2_load_data")
    kafka_to_orc_v2_load_data = DataprocCreateBatchOperator(
        task_id="kafka_to_orc_v2_load_data",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_ascp_distribution_center_inbound_carton_deduplication_16753_TECH_SC_NAP_insights_kafka_to_orc_v2_load_data.json",
    ...
    creds_setup >> fetch_batch_run_id_task >> [kafka_to_orc_v2_load_data]
    kafka_to_orc_v2_load_data >> pelican_validator >> pelican_sensor
