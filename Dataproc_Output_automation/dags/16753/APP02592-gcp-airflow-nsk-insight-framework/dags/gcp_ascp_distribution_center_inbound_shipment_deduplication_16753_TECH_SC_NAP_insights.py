# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        9c31787c1c3e72fdbb0e7dcae5e796c60e6ff0b0
# CI pipeline URL:      https://git.jwn.app/TM00800/app02592-gcp-airflow-nsk-insight-framework/-/pipelines/7427597
# CI commit timestamp:  2024-11-05T12:57:35+00:00
...
dag_id = "gcp_ascp_distribution_center_inbound_shipment_deduplication_16753_TECH_SC_NAP_insights"
...
default_args = {
    ...
    "description": "ascp_distribution_center_inbound_shipment_deduplication_16753_TECH_SC_NAP_insights DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="inventory-distribution-center-inbound-shipment-analytical-avro",
        consumer_group_name="onix-inventory-distribution-center-inbound-shipment-analytical-avro_ascp_distribution_center_inbound_shipment_deduplication_16753_TECH_SC_NAP_insights_kafka_to_orc_load_data",
    ...
    session_name = get_batch_id(dag_id=dag_id, task_id="kafka_to_orc_load_data")
    kafka_to_orc_load_data = DataprocCreateBatchOperator(
        task_id="kafka_to_orc_load_data",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_ascp_distribution_center_inbound_shipment_deduplication_16753_TECH_SC_NAP_insights_kafka_to_orc_load_data.json",
    ...
    creds_setup >> fetch_batch_run_id_task >> [kafka_to_orc_load_data]
    kafka_to_orc_load_data >> pelican_validator >> pelican_sensor
