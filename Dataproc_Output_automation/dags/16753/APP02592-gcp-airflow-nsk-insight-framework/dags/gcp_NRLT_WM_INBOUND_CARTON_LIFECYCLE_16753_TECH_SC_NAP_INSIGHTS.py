# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        1eb975d01893baa479ffc41f5a7b7ee1b45e2183
# CI pipeline URL:      https://git.jwn.app/TM00800/app02592-gcp-airflow-nsk-insight-framework/-/pipelines/7238276
# CI commit timestamp:  2024-10-16T09:28:59+00:00
...
dag_id = "gcp_nrlt_wm_inbound_carton_lifecycle_16753_TECH_SC_NAP_insights"
...
default_args = {
    ...
    "description": "nrlt_wm_inbound_carton_lifecycle_16753_TECH_SC_NAP_insights DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="inventory-distribution-center-inbound-carton-v2-analytical-avro",
        consumer_group_name="onix-inventory-distribution-center-inbound-carton-v2-analytical-avro_nrlt_wm_inbound_carton_lifecycle_16753_TECH_SC_NAP_insights_kafka_load_02_kafka   ",
    ...
    nrlt_wm_inbound_carton_start_batch = open(
        os.path.join(sql_path, "nrlt_wm_inbound_carton/start_batch.sql"), "r"
    ).read()
    ...
    launch_start_batch_load_01_start_batch = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": nrlt_wm_inbound_carton_start_batch,
                "useLegacySql": False,
            }
        },
    ...
    kafka_load_02_kafka = DataprocCreateBatchOperator(
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_nrlt_wm_inbound_carton_lifecycle_16753_TECH_SC_NAP_insights_kafka_load_02_kafka.json",
    ...
    nrlt_wm_inbound_carton_wm_inbound_carton_fact_load = open(
        os.path.join(
            sql_path, "nrlt_wm_inbound_carton/wm_inbound_carton_fact_load.sql"
        ),
        "r",
    ).read()

    launch_bigquery_wm_inbound_carton_fact_load = BigQueryInsertJobOperator(
        task_id="bigquery_wm_inbound_carton_fact_load",
        configuration={
            "query": {
                "query": nrlt_wm_inbound_carton_wm_inbound_carton_fact_load,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    nrlt_wm_inbound_carton_wm_inbound_carton_events_fact_load = open(
        os.path.join(
            sql_path, "nrlt_wm_inbound_carton/wm_inbound_carton_events_fact_load.sql"
        ),
        "r",
    ).read()

    launch_bigquery_wm_inbound_carton_events_fact_load = BigQueryInsertJobOperator(
        task_id="bigquery_wm_inbound_carton_events_fact_load",
        configuration={
            "query": {
                "query": nrlt_wm_inbound_carton_wm_inbound_carton_events_fact_load,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    nrlt_wm_inbound_carton_wm_inbound_carton_sku_adjustment_events_fact_load = open(
        os.path.join(
            sql_path,
            "nrlt_wm_inbound_carton/wm_inbound_carton_sku_adjustment_events_fact_load.sql",
        ),
        "r",
    ).read()

    launch_bigquery_wm_inbound_carton_sku_adjustment_events_fact_load = BigQueryInsertJobOperator(
        task_id="bigquery_wm_inbound_carton_sku_adjustment_events_fact_load",
        configuration={
            "query": {
                "query": nrlt_wm_inbound_carton_wm_inbound_carton_sku_adjustment_events_fact_load,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    nrlt_wm_inbound_carton_wm_inbound_carton_received_fact_load = open(
        os.path.join(
            sql_path, "nrlt_wm_inbound_carton/wm_inbound_carton_received_fact_load.sql"
        ),
        "r",
    ).read()

    launch_bigquery_wm_inbound_carton_received_fact_load = BigQueryInsertJobOperator(
        task_id="bigquery_wm_inbound_carton_received_fact_load",
        configuration={
            "query": {
                "query": nrlt_wm_inbound_carton_wm_inbound_carton_received_fact_load,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    launch_send_new_relic_metric_send_newrelic_metric = PythonOperator(
        ...
        op_kwargs={
            ...
            "metrics_yaml_file": os.path.join(
                module_path, "yaml/NRLT_WM_INBOUND_CARTON_METRICS.yaml"
            ),
        },
    )
    ...
    launch_end_batch_load_09_end_batch = BigQueryInsertJobOperator(
        task_id="end_batch_load_09_end_batch",
    ...
    (
        ...
        >> launch_start_batch_load_01_start_batch
        >> [kafka_load_02_kafka, launch_kafka_start_cntl_track_kafka_start]
    )

    kafka_load_02_kafka >> [
        launch_kafka_end_cntl_track_kafka_end,
        launch_bigquery_wm_inbound_carton_events_fact_load,
        launch_bigquery_wm_inbound_carton_fact_load,
        launch_bigquery_wm_inbound_carton_received_fact_load,
        launch_bigquery_wm_inbound_carton_sku_adjustment_events_fact_load,
    ]

    launch_bigquery_wm_inbound_carton_fact_load >> [
        launch_end_batch_load_09_end_batch,
        launch_send_new_relic_metric_send_newrelic_metric,
    ]
    launch_bigquery_wm_inbound_carton_events_fact_load >> [
        launch_end_batch_load_09_end_batch,
        launch_send_new_relic_metric_send_newrelic_metric,
