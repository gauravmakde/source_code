...
dag_id = 'gcp_cco_line_items_table_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'cco_line_items_table_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    launch_check_external_upstream_dependencies_sensor_0 = DummyOperator(task_id='check_external_upstream_dependencies_0')

    cco_refresh_cco_line_items_daily = open( os.path.join(sql_path, 'cco_refresh/cco_line_items_daily.sql'),"r").read()
    ...
    launch_run_cco_job_1_cco_line_items = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": cco_refresh_cco_line_items_daily,
                "useLegacySql": False
            }
        },
    ...
    launch_run_cco_job_1_cco_line_items >> pelican_validator >> pelican_sensor