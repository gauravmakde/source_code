...
dag_id = "gcp_outcomes_ops_scorecard_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "outcomes_ops_scorecard_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    ops_scorecard_outcomes_ops_scorecard = open(
        os.path.join(sql_path, "ops_scorecard/main/outcomes_ops_scorecard.sql"), "r"
    ).read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": ops_scorecard_outcomes_ops_scorecard,
                "useLegacySql": False,
            }
        },
