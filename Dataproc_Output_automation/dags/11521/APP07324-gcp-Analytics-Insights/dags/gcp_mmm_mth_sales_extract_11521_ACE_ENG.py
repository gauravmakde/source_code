...
dag_id = 'gcp_mmm_mth_sales_extract_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'mmm_mth_sales_extract_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    mmm_mmm_mth_sales_extract = open( os.path.join(sql_path, 'mmm/mmm_mth_sales_extract.sql'),"r").read()
    ...
    launch_run_terdata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": mmm_mmm_mth_sales_extract,
                "useLegacySql": False
            }
        },
