...
dag_id = 'gcp_divisional_sessions_daily_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'divisional_sessions_daily_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    product_funnel_divisional_sessions_daily = open( os.path.join(sql_path, 'product_funnel/divisional_sessions_daily.sql'),"r").read()

    launch_run_divisional_sessions_daily_sql_run_divisional_sessions_daily_table = BigQueryInsertJobOperator(
        task_id = "run_divisional_sessions_daily_sql_run_divisional_sessions_daily_table",
        configuration =
        {
            "query":
            {
                "query": product_funnel_divisional_sessions_daily,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_divisional_sessions_daily_sql_run_divisional_sessions_daily_table >> pelican_validator >> pelican_sensor