...
dag_id = 'gcp_mothership_clarity_digital_demand_price_band_agg_11521_ACE_ENG'
...
start_date = pendulum.datetime(2024, 2, 27, 15, 5)
...
default_args = {
    ...
    'description': 'mothership_clarity_digital_demand_price_band_agg_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    clarity_clarity_mothership_clarity_digital_demand_price_band_agg_11521_ACE_ENG_run_clarity_digital_demand_price_band_agg_clarity_digital_demand_price_band_agg = open( os.path.join(sql_path, 'clarity/mothership_clarity_digital_demand_price_band_agg_11521_ACE_ENG_run_clarity_digital_demand_price_band_agg_clarity_digital_demand_price_band_agg.sql'),"r").read()

    launch_run_clarity_digital_demand_price_band_agg_job_0 = BigQueryInsertJobOperator(
        task_id = "run_clarity_digital_demand_price_band_agg_job_0",
        configuration = 
        {
            "query": 
            {
                "query": clarity_clarity_mothership_clarity_digital_demand_price_band_agg_11521_ACE_ENG_run_clarity_digital_demand_price_band_agg_clarity_digital_demand_price_band_agg,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_clarity_digital_demand_price_band_agg_job_0 >> pelican_validator >> pelican_sensor