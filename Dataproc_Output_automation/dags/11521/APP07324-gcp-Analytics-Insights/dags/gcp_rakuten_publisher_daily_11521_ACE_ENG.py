...
dag_id = 'gcp_rakuten_publisher_daily_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'rakuten_publisher_daily_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    apd_rakuten_publisher_daily = open( os.path.join(sql_path, 'apd/rakuten_publisher_daily.sql'),"r").read()

    launch_run_bq_sql_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        task_id = "run_bq_sql_job_1_run_sql_to_update_t2_table",
        configuration = 
        {
            "query": 
            {
                "query": apd_rakuten_publisher_daily,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_bq_sql_job_1_run_sql_to_update_t2_table >> pelican_validator >> pelican_sensor