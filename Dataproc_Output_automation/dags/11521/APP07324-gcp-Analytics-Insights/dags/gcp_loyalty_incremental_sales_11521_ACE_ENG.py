...
dag_id = 'gcp_loyalty_incremental_sales_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'loyalty_incremental_sales_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    KPI_Scorecard_loyalty_incremental_sales = open( os.path.join(sql_path, 'KPI_Scorecard/loyalty_incremental_sales.sql'),"r").read()
    ...
    launch_run_terdata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": KPI_Scorecard_loyalty_incremental_sales,
                "useLegacySql": False
            }
        },
