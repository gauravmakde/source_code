...
dag_id = 'gcp_marketability_last12month_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'marketability_last12month_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    audience_marketability_marketability_last12month = open( os.path.join(sql_path, 'audience_marketability/marketability_last12month.sql'),"r").read()

    launch_run_bq_sql_job_0_run_marketability_last12month = BigQueryInsertJobOperator(
        task_id = "run_bq_sql_job_0_run_marketability_last12month",
        configuration = 
        {
            "query": 
            {
                "query": audience_marketability_marketability_last12month,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_bq_sql_job_0_run_marketability_last12month >> pelican_validator >> pelican_sensor