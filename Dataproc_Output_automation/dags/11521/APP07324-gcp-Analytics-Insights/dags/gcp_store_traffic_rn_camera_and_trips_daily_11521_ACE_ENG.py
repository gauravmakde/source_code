...
dag_id = 'gcp_store_traffic_rn_camera_and_trips_daily_11521_ACE_ENG'
...
from modules import retailnext_camera_upstream_check
...
default_args = {
    ...
    'description': 'store_traffic_rn_camera_and_trips_daily_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    upstream_dep_stage_check_retailnext_camera_data_operator = BranchPythonOperator(
    task_id='upstream_dep_stage_check_retailnext_camera_data',
    python_callable=retailnext_camera_upstream_check.callable_func_name,op_args=[bq_hook])

    
        
    store_traffic_model_fls_store_traffic_rn_camera_and_trips_daily = open( os.path.join(sql_path, 'store_traffic_model/fls_store_traffic/rn_camera_and_trips_daily.sql'),"r").read()

    launch_run_bigquery_sql_job_0_refresh_t2_table = BigQueryInsertJobOperator(
        task_id = "run_bigquery_sql_job_0_refresh_t2_table",
        configuration = 
        {
            "query": 
            {
                "query": store_traffic_model_fls_store_traffic_rn_camera_and_trips_daily,
                "useLegacySql": False
            }
        },
    ...
    # launch_store_traffic_daily_11521_ACE_ENG = TriggerDagRunOperator(
    # dag=dag,
    # task_id='trigger_dag_store_traffic_daily_11521_ACE_ENG',
    # trigger_dag_id='gcp_store_traffic_daily_11521_ACE_ENG',
    # execution_date='{{ execution_date }}')

    launch_store_traffic_daily_11521_ACE_ENG = DummyOperator(task_id="launch_store_traffic_daily_11521_ACE_ENG",dag=dag)


    creds_setup >> upstream_dep_stage_check_retailnext_camera_data_operator >>launch_run_bigquery_sql_job_0_refresh_t2_table
    launch_run_bigquery_sql_job_0_refresh_t2_table >>launch_store_traffic_daily_11521_ACE_ENG >> pelican_validator >> pelican_sensor