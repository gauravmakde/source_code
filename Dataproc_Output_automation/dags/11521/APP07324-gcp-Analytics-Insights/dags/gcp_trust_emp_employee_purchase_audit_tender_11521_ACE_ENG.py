...
dag_id = 'gcp_trust_emp_employee_purchase_audit_tender_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'trust_emp_employee_purchase_audit_tender_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    employee_purchase_audit_trust_emp_employee_purchase_audit_tender = open( os.path.join(sql_path, 'employee_purchase_audit/trust_emp_employee_purchase_audit_tender.sql'),"r").read()
    ...
    launch_run_terdata_sql_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        ...
        configuration =
        {
            "query":
            {
                "query": employee_purchase_audit_trust_emp_employee_purchase_audit_tender,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_terdata_sql_job_1_run_sql_to_update_t2_table >> pelican_validator >> pelican_sensor