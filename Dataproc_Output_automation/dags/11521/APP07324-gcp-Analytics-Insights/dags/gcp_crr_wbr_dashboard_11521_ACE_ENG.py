...
dag_id = "gcp_crr_wbr_dashboard_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "crr_wbr_dashboard_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    npr_credit_refund_request_crr_wbr_dashboard = open(
        os.path.join(sql_path, "npr_credit_refund_request/crr_wbr_dashboard.sql"), "r"
    ).read()
    ...
    launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": npr_credit_refund_request_crr_wbr_dashboard,
                "useLegacySql": False,
            }
        },
