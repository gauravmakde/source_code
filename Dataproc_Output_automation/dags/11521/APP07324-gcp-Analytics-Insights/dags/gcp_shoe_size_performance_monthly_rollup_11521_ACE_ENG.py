...
dag_id = "gcp_shoe_size_performance_monthly_rollup_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "shoe_size_performance_monthly_rollup_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    # external_dag_id='gcp_shoe_size_performance_monthly_base_11521_ACE_ENG',
    # timeout=3600,
    # execution_date_fn=get_most_recent_dag_run,
    # poke_interval=120,
    # retries=3)

    shoe_size_performance_monthly_shoe_size_performance_monthly_rollup = open(
        os.path.join(
            sql_path,
            "shoe_size_performance_monthly/shoe_size_performance_monthly_rollup.sql",
        ),
        "r",
    ).read()

    launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        task_id="run_bigquery_sql_job_1_run_sql_to_update_t2_table",
        configuration={
            "query": {
                "query": shoe_size_performance_monthly_shoe_size_performance_monthly_rollup,
                "useLegacySql": False,
            }
        },
    ...
    # creds_setup >> launch_check_external_upstream_dependencies_sensor_0 >>[launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table]
    # launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table >> pelican_validator >> pelican_sensor

    creds_setup >> [launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table]
    (
        launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table
        >> pelican_validator
        >> pelican_sensor
    )
