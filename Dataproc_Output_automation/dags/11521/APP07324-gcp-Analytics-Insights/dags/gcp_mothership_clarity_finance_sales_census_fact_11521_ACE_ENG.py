...
dag_id = 'gcp_mothership_clarity_finance_sales_census_fact_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'mothership_clarity_finance_sales_census_fact_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    clarity_clarity_finance_sales_census_fact = open( os.path.join(sql_path, 'clarity/clarity_finance_sales_census_fact.sql'),"r").read()

    launch_run_clarity_finance_sales_census_fact_job_0 = BigQueryInsertJobOperator(
        task_id = "run_clarity_finance_sales_census_fact_job_0",
        configuration = 
        {
            "query": 
            {
                "query": clarity_clarity_finance_sales_census_fact,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_clarity_finance_sales_census_fact_job_0 >> pelican_validator >> pelican_sensor