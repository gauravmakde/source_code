...
dag_id = 'gcp_mothership_finance_sales_demand_orders_traffic_fact_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'mothership_finance_sales_demand_orders_traffic_fact_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    mothership_sales_demand_orders_traffic_fact = open( os.path.join(sql_path, 'mothership/sales_demand_orders_traffic_fact.sql'),"r").read()

    launch_run_finance_sales_demand_orders_traffic_job_0 = BigQueryInsertJobOperator(
        task_id = "run_finance_sales_demand_orders_traffic_job_0",
        configuration = 
        {
            "query": 
            {
                "query": mothership_sales_demand_orders_traffic_fact,
                "useLegacySql": False
            }
        },
    ...
    launch_precast_daily_11521_ACE_ENG = DummyOperator(task_id='trigger_dag_precast_daily_11521_ACE_ENG')

    # launch_precast_daily_11521_ACE_ENG = TriggerDagRunOperator(
    # dag=dag,
    # task_id='trigger_dag_precast_daily_11521_ACE_ENG',
    # trigger_dag_id='gcp_precast_daily_11521_ACE_ENG',
    # execution_date='{{ execution_date }}')

    creds_setup >> launch_run_finance_sales_demand_orders_traffic_job_0 >>[launch_precast_daily_11521_ACE_ENG] >> pelican_validator >> pelican_sensor