...
dag_id = 'gcp_trust_emp_employee_purchase_audit_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'trust_emp_employee_purchase_audit_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    employee_purchase_audit_trust_emp_employee_purchase_audit = open( os.path.join(sql_path, 'employee_purchase_audit/trust_emp_employee_purchase_audit.sql'),"r").read()
    ...
    launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": employee_purchase_audit_trust_emp_employee_purchase_audit,
                "useLegacySql": False
            }
        },
    ...
    launch_trust_emp_employee_purchase_audit_tender_11521_ACE_ENG = TriggerDagRunOperator(
    dag=dag,
    task_id='trigger_dag_trust_emp_employee_purchase_audit_tender_11521_ACE_ENG',
    trigger_dag_id='gcp_trust_emp_employee_purchase_audit_tender_11521_ACE_ENG',
    execution_date='{{ execution_date }}')

    creds_setup >> launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table >> launch_trust_emp_employee_purchase_audit_tender_11521_ACE_ENG >> pelican_validator >> pelican_sensor