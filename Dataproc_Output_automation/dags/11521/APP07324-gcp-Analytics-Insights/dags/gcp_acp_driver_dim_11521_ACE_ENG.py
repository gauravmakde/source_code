...
dag_id = "gcp_acp_driver_dim_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "acp_driver_dim_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    universal_semantic_layer_acp_driver_dim = open(
        os.path.join(sql_path, "universal_semantic_layer/acp_driver_dim.sql"), "r"
    ).read()
    ...
    launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table = (
        BigQueryInsertJobOperator(
            ...
            configuration={
                "query": {
                    "query": universal_semantic_layer_acp_driver_dim,
                    "useLegacySql": False,
                }
            },
    ...
    launch_customer_acquisition_dim_11521_ACE_ENG = TriggerDagRunOperator(
        dag=dag,
        task_id="trigger_dag_customer_acquisition_dim_11521_ACE_ENG",
        trigger_dag_id="gcp_customer_acquisition_dim_11521_ACE_ENG",
    ...
    (
        creds_setup
        >> launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table
        >> launch_customer_acquisition_dim_11521_ACE_ENG
        >> pelican_validator
        >> pelican_sensor
    )
