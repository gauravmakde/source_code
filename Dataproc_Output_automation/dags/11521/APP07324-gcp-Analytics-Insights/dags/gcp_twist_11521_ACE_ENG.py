...
dag_id = "gcp_twist_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "twist_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    twist_twist_daily = open(
        os.path.join(sql_path, "twist/twist_daily.sql"), "r"
    ).read()

    launch_run_bigquery_sql_stg_0_job_0_twist_daily = BigQueryInsertJobOperator(
        task_id="run_bigquery_sql_stg_0_job_0_twist_daily",
        configuration={"query": {"query": twist_twist_daily, "useLegacySql": False}},
    ...
    # launch_product_price_funnel_daily_11521_ACE_ENG = TriggerDagRunOperator(
    # dag=dag,
    # task_id='trigger_dag_product_price_funnel_daily_11521_ACE_ENG',
    # trigger_dag_id='gcp_product_price_funnel_daily_11521_ACE_ENG',
    # execution_date='{{ execution_date }}')

    # creds_setup >> launch_run_bigquery_sql_stg_0_job_0_twist_daily >>[launch_product_price_funnel_daily_11521_ACE_ENG] >> pelican_validator >> pelican_sensor

    (
        creds_setup
        >> launch_run_bigquery_sql_stg_0_job_0_twist_daily
        >> pelican_validator
        >> pelican_sensor
    )
