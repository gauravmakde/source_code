...
dag_id = "gcp_shoe_size_performance_monthly_base_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "shoe_size_performance_monthly_base_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    shoe_size_performance_monthly_shoe_size_performance_monthly_base = open(
        os.path.join(
            sql_path,
            "shoe_size_performance_monthly/shoe_size_performance_monthly_base.sql",
        ),
        "r",
    ).read()
    ...
    launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": shoe_size_performance_monthly_shoe_size_performance_monthly_base,
                "useLegacySql": False,
            }
        },
