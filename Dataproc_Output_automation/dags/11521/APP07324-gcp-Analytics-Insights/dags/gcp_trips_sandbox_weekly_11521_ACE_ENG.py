...
dag_id = 'gcp_trips_sandbox_weekly_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'trips_sandbox_weekly_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    universal_semantic_layer_trips_sandbox_weekly = open( os.path.join(sql_path, 'universal_semantic_layer/trips_sandbox_weekly.sql'),"r").read()
    ...
    launch_run_bigquery_sql_job_1_create_t2_view = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": universal_semantic_layer_trips_sandbox_weekly,
                "useLegacySql": False
            }
        },
