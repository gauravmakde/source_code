...
dag_id = "gcp_nmn_weekly_overall_fact_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "nmn_weekly_overall_fact_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    nmn_nmn_weekly_overall_fact = open(
        os.path.join(sql_path, "nmn/nmn_reporting_stack/nmn_weekly_overall_fact.sql"),
        "r",
    ).read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {"query": nmn_nmn_weekly_overall_fact, "useLegacySql": False}
        },
