...
dag_id = 'gcp_consented_customer_seller_monthly_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'consented_customer_seller_monthly_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    consented_customer_consented_customer_seller_monthly = open( os.path.join(sql_path, 'consented_customer/consented_customer_seller_monthly.sql'),"r").read()
    ...
    launch_run_terdata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": consented_customer_consented_customer_seller_monthly,
                "useLegacySql": False
            }
        },
