...
dag_id = "gcp_campaign_attributed_weekly_fact_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "campaign_attributed_weekly_fact_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    nmn_campaign_attributed_weekly_fact = open(
        os.path.join(sql_path, "nmn/campaign_attributed_weekly_fact.sql"), "r"
    ).read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": nmn_campaign_attributed_weekly_fact,
                "useLegacySql": False,
            }
        },
    ...
    """launch_run_bigquery_sql_stg_0_job_0_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ACE_ENGINEERING_APP07324_K8S_GUMBO_CONN_PROD',
    namespace='app07324',
    task_id='run_bigquery_sql_stg_0_job_0_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='run-bigquery-sql-stg-0-job-0-campaign-attributed-weekly-fact-115',
