...
dag_id = 'gcp_nmn_brand_customer_metrics_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'nmn_brand_customer_metrics_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    nmn_nmn_brand_customer_metrics = open( os.path.join(sql_path, 'nmn/nmn_brand_customer_metrics.sql'),"r").read()
    ...
    launch_run_terdata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": nmn_nmn_brand_customer_metrics,
                "useLegacySql": False
            }
        },
