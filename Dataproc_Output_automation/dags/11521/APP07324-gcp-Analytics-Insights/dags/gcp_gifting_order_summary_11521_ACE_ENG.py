...
dag_id = 'gcp_gifting_order_summary_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'gifting_order_summary_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    gifting_gifting_order_summary = open( os.path.join(sql_path, 'gifting/gifting_order_summary.sql'),"r").read()

    launch_run_terdata_sql_job_0_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        task_id = "run_terdata_sql_job_0_run_sql_to_update_t2_table",
        configuration =
        {
            "query":
            {
                "query": gifting_gifting_order_summary,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_terdata_sql_job_0_run_sql_to_update_t2_table >> pelican_validator >> pelican_sensor