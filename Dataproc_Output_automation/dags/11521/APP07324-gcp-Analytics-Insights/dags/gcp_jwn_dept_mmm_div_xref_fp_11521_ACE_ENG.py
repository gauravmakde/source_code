...
dag_id = "gcp_jwn_dept_mmm_div_xref_fp_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "jwn_dept_mmm_div_xref_fp_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    mmm_jwn_dept_mmm_div_xref_fp = open(
        os.path.join(sql_path, "mmm/jwn_dept_mmm_div_xref_fp.sql"), "r"
    ).read()

    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        task_id="run_bigquery_sql_stg_0_job_0",
        configuration={
            "query": {"query": mmm_jwn_dept_mmm_div_xref_fp, "useLegacySql": False}
        },
