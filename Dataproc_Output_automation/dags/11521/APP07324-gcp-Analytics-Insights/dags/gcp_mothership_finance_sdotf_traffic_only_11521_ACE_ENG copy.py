...
dag_id = "gcp_mothership_finance_sdotf_traffic_only_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "mothership_finance_sdotf_traffic_only_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    launch_check_external_upstream_dependencies_sensor_0 = ExternalTaskSensor(
        ...
        external_dag_id="gcp_rack_store_traffic_11521_ACE_ENG",
        timeout=3600,
    ...
    mothership_sdotf_traffic_only = open(
        os.path.join(sql_path, "mothership/sdotf_traffic_only.sql"), "r"
    ).read()

    launch_run_sdotf_traffic_only_job_0 = BigQueryInsertJobOperator(
        task_id="run_sdotf_traffic_only_job_0",
        configuration={
            "query": {"query": mothership_sdotf_traffic_only, "useLegacySql": False}
        },
    ...
    (
        ...
        >> [launch_run_sdotf_traffic_only_job_0]
    )
    launch_run_sdotf_traffic_only_job_0 >> pelican_validator >> pelican_sensor
