...
dag_id = 'gcp_node_week_sku_inventory_twist_fact_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'node_week_sku_inventory_twist_fact_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    universal_semantic_layer_node_week_sku_inventory_twist_fact = open( os.path.join(sql_path, 'universal_semantic_layer/node_week_sku_inventory_twist_fact.sql'),"r").read()
    ...
    launch_run_terdata_sql_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": universal_semantic_layer_node_week_sku_inventory_twist_fact,
                "useLegacySql": False
            }
        },
