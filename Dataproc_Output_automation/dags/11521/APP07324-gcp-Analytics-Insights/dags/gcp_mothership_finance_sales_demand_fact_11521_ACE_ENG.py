...
dag_id = 'gcp_mothership_finance_sales_demand_fact_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'mothership_finance_sales_demand_fact_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    mothership_finance_sales_demand_fact = open( os.path.join(sql_path, 'mothership/finance_sales_demand_fact.sql'),"r").read()

    launch_run_finance_sales_job_0 = BigQueryInsertJobOperator(
        task_id = "run_finance_sales_job_0",
        configuration = 
        {
            "query": 
            {
                "query": mothership_finance_sales_demand_fact,
                "useLegacySql": False
            }
        },
    ...
    launch_mothership_finance_sales_demand_orders_traffic_fact_11521_ACE_ENG = DummyOperator(task_id="trigger_dag_mothership_finance_sales_demand_orders_traffic_fact_11521_ACE_ENG",dag=dag)
    # launch_mothership_finance_sales_demand_orders_traffic_fact_11521_ACE_ENG = TriggerDagRunOperator(
    # dag=dag,
    # task_id='trigger_dag_mothership_finance_sales_demand_orders_traffic_fact_11521_ACE_ENG',
    # trigger_dag_id='gcp_mothership_finance_sales_demand_orders_traffic_fact_11521_ACE_ENG',
    # execution_date='{{ execution_date }}')

    creds_setup >>  launch_run_finance_sales_job_0 >> launch_mothership_finance_sales_demand_orders_traffic_fact_11521_ACE_ENG >> pelican_validator >> pelican_sensor