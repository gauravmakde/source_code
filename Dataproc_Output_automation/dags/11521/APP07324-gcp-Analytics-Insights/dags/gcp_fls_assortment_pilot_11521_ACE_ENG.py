...
dag_id = "gcp_fls_assortment_pilot_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "fls_assortment_pilot_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    fls_assortment_pilot_fls_assortment_lkps = open(
        os.path.join(sql_path, "fls_assortment_pilot/fls_assortment_lkps.sql"), "r"
    ).read()

    launch_run_bigquery_sql_job_0 = BigQueryInsertJobOperator(
        task_id="run_bigquery_sql_job_0",
        configuration={
            "query": {
                "query": fls_assortment_pilot_fls_assortment_lkps,
                "useLegacySql": False,
            }
        },
    ...
    fls_assortment_pilot_fls_assortment_trans = open(
        os.path.join(sql_path, "fls_assortment_pilot/fls_assortment_trans.sql"), "r"
    ).read()

    launch_run_bigquery_sql_job_1 = BigQueryInsertJobOperator(
        task_id="run_bigquery_sql_job_1",
        configuration={
            "query": {
                "query": fls_assortment_pilot_fls_assortment_trans,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    fls_assortment_pilot_fls_assortment_merch = open(
        os.path.join(sql_path, "fls_assortment_pilot/fls_assortment_merch.sql"), "r"
    ).read()

    launch_run_bigquery_sql_job_2 = BigQueryInsertJobOperator(
        task_id="run_bigquery_sql_job_2",
        configuration={
            "query": {
                "query": fls_assortment_pilot_fls_assortment_merch,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    creds_setup >> launch_run_bigquery_sql_job_0 >> [launch_run_bigquery_sql_job_1]
    launch_run_bigquery_sql_job_1 >> [launch_run_bigquery_sql_job_2]
    launch_run_bigquery_sql_job_2 >> pelican_validator >> pelican_sensor
