...
dag_id = 'gcp_live_on_site_daily_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'live_on_site_daily_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    live_on_site_daily_live_on_site_daily = open( os.path.join(sql_path, 'live_on_site_daily/live_on_site_daily.sql'),"r").read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": live_on_site_daily_live_on_site_daily,
                "useLegacySql": False
            }
        },
