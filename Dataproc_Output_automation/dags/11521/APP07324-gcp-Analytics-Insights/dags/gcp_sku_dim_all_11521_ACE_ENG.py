...
dag_id = 'gcp_sku_dim_all_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'sku_dim_all_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    universal_semantic_layer_sku_dim_all = open( os.path.join(sql_path, 'universal_semantic_layer/sku_dim_all.sql'),"r").read()
    ...
    launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": universal_semantic_layer_sku_dim_all,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table >> pelican_validator >> pelican_sensor