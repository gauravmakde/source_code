...
dag_id = "gcp_campaign_attributed_funnel_fact_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "campaign_attributed_funnel_fact_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    nmn_campaign_attributed_funnel_fact = open(
        os.path.join(sql_path, "nmn/campaign_attributed_funnel_fact.sql"), "r"
    ).read()
    ...
    launch_run_terdata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": nmn_campaign_attributed_funnel_fact,
                "useLegacySql": False,
            }
        },
    ...
    (
        creds_setup
        >> launch_run_terdata_sql_stg_0_job_0
        >> pelican_validator
        >> pelican_sensor
    )
