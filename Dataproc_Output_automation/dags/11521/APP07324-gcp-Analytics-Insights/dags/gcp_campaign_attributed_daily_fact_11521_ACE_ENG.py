...
dag_id = "gcp_campaign_attributed_daily_fact_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "campaign_attributed_daily_fact_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    nmn_campaign_attributed_daily_fact = open(
        os.path.join(
            sql_path,
            "nmn/campaign_attributed_daily_fact.sql",
        ),
        "r",
    ).read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": nmn_campaign_attributed_daily_fact,
                "useLegacySql": False,
            }
        },
