...
dag_id = 'gcp_mmm_mth_inv_extract_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'mmm_mth_inv_extract_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    mmm_mmm_mth_inv_extract = open( os.path.join(sql_path, 'mmm/mmm_mth_inv_extract.sql'),"r").read()
