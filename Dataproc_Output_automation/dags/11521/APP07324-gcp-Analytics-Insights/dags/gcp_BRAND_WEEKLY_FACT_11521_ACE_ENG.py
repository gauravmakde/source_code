...
dag_id = "gcp_brand_weekly_fact_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "brand_weekly_fact_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    nmn_nmn_reporting_stack_brand_weekly_fact = open(
        os.path.join(sql_path, "nmn/nmn_reporting_stack/brand_weekly_fact.sql"), "r"
    ).read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": nmn_nmn_reporting_stack_brand_weekly_fact,
                "useLegacySql": False,
            }
        },
    ...
    poke_interval=100,
    time_out=1800,
    job_name='run-bigquery-sql-stg-0-job-0-brand-weekly-fact-11521-ace-eng',
