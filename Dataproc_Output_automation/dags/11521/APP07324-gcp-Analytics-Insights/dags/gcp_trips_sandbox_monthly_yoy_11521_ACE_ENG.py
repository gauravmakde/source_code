# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        3fc3cfaeba1c0be6c45d4771c5a71d3ec3939c0a
# CI pipeline URL:      https://git.jwn.app/TM01007/APP07324-gcp-Analytics-Insights/-/pipelines/7202150
# CI commit timestamp:  2024-10-11T07:00:43+00:00
...
dag_id = 'gcp_trips_sandbox_monthly_yoy_11521_ACE_ENG'
...
start_date = pendulum.datetime(2024, 2, 27, 13, 30)
...
default_args = {
    ...
    'description': 'trips_sandbox_monthly_yoy_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    universal_semantic_layer_trips_sandbox_monthly_yoy = open( os.path.join(sql_path, 'universal_semantic_layer/trips_sandbox_monthly_yoy.sql'),"r").read()

    launch_run_bigquery_sql_job_1_create_t2_view = BigQueryInsertJobOperator(
        task_id = "run_bigquery_sql_job_1_create_t2_view",
        configuration = 
        {
            "query": 
            {
                "query": universal_semantic_layer_trips_sandbox_monthly_yoy,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_run_bigquery_sql_job_1_create_t2_view >> pelican_validator >> pelican_sensor