...
dag_id = 'gcp_nordstrom_on_digital_styling_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'nordstrom_on_digital_styling_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    nordstrom_on_nordstrom_on_digital_daily = open( os.path.join(sql_path, 'nordstrom_on/nordstrom_on_digital_daily.sql'),"r").read()

    launch_on_digital_styling_stage_job_1_run_tdsql = BigQueryInsertJobOperator(
        task_id = "on_digital_styling_stage_job_1_run_tdsql",
        configuration =
        {
            "query":
            {
                "query": nordstrom_on_nordstrom_on_digital_daily,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_on_digital_styling_stage_job_1_run_tdsql >> pelican_validator >> pelican_sensor