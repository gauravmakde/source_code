...
dag_id = 'gcp_divisional_summary_weekly_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'divisional_summary_weekly_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    external_dag_id='gcp_product_price_funnel_daily_11521_ACE_ENG',
    timeout=3600,
    ...
    product_funnel_divisional_summary_weekly = open( os.path.join(sql_path, 'product_funnel/divisional_summary_weekly.sql'),"r").read()

    launch_run_divisional_summary_weekly_sql_run_divisional_summary_weekly_table = BigQueryInsertJobOperator(
        task_id = "run_divisional_summary_weekly_sql_run_divisional_summary_weekly_table",
        configuration =
        {
            "query":
            {
                "query": product_funnel_divisional_summary_weekly,
                "useLegacySql": False
            }
        },
    ...
    launch_refresh_divisional_summary_weekly_11521_ACE_ENG = TriggerDagRunOperator(
    dag=dag,
    task_id='trigger_dag_refresh_divisional_summary_weekly_11521_ACE_ENG',
    trigger_dag_id='gcp_refresh_divisional_summary_weekly_11521_ACE_ENG',
    execution_date='{{ execution_date }}')

    creds_setup >> launch_check_external_upstream_dependencies_sensor_0 >>[launch_run_divisional_summary_weekly_sql_run_divisional_summary_weekly_table]
    launch_run_divisional_summary_weekly_sql_run_divisional_summary_weekly_table >>[launch_refresh_divisional_summary_weekly_11521_ACE_ENG] >> pelican_validator >> pelican_sensor