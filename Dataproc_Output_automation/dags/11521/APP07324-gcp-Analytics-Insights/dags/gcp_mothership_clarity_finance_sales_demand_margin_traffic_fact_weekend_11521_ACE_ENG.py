...
dag_id = 'gcp_mothership_clarity_finance_sales_demand_margin_traffic_fact_weekend_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'mothership_clarity_finance_sales_demand_margin_traffic_fact_weekend_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    launch_mothership_clarity_finance_sales_demand_price_band_agg_weekend_11521_ACE_ENG = TriggerDagRunOperator(
    dag=dag,
    task_id='trigger_dag_mothership_clarity_finance_sales_demand_price_band_agg_weekend_11521_ACE_ENG',
    trigger_dag_id='gcp_mothership_clarity_finance_sales_demand_price_band_agg_weekend_11521_ACE_ENG',
    execution_date='{{ execution_date }}')

    creds_setup >> fsdf_dq_check_check_clarity_demand_opgmv_operator >>[launch_run_clarity_finance_sales_demand_margin_traffic_fact_job_0]
    launch_run_clarity_finance_sales_demand_margin_traffic_fact_job_0 >>[launch_mothership_clarity_finance_sales_demand_price_band_agg_weekend_11521_ACE_ENG] >> pelican_validator >> pelican_sensor