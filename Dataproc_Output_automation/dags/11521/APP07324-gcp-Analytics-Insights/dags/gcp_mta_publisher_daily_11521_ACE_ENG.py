...
dag_id = "gcp_mta_publisher_daily_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "mta_publisher_daily_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    apd_mta_publisher_daily = open(
        os.path.join(sql_path, "apd/mta_publisher_daily.sql"), "r"
    ).read()
    ...
    launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {"query": apd_mta_publisher_daily, "useLegacySql": False}
        },
    ...
    # launch_rakuten_publisher_daily_11521_ACE_ENG = TriggerDagRunOperator(
    # dag=dag,
    # task_id='trigger_dag_rakuten_publisher_daily_11521_ACE_ENG',
    # trigger_dag_id='gcp_rakuten_publisher_daily_11521_ACE_ENG',
    # execution_date='{{ execution_date }}')

    # creds_setup >> launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table >>[launch_rakuten_publisher_daily_11521_ACE_ENG] >> pelican_validator >> pelican_sensor
