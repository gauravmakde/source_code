...
dag_id = 'gcp_mothership_clarity_finance_sales_demand_fact_weekend_11521_ACE_ENG'
...
dag_sla = timedelta(minutes=int(145)) if int(145)>1 else None
...
default_args = {
    ...
    'description': 'mothership_clarity_finance_sales_demand_fact_weekend_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    clarity_clarity_finance_sales_demand_fact = open( os.path.join(sql_path, 'clarity/clarity_finance_sales_demand_fact.sql'),"r").read()
    ...
    launch_run_clarity_finance_sales_demand_fact_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": clarity_clarity_finance_sales_demand_fact,
                "useLegacySql": False
            }
        },
    ...
    launch_mothership_clarity_finance_margin_fact_weekend_11521_ACE_ENG = TriggerDagRunOperator(
    dag=dag,
    task_id='trigger_dag_mothership_clarity_finance_margin_fact_weekend_11521_ACE_ENG',
    trigger_dag_id='gcp_mothership_clarity_finance_margin_fact_weekend_11521_ACE_ENG',
    ...
    launch_run_clarity_finance_sales_demand_fact_job_0 >>[launch_mothership_clarity_finance_margin_fact_weekend_11521_ACE_ENG] >> pelican_validator >> pelican_sensor