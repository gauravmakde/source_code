...
dag_id = 'gcp_product_price_funnel_daily_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'product_price_funnel_daily_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    product_funnel_product_price_funnel_daily = open( os.path.join(sql_path, 'product_funnel/product_price_funnel_daily.sql'),"r").read()

    launch_run_ppfd_divisional_style_sql_product_price_funnel_daily_table = BigQueryInsertJobOperator(
        task_id = "run_ppfd_divisional_style_sql_product_price_funnel_daily_table",
        configuration = 
        {
            "query": 
            {
                "query": product_funnel_product_price_funnel_daily,
                "useLegacySql": False
            }
        },
    ...
    product_funnel_divisional_style_daily = open( os.path.join(sql_path, 'product_funnel/divisional_style_daily.sql'),"r").read()

    launch_run_ppfd_divisional_style_sql_divisional_style_daily_table = BigQueryInsertJobOperator(
        task_id = "run_ppfd_divisional_style_sql_divisional_style_daily_table",
        configuration = 
        {
            "query": 
            {
                "query": product_funnel_divisional_style_daily,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_refresh_divisional_style_daily_11521_ACE_ENG = TriggerDagRunOperator(
    dag=dag,
    task_id='trigger_dag_refresh_divisional_style_daily_11521_ACE_ENG',
    trigger_dag_id='gcp_refresh_divisional_style_daily_11521_ACE_ENG',
    execution_date='{{ execution_date }}')

    launch_divisional_sessions_daily_11521_ACE_ENG = TriggerDagRunOperator(
    dag=dag,
    task_id='trigger_dag_divisional_sessions_daily_11521_ACE_ENG',
    trigger_dag_id='gcp_divisional_sessions_daily_11521_ACE_ENG',
    execution_date='{{ execution_date }}')

    creds_setup >> launch_check_external_upstream_dependencies_sensor_0 >>[launch_run_ppfd_divisional_style_sql_product_price_funnel_daily_table]
    launch_run_ppfd_divisional_style_sql_product_price_funnel_daily_table >>[launch_run_ppfd_divisional_style_sql_divisional_style_daily_table]
    launch_run_ppfd_divisional_style_sql_divisional_style_daily_table >>[launch_refresh_divisional_style_daily_11521_ACE_ENG]
    launch_refresh_divisional_style_daily_11521_ACE_ENG >>[launch_divisional_sessions_daily_11521_ACE_ENG] >> pelican_validator >> pelican_sensor