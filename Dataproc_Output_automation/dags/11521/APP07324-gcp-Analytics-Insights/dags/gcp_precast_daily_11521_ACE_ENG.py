...
dag_id = 'gcp_precast_daily_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'precast_daily_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    precast_precast_mothership_daily = open( os.path.join(sql_path, 'precast/precast_mothership_daily.sql'),"r").read()
    ...
    launch_run_terdata_sql_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": precast_precast_mothership_daily,
                "useLegacySql": False
            }
        },
