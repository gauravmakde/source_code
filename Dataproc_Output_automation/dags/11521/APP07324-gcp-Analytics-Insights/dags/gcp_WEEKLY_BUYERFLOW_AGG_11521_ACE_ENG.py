...
dag_id = 'gcp_weekly_buyerflow_agg_11521_ACE_ENG'
...
default_args = {
    ...
    "description": "weekly_buyerflow_agg_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    buyerflow_weekly_buyerflow_agg = open( os.path.join(sql_path, 'buyerflow/weekly_buyerflow_agg.sql'),"r").read()
    ...
    launch_run_bigquery_sql_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": buyerflow_weekly_buyerflow_agg,
                "useLegacySql": False
            }
        },
