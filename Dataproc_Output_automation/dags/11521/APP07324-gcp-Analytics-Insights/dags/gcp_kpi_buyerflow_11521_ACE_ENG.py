...
dag_id = 'gcp_kpi_buyerflow_11521_ACE_ENG'
...
default_args = {
    ...
    'description': 'kpi_buyerflow_11521_ACE_ENG DAG Description',
...
with DAG(
    ...
    KPI_Scorecard_kpi_buyerflow = open( os.path.join(sql_path, 'KPI_Scorecard/kpi_buyerflow.sql'),"r").read()
    ...
    launch_run_bigquery_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": KPI_Scorecard_kpi_buyerflow,
                "useLegacySql": False
            }
        },
