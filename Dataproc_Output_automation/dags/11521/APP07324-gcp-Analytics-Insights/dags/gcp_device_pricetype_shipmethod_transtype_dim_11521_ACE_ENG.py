...
dag_id = "gcp_device_pricetype_shipmethod_transtype_dim_11521_ACE_ENG"
...
default_args = {
    ...
    "description": "device_pricetype_shipmethod_transtype_dim_11521_ACE_ENG DAG Description",
...
with DAG(
    ...
    universal_semantic_layer_device_dim = open(
        os.path.join(sql_path, "universal_semantic_layer/device_dim.sql"), "r"
    ).read()

    launch_device_dim_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        task_id="device_dim_job_1_run_sql_to_update_t2_table",
        configuration={
            "query": {
                "query": universal_semantic_layer_device_dim,
                "useLegacySql": False,
            }
        },
    ...
    universal_semantic_layerd_price_type_dim = open(
        os.path.join(sql_path, "universal_semantic_layer/price_type_dim.sql"), "r"
    ).read()

    launch_price_type_dim_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        task_id="price_type_dim_job_1_run_sql_to_update_t2_table",
        configuration={
            "query": {
                "query": universal_semantic_layerd_price_type_dim,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    universal_semantic_layerdevice_ship_method_dim = open(
        os.path.join(sql_path, "universal_semantic_layer/ship_method_dim.sql"), "r"
    ).read()

    launch_ship_method_dim_job_1_run_sql_to_update_t2_table = BigQueryInsertJobOperator(
        task_id="ship_method_dim_job_1_run_sql_to_update_t2_table",
        configuration={
            "query": {
                "query": universal_semantic_layerdevice_ship_method_dim,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    universal_semantic_layer_transaction_type_dim = open(
        os.path.join(sql_path, "universal_semantic_layer/transaction_type_dim.sql"), "r"
    ).read()

    launch_transaction_type_dim_job_1_run_sql_to_update_t2_table = (
        BigQueryInsertJobOperator(
            task_id="transaction_type_dim_job_1_run_sql_to_update_t2_table",
            configuration={
                "query": {
                    "query": universal_semantic_layer_transaction_type_dim,
                    "useLegacySql": False,
                }
            },
            project_id=project_id,
    ...
    (
        creds_setup
        >> launch_device_dim_job_1_run_sql_to_update_t2_table
        >> launch_price_type_dim_job_1_run_sql_to_update_t2_table
        >> launch_ship_method_dim_job_1_run_sql_to_update_t2_table
        >> launch_transaction_type_dim_job_1_run_sql_to_update_t2_table
        >> pelican_validator
        >> pelican_sensor
    )
