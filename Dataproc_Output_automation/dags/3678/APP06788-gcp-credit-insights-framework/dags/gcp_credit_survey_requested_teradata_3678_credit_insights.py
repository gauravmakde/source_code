...
dag_id = 'gcp_credit_survey_requested_teradata_3678_credit_insights'
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'customer-credit-customer-support-contacted-survey-requested-avro',
        consumer_group_name = 'onix-customer-credit-customer-support-contacted-survey-requested-avro_credit_survey_requested_teradata_3678_credit_insights_credit_survey_requested_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job',
    ...
    session_name=get_batch_id(dag_id=dag_id,task_id="credit_survey_requested_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job")   

    credit_survey_requested_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job = DataprocCreateBatchOperator(
            task_id = "credit_survey_requested_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job",
            ...
            batch=
            {    
                "runtime_config": {"version": "1.1","properties":{ 'spark.sql.legacy.avro.datetimeRebaseModeInWrite': 'LEGACY', 'spark.speculation': 'false', 'spark.airflow.run_id':"{{ ti.xcom_pull(task_ids='fetch_batch_run_id_task')}}", 'spark.dynamicAllocation.enabled': 'true', 
                # 'spark.dynamicAllocation.shuffleTracking.enabled': 'true', 'spark.dynamicAllocation.minExecutors': '5', 'spark.dynamicAllocation.maxExecutors': '30', 'spark.dynamicAllocation.initialExecutors': '10', 'spark.dynamicAllocation.executorIdleTimeout': '240', 
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_credit_survey_requested_bigquery_3678_credit_insights_credit_survey_requested_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job.json",
    ...
    bigquery_credit_survey_requested_bigquery_stg_to_bigquery_fct = open( os.path.join(sql_path, 'bigquery/credit_survey_requested_bigquery_stg_to_bigquery_fct.sql'),"r").read()

    launch_credit_survey_requested_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job = BigQueryInsertJobOperator(
        task_id = "credit_survey_requested_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job",
        configuration = 
        {
            "query": 
            {
                "query": bigquery_credit_survey_requested_bigquery_stg_to_bigquery_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >>[credit_survey_requested_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job]
    credit_survey_requested_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job >>[launch_credit_survey_requested_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job]
    launch_credit_survey_requested_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job >> pelican_validator >> pelican_sensor