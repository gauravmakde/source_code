...
default_args = {
    ...
    "description": "credit_support_contacted_bigquery_3678_credit_insights DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="customer-credit-customer-support-contacted-avro",
        consumer_group_name="onix-customer-credit-customer-support-contacted-avro_credit_support_contacted_teradata_3678_credit_insights_credit_support_contacted_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job",
    ...
    session_name = get_batch_id(
        dag_id=dag_id,
        task_id="credit_support_contacted_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job",
    )
    credit_support_contacted_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job = DataprocCreateBatchOperator(
        task_id="credit_support_contacted_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_credit_support_contacted_bigquery_3678_credit_insights_credit_support_contacted_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job.json",
    ...
    bigquery_credit_support_contacted_bigquery_stg_to_bigquery_fct = open(
        os.path.join(
            sql_path,
            "bigquery/credit_support_contacted_bigquery_stg_to_bigquery_fct.sql",
        ),
        "r",
    ).read()

    launch_credit_support_contacted_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job = BigQueryInsertJobOperator(
        task_id="credit_support_contacted_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job",
        configuration={
            "query": {
                "query": bigquery_credit_support_contacted_bigquery_stg_to_bigquery_fct,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    (
        ...
        >> [
            credit_support_contacted_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job
        ]
    )
    (
        credit_support_contacted_kafka_to_bigquery_stg_stage_0_kafka_to_bigquery_stg_job
        >> [
            launch_credit_support_contacted_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job
        ]
    )
    (
        launch_credit_support_contacted_kafka_to_bigquery_stg_stage_0_bigquery_stg_to_bigquery_fct_job
