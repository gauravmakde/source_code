...
root_path = path.dirname(__file__).split('APP04070-gcp-isf-airflow-nsk-dag-repo')[0] + 'APP04070-gcp-isf-airflow-nsk-dag-repo/'
...
dag_id = 'gcp_mfp_actual_country_banner_weekly_snapshot_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'mfp_actual_country_banner_weekly_snapshot_load_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    external_dag_id='gcp_mfp_cost_country_banner_blend_week_fact_load_10976_tech_nap_merch',
    ...
    mfp_actual_country_banner_weekly_snapshot_load = open(
    os.path.join(sql_path, 'mfp_actual_country_banner_weekly_snapshot_load.sql'),
    "r").read()

    launch_mfp_actual_country_banner_t1_load_last_fiscal_week_snapshot = BigQueryInsertJobOperator(
        task_id = "mfp_actual_country_banner_t1_load_last_fiscal_week_snapshot",
        configuration = 
        {
            "query": 
            {
                "query": mfp_actual_country_banner_weekly_snapshot_load,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_other_appId_upstream_dependencies_sensor_0 >>[launch_mfp_actual_country_banner_t1_load_last_fiscal_week_snapshot]
    launch_mfp_actual_country_banner_t1_load_last_fiscal_week_snapshot >> pelican_validator >> pelican_sensor