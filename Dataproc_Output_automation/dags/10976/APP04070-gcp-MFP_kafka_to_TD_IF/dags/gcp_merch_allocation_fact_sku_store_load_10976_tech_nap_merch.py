...
dag_id = 'gcp_merch_allocation_fact_sku_store_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'merch_allocation_fact_sku_store_load_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    merch_allocation_fact_sku_store_sales_load = open(
    os.path.join(sql_path, 'merch_allocation_fact_sku_store_sales_load.sql'),
    "r").read()
    ...
    launch_main_merch_allocation_fact_sku_store_sales_load = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": merch_allocation_fact_sku_store_sales_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
