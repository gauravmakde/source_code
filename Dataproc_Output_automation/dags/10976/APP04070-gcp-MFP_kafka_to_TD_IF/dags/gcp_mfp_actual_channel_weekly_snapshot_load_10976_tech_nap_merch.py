...
dag_id = "gcp_mfp_actual_channel_weekly_snapshot_load_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "mfp_actual_channel_weekly_snapshot_load_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    launch_other_appId_upstream_dependencies_sensor_0 = ApiDagRunLatestSensor(
        ...
        external_dag_id="gcp_mfp_cost_channel_blend_week_fact_load_10976_tech_nap_merch",
    ...
    mfp_actual_channel_weekly_snapshot_load = open(
        os.path.join(sql_path, "mfp_actual_channel_weekly_snapshot_load.sql"), "r"
    ).read()

    launch_mfp_actual_channel_t1_load_last_fiscal_week_snapshot = (
        BigQueryInsertJobOperator(
            task_id="mfp_actual_channel_t1_load_last_fiscal_week_snapshot",
            configuration={
                "query": {
                    "query": mfp_actual_channel_weekly_snapshot_load,
                    "useLegacySql": False,
                }
            },
