...
dag_id = 'gcp_merch_sale_return_dept_channel_week_agg_fact_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'merch_sale_return_dept_channel_week_agg_fact_load_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    merch_sale_return_dept_channel_week_agg_fact_data_prepare = open(
    os.path.join(sql_path, 'merch_sale_return_dept_channel_week_agg_fact_data_prepare.sql'),
    "r").read()

    launch_load_weeks_prepare = BigQueryInsertJobOperator(
        task_id = "load_weeks_prepare",
        configuration = 
        {
            "query": 
            {
                "query": merch_sale_return_dept_channel_week_agg_fact_data_prepare,
                "useLegacySql": False
            }
        },
    ...
    merch_sale_return_dept_channel_week_agg_fact_data_load = open(
    os.path.join(sql_path, 'merch_sale_return_dept_channel_week_agg_fact_data_load.sql'),
    "r").read()

    launch_load_weeks_agg_fact_load_1_40 = BigQueryInsertJobOperator(
        task_id = "load_weeks_agg_fact_load_1_40",
        configuration = 
        {
            "query": 
            {
                "query": merch_sale_return_dept_channel_week_agg_fact_data_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_load_weeks_agg_fact_load_41_80 = BigQueryInsertJobOperator(
        task_id = "load_weeks_agg_fact_load_41_80",
        configuration = 
        {
            "query": 
            {
    ...
    launch_load_weeks_agg_fact_load_81_120 = BigQueryInsertJobOperator(
        task_id = "load_weeks_agg_fact_load_81_120",
        configuration = 
        {
            "query": 
            {
    ...
    launch_load_weeks_agg_fact_load_121_160 = BigQueryInsertJobOperator(
        task_id = "load_weeks_agg_fact_load_121_160",
        configuration = 
        {
            "query": 
            {
    ...
    launch_load_weeks_agg_fact_load_161_200 = BigQueryInsertJobOperator(
        task_id = "load_weeks_agg_fact_load_161_200",
        configuration = 
        {
            "query": 
            {
    ...
    launch_load_weeks_agg_fact_load_201_209 = BigQueryInsertJobOperator(
        task_id = "load_weeks_agg_fact_load_201_209",
        configuration = 
        {
            "query": 
            {
    ...
    # Removing the following task as ( Sql is out of scope )

    # merch_sale_return_dept_channel_week_agg_fact_data_collect = open(
    # os.path.join(sql_path, 'merch_sale_return_dept_channel_week_agg_fact_data_collect.sql'),
    # "r").read()

    # launch_load_weeks_collect = BigQueryInsertJobOperator(
    #     task_id = "load_weeks_collect",
    #     configuration = 
    #     {
    #         "query": 
    #         {
    #             "query": merch_sale_return_dept_channel_week_agg_fact_data_collect,
    #             "useLegacySql": False
    #         }
    #     },
    #     project_id = project_id,
    ...
    creds_setup >> launch_other_appId_upstream_dependencies_sensor_0 >>[launch_load_weeks_prepare]
    launch_load_weeks_prepare >>[launch_load_weeks_agg_fact_load_1_40]
    launch_load_weeks_agg_fact_load_1_40 >>[launch_load_weeks_agg_fact_load_41_80]
    launch_load_weeks_agg_fact_load_41_80 >>[launch_load_weeks_agg_fact_load_81_120]
    launch_load_weeks_agg_fact_load_81_120 >>[launch_load_weeks_agg_fact_load_121_160]
    launch_load_weeks_agg_fact_load_121_160 >>[launch_load_weeks_agg_fact_load_161_200]
    launch_load_weeks_agg_fact_load_161_200 >>[launch_load_weeks_agg_fact_load_201_209]
    launch_load_weeks_agg_fact_load_201_209 >> pelican_validator >> pelican_sensor