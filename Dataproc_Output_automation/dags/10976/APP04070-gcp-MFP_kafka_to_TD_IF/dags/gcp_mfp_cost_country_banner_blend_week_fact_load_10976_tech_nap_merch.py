...
dag_id = 'gcp_mfp_cost_country_banner_blend_week_fact_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'mfp_cost_country_banner_blend_week_fact_load_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    external_dag_id='gcp_mfpc_financial_country_banner_kafka_to_teradata_v4_10976_tech_nap_merch',
    ...
    conn_id='okta_conn_to_APP04070_team',
    external_dag_id='gcp_mfpc_transfer_ledger_extract_10976_tech_nap_merch',
    ...
    conn_id='okta_conn_to_APP04070_team',
    external_dag_id='gcp_mfpc_poreceipts_extract_10976_tech_nap_merch',
    date_query_fn=upstream_dependency.weekly_query_function,
    timeout=3600,
    retries=1,
    poke_interval=120
    ...
    conn_id='okta_conn_to_APP04070_team',
    external_dag_id='gcp_mfpc_return_to_vendor_extract_10976_tech_nap_merch',
    date_query_fn=upstream_dependency.weekly_query_function,
    timeout=3600,
    retries=1,
    poke_interval=120
    ...
    conn_id='okta_conn_to_APP04070_team',
    external_dag_id='gcp_project_mfp_reclass_extract_10976_tech_nap_merch',
    date_query_fn=upstream_dependency.weekly_query_function,
    timeout=3600,
    retries=1,
    poke_interval=120
    ...
    conn_id='okta_conn_to_APP04070_team',
    external_dag_id='gcp_mfpc_vfmdt_extract_10976_tech_nap_merch',
    date_query_fn=upstream_dependency.weekly_query_function,
    timeout=3600,
    retries=1,
    poke_interval=120
    ...
    conn_id='okta_conn_to_APP04070_team',
    external_dag_id='gcp_mfpc_merch_margin_extract_10976_tech_nap_merch',
    date_query_fn=upstream_dependency.weekly_query_function,
    timeout=3600,
    retries=1,
    poke_interval=120
    ...
    mfp_cost_country_banner_blend_week_wrk = open(
    os.path.join(sql_path, 'mfp_cost_country_banner_blend_week_wrk.sql'),
    "r").read()

    launch_country_banner_blend_data_load_country_banner_week_wrk_load = BigQueryInsertJobOperator(
        task_id = "country_banner_blend_data_load_country_banner_week_wrk_load",
        configuration = 
        {
            "query": 
            {
                "query": mfp_cost_country_banner_blend_week_wrk,
                "useLegacySql": False
            }
        },
    ...
    mfp_cost_country_banner_blend_week_trueday_wrk = open(
    os.path.join(sql_path, 'mfp_cost_country_banner_blend_week_trueday_wrk.sql'),
    "r").read()

    launch_country_banner_blend_data_load_country_banner_week_trueday_wrk_load = BigQueryInsertJobOperator(
        task_id = "country_banner_blend_data_load_country_banner_week_trueday_wrk_load",
        configuration = 
        {
            "query": 
            {
                "query": mfp_cost_country_banner_blend_week_trueday_wrk,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    mfp_cost_country_banner_blend_week_fact = open(
    os.path.join(sql_path, 'mfp_cost_country_banner_blend_week_fact.sql'),
    "r").read()

    launch_country_banner_blend_data_load_country_banner_week_fct_load = BigQueryInsertJobOperator(
        task_id = "country_banner_blend_data_load_country_banner_week_fct_load",
        configuration = 
        {
            "query": 
            {
                "query": mfp_cost_country_banner_blend_week_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    country_banner_batch_update = open(
    os.path.join(sql_path, 'country_banner_batch_update.sql'),
    "r").read()

    launch_country_banner_blend_data_load_country_banner_batch_update = BigQueryInsertJobOperator(
        task_id = "country_banner_blend_data_load_country_banner_batch_update",
        configuration = 
        {
            "query": 
            {
                "query": country_banner_batch_update,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_other_appId_upstream_dependencies_sensor_6 >>[launch_country_banner_blend_data_load_country_banner_week_wrk_load]
    launch_country_banner_blend_data_load_country_banner_week_wrk_load >>[launch_country_banner_blend_data_load_country_banner_week_trueday_wrk_load]
    launch_country_banner_blend_data_load_country_banner_week_trueday_wrk_load >>[launch_country_banner_blend_data_load_country_banner_week_fct_load]
    launch_country_banner_blend_data_load_country_banner_week_fct_load >>[launch_country_banner_blend_data_load_country_banner_batch_update]
    launch_country_banner_blend_data_load_country_banner_batch_update >> pelican_validator >> pelican_sensor
