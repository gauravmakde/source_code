...
dag_id = 'gcp_mfpc_return_to_vendor_kafka_to_teradata_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'mfpc_return_to_vendor_kafka_to_bigquery_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'inventory-return-to-vendor-ledger-analytical-avro',
        consumer_group_name = 'onix-inventory-return-to-vendor-ledger-analytical-avro_mfpc_return_to_vendor_kafka_to_teradata_10976_tech_nap_merch_read_rtv_from_kafka_and_write_to_teradata_job_rtv_first_exec_004',
    ...
    session_name=get_batch_id(dag_id=dag_id,task_id="read_rtv_from_kafka_and_write_to_bigquery_job_rtv_first_exec_004")   
    read_rtv_from_kafka_and_write_to_bigquery_job_rtv_first_exec_004 = DataprocCreateBatchOperator(
            task_id = "read_rtv_from_kafka_and_write_to_bigquery_job_rtv_first_exec_004",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
            batch=
            {    
                "runtime_config": {"version": "1.1","properties":{ 'spark.sql.legacy.avro.datetimeRebaseModeInWrite': 'LEGACY', 'spark.speculation': 'false', 'spark.airflow.run_id':"{{ ti.xcom_pull(task_ids='fetch_batch_run_id_task')}}", "spark.sql.parquet.int96AsTimestamp": "false","spark.sql.parquet.outputTimestampType": "TIMESTAMP_MICROS"}},
                "spark_batch": 
                    {
                    ...
                    "args": [f"{user_config_path}/argument_mfpc_return_to_vendor_kafka_to_bigquery_10976_tech_nap_merch_read_rtv_from_kafka_and_write_to_bigquery_job_rtv_first_exec_004.json",
    ...
    tpt_jdbc_insert_read_rtv_from_kafka_and_write_to_bigquery_job_rtv_second_exec_004_control_tbl = BashOperator(
    task_id='tpt_jdbc_insert_read_rtv_from_kafka_and_write_to_bigquery_job_rtv_second_exec_004_control_tbl',
    bash_command=f'echo "Skipping Control Table Entry"')

    
    read_rtv_from_bigquery_and_write_to_bigquery = open(os.path.join(sql_path, 'read_rtv_from_bigquery_and_write_to_bigquery.sql'),"r").read()

    launch_read_rtv_from_kafka_and_write_to_bigquery_job_rtv_third_exec_004 = BigQueryInsertJobOperator(
        task_id = "read_rtv_from_kafka_and_write_to_bigquery_job_rtv_third_exec_004",
        configuration = 
        {
            "query": 
            {
                "query": read_rtv_from_bigquery_and_write_to_bigquery,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >>[read_rtv_from_kafka_and_write_to_bigquery_job_rtv_first_exec_004]
    read_rtv_from_kafka_and_write_to_bigquery_job_rtv_first_exec_004 >>[tpt_jdbc_insert_read_rtv_from_kafka_and_write_to_bigquery_job_rtv_second_exec_004_control_tbl]
    tpt_jdbc_insert_read_rtv_from_kafka_and_write_to_bigquery_job_rtv_second_exec_004_control_tbl >>[launch_read_rtv_from_kafka_and_write_to_bigquery_job_rtv_third_exec_004]
    launch_read_rtv_from_kafka_and_write_to_bigquery_job_rtv_third_exec_004 >> pelican_validator >> pelican_sensor