...
dag_id = "gcp_demand_fact_load_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "demand_fact_load_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    launch_other_appId_upstream_dependencies_sensor_0 = ApiDagRunLatestSensor(
        ...
        conn_id="okta_conn_to_APP02560_team",
        external_dag_id="gcp_prev_day_oldf_batch_completed_17421_DAS_SC_OUTBOUND_APP02560_insights_v2",
    ...
    demand_fact_load_10976_tech_nap_merch_DMND_LD_order_line_detail_daily_delta_ld = open(
        os.path.join(
            sql_path,
            "order_line_detail_daily_delta_ld.sql",
        ),
        "r",
    ).read()

    launch_DMND_LD_t1_ord_fct_to_ord_dlta = BigQueryInsertJobOperator(
        task_id="DMND_LD_t1_ord_fct_to_ord_dlta",
        configuration={
            "query": {
                "query": demand_fact_load_10976_tech_nap_merch_DMND_LD_order_line_detail_daily_delta_ld,
                "useLegacySql": False,
            }
        },
    ...
    demand_fact_load_10976_tech_nap_merch_DMND_LD_order_sku_store_daily_delta_ld = open(
        os.path.join(
            sql_path,
            "order_sku_store_daily_delta_ld.sql",
        ),
        "r",
    ).read()

    launch_DMND_LD_t2_ord_dlta_to_dmnd_dlta = BigQueryInsertJobOperator(
        task_id="DMND_LD_t2_ord_dlta_to_dmnd_dlta",
        configuration={
            "query": {
                "query": demand_fact_load_10976_tech_nap_merch_DMND_LD_order_sku_store_daily_delta_ld,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    demand_fact_load_10976_tech_nap_merch_DMND_LD_demand_sku_store_fact_ld = open(
        os.path.join(
            sql_path,
            "demand_sku_store_fact_ld.sql",
        ),
        "r",
    ).read()

    launch_DMND_LD_t3_dmnd_dlta_to_fct = BigQueryInsertJobOperator(
        task_id="DMND_LD_t3_dmnd_dlta_to_fct",
        configuration={
            "query": {
                "query": demand_fact_load_10976_tech_nap_merch_DMND_LD_demand_sku_store_fact_ld,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    demand_fact_load_10976_tech_nap_merch_DMND_LD_order_line_detail_fact_prev_ld = open(
        os.path.join(
            sql_path,
            "order_line_detail_fact_prev_ld.sql",
        ),
        "r",
    ).read()

    launch_DMND_LD_t4_ord_dlta_to_prev = BigQueryInsertJobOperator(
        task_id="DMND_LD_t4_ord_dlta_to_prev",
        configuration={
            "query": {
                "query": demand_fact_load_10976_tech_nap_merch_DMND_LD_order_line_detail_fact_prev_ld,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    (
        ...
        >> [launch_DMND_LD_t1_ord_fct_to_ord_dlta]
    )
    launch_DMND_LD_t1_ord_fct_to_ord_dlta >> [launch_DMND_LD_t2_ord_dlta_to_dmnd_dlta]
    launch_DMND_LD_t2_ord_dlta_to_dmnd_dlta >> [launch_DMND_LD_t3_dmnd_dlta_to_fct]
    launch_DMND_LD_t3_dmnd_dlta_to_fct >> [launch_DMND_LD_t4_ord_dlta_to_prev]
    launch_DMND_LD_t4_ord_dlta_to_prev >> pelican_validator >> pelican_sensor
