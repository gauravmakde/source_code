...
dag_id = 'gcp_receipt_sku_store_fact_load_po_otb_run_10976_tech_nap_merch'
...
sys.path.append(module_path + 'sub1/')
...
default_args = {
    ...
    'description': 'receipt_sku_store_fact_load_po_otb_run_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    external_dag_id='gcp_mfp_poreceipt_kafka_to_teradata_10976_tech_nap_merch',
    ...
    receipt_sku_store_fact_load_poreceipt = open(
    os.path.join(sql_path, 'receipt_sku_store_fact_load_poreceipt.sql'),
    "r").read()

    launch_receipt_sku_store_fact_load_poreceipt_job_000 = BigQueryInsertJobOperator(
        task_id = "receipt_sku_store_fact_load_poreceipt_job_000",
        configuration = 
        {
            "query": 
            {
                "query": receipt_sku_store_fact_load_poreceipt,
                "useLegacySql": False
            }
        },
    ...
    launch_other_appId_upstream_dependencies_sensor_1 >>[launch_receipt_sku_store_fact_load_poreceipt_job_000]
    launch_receipt_sku_store_fact_load_poreceipt_job_000 >> pelican_validator >> pelican_sensor
