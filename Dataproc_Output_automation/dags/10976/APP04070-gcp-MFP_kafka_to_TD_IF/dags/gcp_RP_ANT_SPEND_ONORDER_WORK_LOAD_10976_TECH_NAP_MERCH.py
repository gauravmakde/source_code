...
dag_id = 'gcp_rp_ant_spend_onorder_work_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'rp_ant_spend_onorder_work_load_10976_tech_nap_merch DAG Description',
...
#     external_dag_id='gcp_rp_bkd_msrs_wrk_load_10976_tech_nap_merch',
#     date_query_fn=upstream_dependency.date_query_function,
#     timeout=3600,
#     retries=1,
#     poke_interval=120
...
# )
    ...
    merch_rp_anticipated_spend_onorder_wrk_load = open(
    os.path.join(sql_path, 'merch_rp_anticipated_spend_onorder_wrk_load.sql'),
    "r").read()

    launch_merch_rp_ant_spend_job1_onorder_work_load = BigQueryInsertJobOperator(
        task_id = "merch_rp_ant_spend_job1_onorder_work_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_rp_anticipated_spend_onorder_wrk_load,
                "useLegacySql": False
            }
        },
    ...
    launch_other_appId_upstream_dependencies_sensor_2 >>[launch_merch_rp_ant_spend_job1_onorder_work_load]
    launch_merch_rp_ant_spend_job1_onorder_work_load >> pelican_validator >> pelican_sensor