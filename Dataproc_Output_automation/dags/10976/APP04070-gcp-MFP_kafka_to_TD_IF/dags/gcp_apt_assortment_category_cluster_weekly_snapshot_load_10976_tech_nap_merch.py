...
# CI pipeline URL:      https://git.jwn.app/TM00593/das_merch/APP04070-gcp-MFP_kafka_to_TD_IF/-/pipelines/6786039
...
dag_id = "gcp_apt_assortment_category_cluster_weekly_snapshot_load_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "apt_assortment_category_cluster_weekly_snapshot_load_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    #     external_dag_id='gcp_mfpc_assortment_category_cluster_kafka_to_teradata_10976_tech_nap_merch',
    ...
    apt_assortment_category_cluster_weekly_snapshot_load = open(
        os.path.join(
            sql_path, "apt_assortment_category_cluster_weekly_snapshot_load.sql"
        ),
        "r",
    ).read()

    launch_apt_category_cluster_load_weekly_snapshot = BigQueryInsertJobOperator(
        task_id="apt_category_cluster_load_weekly_snapshot",
        configuration={
            "query": {
                "query": apt_assortment_category_cluster_weekly_snapshot_load,
                "useLegacySql": False,
            }
        },
    ...
    # creds_setup  >> launch_other_appId_upstream_dependencies_sensor_0 >>[launch_apt_category_cluster_load_weekly_snapshot]
    # launch_apt_category_cluster_load_weekly_snapshot >> pelican_validator >> pelican_sensor

    creds_setup >> [launch_apt_category_cluster_load_weekly_snapshot]
    (
        launch_apt_category_cluster_load_weekly_snapshot
        >> pelican_validator
        >> pelican_sensor
    )
