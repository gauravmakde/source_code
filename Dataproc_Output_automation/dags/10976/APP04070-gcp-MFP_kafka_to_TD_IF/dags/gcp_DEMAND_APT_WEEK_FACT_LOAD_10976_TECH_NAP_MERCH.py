# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        da9c0640de54bbd0c0d4f84b109dbbadde024514
# CI pipeline URL:      https://git.jwn.app/TM00593/das_merch/APP04070-gcp-MFP_kafka_to_TD_IF/-/pipelines/6812757
# CI commit timestamp:  2024-08-27T04:57:05+00:00
...
dag_id = 'gcp_demand_apt_week_fact_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'demand_apt_week_fact_load_10976_tech_nap_merch DAG Description',
...
# )
    ...
    merch_demand_sku_store_week_fct_load = open(
    os.path.join(sql_path, 'merch_demand_sku_store_week_fct_load.sql'),
    "r").read()

    launch_demand_apt_data_load_job_0 = BigQueryInsertJobOperator(
        task_id = "demand_apt_data_load_job_0",
        configuration = 
        {
            "query": 
            {
                "query": merch_demand_sku_store_week_fct_load,
                "useLegacySql": False
            }
        },
    ...
    demand_dw_batch_update = open(
    os.path.join(sql_path, 'demand_dw_batch_update.sql'),
    "r").read()

    launch_demand_apt_data_load_job_1 = BigQueryInsertJobOperator(
        task_id = "demand_apt_data_load_job_1",
        configuration = 
        {
            "query": 
            {
                "query": demand_dw_batch_update,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_other_appId_upstream_dependencies_sensor_1 >>[launch_demand_apt_data_load_job_0]
    launch_demand_apt_data_load_job_0 >>[launch_demand_apt_data_load_job_1]
    launch_demand_apt_data_load_job_1 >> pelican_validator >> pelican_sensor