# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        02e51c37f2d4b0dcca7fa9206c6534149ac592b0
# CI pipeline URL:      https://git.jwn.app/TM00593/das_merch/APP04070-gcp-MFP_kafka_to_TD_IF/-/pipelines/6836851
# CI commit timestamp:  2024-08-29T05:45:12+00:00
...
dag_id = 'gcp_merch_on_order_load_otb_run_10976_tech_nap_merch'
...
default_args = {    
    ...
    'description': 'merch_on_order_load_otb_run_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    launch_other_appId_upstream_dependencies_sensor_3 = ApiDagRunLatestSensor(
        ...
        conn_id='okta_conn_to_APP08918_team',
        external_dag_id='gcp_TECH_Merch_NAP_PRICE_AND_PROMOTION_INCREMENTAL_LOAD',
        date_query_fn=upstream_dependency.date_query_function,
        timeout=3600,
        retries=1,
        poke_interval=120
    ...
    merch_on_order_work_load = open(
    os.path.join(sql_path, 'merch_on_order_work_load.sql'),
    "r").read()

    launch_merch_on_order_load_stage_work_load = BigQueryInsertJobOperator(
        task_id = "merch_on_order_load_stage_work_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_on_order_work_load,
                "useLegacySql": False
            }
        },
    ...
    merch_on_order_fact_load = open(
    os.path.join(sql_path, 'merch_on_order_fact_load.sql'),
    "r").read()

    launch_merch_on_order_load_stage_fact_load = BigQueryInsertJobOperator(
        task_id = "merch_on_order_load_stage_fact_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_on_order_fact_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_other_appId_upstream_dependencies_sensor_4 >>[launch_merch_on_order_load_stage_work_load]
    launch_merch_on_order_load_stage_work_load >>[launch_merch_on_order_load_stage_fact_load]
    launch_merch_on_order_load_stage_fact_load >> pelican_validator >> pelican_sensor