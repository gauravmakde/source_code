...
dag_id = 'gcp_rp_batch_updt_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'rp_batch_updt_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    merch_rp_dly_batch_date_update = open(
    os.path.join(sql_path, 'merch_rp_dly_batch_date_update.sql'),
    "r").read()

    launch_merch_rp_t1_batch_updt = BigQueryInsertJobOperator(
        task_id = "merch_rp_t1_batch_updt",
        configuration = 
        {
            "query": 
            {
                "query": merch_rp_dly_batch_date_update,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_merch_rp_t1_batch_updt >> pelican_validator >> pelican_sensor