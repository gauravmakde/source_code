...
dag_id = 'gcp_project_mfp_reclass_kafka_to_td_tpt_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'project_mfp_reclass_kafka_to_td_tpt_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'inventory-reclass-ledger-analytical-avro',
        consumer_group_name = 'onix-inventory-reclass-ledger-analytical-avro_project_mfp_reclass_kafka_to_td_tpt_10976_tech_nap_merch_read_reclass_from_kafka_and_write_to_teradata_job_1',
    ...
    session_name=get_batch_id(dag_id=dag_id,task_id="read_reclass_from_kafka_and_write_to_bigquery_job_1")   
    read_reclass_from_kafka_and_write_to_bigquery_job_1 = DataprocCreateBatchOperator(
            task_id = "read_reclass_from_kafka_and_write_to_bigquery_job_1",
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_project_mfp_reclass_kafka_to_td_tpt_10976_tech_nap_merch_read_reclass_from_kafka_and_write_to_bigquery_job_1.json",
    ...
    tpt_jdbc_insert_read_reclass_from_kafka_and_write_to_bigquery_job_2_control_tbl = BashOperator(
    task_id='tpt_jdbc_insert_read_reclass_from_kafka_and_write_to_bigquery_job_2_control_tbl',
    bash_command=f'echo "Skipping Control Table Entry"')

    
    read_reclass_bigquery_ldg_to_fact = open(
    os.path.join(sql_path, 'read_reclass_bigquery_ldg_to_fact.sql'),
    "r").read()

    launch_read_reclass_from_kafka_and_write_to_bigquery_job_3 = BigQueryInsertJobOperator(
        task_id = "read_reclass_from_kafka_and_write_to_bigquery_job_3",
        configuration = 
        {
            "query": 
            {
                "query": read_reclass_bigquery_ldg_to_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >>[read_reclass_from_kafka_and_write_to_bigquery_job_1]
    read_reclass_from_kafka_and_write_to_bigquery_job_1 >>[tpt_jdbc_insert_read_reclass_from_kafka_and_write_to_bigquery_job_2_control_tbl]
    tpt_jdbc_insert_read_reclass_from_kafka_and_write_to_bigquery_job_2_control_tbl >>[launch_read_reclass_from_kafka_and_write_to_bigquery_job_3]
    launch_read_reclass_from_kafka_and_write_to_bigquery_job_3 >> pelican_validator >> pelican_sensor