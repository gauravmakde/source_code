...
dag_id = "gcp_mfp_financial_channel_plan_weekly_snapshot_load_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "mfp_financial_channel_plan_weekly_snapshot_load_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    mfp_financial_channel_plan_weekly_snapshot_load = open(
        os.path.join(sql_path, "mfp_financial_channel_plan_weekly_snapshot_load.sql"),
        "r",
    ).read()

    launch_mfp_financial_channel_plan_t1_load_last_fiscal_week_snapshot = (
        BigQueryInsertJobOperator(
            task_id="mfp_financial_channel_plan_t1_load_last_fiscal_week_snapshot",
            configuration={
                "query": {
                    "query": mfp_financial_channel_plan_weekly_snapshot_load,
                    "useLegacySql": False,
                }
            },
