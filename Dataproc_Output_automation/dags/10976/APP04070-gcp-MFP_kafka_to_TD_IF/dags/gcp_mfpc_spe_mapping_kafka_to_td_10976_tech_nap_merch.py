...
dag_id = "gcp_mfpc_spe_mapping_kafka_to_td_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "mfpc_spe_mapping_kafka_to_td_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="product-supplier-group-id-assignment-analytical-avro",
        consumer_group_name="gcp-product-supplier-group-id-assignment-analytical-avro_mfpc_spe_mapping_kafka_to_td_10976_tech_nap_merch_read_spe_mapping_from_kafka_and_write_to_teradata_job_spe_mapping_first_exec_2",
    ...
    session_name = get_batch_id(
        dag_id=dag_id,
        task_id="read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_first_exec_2",
    )
    read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_first_exec_2 = DataprocCreateBatchOperator(
        task_id="read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_first_exec_2",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_mfpc_spe_mapping_kafka_to_td_10976_tech_nap_merch_read_spe_mapping_from_kafka_and_write_to_teradata_job_spe_mapping_first_exec_2.json",
    ...
    tpt_jdbc_insert_read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_second_exec_2_control_tbl = BashOperator(
        task_id="tpt_jdbc_insert_read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_second_exec_2_control_tbl",
        bash_command=f'echo "Skipping Control Table Entry"',
    )


    mfpc_spe_mapping_kafka_to_bq_10976_tech_nap_merch_read_spe_mapping_from_kafka_and_write_to_bigquery_read_spe_mapping_from_bigquery_and_write_to_bigquery = open(
        os.path.join(sql_path, "read_spe_mapping_from_bigquery_and_write_to_bigquery.sql"),
        "r",
    ).read()

    launch_read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_third_exec_2 = BigQueryInsertJobOperator(
        task_id="read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_third_exec_2",
        configuration={
            "query": {
                "query": mfpc_spe_mapping_kafka_to_bq_10976_tech_nap_merch_read_spe_mapping_from_kafka_and_write_to_bigquery_read_spe_mapping_from_bigquery_and_write_to_bigquery,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >>[read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_first_exec_2]
    read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_first_exec_2 >>[tpt_jdbc_insert_read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_second_exec_2_control_tbl]
    tpt_jdbc_insert_read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_second_exec_2_control_tbl >>[launch_read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_third_exec_2]
    launch_read_spe_mapping_from_kafka_and_write_to_bigquery_job_spe_mapping_third_exec_2 >> pelican_validator >> pelican_sensor
