...
dag_id = 'gcp_mfp_quarterly_plan_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'mfp_quarterly_plan_load_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    merch_financial_channel_plan_qtr_plan_fct = open(
    os.path.join(sql_path, 'merch_financial_channel_plan_qtr_plan_fct.sql'),
    "r").read()

    launch_qp_load_job_financial_channel_exec_01 = BigQueryInsertJobOperator(
        task_id = "qp_load_job_financial_channel_exec_01",
        configuration = 
        {
            "query": 
            {
                "query": merch_financial_channel_plan_qtr_plan_fct,
                "useLegacySql": False
            }
        },
    ...
    merch_financial_country_banner_plan_qtr_plan_fct = open(
    os.path.join(sql_path, 'merch_financial_country_banner_plan_qtr_plan_fct.sql'),
    "r").read()

    launch_qp_load_job_financial_country_banner_exec_01 = BigQueryInsertJobOperator(
        task_id = "qp_load_job_financial_country_banner_exec_01",
        configuration = 
        {
            "query": 
            {
                "query": merch_financial_country_banner_plan_qtr_plan_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> launch_qp_load_job_financial_channel_exec_01 >> launch_qp_load_job_financial_country_banner_exec_01 >> pelican_validator >> pelican_sensor