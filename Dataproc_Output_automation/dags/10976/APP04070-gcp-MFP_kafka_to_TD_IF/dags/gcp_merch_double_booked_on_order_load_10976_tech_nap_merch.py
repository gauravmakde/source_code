...
dag_id = 'gcp_merch_double_booked_on_order_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'merch_double_booked_on_order_load_10976_tech_nap_merch DAG Description',
...
# )
    ...
    merch_double_booked_on_order_merch_double_booked_on_order_merch_double_booked_on_order_load_10976_tech_nap_merch_merch_double_booked_on_order_load_stage_merch_po_sku_fact_load = open( os.path.join(sql_path, 'merch_double_booked_on_order/merch_po_sku_fact_load.sql'),"r").read()
    ...
    launch_merch_double_booked_on_order_load_stage_merch_po_sku_fact_load = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": merch_double_booked_on_order_merch_double_booked_on_order_merch_double_booked_on_order_load_10976_tech_nap_merch_merch_double_booked_on_order_load_stage_merch_po_sku_fact_load,
                "useLegacySql": False
            }
        },
    ...
    merch_double_booked_on_order_merch_double_booked_on_order_merch_double_booked_on_order_load_10976_tech_nap_merch_merch_double_booked_on_order_load_stage_merch_double_booked_fact_load = open( os.path.join(sql_path, 'merch_double_booked_on_order/merch_double_booked_fact_load.sql'),"r").read()
    ...
    launch_merch_double_booked_on_order_load_stage_merch_double_booked_fact_load = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": merch_double_booked_on_order_merch_double_booked_on_order_merch_double_booked_on_order_load_10976_tech_nap_merch_merch_double_booked_on_order_load_stage_merch_double_booked_fact_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_merch_double_booked_on_order_load_stage_merch_double_booked_fact_load >> pelican_validator >> pelican_sensor