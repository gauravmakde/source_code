...
dag_id = "gcp_mfpc_spe_ledger_kafka_to_teradata_v1_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "mfpc_spe_ledger_kafka_to_teradata_v1_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="inventory-supplier-group-profitability-expectations-analytical-avro",
        consumer_group_name="onix-inventory-supplier-group-profitability-expectations-analytical-avro_mfpc_spe_ledger_kafka_to_teradata_v1_10976_tech_nap_merch_read_spe_ledger_from_kafka_and_write_to_teradata_job_spe_ledger_first_exec_04",
    ...
    launch_other_appId_upstream_dependencies_sensor_0 = ApiDagRunLatestSensor(
        ...
        external_dag_id="gcp_mfpc_spe_mapping_kafka_to_td_10976_tech_nap_merch",
    ...
    session_name = get_batch_id(
        dag_id=dag_id,
        task_id="read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_first_exec_04",
    )
    read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_first_exec_04 = DataprocCreateBatchOperator(
        task_id="read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_first_exec_04",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_mfpc_spe_ledger_kafka_to_teradata_v1_10976_tech_nap_merch_read_spe_ledger_from_kafka_and_write_to_teradata_job_spe_ledger_first_exec_04.json",
                ],
            },
            "environment_config": {
                "execution_config": {
    ...
    tpt_jdbc_insert_read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_second_exec_04_control_tbl = BashOperator(
        task_id="tpt_jdbc_insert_read_read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_second_exec_04_control_tbl",
        bash_command=f'echo "Skipping Control Table Entry"',
    )

    read_spe_ledger_from_bigquery_write_bigquery = open(
        os.path.join(sql_path, "read_spe_ledger_from_bigquery_write_bigquery.sql"), "r"
    ).read()

    launch_read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_third_exec_04 = BigQueryInsertJobOperator(
        task_id="read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_third_exec_04",
        configuration={
            "query": {
                "query": read_spe_ledger_from_bigquery_write_bigquery,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
...
(
    ...
    >> [read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_first_exec_04]
)
read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_first_exec_04 >> [
    tpt_jdbc_insert_read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_second_exec_04_control_tbl
]
(
    tpt_jdbc_insert_read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_second_exec_04_control_tbl
    >> [
        launch_read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_third_exec_04
    ]
)
(
    launch_read_spe_ledger_from_kafka_and_write_to_bigquery_job_spe_ledger_third_exec_04
