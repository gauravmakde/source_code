...
dag_id = "gcp_clearance_markdown_stock_quantity_history_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "clearance_markdown_stock_quantity_history_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    clearance_markdown_stock_quantity_history_clear_clearance_markdown_stock_quantity_end_of_wk_fact = open(
        os.path.join(
            sql_path,
            "clearance_markdown_stock_quantity_history/clear_clearance_markdown_stock_quantity_end_of_wk_fact.sql",
        ),
        "r",
    ).read()
    ...
    launch_run_clear_inv_fact = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": clearance_markdown_stock_quantity_history_clear_clearance_markdown_stock_quantity_end_of_wk_fact,
                "useLegacySql": False,
            }
        },
    ...
    clearance_markdown_stock_quantity_history_load_clearance_markdown_stock_quantity_end_of_wk_fact = open(
        os.path.join(
            sql_path,
            "clearance_markdown_stock_quantity_history/load_clearance_markdown_stock_quantity_end_of_wk_fact.sql",
        ),
        "r",
    ).read()
    ...
    launch_run_load_inv_fact = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": clearance_markdown_stock_quantity_history_load_clearance_markdown_stock_quantity_end_of_wk_fact,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    clearance_markdown_stock_quantity_history_cmd_stock_qnty_batch_dt_update = open(
        os.path.join(
            sql_path,
            "clearance_markdown_stock_quantity_history/cmd_stock_qnty_batch_dt_update.sql",
        ),
        "r",
    ).read()

    launch_run_cmd_stck_qnty_batch_dt_update = BigQueryInsertJobOperator(
        task_id="run_cmd_stck_qnty_batch_dt_update",
        configuration={
            "query": {
                "query": clearance_markdown_stock_quantity_history_cmd_stock_qnty_batch_dt_update,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    (
        ...
        >> [launch_run_clear_inv_fact]
    )
    launch_run_clear_inv_fact >> [launch_run_load_inv_fact]
    launch_run_load_inv_fact >> [launch_run_cmd_stck_qnty_batch_dt_update]
    launch_run_cmd_stck_qnty_batch_dt_update >> pelican_validator >> pelican_sensor
