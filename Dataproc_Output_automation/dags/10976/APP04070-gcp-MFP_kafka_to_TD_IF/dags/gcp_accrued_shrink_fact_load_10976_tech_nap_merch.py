...
dag_id = 'gcp_accrued_shrink_fact_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'accrued_shrink_fact_load_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    external_dag_id='gcp_project_mfp_eowsl_kafka_to_td_tpt_10976_tech_nap_merch',
    ...
    conn_id='okta_conn_to_APP04070_team',
    external_dag_id='gcp_mfpc_sales_returns_extract_nap_to_s3_10976_tech_nap_merch',
    ...
    accrued_shrink_config_update = open(
    os.path.join(sql_path, 'accrued_shrink_config_update.sql'),
    "r").read()

    launch_accrued_shrink_load_accr_shrink_config_update = BigQueryInsertJobOperator(
        task_id = "accrued_shrink_load_accr_shrink_config_update",
        configuration = 
        {
            "query": 
            {
                "query": accrued_shrink_config_update,
                "useLegacySql": False
            }
        },
    ...
    accrued_shrink_fact_load = open(
    os.path.join(sql_path, 'accrued_shrink_fact_load.sql'),
    "r").read()

    launch_accrued_shrink_load_accr_shrink_load_1 = BigQueryInsertJobOperator(
        task_id = "accrued_shrink_load_accr_shrink_load_1",
        configuration = 
        {
            "query": 
            {
                "query": accrued_shrink_fact_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_accrued_shrink_load_accr_shrink_load_2 = BigQueryInsertJobOperator(
        task_id = "accrued_shrink_load_accr_shrink_load_2",
        configuration = 
        {
            "query": 
            {
    ...
    launch_accrued_shrink_load_accr_shrink_load_3 = BigQueryInsertJobOperator(
        task_id = "accrued_shrink_load_accr_shrink_load_3",
        configuration = 
        {
            "query": 
            {
    ...
    launch_accrued_shrink_load_accr_shrink_load_4 = BigQueryInsertJobOperator(
        task_id = "accrued_shrink_load_accr_shrink_load_4",
        configuration = 
        {
            "query": 
            {
    ...
    launch_accrued_shrink_load_accr_shrink_load_5 = BigQueryInsertJobOperator(
        task_id = "accrued_shrink_load_accr_shrink_load_5",
        configuration = 
        {
            "query": 
            {
    ...
    launch_accrued_shrink_load_accr_shrink_load_6 = BigQueryInsertJobOperator(
        task_id = "accrued_shrink_load_accr_shrink_load_6",
        configuration = 
        {
            "query": 
            {
    ...
    accrued_shrink_batch_date_update = open(
    os.path.join(sql_path, 'accrued_shrink_batch_date_update.sql'),
    "r").read()

    launch_accrued_shrink_load_accr_shrink_batch_date_update = BigQueryInsertJobOperator(
        task_id = "accrued_shrink_load_accr_shrink_batch_date_update",
        configuration = 
        {
            "query": 
            {
                "query": accrued_shrink_batch_date_update,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_other_appId_upstream_dependencies_sensor_1 >>[launch_accrued_shrink_load_accr_shrink_config_update]
    launch_accrued_shrink_load_accr_shrink_config_update >>[launch_accrued_shrink_load_accr_shrink_load_1]
    launch_accrued_shrink_load_accr_shrink_load_1 >>[launch_accrued_shrink_load_accr_shrink_load_2]
    launch_accrued_shrink_load_accr_shrink_load_2 >>[launch_accrued_shrink_load_accr_shrink_load_3]
    launch_accrued_shrink_load_accr_shrink_load_3 >>[launch_accrued_shrink_load_accr_shrink_load_4]
    launch_accrued_shrink_load_accr_shrink_load_4 >>[launch_accrued_shrink_load_accr_shrink_load_5]
    launch_accrued_shrink_load_accr_shrink_load_5 >>[launch_accrued_shrink_load_accr_shrink_load_6]
    launch_accrued_shrink_load_accr_shrink_load_6 >>[launch_accrued_shrink_load_accr_shrink_batch_date_update]
    launch_accrued_shrink_load_accr_shrink_batch_date_update >> pelican_validator >> pelican_sensor