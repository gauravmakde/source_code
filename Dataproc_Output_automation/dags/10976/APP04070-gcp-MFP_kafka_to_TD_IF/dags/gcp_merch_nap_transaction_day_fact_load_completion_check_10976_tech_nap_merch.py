...
dag_id = "gcp_merch_nap_transaction_day_fact_load_completion_check_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "merch_nap_transaction_day_fact_load_completion_check_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    merch_nap_transaction_day_fact_load_completion_check_10976_tech_nap_merch_update_nap_transaction_day_fact_load_flag = open(
        os.path.join(sql_path, "update_nap_transaction_day_fact_load_flag.sql"), "r"
    ).read()

    launch_merch_nap_transaction_day_fact_load_flag_update_t1_update_nap_transaction_day_fact_load_flag = BigQueryInsertJobOperator(
        task_id="merch_nap_transaction_day_fact_load_flag_update_t1_update_nap_transaction_day_fact_load_flag",
        configuration={
            "query": {
                "query": merch_nap_transaction_day_fact_load_completion_check_10976_tech_nap_merch_update_nap_transaction_day_fact_load_flag,
                "useLegacySql": False,
            }
        },
    ...
    # launch_other_appId_upstream_dependencies_sensor_1 >>[launch_merch_nap_transaction_day_fact_load_flag_update_t1_update_nap_transaction_day_fact_load_flag]
    # launch_merch_nap_transaction_day_fact_load_flag_update_t1_update_nap_transaction_day_fact_load_flag >> pelican_validator >> pelican_sensor

    creds_setup >> [
        launch_merch_nap_transaction_day_fact_load_flag_update_t1_update_nap_transaction_day_fact_load_flag
    ]
    (
        launch_merch_nap_transaction_day_fact_load_flag_update_t1_update_nap_transaction_day_fact_load_flag
        >> pelican_validator
