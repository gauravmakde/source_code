...
dag_id = 'gcp_mfpc_mos_kafka_to_teradata_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'mfpc_mos_kafka_to_bigquery_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'inventory-merch-expense-transfer-ledger-analytical-avro',
        consumer_group_name = 'onix-inventory-merch-expense-transfer-ledger-analytical-avro_mfpc_mos_kafka_to_teradata_10976_tech_nap_merch_read_mos_from_kafka_and_write_to_teradata_job_mos_first_exec_2',
    ...
    session_name=get_batch_id(dag_id=dag_id,task_id="read_mos_from_kafka_and_write_to_bigquery_job_mos_first_exec_2")   
    read_mos_from_kafka_and_write_to_bigquery_job_mos_first_exec_2 = DataprocCreateBatchOperator(
            task_id = "read_mos_from_kafka_and_write_to_bigquery_job_mos_first_exec_2",
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_mfpc_mos_kafka_to_bigquery_10976_tech_nap_merch_read_mos_from_kafka_and_write_to_bigquery_job_mos_first_exec_2.json",
    ...
    tpt_jdbc_insert_read_mos_from_kafka_and_write_to_bigquery_job_mos_second_exec_2_control_tbl = BashOperator(
    task_id='tpt_jdbc_insert_read_mos_from_kafka_and_write_to_bigquery_job_mos_second_exec_2_control_tbl',
    bash_command=f'echo "Skipping Control Table Entry"')

    
    read_mos_from_bigquery_and_write_to_bigquery = open(
    os.path.join(sql_path, 'read_mos_from_bigquery_and_write_to_bigquery.sql'),
    "r").read()

    launch_read_mos_from_kafka_and_write_to_bigquery_job_mos_third_exec_2 = BigQueryInsertJobOperator(
        task_id = "read_mos_from_kafka_and_write_to_bigquery_job_mos_third_exec_2",
        configuration = 
        {
            "query": 
            {
                "query": read_mos_from_bigquery_and_write_to_bigquery,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >>[read_mos_from_kafka_and_write_to_bigquery_job_mos_first_exec_2]
    read_mos_from_kafka_and_write_to_bigquery_job_mos_first_exec_2 >>[tpt_jdbc_insert_read_mos_from_kafka_and_write_to_bigquery_job_mos_second_exec_2_control_tbl]
    tpt_jdbc_insert_read_mos_from_kafka_and_write_to_bigquery_job_mos_second_exec_2_control_tbl >>[launch_read_mos_from_kafka_and_write_to_bigquery_job_mos_third_exec_2]
    launch_read_mos_from_kafka_and_write_to_bigquery_job_mos_third_exec_2 >> pelican_validator >> pelican_sensor