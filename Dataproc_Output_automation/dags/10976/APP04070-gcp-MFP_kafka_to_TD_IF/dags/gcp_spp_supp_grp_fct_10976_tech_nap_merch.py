...
dag_id = "gcp_spp_supp_grp_fct_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "spp_supp_grp_fct_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    merch_spp_suppgrp_dept_banner_month_fact_load = open(
        os.path.join(
            sql_path,
            "merch_spp_suppgrp_dept_banner_month_fact_load.sql",
        ),
        "r",
    ).read()
    ...
    #     >> [launch_SPP_SUPP_GRP_FACT_t0_1_spp_supp_grp_fact_load]
    # )
    # launch_SPP_SUPP_GRP_FACT_t0_1_spp_supp_grp_fact_load >> [
    #     launch_SPP_SUPP_GRP_FACT_t3_spp_batch_updt
    # ]
    # launch_SPP_SUPP_GRP_FACT_t3_spp_batch_updt >> pelican_validator >> pelican_sensor

    creds_setup >> launch_SPP_SUPP_GRP_FACT_t0_1_spp_supp_grp_fact_load
    (
        launch_SPP_SUPP_GRP_FACT_t0_1_spp_supp_grp_fact_load
        >> launch_SPP_SUPP_GRP_FACT_t3_spp_batch_updt
    )
