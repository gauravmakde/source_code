...
dag_id = "gcp_merch_transaction_dept_channel_week_agg_fact_load_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "merch_transaction_dept_channel_week_agg_fact_load_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    merch_transaction_dept_channel_week_agg_fact_data_prepare = open(
        os.path.join(
            sql_path, "merch_transaction_dept_channel_week_agg_fact_data_prepare.sql"
        ),
        "r",
    ).read()
    ...
    launch_load_weeks_prepare = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": merch_transaction_dept_channel_week_agg_fact_data_prepare,
                "useLegacySql": False,
            }
        },
    ...
    merch_transaction_dept_channel_week_agg_fact_data_load = open(
        os.path.join(
            sql_path, "merch_transaction_dept_channel_week_agg_fact_data_load.sql"
        ),
        "r",
    ).read()
    ...
    launch_load_weeks_agg_fact_load_1_40 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": merch_transaction_dept_channel_week_agg_fact_data_load,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
...
# Commented the collect stats as it is not supported in BQ
# merch_transaction_dept_channel_week_agg_fact_data_collect = open(
# os.path.join(sql_path, 'merch_transaction_dept_channel_week_agg_fact_data_collect.sql'),
# "r").read()
...
#         "query":
#         {
#             "query": merch_transaction_dept_channel_week_agg_fact_data_collect,
#             "useLegacySql": False
#         }
#     },
#     project_id = project_id,
