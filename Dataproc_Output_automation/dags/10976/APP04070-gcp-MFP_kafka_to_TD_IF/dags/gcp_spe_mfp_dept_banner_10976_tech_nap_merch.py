# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        e238b6653635d809f0ebd2d341941d6e4af9f94e
# CI pipeline URL:      https://git.jwn.app/TM00593/das_merch/APP04070-gcp-MFP_kafka_to_TD_IF/-/pipelines/6825189
# CI commit timestamp:  2024-08-27T23:55:50+00:00
...
dag_id = "gcp_spe_mfp_dept_banner_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "spe_mfp_dept_banner_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    merch_spe_mfp_banner_fact_load = open(
        os.path.join(sql_path, "merch_spe_mfp_banner_fact_load.sql"), "r"
    ).read()

    launch_SPE_MFP_DEPT_t1_mfp_plan_act_dept_banner_fact_load = (
        BigQueryInsertJobOperator(
            task_id="SPE_MFP_DEPT_t1_mfp_plan_act_dept_banner_fact_load",
            configuration={
                "query": {
                    "query": merch_spe_mfp_banner_fact_load,
                    "useLegacySql": False,
                }
            },
    ...
    # creds_setup >> launch_other_appId_upstream_dependencies_sensor_0 >>[launch_SPE_MFP_DEPT_t1_mfp_plan_act_dept_banner_fact_load]
    # launch_SPE_MFP_DEPT_t1_mfp_plan_act_dept_banner_fact_load >> pelican_validator >> pelican_sensor

    creds_setup >> [launch_SPE_MFP_DEPT_t1_mfp_plan_act_dept_banner_fact_load]
    (
        launch_SPE_MFP_DEPT_t1_mfp_plan_act_dept_banner_fact_load
        >> pelican_validator
        >> pelican_sensor
