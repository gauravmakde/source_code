...
dag_id = 'gcp_rp_ant_spend_fact_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'rp_ant_spend_fact_load_10976_tech_nap_merch DAG Description',
...
#     external_dag_id='gcp_mfp_rp_anticipated_receipt_load_10976_tech_nap_merch',
...
#     conn_id='okta_conn_to_APP04070_team',
#     external_dag_id='gcp_rp_ant_spend_onorder_work_load_10976_tech_nap_merch',
#     date_query_fn=upstream_dependency.date_query_function,
#     timeout=3600,
#     retries=1,
#     poke_interval=120
...
# )
    ...
    merch_rp_anticipated_spend_fact_load = open(
    os.path.join(sql_path, 'merch_rp_anticipated_spend_fact_load.sql'),
    "r").read()

    launch_merch_rp_t1_ant_spend_fact_load = BigQueryInsertJobOperator(
        task_id = "merch_rp_t1_ant_spend_fact_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_rp_anticipated_spend_fact_load,
                "useLegacySql": False
            }
        },
    ...
    launch_other_appId_upstream_dependencies_sensor_2 >>[launch_merch_rp_t1_ant_spend_fact_load]
    launch_merch_rp_t1_ant_spend_fact_load >> pelican_validator >> pelican_sensor