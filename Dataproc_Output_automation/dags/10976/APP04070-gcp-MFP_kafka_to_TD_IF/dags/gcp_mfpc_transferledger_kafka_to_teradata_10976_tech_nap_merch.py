...
dag_id = 'gcp_mfpc_transferledger_kafka_to_teradata_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'mfpc_transferledger_kafka_to_teradata_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'inventory-transfer-ledger-analytical-avro',
        consumer_group_name = 'onix-inventory-transfer-ledger-analytical-avro_mfpc_transferledger_kafka_to_teradata_10976_tech_nap_merch_read_transferledger_from_kafka_and_write_to_teradata_job_00003',
    ...
    session_name=get_batch_id(dag_id=dag_id,task_id="read_transferledger_from_kafka_and_write_to_teradata_job_00003")   
    read_transferledger_from_kafka_and_write_to_teradata_job_00003 = DataprocCreateBatchOperator(
            task_id = "read_transferledger_from_kafka_and_write_to_teradata_job_00003",
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_mfpc_transferledger_kafka_to_teradata_10976_tech_nap_merch_read_transferledger_from_kafka_and_write_to_teradata_job_00003.json",
    ...
    tpt_jdbc_insert_read_transferledger_from_kafka_and_write_to_teradata_job_0004_control_tbl = BashOperator(
    task_id='tpt_jdbc_insert_read_transferledger_from_kafka_and_write_to_teradata_job_0004_control_tbl',
    bash_command=f'echo "Skipping Control Table Entry"')

    # tpt_read_transferledger_from_kafka_and_write_to_teradata_job_0004_load_tbl = SSHOperator(
    # task_id='tpt_read_transferledger_from_kafka_and_write_to_teradata_job_0004_load_tbl',
    # command="/db/teradata/bin/tpt_load.sh  -e PRD_NAP_UTL -j PRD_NAP_STG_MERCH_TRANSFER_LEDGER_LDG_JOB -h tdnapprod.nordstrom.net -l 'N' -u SCH_NAP_MERCH_BATCH -p \"\$tdwallet(SCH_NAP_MERCH_BATCH_PWD)\" -f s3://nap-das-merch-tpt-prod-v1/transferledger/*/*/*/* -o UPDATE",
    # timeout=1800,
    # ssh_conn_id="TECH_ISF_NAP_MERCH_MFP_SECURITY_TDUTIL_SERVER_S3EXT_PROD")

    
    read_transferledger_from_teradata_write_teradata = open(
    os.path.join(sql_path, 'read_transferledger_from_teradata_write_teradata.sql'),
    "r").read()

    launch_read_transferledger_from_kafka_and_write_to_teradata_job_0005 = BigQueryInsertJobOperator(
        task_id = "read_transferledger_from_kafka_and_write_to_teradata_job_0005",
        configuration = 
        {
            "query": 
            {
                "query": read_transferledger_from_teradata_write_teradata,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >>[read_transferledger_from_kafka_and_write_to_teradata_job_00003]
    read_transferledger_from_kafka_and_write_to_teradata_job_00003 >>[tpt_jdbc_insert_read_transferledger_from_kafka_and_write_to_teradata_job_0004_control_tbl]
    tpt_jdbc_insert_read_transferledger_from_kafka_and_write_to_teradata_job_0004_control_tbl >>[launch_read_transferledger_from_kafka_and_write_to_teradata_job_0005]
    launch_read_transferledger_from_kafka_and_write_to_teradata_job_0005 >> pelican_validator >> pelican_sensor