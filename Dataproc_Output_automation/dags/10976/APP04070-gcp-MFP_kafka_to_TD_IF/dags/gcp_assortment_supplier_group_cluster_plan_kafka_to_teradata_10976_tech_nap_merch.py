# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        74029d2f0d2a9674305c09cf9c67a8bb696fccc1
# CI pipeline URL:      https://git.jwn.app/TM00593/das_merch/APP04070-gcp-MFP_kafka_to_TD_IF/-/pipelines/6842264
# CI commit timestamp:  2024-08-29T17:48:26+00:00
...
dag_id = (
    "gcp_assortment_supplier_group_cluster_plan_kafka_to_teradata_10976_tech_nap_merch"
)
...
default_args = {
    ...
    "description": "assortment_supplier_group_cluster_plan_kafka_to_teradata_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="inventory-supplier-group-cluster-level-plan-analytical-avro",
        consumer_group_name="onix-inventory-supplier-group-cluster-level-plan-analytical-avro_assortment_supplier_group_cluster_plan_kafka_to_teradata_10976_tech_nap_merch_assortment_supplier_group_cluster_plan_read_from_kafka_write_to_s3_01",
    ...
    session_name = get_batch_id(
        dag_id=dag_id,
        task_id="assortment_supplier_group_cluster_plan_read_from_kafka_write_to_s3_01",
    )
    assortment_supplier_group_cluster_plan_read_from_kafka_write_to_s3_01 = DataprocCreateBatchOperator(
        task_id="assortment_supplier_group_cluster_plan_read_from_kafka_write_to_s3_01",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_assortment_supplier_group_cluster_plan_kafka_to_bigquery_10976_tech_nap_merch_assortment_supplier_group_cluster_plan_read_from_kafka_write_to_s3_01.json",
    ...
    tpt_jdbc_insert_assortment_supplier_group_cluster_plan_load_to_landing_table_using_tpt_control_tbl = BashOperator(
        task_id="tpt_jdbc_insert_assortment_supplier_group_cluster_plan_load_to_landing_table_using_tpt_control_tbl",
        bash_command=f'echo "Skipping Control Table Entry"',
    )

    # # PRD_NAP_STG,MERCH_ASSORTMENT_SUPPGRP_CLUSTER_PLAN_LDG
    # tpt_assortment_supplier_group_cluster_plan_load_to_landing_table_using_tpt_load_tbl = SSHOperator(
    # task_id='tpt_assortment_supplier_group_cluster_plan_load_to_landing_table_using_tpt_load_tbl',
    # command="/db/bigquery/bin/tpt_load.sh  -e PRD_NAP_UTL -j PRD_NAP_STG_MERCH_ASSORTMENT_SUPPGRP_CLUSTER_PLAN_LDG_JOB -h tdnapprod.nordstrom.net -l 'N' -u SCH_NAP_MERCH_BATCH -p \"\$tdwallet(SCH_NAP_MERCH_BATCH_PWD)\" -f s3://nap-das-merch-tpt-prod-v1/assortmentsuppliergroupclusterplan/*/*/*/* -o UPDATE",
    # timeout=1800,
    # ssh_conn_id="TECH_ISF_NAP_MERCH_MFP_SECURITY_TDUTIL_SERVER_S3EXT_PROD")

    read_assortmentsuppliergroup_cluster_plan_from_bigquery_and_write_to_bigquery = open(
        os.path.join(
            sql_path,
            "read_assortmentsuppliergroup_cluster_plan_from_bigquery_and_write_to_bigquery.sql",
        ),
        "r",
    ).read()

    launch_assortment_supplier_group_cluster_plan_load_fact_table = BigQueryInsertJobOperator(
        task_id="assortment_supplier_group_cluster_plan_load_fact_table",
        configuration={
            "query": {
                "query": read_assortmentsuppliergroup_cluster_plan_from_bigquery_and_write_to_bigquery,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    # launch_assortment_supplier_group_cluster_plan_s3_cleanup_stage_v2 = launch_k8s_api_job_operator(
    # dag=dag,
    # connection_id='TECH_Merchandising_NAP_Engineering_K8S_CONN_PROD',
    # namespace='app04070',
    # task_id='assortment_supplier_group_cluster_plan_s3_cleanup_stage_v2',
    # job_name='assortment-supplier-group-cluster-plan-s3-cleanup-stage-v2-asso',
    # macros=None,
    ...
    # container_command=['python', '/home/nonroot/python/s3cleanup/main.py', 'assortmentsuppliergroupclusterplan'],
    ...
    (
        ...
        >> [assortment_supplier_group_cluster_plan_read_from_kafka_write_to_s3_01]
    )
    assortment_supplier_group_cluster_plan_read_from_kafka_write_to_s3_01 >> [
        tpt_jdbc_insert_assortment_supplier_group_cluster_plan_load_to_landing_table_using_tpt_control_tbl
    ]
    (
        tpt_jdbc_insert_assortment_supplier_group_cluster_plan_load_to_landing_table_using_tpt_control_tbl
        >> [launch_assortment_supplier_group_cluster_plan_load_fact_table]
    )
    (
        launch_assortment_supplier_group_cluster_plan_load_fact_table
        >> pelican_validator
