...
dag_id = 'gcp_merch_expected_transfer_load_dly_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'merch_expected_transfer_load_dly_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    merch_expected_transfer_fact_load_dly = open(
    os.path.join(sql_path, 'merch_expected_transfer_fact_load_dly.sql'),
    "r").read()

    launch_merch_expected_transfer_fact_load_dly_merch_expected_transfer_fact_load_dly = BigQueryInsertJobOperator(
        task_id = "merch_expected_transfer_fact_load_dly_merch_expected_transfer_fact_load_dly",
        configuration = 
        {
            "query": 
            {
                "query": merch_expected_transfer_fact_load_dly,
                "useLegacySql": False
            }
        },
    ...
    launch_other_appId_upstream_dependencies_sensor_3 >>[launch_merch_expected_transfer_fact_load_dly_merch_expected_transfer_fact_load_dly]
    launch_merch_expected_transfer_fact_load_dly_merch_expected_transfer_fact_load_dly >> pelican_validator >> pelican_sensor