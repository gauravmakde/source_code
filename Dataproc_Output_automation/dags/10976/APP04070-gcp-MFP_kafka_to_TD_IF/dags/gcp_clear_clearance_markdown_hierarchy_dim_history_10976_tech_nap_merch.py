...
dag_id = "gcp_clear_clearance_markdown_hierarchy_dim_history_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "clear_clearance_markdown_hierarchy_dim_history_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    clear_clearance_markdown_hierarchy_dim_history_clear_clearance_markdown_hierarchy_dim = open(
        os.path.join(
            sql_path,
            "clear_clearance_markdown_hierarchy_dim_history/clear_clearance_markdown_hierarchy_dim.sql",
        ),
        "r",
    ).read()
    ...
    launch_run_clear_inv_fact = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": clear_clearance_markdown_hierarchy_dim_history_clear_clearance_markdown_hierarchy_dim,
                "useLegacySql": False,
            }
        },
    ...
    clear_clearance_markdown_hierarchy_dim_history_load_clearance_markdown_hierarchy_dim = open(
        os.path.join(
            sql_path,
            "clear_clearance_markdown_hierarchy_dim_history/load_clearance_markdown_hierarchy_dim.sql",
        ),
        "r",
    ).read()
    ...
    launch_run_load_inv_fact = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": clear_clearance_markdown_hierarchy_dim_history_load_clearance_markdown_hierarchy_dim,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    creds_setup >> launch_run_clear_inv_fact >> [launch_run_load_inv_fact]
    launch_run_load_inv_fact >> pelican_validator >> pelican_sensor
