...
dag_id = 'gcp_mfp_rp_anticipated_receipt_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'mfp_rp_anticipated_receipt_load_10976_tech_nap_merch DAG Description',
...
# )
    ...
    mfp_rp_anticipated_receipt_load_10976_tech_nap_merch_rp_anticipated_receipt_load_rp_ant_spend_receipt_work_load = open(
    os.path.join(sql_path, 'rp_ant_spend_receipt_work_load.sql'),
    "r").read()

    launch_rp_anticipated_receipt_load_rp_ant_spend_receipt_work_load = BigQueryInsertJobOperator(
        task_id = "rp_anticipated_receipt_load_rp_ant_spend_receipt_work_load",
        configuration = 
        {
            "query": 
            {
                "query": mfp_rp_anticipated_receipt_load_10976_tech_nap_merch_rp_anticipated_receipt_load_rp_ant_spend_receipt_work_load,
                "useLegacySql": False
            }
        },
    ...
    launch_other_appId_upstream_dependencies_sensor_2 >>[launch_rp_anticipated_receipt_load_rp_ant_spend_receipt_work_load]
    launch_rp_anticipated_receipt_load_rp_ant_spend_receipt_work_load >> pelican_validator >> pelican_sensor