...
dag_id = 'gcp_merch_double_booked_on_order_load_otb_run_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'merch_double_booked_on_order_load_otb_run_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    external_dag_id='gcp_merch_on_order_load_otb_run_10976_tech_nap_merch',
    ...
    merch_double_booked_on_order_merch_po_sku_fact_load = open( os.path.join(sql_path, 'merch_double_booked_on_order/merch_po_sku_fact_load.sql'),"r").read()

    launch_merch_double_booked_on_order_load_stage_merch_po_sku_fact_load = BigQueryInsertJobOperator(
        task_id = "merch_double_booked_on_order_load_stage_merch_po_sku_fact_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_double_booked_on_order_merch_po_sku_fact_load,
                "useLegacySql": False
            }
        },
    ...
    merch_double_booked_on_order_merch_double_booked_fact_load = open( os.path.join(sql_path, 'merch_double_booked_on_order/merch_double_booked_fact_load.sql'),"r").read()

    launch_merch_double_booked_on_order_load_stage_merch_double_booked_fact_load = BigQueryInsertJobOperator(
        task_id = "merch_double_booked_on_order_load_stage_merch_double_booked_fact_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_double_booked_on_order_merch_double_booked_fact_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    merch_double_booked_on_order_merch_double_booked_snapshot_fact_load = open( os.path.join(sql_path, 'merch_double_booked_on_order/merch_double_booked_snapshot_fact_load.sql'),"r").read()

    launch_merch_double_booked_on_order_load_stage_merch_double_booked_snapshot_fact_load = BigQueryInsertJobOperator(
        task_id = "merch_double_booked_on_order_load_stage_merch_double_booked_snapshot_fact_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_double_booked_on_order_merch_double_booked_snapshot_fact_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> launch_other_appId_upstream_dependencies_sensor_0 >>[launch_merch_double_booked_on_order_load_stage_merch_po_sku_fact_load]
    launch_merch_double_booked_on_order_load_stage_merch_po_sku_fact_load >>[launch_merch_double_booked_on_order_load_stage_merch_double_booked_fact_load]
    launch_merch_double_booked_on_order_load_stage_merch_double_booked_fact_load >>[launch_merch_double_booked_on_order_load_stage_merch_double_booked_snapshot_fact_load]
    launch_merch_double_booked_on_order_load_stage_merch_double_booked_snapshot_fact_load >> pelican_validator >> pelican_sensor