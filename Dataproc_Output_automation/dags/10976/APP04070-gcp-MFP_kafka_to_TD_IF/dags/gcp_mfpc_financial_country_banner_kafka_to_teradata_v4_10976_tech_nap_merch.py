...
dag_id = "gcp_mfpc_financial_country_banner_kafka_to_teradata_v4_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "mfpc_financial_country_banner_kafka_to_teradata_v4_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region=region,
        topic_name="inventory-financial-country-banner-level-plans-approved-analytical-avro",
        consumer_group_name="onix-inventory-financial-country-banner-level-plans-approved-analytical-avro_mfpc_financial_country_banner_kafka_to_teradata_v4_10976_tech_nap_merch_read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_first_exec_002",
    ...
    session_name = get_batch_id(
        dag_id=dag_id,
        task_id="read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_first_exec_002",
    )
    read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_first_exec_002 = DataprocCreateBatchOperator(
        task_id="read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_first_exec_002",
        ...
        batch={
            ...
            "spark_batch": {
                ...
                "args": [
                    f"{user_config_path}/argument_mfpc_financial_country_banner_kafka_to_teradata_v4_10976_tech_nap_merch_read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_first_exec_002.json",
    ...
    tpt_jdbc_insert_read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_second_exec_002_control_tbl = BashOperator(
        task_id="tpt_jdbc_insert_read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_second_exec_002_control_tbl",
        bash_command=f'echo "Skipping Control Table Entry"',
    )

    mfpc_financial_country_banner_kafka_to_teradata_v4_10976_tech_nap_merch_read_financial_countrybanner_from_kafka_and_write_to_teradata_read_financial_country_banner_from_teradata_and_write_to_teradata = open(
        os.path.join(
            sql_path,
            "read_financial_country_banner_from_teradata_and_write_to_teradata.sql",
        ),
        "r",
    ).read()

    launch_read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_third_exec_002 = BigQueryInsertJobOperator(
        task_id="read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_third_exec_002",
        configuration={
            "query": {
                "query": mfpc_financial_country_banner_kafka_to_teradata_v4_10976_tech_nap_merch_read_financial_countrybanner_from_kafka_and_write_to_teradata_read_financial_country_banner_from_teradata_and_write_to_teradata,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    (
        ...
        >> [
            read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_first_exec_002
        ]
    )
    (
        read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_first_exec_002
        >> [
            tpt_jdbc_insert_read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_second_exec_002_control_tbl
        ]
    )
    (
        tpt_jdbc_insert_read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_second_exec_002_control_tbl
        >> [
            launch_read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_third_exec_002
        ]
    )
    (
        launch_read_financial_countrybanner_from_kafka_and_write_to_teradata_job_financial_country_banner_third_exec_002
