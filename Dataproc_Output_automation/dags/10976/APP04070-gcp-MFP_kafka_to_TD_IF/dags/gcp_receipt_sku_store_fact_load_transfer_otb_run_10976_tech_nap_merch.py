...
dag_id = "gcp_receipt_sku_store_fact_load_transfer_otb_run_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "receipt_sku_store_fact_load_transfer_otb_run_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    #     external_dag_id="gcp_receipt_sku_store_fact_load_po_otb_run_10976_tech_nap_merch",
    ...
    receipt_sku_store_fact_load_transfer = open(
        os.path.join(sql_path, "receipt_sku_store_fact_load_transfer.sql"), "r"
    ).read()

    launch_receipt_sku_store_fact_load_transfer_job_000 = BigQueryInsertJobOperator(
        task_id="receipt_sku_store_fact_load_transfer_job_000",
        configuration={
            "query": {
                "query": receipt_sku_store_fact_load_transfer,
                "useLegacySql": False,
            }
        },
    ...
    # )
    # launch_other_appId_upstream_dependencies_sensor_1 >> [
    #     launch_receipt_sku_store_fact_load_transfer_job_000
    # ]
    # (
    #     launch_receipt_sku_store_fact_load_transfer_job_000
    #     >> pelican_validator
