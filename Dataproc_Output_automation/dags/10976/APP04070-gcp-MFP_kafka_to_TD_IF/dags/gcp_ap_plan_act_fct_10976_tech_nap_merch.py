...
dag_id = "gcp_ap_plan_act_fct_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "ap_plan_act_fct_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    merch_ap_plan_act_wrk_plan_load = open(
        os.path.join(
            sql_path,
            "merch_ap_plan_act_wrk_plan_load.sql",
        ),
        "r",
    ).read()

    launch_AP_PLAN_FCT_t0_1_ap_plan_act_wrk_plan_load = BigQueryInsertJobOperator(
        task_id="AP_PLAN_FCT_t0_1_ap_plan_act_wrk_plan_load",
        configuration={
            "query": {
    ...
    merch_ap_plan_act_wrk_onorder_load = open(
        os.path.join(
            sql_path,
            "merch_ap_plan_act_wrk_onorder_load.sql",
        ),
        "r",
    ).read()

    launch_AP_PLAN_FCT_t0_2_ap_plan_act_wrk_onorder_load = BigQueryInsertJobOperator(
        task_id="AP_PLAN_FCT_t0_2_ap_plan_act_wrk_onorder_load",
        configuration={
            "query": {
    ...
    merch_ap_plan_act_supgrp_bnr_fact_daily_load = open(
        os.path.join(
            sql_path,
            "merch_ap_plan_act_supgrp_bnr_fact_daily_load.sql",
        ),
        "r",
    ).read()

    launch_AP_PLAN_FCT_t1_ap_plan_act_supgrp_bnr_fact_daily_load = BigQueryInsertJobOperator(
        task_id="AP_PLAN_FCT_t1_ap_plan_act_supgrp_bnr_fact_daily_load",
        configuration={
            "query": {
                "query": merch_ap_plan_act_supgrp_bnr_fact_daily_load,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    merch_ap_plan_act_wrk_truncate = open(
        os.path.join(
            sql_path,
            "merch_ap_plan_act_wrk_truncate.sql",
        ),
        "r",
    ).read()

    launch_AP_PLAN_FCT_t2_ap_plan_act_wrk_truncate = BigQueryInsertJobOperator(
        task_id="AP_PLAN_FCT_t2_ap_plan_act_wrk_truncate",
        configuration={
            "query": {
    ...
    # )
    # launch_other_appId_upstream_dependencies_sensor_1 >> [
    #     launch_AP_PLAN_FCT_t0_1_ap_plan_act_wrk_plan_load
    # ]
    # launch_AP_PLAN_FCT_t0_1_ap_plan_act_wrk_plan_load >> [
    #     launch_AP_PLAN_FCT_t0_2_ap_plan_act_wrk_onorder_load
    # ]
    # launch_AP_PLAN_FCT_t0_2_ap_plan_act_wrk_onorder_load >> [
    #     launch_AP_PLAN_FCT_t1_ap_plan_act_supgrp_bnr_fact_daily_load
    # ]
    # launch_AP_PLAN_FCT_t1_ap_plan_act_supgrp_bnr_fact_daily_load >> [
    #     launch_AP_PLAN_FCT_t2_ap_plan_act_wrk_truncate
    # ]
    # (
    #     launch_AP_PLAN_FCT_t2_ap_plan_act_wrk_truncate
    #     >> pelican_validator
    ...
    creds_setup >> launch_AP_PLAN_FCT_t0_1_ap_plan_act_wrk_plan_load
    (
        launch_AP_PLAN_FCT_t0_1_ap_plan_act_wrk_plan_load
        >> launch_AP_PLAN_FCT_t0_2_ap_plan_act_wrk_onorder_load
    )
