...
dag_id = 'gcp_receipt_sku_store_fact_load_transfer_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'receipt_sku_store_fact_load_transfer_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    os.path.join(sql_path, 'receipt_sku_store_fact_load_transfer.sql'),
    "r").read()
    ...
    creds_setup >> launch_other_appId_upstream_dependencies_sensor_0 >>launch_other_appId_upstream_dependencies_sensor_1 >> launch_receipt_sku_store_fact_load_transfer_job_000 >> pelican_validator >> pelican_sensor