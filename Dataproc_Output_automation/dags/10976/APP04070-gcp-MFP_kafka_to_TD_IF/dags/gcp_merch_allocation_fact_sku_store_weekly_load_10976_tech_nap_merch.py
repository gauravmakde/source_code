...
dag_id = 'gcp_merch_allocation_fact_sku_store_weekly_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'merch_allocation_fact_sku_store_weekly_load_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    merch_allocation_fact_sku_store_wrk_truncate = open(
    os.path.join(sql_path, 'merch_allocation_fact_sku_store_wrk_truncate.sql'),
    "r").read()

    launch_main_merch_allocation_fact_sku_store_wrk_truncate = BigQueryInsertJobOperator(
        task_id = "main_merch_allocation_fact_sku_store_wrk_truncate",
        configuration = 
        {
            "query": 
            {
                "query": merch_allocation_fact_sku_store_wrk_truncate,
                "useLegacySql": False
            }
        },
    ...
    merch_allocation_fact_sku_store_batch_date_update = open(
    os.path.join(sql_path, 'merch_allocation_fact_sku_store_batch_date_update.sql'),
    "r").read()

    launch_main_merch_allocation_fact_sku_store_batch_date_update = BigQueryInsertJobOperator(
        task_id = "main_merch_allocation_fact_sku_store_batch_date_update",
        configuration = 
        {
            "query": 
            {
                "query": merch_allocation_fact_sku_store_batch_date_update,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    merch_allocation_fact_sku_store_inv_load = open(
    os.path.join(sql_path, 'merch_allocation_fact_sku_store_inv_load.sql'),
    "r").read()

    launch_main_merch_allocation_fact_sku_store_inv_load = BigQueryInsertJobOperator(
        task_id = "main_merch_allocation_fact_sku_store_inv_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_allocation_fact_sku_store_inv_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    merch_allocation_fact_sku_store_sales_weekly_load = open(
    os.path.join(sql_path, 'merch_allocation_fact_sku_store_sales_weekly_load.sql'),
    "r").read()

    launch_main_merch_allocation_fact_sku_store_sales_load = BigQueryInsertJobOperator(
        task_id = "main_merch_allocation_fact_sku_store_sales_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_allocation_fact_sku_store_sales_weekly_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    merch_allocation_fact_sku_store_oo_load = open(
    os.path.join(sql_path, 'merch_allocation_fact_sku_store_oo_load.sql'),
    "r").read()

    launch_main_merch_allocation_fact_sku_store_oo_load = BigQueryInsertJobOperator(
        task_id = "main_merch_allocation_fact_sku_store_oo_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_allocation_fact_sku_store_oo_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_other_appId_upstream_dependencies_sensor_2 >>[launch_main_merch_allocation_fact_sku_store_wrk_truncate]
    launch_main_merch_allocation_fact_sku_store_wrk_truncate >>[launch_main_merch_allocation_fact_sku_store_batch_date_update]
    launch_main_merch_allocation_fact_sku_store_batch_date_update >>[launch_main_merch_allocation_fact_sku_store_inv_load]
    launch_main_merch_allocation_fact_sku_store_inv_load >>[launch_main_merch_allocation_fact_sku_store_sales_load]
    launch_main_merch_allocation_fact_sku_store_sales_load >>[launch_main_merch_allocation_fact_sku_store_oo_load]
    launch_main_merch_allocation_fact_sku_store_oo_load >> pelican_validator >> pelican_sensor