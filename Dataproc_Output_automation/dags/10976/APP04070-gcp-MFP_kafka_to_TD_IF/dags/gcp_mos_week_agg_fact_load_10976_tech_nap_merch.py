...
dag_id = "gcp_mos_week_agg_fact_load_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "mos_week_agg_fact_load_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    mos_week_fact_load = open(
        os.path.join(
            sql_path,
            "mos_week_fact_load.sql",
        ),
        "r",
    ).read()
    ...
    mos_batch_date_update = open(
        os.path.join(
            sql_path,
            "mos_batch_date_update.sql",
        ),
        "r",
    ).read()
