...
dag_id = 'gcp_merch_nap_sales_fact_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'merch_nap_sales_fact_load_10976_tech_nap_merch DAG Description',
...
#     conn_id='okta_conn_to_APP02432_team',
#     external_dag_id='gcp_org_load_2656_napstore_insights',
#     date_query_fn=upstream_dependency.date_query_function,
#     timeout=3600,
#     retries=1,
#     poke_interval=120
...
#     conn_id='okta_conn_to_APP07465_team',
#     external_dag_id='gcp_TECH_DSID_NAP_DW_SALES_FACT',
#     date_query_fn=upstream_dependency.date_query_function,
#     timeout=3600,
#     retries=1,
#     poke_interval=120
...
# )
    ...
    merch_nap_sale_sku_store_day_fact_load = open(
    os.path.join(sql_path, 'merch_nap_sale_sku_store_day_fact_load.sql'),
    "r").read()

    launch_merch_nap_sales_t1_day_fact_load = BigQueryInsertJobOperator(
        task_id = "merch_nap_sales_t1_day_fact_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_nap_sale_sku_store_day_fact_load,
                "useLegacySql": False
            }
        },
    ...
    merch_nap_sale_sku_store_week_fact_load = open(
    os.path.join(sql_path, 'merch_nap_sale_sku_store_week_fact_load.sql'),
    "r").read()

    launch_merch_nap_sales_t2_week_fact_load = BigQueryInsertJobOperator(
        task_id = "merch_nap_sales_t2_week_fact_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_nap_sale_sku_store_week_fact_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    merch_nap_sale_dw_batch_update = open(
    os.path.join(sql_path, 'merch_nap_sale_dw_batch_update.sql'),
    "r").read()

    launch_merch_nap_sales_t3_dw_batch_update = BigQueryInsertJobOperator(
        task_id = "merch_nap_sales_t3_dw_batch_update",
        configuration = 
        {
            "query": 
            {
                "query": merch_nap_sale_dw_batch_update,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_other_appId_upstream_dependencies_sensor_4 >>[launch_merch_nap_sales_t1_day_fact_load]
    launch_merch_nap_sales_t1_day_fact_load >>[launch_merch_nap_sales_t2_week_fact_load]
    launch_merch_nap_sales_t2_week_fact_load >>[launch_merch_nap_sales_t3_dw_batch_update]
    launch_merch_nap_sales_t3_dw_batch_update >> pelican_validator >> pelican_sensor