...
dag_id = "gcp_spe_ap_supp_grp_fct_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "spe_ap_supp_grp_fct_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    #     external_dag_id="gcp_ap_plan_act_fct_10976_tech_nap_merch",
    ...
    merch_spe_ap_suppgrp_bnr_yr_fact_load = open(
        os.path.join(sql_path, "merch_spe_ap_suppgrp_bnr_yr_fact_load.sql"), "r"
    ).read()

    launch_SPE_AP_SUPP_GRP_FACT_t1_spe_ap_supgrp_bnr_fact_load = (
    ...
    # ]
    # launch_SPE_AP_SUPP_GRP_FACT_t1_spe_ap_supgrp_bnr_fact_load >> [
    #     launch_SPE_AP_SUPP_GRP_FACT_t2_spe_batch_updt
    # ]
