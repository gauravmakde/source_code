...
dag_id = 'gcp_receipt_sku_store_week_agg_fct_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'receipt_sku_store_week_agg_fct_load_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    receipt_sku_store_week_agg_fct_load = open(
    os.path.join(sql_path, 'receipt_sku_store_week_agg_fct_load.sql'),
    "r").read()

    launch_receipt_sku_store_week_agg_fct_load_job_000 = BigQueryInsertJobOperator(
        task_id = "receipt_sku_store_week_agg_fct_load_job_000",
        configuration = 
        {
            "query": 
            {
                "query": receipt_sku_store_week_agg_fct_load,
                "useLegacySql": False
            }
        },
    ...
    receipt_dw_batch_update = open(
    os.path.join(sql_path, 'receipt_dw_batch_update.sql'),
    "r").read()

    launch_receipt_sku_store_week_agg_fct_load_receipt_dw_batch_update = BigQueryInsertJobOperator(
        task_id = "receipt_sku_store_week_agg_fct_load_receipt_dw_batch_update",
        configuration = 
        {
            "query": 
            {
                "query": receipt_dw_batch_update,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    launch_other_appId_upstream_dependencies_sensor_1 >>[launch_receipt_sku_store_week_agg_fct_load_job_000]
    launch_receipt_sku_store_week_agg_fct_load_job_000 >>[launch_receipt_sku_store_week_agg_fct_load_receipt_dw_batch_update]
    launch_receipt_sku_store_week_agg_fct_load_receipt_dw_batch_update >> pelican_validator >> pelican_sensor