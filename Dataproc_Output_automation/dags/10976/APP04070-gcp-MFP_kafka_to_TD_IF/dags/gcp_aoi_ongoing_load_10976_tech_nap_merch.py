# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        14427d477613ddd72f7f4611bf3ebd9cdf0cbeda
# CI pipeline URL:      https://git.jwn.app/TM00593/das_merch/APP04070-MFP_kafka_to_TD_IF/-/pipelines/6786039
# CI commit timestamp:  2024-08-22T18:50:44+00:00
...
dag_id = "gcp_aoi_ongoing_load_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "aoi_ongoing_load_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    conn_id='okta_conn_to_APP04070_team',
    external_dag_id='gcp_receipt_sku_store_fact_load_transfer_10976_tech_nap_merch',
    ...
    aoi_ongoing_load_10976_tech_nap_merch_aoi_load_age_of_inventory_receipts_ongoing_load = open(
        os.path.join(
            sql_path,
            "age_of_inventory_receipts_ongoing_load.sql",
        ),
        "r",
    ).read()

    launch_aoi_load_job_0 = BigQueryInsertJobOperator(
        task_id="aoi_load_job_0",
        configuration={
            "query": {
                "query": aoi_ongoing_load_10976_tech_nap_merch_aoi_load_age_of_inventory_receipts_ongoing_load,
                "useLegacySql": False,
            }
        },
    ...
    aoi_ongoing_load_10976_tech_nap_merch_aoi_load_age_of_inventory_transfer_ongoing_load = open(
        os.path.join(
            sql_path,
            "age_of_inventory_transfer_ongoing_load.sql",
        ),
        "r",
    ).read()

    launch_aoi_load_job_1 = BigQueryInsertJobOperator(
        task_id="aoi_load_job_1",
        configuration={
            "query": {
                "query": aoi_ongoing_load_10976_tech_nap_merch_aoi_load_age_of_inventory_transfer_ongoing_load,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    aoi_ongoing_load_10976_tech_nap_merch_aoi_load_age_of_inventory_ongoing_load = open(
        os.path.join(
            sql_path,
            "age_of_inventory_ongoing_load.sql",
        ),
        "r",
    ).read()

    launch_aoi_load_job_2 = BigQueryInsertJobOperator(
        task_id="aoi_load_job_2",
        configuration={
            "query": {
                "query": aoi_ongoing_load_10976_tech_nap_merch_aoi_load_age_of_inventory_ongoing_load,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    launch_other_appId_upstream_dependencies_sensor_3 >> [launch_aoi_load_job_0]
    launch_aoi_load_job_0 >> [launch_aoi_load_job_1]
    launch_aoi_load_job_1 >> [launch_aoi_load_job_2]
    launch_aoi_load_job_2 >> pelican_validator >> pelican_sensor
