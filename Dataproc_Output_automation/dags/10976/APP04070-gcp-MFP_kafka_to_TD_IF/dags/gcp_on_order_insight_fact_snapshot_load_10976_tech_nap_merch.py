...
dag_id = 'gcp_on_order_insight_fact_snapshot_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'on_order_insight_fact_snapshot_load_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    launch_other_appId_upstream_dependencies_sensor_0 = DummyOperator(task_id="check_other_appId_upstream_dependencies_0",dag=dag)
    
    merch_on_order_insight_snapshot_fact = open(
    os.path.join(sql_path, 'merch_on_order_insight_snapshot_fact.sql'),
    "r").read()

    launch_merch_on_order_snapshot_stage_insight_fact_snapshot_load = BigQueryInsertJobOperator(
        task_id = "merch_on_order_snapshot_stage_insight_fact_snapshot_load",
        configuration = 
        {
            "query": 
            {
                "query": merch_on_order_insight_snapshot_fact,
                "useLegacySql": False
            }
        },
    ...
    creds_setup >> launch_other_appId_upstream_dependencies_sensor_0 >>[launch_merch_on_order_snapshot_stage_insight_fact_snapshot_load]
    launch_merch_on_order_snapshot_stage_insight_fact_snapshot_load >> pelican_validator >> pelican_sensor