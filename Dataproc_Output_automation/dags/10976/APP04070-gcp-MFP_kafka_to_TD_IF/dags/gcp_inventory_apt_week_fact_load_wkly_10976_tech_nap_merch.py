...
dag_id = "gcp_inventory_apt_week_fact_load_wkly_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "inventory_apt_week_fact_load_wkly_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    merch_inv_batch_dt_update_01 = open(
        os.path.join(sql_path, "merch_inv_batch_dt_update_01.sql"), "r"
    ).read()

    launch_inventory_apt_data_load_wkly_inv_week_fct_updt_batch_dt_01 = (
        BigQueryInsertJobOperator(
            task_id="inventory_apt_data_load_wkly_inv_week_fct_updt_batch_dt_01",
            configuration={
                "query": {"query": merch_inv_batch_dt_update_01, "useLegacySql": False}
            },
    ...
    merch_inventory_sku_store_week_fct_load_wkly = open(
        os.path.join(sql_path, "merch_inventory_sku_store_week_fct_load_wkly.sql"), "r"
    ).read()

    launch_inventory_apt_data_load_wkly_inv_week_fct_load_02 = (
        BigQueryInsertJobOperator(
            task_id="inventory_apt_data_load_wkly_inv_week_fct_load_02",
            configuration={
                "query": {
                    "query": merch_inventory_sku_store_week_fct_load_wkly,
                    "useLegacySql": False,
                }
            },
            project_id=project_id,
    ...
    merch_inv_batch_dt_update_02 = open(
        os.path.join(sql_path, "merch_inv_batch_dt_update_02.sql"), "r"
    ).read()

    launch_inventory_apt_data_load_wkly_inv_week_fct_updt_batch_dt_03 = (
        BigQueryInsertJobOperator(
            task_id="inventory_apt_data_load_wkly_inv_week_fct_updt_batch_dt_03",
            configuration={
                "query": {"query": merch_inv_batch_dt_update_02, "useLegacySql": False}
            },
            project_id=project_id,
            gcp_conn_id=gcp_conn,
            params=sql_config_dict,
    ...
    launch_inventory_apt_data_load_wkly_inv_week_fct_load_04 = (
        BigQueryInsertJobOperator(
            task_id="inventory_apt_data_load_wkly_inv_week_fct_load_04",
            configuration={
                "query": {
                    "query": merch_inventory_sku_store_week_fct_load_wkly,
                    "useLegacySql": False,
    ...
    inv_dw_batch_update = open(
        os.path.join(sql_path, "inv_dw_batch_update.sql"), "r"
    ).read()

    launch_inventory_apt_data_load_wkly_inv_dw_batch_update = BigQueryInsertJobOperator(
        task_id="inventory_apt_data_load_wkly_inv_dw_batch_update",
        configuration={"query": {"query": inv_dw_batch_update, "useLegacySql": False}},
        project_id=project_id,
        gcp_conn_id=gcp_conn,
        params=sql_config_dict,
        location=region,
    ...
    # ]
    # launch_inventory_apt_data_load_wkly_inv_week_fct_load_04 >> [
    #     launch_inventory_apt_data_load_wkly_inv_dw_batch_update
    # ]
    # (
    #     launch_inventory_apt_data_load_wkly_inv_dw_batch_update
    #     >> pelican_validator
    ...
    creds_setup >> launch_inventory_apt_data_load_wkly_inv_week_fct_updt_batch_dt_01
    launch_inventory_apt_data_load_wkly_inv_week_fct_updt_batch_dt_01 >> [
        launch_inventory_apt_data_load_wkly_inv_week_fct_load_02
    ]
    launch_inventory_apt_data_load_wkly_inv_week_fct_load_02 >> [
