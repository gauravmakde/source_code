...
dag_id = 'gcp_clearance_markdown_buckets_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'clearance_markdown_buckets_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    clearance_markdown_buckets_clear_clearance_markdown_buckets_fact = open( os.path.join(sql_path, 'clearance_markdown_buckets/clear_clearance_markdown_buckets_fact.sql'),"r").read()

    launch_load_job_0_clear_clearance_markdown_buckets_fact = BigQueryInsertJobOperator(
        task_id = "load_job_0_clear_clearance_markdown_buckets_fact",
        configuration = 
        {
            "query": 
            {
                "query": clearance_markdown_buckets_clear_clearance_markdown_buckets_fact,
                "useLegacySql": False
            }
        },
    ...
    clearance_markdown_buckets_load_clearance_markdown_buckets_fact = open( os.path.join(sql_path, 'clearance_markdown_buckets/load_clearance_markdown_buckets_fact.sql'),"r").read()

    launch_load_job_1_load_clearance_markdown_buckets_fact = BigQueryInsertJobOperator(
        task_id = "load_job_1_load_clearance_markdown_buckets_fact",
        configuration = 
        {
            "query": 
            {
                "query": clearance_markdown_buckets_load_clearance_markdown_buckets_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> launch_load_job_0_clear_clearance_markdown_buckets_fact >>[launch_load_job_1_load_clearance_markdown_buckets_fact]
    launch_load_job_1_load_clearance_markdown_buckets_fact >> pelican_validator >> pelican_sensor