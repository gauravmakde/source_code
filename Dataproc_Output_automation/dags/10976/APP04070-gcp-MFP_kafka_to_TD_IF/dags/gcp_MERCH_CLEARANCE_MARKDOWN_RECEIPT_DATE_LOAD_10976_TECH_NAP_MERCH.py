# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        bdfb4f3fa273d40a64f3e42798d7cac0bb2d2192
# CI pipeline URL:      https://git.jwn.app/TM00593/das_merch/APP04070-gcp-MFP_kafka_to_TD_IF/-/pipelines/7104332
# CI commit timestamp:  2024-09-30T21:17:13+00:00
...
dag_id = 'gcp_merch_clearance_markdown_receipt_date_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'merch_clearance_markdown_receipt_date_load_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    # external_dag_id='gcp_receipt_sku_store_fact_load_transfer_otb_run_10976_tech_nap_merch',
    # date_query_fn=upstream_dependency.weekly_query_function,
    # timeout=3600,
    # retries=1,
    # poke_interval=120)
    
    launch_other_appId_upstream_dependencies_sensor_0 = DummyOperator(task_id="launch_other_appId_upstream_dependencies_sensor_0",dag=dag)
    launch_other_appId_upstream_dependencies_sensor_1 = DummyOperator(task_id="launch_other_appId_upstream_dependencies_sensor_1",dag=dag)
    launch_other_appId_upstream_dependencies_sensor_2 = DummyOperator(task_id="launch_other_appId_upstream_dependencies_sensor_2",dag=dag)
    launch_other_appId_upstream_dependencies_sensor_3 = DummyOperator(task_id="launch_other_appId_upstream_dependencies_sensor_3",dag=dag)
    ...
    # conn_id='okta_conn_to_APP04070_team',
    # external_dag_id='gcp_mfpc_transferledger_kafka_to_teradata_10976_tech_nap_merch',
    # date_query_fn=upstream_dependency.date_query_function,
    # timeout=3600,
    # retries=1,
    # poke_interval=120)
    ...
    smart_markdown_insights_merch_receipt_date_reset_applied_fact_load = open( os.path.join(sql_path, 'smart_markdown_insights/merch_receipt_date_reset_applied_fact_load.sql'),"r").read()

    launch_run_merch_receipt_date_reset_applied_fact_load = BigQueryInsertJobOperator(
        task_id = "run_merch_receipt_date_reset_applied_fact_load",
        configuration = 
        {
            "query": 
            {
                "query": smart_markdown_insights_merch_receipt_date_reset_applied_fact_load,
                "useLegacySql": False
            }
        },
    ...
    smart_markdown_insights_merch_receipt_date_rack_date_fact_load = open( os.path.join(sql_path, 'smart_markdown_insights/merch_receipt_date_rack_date_fact_load.sql'),"r").read()

    launch_run_receipt_date_rack_date_fact_load = BigQueryInsertJobOperator(
        task_id = "run_receipt_date_rack_date_fact_load",
        configuration = 
        {
            "query": 
            {
                "query": smart_markdown_insights_merch_receipt_date_rack_date_fact_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> launch_other_appId_upstream_dependencies_sensor_0 >>[launch_run_merch_receipt_date_reset_applied_fact_load]
    creds_setup >> launch_other_appId_upstream_dependencies_sensor_1 >>[launch_run_merch_receipt_date_reset_applied_fact_load]
    creds_setup >> launch_other_appId_upstream_dependencies_sensor_2 >>[launch_run_merch_receipt_date_reset_applied_fact_load]
    creds_setup >> launch_other_appId_upstream_dependencies_sensor_3 >>[launch_run_merch_receipt_date_reset_applied_fact_load]
    launch_run_merch_receipt_date_reset_applied_fact_load >>[launch_run_receipt_date_rack_date_fact_load]
    launch_run_receipt_date_rack_date_fact_load >> pelican_validator >> pelican_sensor