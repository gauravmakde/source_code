...
dag_id = "gcp_apt_assortment_supplier_group_cluster_plan_weekly_snapshot_load_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "apt_assortment_supplier_group_cluster_plan_weekly_snapshot_load_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    apt_assortment_supplier_group_cluster_plan_weekly_snapshot_load = open(
        os.path.join(
            sql_path,
            "apt_assortment_supplier_group_cluster_plan_weekly_snapshot_load.sql",
        ),
        "r",
    ).read()

    launch_apt_supp_cluster_load_weekly_snapshot = BigQueryInsertJobOperator(
        task_id="apt_supp_cluster_load_weekly_snapshot",
        configuration={
            "query": {
                "query": apt_assortment_supplier_group_cluster_plan_weekly_snapshot_load,
                "useLegacySql": False,
            }
        },
    ...
    launch_other_appId_upstream_dependencies_sensor_1 >> [
        launch_apt_supp_cluster_load_weekly_snapshot
    ]
    launch_apt_supp_cluster_load_weekly_snapshot >> pelican_validator >> pelican_sensor
