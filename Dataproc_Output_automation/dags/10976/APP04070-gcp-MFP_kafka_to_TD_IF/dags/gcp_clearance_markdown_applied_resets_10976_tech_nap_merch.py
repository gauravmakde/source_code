...
dag_id = "gcp_clearance_markdown_applied_resets_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "clearance_markdown_applied_resets_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    clearance_markdown_applied_resets_clearance_markdown_wkly_batch_date_update = open(
        os.path.join(
            sql_path,
            "clearance_markdown_applied_resets/clearance_markdown_wkly_batch_date_update.sql",
        ),
        "r",
    ).read()

    launch_clearance_markdown_applied_resets_load_wkly_batch_date_update = BigQueryInsertJobOperator(
        task_id="clearance_markdown_applied_resets_load_wkly_batch_date_update",
        configuration={
            "query": {
                "query": clearance_markdown_applied_resets_clearance_markdown_wkly_batch_date_update,
                "useLegacySql": False,
            }
        },
    ...
    clearance_markdown_applied_resets_clearance_markdown_applied_resets_fact_load = open(
        os.path.join(
            sql_path,
            "clearance_markdown_applied_resets/clearance_markdown_applied_resets_fact_load.sql",
        ),
        "r",
    ).read()

    launch_clearance_markdown_applied_resets_load_applied_resets_fact_load = BigQueryInsertJobOperator(
        task_id="clearance_markdown_applied_resets_load_applied_resets_fact_load",
        configuration={
            "query": {
                "query": clearance_markdown_applied_resets_clearance_markdown_applied_resets_fact_load,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    clearance_markdown_applied_resets_clearance_markdown_future_fact_load = open(
        os.path.join(
            sql_path,
            "clearance_markdown_applied_resets/clearance_markdown_future_fact_load.sql",
        ),
        "r",
    ).read()

    launch_clearance_markdown_applied_resets_load_clearance_markdown_future_fact_load = BigQueryInsertJobOperator(
        task_id="clearance_markdown_applied_resets_load_clearance_markdown_future_fact_load",
        configuration={
            "query": {
                "query": clearance_markdown_applied_resets_clearance_markdown_future_fact_load,
                "useLegacySql": False,
            }
        },
        project_id=project_id,
    ...
    (
        creds_setup
        >> launch_clearance_markdown_applied_resets_load_wkly_batch_date_update
        >> [launch_clearance_markdown_applied_resets_load_applied_resets_fact_load]
    )
    launch_clearance_markdown_applied_resets_load_applied_resets_fact_load >> [
        launch_clearance_markdown_applied_resets_load_clearance_markdown_future_fact_load
    ]
    (
        launch_clearance_markdown_applied_resets_load_clearance_markdown_future_fact_load
        >> pelican_validator
