...
dag_id = "gcp_merch_mos_sp_adjusted_cost_td_ledger_load_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "merch_mos_sp_adjusted_cost_td_ledger_load_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    launch_other_appId_upstream_dependencies_sensor_0 = ApiDagRunLatestSensor(
        ...
        external_dag_id="gcp_mfpc_mos_kafka_to_teradata_10976_tech_nap_merch",
    ...
    mos_sp_adjusted_cost_td_ledger_load = open(
        os.path.join(sql_path, "mos_sp_adjusted_cost_td_ledger_load.sql"), "r"
    ).read()

    launch_mos_sp_adjusted_cost_td_ledger_stage_ledger_load = BigQueryInsertJobOperator(
        task_id="mos_sp_adjusted_cost_td_ledger_stage_ledger_load",
        configuration={
            "query": {
                "query": mos_sp_adjusted_cost_td_ledger_load,
                "useLegacySql": False,
            }
        },
    ...
    (
        ...
        >> [launch_mos_sp_adjusted_cost_td_ledger_stage_ledger_load]
    )
    (
        launch_mos_sp_adjusted_cost_td_ledger_stage_ledger_load
        >> pelican_validator
