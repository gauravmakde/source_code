...
dag_id = 'gcp_wac_channel_dim_load_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'wac_channel_dim_load_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    weighted_average_cost_channel_work_load = open(
    os.path.join(sql_path, 'weighted_average_cost_channel_work_load.sql'),
    "r").read()

    launch_wac_channel_load_stage_work_load = BigQueryInsertJobOperator(
        task_id = "wac_channel_load_stage_work_load",
        configuration = 
        {
            "query": 
            {
                "query": weighted_average_cost_channel_work_load,
                "useLegacySql": False
            }
        },
    ...
    weighted_average_cost_channel_dim_load = open(
    os.path.join(sql_path, 'weighted_average_cost_channel_dim_load.sql'),
    "r").read()

    launch_wac_channel_load_stage_dim_load = BigQueryInsertJobOperator(
        task_id = "wac_channel_load_stage_dim_load",
        configuration = 
        {
            "query": 
            {
                "query": weighted_average_cost_channel_dim_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> launch_other_appId_upstream_dependencies_sensor_0 >>[launch_wac_channel_load_stage_work_load]
    launch_wac_channel_load_stage_work_load >>[launch_wac_channel_load_stage_dim_load]
    launch_wac_channel_load_stage_dim_load >> pelican_validator >> pelican_sensor