...
dag_id = "gcp_rp_bkd_msrs_wrk_load_10976_tech_nap_merch"
...
default_args = {
    ...
    "description": "rp_bkd_msrs_wrk_load_10976_tech_nap_merch DAG Description",
...
with DAG(
    ...
    #     external_dag_id='gcp_wac_sku_dim_10976_tech_nap_merch',
    #     date_query_fn=upstream_dependency.date_query_function,
    #     timeout=3600,
    #     retries=1,
    #     poke_interval=120
    ...
    #     conn_id='okta_conn_to_APP04070_team',
    #     external_dag_id='gcp_mfp_rp_anticipated_spend_kafka_to_teradata_10976_tech_nap_merch',
    #     date_query_fn=upstream_dependency.date_query_function,
    #     timeout=3600,
    #     retries=1,
    #     poke_interval=120
    ...
    merch_rp_booked_measures_wrk_load = open(
        os.path.join(sql_path, "merch_rp_booked_measures_wrk_load.sql"), "r"
    ).read()

    launch_merch_rp_t1_bkd_msrs_wrk_load = BigQueryInsertJobOperator(
        task_id="merch_rp_t1_bkd_msrs_wrk_load",
        configuration={
            "query": {"query": merch_rp_booked_measures_wrk_load, "useLegacySql": False}
        },
    ...
    creds_setup >> launch_merch_rp_t1_bkd_msrs_wrk_load
    launch_merch_rp_t1_bkd_msrs_wrk_load >> pelican_validator >> pelican_sensor
    ...
    # launch_other_appId_upstream_dependencies_sensor_3 >>[launch_merch_rp_t1_bkd_msrs_wrk_load]
    # launch_merch_rp_t1_bkd_msrs_wrk_load >> pelican_validator >> pelican_sensor
