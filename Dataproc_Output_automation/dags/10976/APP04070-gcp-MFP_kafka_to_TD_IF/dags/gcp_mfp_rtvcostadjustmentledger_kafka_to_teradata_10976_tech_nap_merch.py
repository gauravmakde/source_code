...
dag_id = 'gcp_mfp_rtvcostadjustmentledger_kafka_to_teradata_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'mfp_rtvcostadjustmentledger_kafka_to_teradata_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'inventory-return-to-vendor-cost-adjustment-ledger-analytical-avro',
        consumer_group_name = 'onix-inventory-return-to-vendor-cost-adjustment-ledger-analytical-avro_mfp_rtvcostadjustmentledger_kafka_to_teradata_10976_tech_nap_merch_rtv_cost_adjustment_03_read_from_kafka_write_to_s3_03',
    ...
    session_name=get_batch_id(dag_id=dag_id,task_id="rtv_cost_adjustment_03_read_from_kafka_write_to_s3_03")   
    rtv_cost_adjustment_03_read_from_kafka_write_to_s3_03 = DataprocCreateBatchOperator(
            task_id = "rtv_cost_adjustment_03_read_from_kafka_write_to_s3_03",
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_mfp_rtvcostadjustmentledger_kafka_to_teradata_10976_tech_nap_merch_rtv_cost_adjustment_03_read_from_kafka_write_to_s3_03.json",
    ...
    tpt_jdbc_insert_rtv_cost_adjustment_03_load_to_landing_table_using_tpt_03_control_tbl = BashOperator(
    task_id='tpt_jdbc_insert_rtv_cost_adjustment_03_load_to_landing_table_using_tpt_03_control_tbl',
    bash_command=f'echo "Skipping Control Table Entry"')

    
    returntovendor_costadjustment_td_fact_load = open(
    os.path.join(sql_path, 'returntovendor_costadjustment_td_fact_load.sql'),
    "r").read()

    launch_rtv_cost_adjustment_03_load_fact_table = BigQueryInsertJobOperator(
        task_id = "rtv_cost_adjustment_03_load_fact_table",
        configuration = 
        {
            "query": 
            {
                "query": returntovendor_costadjustment_td_fact_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    creds_setup >> fetch_batch_run_id_task >>[rtv_cost_adjustment_03_read_from_kafka_write_to_s3_03]
    rtv_cost_adjustment_03_read_from_kafka_write_to_s3_03 >>[tpt_jdbc_insert_rtv_cost_adjustment_03_load_to_landing_table_using_tpt_03_control_tbl]
    tpt_jdbc_insert_rtv_cost_adjustment_03_load_to_landing_table_using_tpt_03_control_tbl >>[launch_rtv_cost_adjustment_03_load_fact_table]
    launch_rtv_cost_adjustment_03_load_fact_table >> pelican_validator >> pelican_sensor