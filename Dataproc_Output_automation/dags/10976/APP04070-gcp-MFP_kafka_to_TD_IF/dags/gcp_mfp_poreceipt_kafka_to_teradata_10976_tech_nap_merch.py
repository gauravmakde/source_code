...
dag_id = 'gcp_mfp_poreceipt_kafka_to_teradata_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'mfp_poreceipt_kafka_to_teradata_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'inventory-purchase-order-receipt-ledger-analytical-avro',
        consumer_group_name = 'onix-inventory-purchase-order-receipt-ledger-analytical-avro_mfp_poreceipt_kafka_to_teradata_10976_tech_nap_merch_kafka_to_td_receipt_tpt_load_v1_job_00',
    ...
    session_name=get_batch_id(dag_id=dag_id,task_id="kafka_to_td_receipt_tpt_load_v1_job_00")   
    kafka_to_td_receipt_tpt_load_v1_job_00 = DataprocCreateBatchOperator(
            task_id = "kafka_to_td_receipt_tpt_load_v1_job_00",
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_mfp_poreceipt_kafka_to_teradata_10976_tech_nap_merch_kafka_to_td_receipt_tpt_load_v1_job_00.json",
    ...
    tpt_jdbc_insert_kafka_to_td_receipt_tpt_load_v1_job_1_control_tbl = BashOperator(
    task_id='tpt_jdbc_insert_kafka_to_td_receipt_tpt_load_v1_job_1_control_tbl',
    bash_command=f'echo "Skipping Control Table Entry"')

    # tpt_kafka_to_td_receipt_tpt_load_v1_job_1_load_tbl = SSHOperator(
    # task_id='tpt_kafka_to_td_receipt_tpt_load_v1_job_1_load_tbl',
    # command="/db/teradata/bin/tpt_load.sh  -e PRD_NAP_UTL -j PRD_NAP_STG_MERCH_PORECEIPT_LEDGER_LDG_JOB -h tdnapprod.nordstrom.net -l 'N' -u SCH_NAP_MERCH_BATCH -p \"\$tdwallet(SCH_NAP_MERCH_BATCH_PWD)\" -f s3://nap-das-merch-tpt-prod-v1/poreceipt/*/*/*/* -o UPDATE",
    # timeout=1800,
    # ssh_conn_id="TECH_ISF_NAP_MERCH_MFP_SECURITY_TDUTIL_SERVER_S3EXT_PROD")

    
    read_poreceipt_teradata_write_teradata_ = open(
    os.path.join(sql_path, 'read_poreceipt_teradata_write_teradata_.sql'),
    "r").read()

    launch_kafka_to_td_receipt_tpt_load_v1_job_2 = BigQueryInsertJobOperator(
        task_id = "kafka_to_td_receipt_tpt_load_v1_job_2",
        configuration = 
        {
            "query": 
            {
                "query": read_poreceipt_teradata_write_teradata_,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    # launch_kafka_to_td_receipt_tpt_load_v1_s3_cleanup_stage_v2 = launch_k8s_api_job_operator(
    # dag=dag,
    # connection_id='TECH_Merchandising_NAP_Engineering_K8S_CONN_PROD',
    # namespace='app04070',
    # task_id='kafka_to_td_receipt_tpt_load_v1_s3_cleanup_stage_v2',
    # job_name='kafka-to-td-receipt-tpt-load-v1-s3-cleanup-stage-v2-mfp-porecei',
    # macros=None,
    ...
    # container_command=['python', '/home/nonroot/python/s3cleanup/main.py', 'poreceipt'],
    ...
    creds_setup >> fetch_batch_run_id_task >> kafka_to_td_receipt_tpt_load_v1_job_00
    kafka_to_td_receipt_tpt_load_v1_job_00 >> tpt_jdbc_insert_kafka_to_td_receipt_tpt_load_v1_job_1_control_tbl
    tpt_jdbc_insert_kafka_to_td_receipt_tpt_load_v1_job_1_control_tbl >> launch_kafka_to_td_receipt_tpt_load_v1_job_2
    launch_kafka_to_td_receipt_tpt_load_v1_job_2 >> pelican_validator >> pelican_sensor