...
dag_id = 'gcp_mfp_poclaimallowanceledger_kafka_to_teradata_10976_tech_nap_merch'
...
default_args = {
    ...
    'description': 'mfp_poclaimallowanceledger_kafka_to_teradata_10976_tech_nap_merch DAG Description',
...
with DAG(
    ...
    fetch_batch_run_id_task = FetchKafkaBatchRunIdOperator(
        ...
        gcp_region = region,
        topic_name = 'inventory-purchase-order-claim-allowance-ledger-analytical-avro',
        consumer_group_name = 'onix-inventory-purchase-order-claim-allowance-ledger-analytical-avro_mfp_poclaimallowanceledger_kafka_to_teradata_10976_tech_nap_merch_po_claim_allowance_ledger_04_read_from_kafka_write_to_s3_04',
    ...
    session_name=get_batch_id(dag_id=dag_id,task_id="po_claim_allowance_ledger_04_read_from_kafka_write_to_s3_04")   
    po_claim_allowance_ledger_04_read_from_kafka_write_to_s3_04 = DataprocCreateBatchOperator(
            task_id = "po_claim_allowance_ledger_04_read_from_kafka_write_to_s3_04",
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_mfp_poclaimallowanceledger_kafka_to_teradata_10976_tech_nap_merch_po_claim_allowance_ledger_04_read_from_kafka_write_to_s3_04.json",
    ...
    tpt_jdbc_insert_po_claim_allowance_ledger_04_load_to_landing_table_using_tpt_04_control_tbl = BashOperator(
    task_id='tpt_jdbc_insert_po_claim_allowance_ledger_04_load_to_landing_table_using_tpt_04_control_tbl',
    bash_command=f'echo "Skipping Control Table Entry"')

    # tpt_po_claim_allowance_ledger_04_load_to_landing_table_using_tpt_04_load_tbl = SSHOperator(
    # task_id='tpt_po_claim_allowance_ledger_04_load_to_landing_table_using_tpt_04_load_tbl',
    # command="/db/teradata/bin/tpt_load.sh  -e PRD_NAP_UTL -j PRD_NAP_STG_MERCH_PO_CLAIM_ALLOWANCE_LEDGER_LDG_JOB -h tdnapprod.nordstrom.net -l 'N' -u SCH_NAP_MERCH_BATCH -p \"\$tdwallet(SCH_NAP_MERCH_BATCH_PWD)\" -f s3://nap-das-merch-tpt-prod-v1/poclaimallowanceledger/*/*/*/* -o UPDATE",
    # timeout=1800,
    # ssh_conn_id="TECH_ISF_NAP_MERCH_MFP_SECURITY_TDUTIL_SERVER_S3EXT_PROD")

    
    purchaseorderledger_claimallowance_td_fact_load = open(
    os.path.join(sql_path, 'purchaseorderledger_claimallowance_td_fact_load.sql'),
    "r").read()

    launch_po_claim_allowance_ledger_04_load_fact_table_04 = BigQueryInsertJobOperator(
        task_id = "po_claim_allowance_ledger_04_load_fact_table_04",
        configuration = 
        {
            "query": 
            {
                "query": purchaseorderledger_claimallowance_td_fact_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
    ...
    # launch_po_claim_allowance_ledger_04_s3_cleanup_stage_v2 = launch_k8s_api_job_operator(
    # dag=dag,
    # connection_id='TECH_Merchandising_NAP_Engineering_K8S_CONN_PROD',
    # namespace='app04070',
    # task_id='po_claim_allowance_ledger_04_s3_cleanup_stage_v2',
    # job_name='po-claim-allowance-ledger-04-s3-cleanup-stage-v2-mfp-poclaimall',
    # macros=None,
    ...
    # container_command=['python', '/home/nonroot/python/s3cleanup/main.py', 'poclaimallowanceledger'],
    ...
    creds_setup >> fetch_batch_run_id_task >> po_claim_allowance_ledger_04_read_from_kafka_write_to_s3_04
    po_claim_allowance_ledger_04_read_from_kafka_write_to_s3_04 >> tpt_jdbc_insert_po_claim_allowance_ledger_04_load_to_landing_table_using_tpt_04_control_tbl
    tpt_jdbc_insert_po_claim_allowance_ledger_04_load_to_landing_table_using_tpt_04_control_tbl >> launch_po_claim_allowance_ledger_04_load_fact_table_04
    launch_po_claim_allowance_ledger_04_load_fact_table_04 >> pelican_validator >> pelican_sensor