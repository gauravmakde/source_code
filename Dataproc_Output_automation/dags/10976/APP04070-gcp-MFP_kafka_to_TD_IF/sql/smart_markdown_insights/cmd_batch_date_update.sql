-- SET QUERY_BAND = 'App_ID=app04070;DAG_ID=smartmarkdown_insights_10976_tech_nap_merch;Task_Name=cmd_batch_dt_update;'
...
WHERE LOWER(interface_code) = LOWER('SMD_INSIGHTS_WKLY') AND dw_batch_dt < CURRENT_DATE('PST8PDT');
