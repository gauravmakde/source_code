...
default_args = {
    'retries': 3,
    'description': 'wfm_ideal_hours_load_2656_napstore_insights DAG Description',
...
with DAG(
    ...
    parent_dag_name="wfm_ideal_hours_load_2656_napstore_insights",
    ...
    livy_wfm_ideal_hours_load_0_stg_table = LivyOperator(
    task_id='wfm_ideal_hours_load_0_stg_table',
    ...
    app_args=['@s3://tf-nap-prod-airflow-nsk-insights/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/user_config/argument_wfm_ideal_hours_load_2656_napstore_insights_wfm_ideal_hours_load_0_stg_table.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='15g',
    driver_cores=2,
    executor_memory='12g',
    executor_cores=5,
    session_name='wfm_ideal_hours_load_2656_napstore_insights_wfm_ideal_hours_load_0_stg_table_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
    ...
    launch_wfm_ideal_hours_load_1_fct_table_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ISF_NAPSTORE_INSIGHTS_CONN_PROD',
    namespace='app02432',
    task_id='wfm_ideal_hours_load_1_fct_table_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='wfm-ideal-hours-load-1-fct-table-wfm-ideal-hours-load-2656-naps',
    nsk_cluster='nsk-miso-prod')
    ...
    create_persistent_cluster_nsp_etl >> [livy_wfm_ideal_hours_load_0_stg_table]
    livy_wfm_ideal_hours_load_0_stg_table >> [livy_wfm_ideal_hours_load_0_stg_table_sensor]
    livy_wfm_ideal_hours_load_0_stg_table_sensor >> [launch_wfm_ideal_hours_load_1_fct_table]
    launch_wfm_ideal_hours_load_1_fct_table >> [launch_wfm_ideal_hours_load_1_fct_table_sensor]
