...
default_args = {
    'retries': 3,
    'description': 'hr_organization_events_load_2656_napstore_insights DAG Description',
...
with DAG(
    ...
    parent_dag_name="hr_organization_events_load_2656_napstore_insights",
    ...
    livy_hr_org_events_load_0_stg_tables = LivyOperator(
    task_id='hr_org_events_load_0_stg_tables',
    ...
    app_args=['@s3://tf-nap-prod-airflow-nsk-insights/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/user_config/argument_hr_organization_events_load_2656_napstore_insights_hr_org_events_load_0_stg_tables.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='9g',
    driver_cores=2,
    executor_memory='6g',
    executor_cores=5,
    num_executors=6,
    session_name='hr_organization_events_load_2656_napstore_insights_hr_org_events_load_0_stg_tables_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
    ...
    launch_hr_org_events_load_1_dim_tables_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ISF_NAPSTORE_INSIGHTS_CONN_PROD',
    namespace='app02432',
    task_id='hr_org_events_load_1_dim_tables_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='hr-org-events-load-1-dim-tables-hr-organization-events-load-265',
    nsk_cluster='nsk-miso-prod')
    ...
    create_persistent_cluster_nsp_etl >> [livy_hr_org_events_load_0_stg_tables]
    livy_hr_org_events_load_0_stg_tables >> [livy_hr_org_events_load_0_stg_tables_sensor]
    livy_hr_org_events_load_0_stg_tables_sensor >> [launch_hr_org_events_load_1_dim_tables]
    launch_hr_org_events_load_1_dim_tables >> [launch_hr_org_events_load_1_dim_tables_sensor]
