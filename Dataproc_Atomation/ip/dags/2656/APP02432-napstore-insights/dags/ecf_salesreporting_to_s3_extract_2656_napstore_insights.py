...
default_args = {
    'retries': 3,
    'description': 'ecf_salesreporting_to_s3_extract_2656_napstore_insights DAG Description',
...
with DAG(
    ...
    parent_dag_name="ecf_salesreporting_to_s3_extract_2656_napstore_insights",
    ...
    livy_ecf_salesreporting_extract_load_0_ecf_salesreporting = LivyOperator(
    task_id='ecf_salesreporting_extract_load_0_ecf_salesreporting',
    ...
    app_args=['@s3://tf-nap-prod-airflow-nsk-insights/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/user_config/argument_ecf_salesreporting_to_s3_extract_2656_napstore_insights_ecf_salesreporting_extract_load_0_ecf_salesreporting.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='15g',
    driver_cores=2,
    executor_memory='12g',
    executor_cores=5,
    session_name='ecf_salesreporting_to_s3_extract_2656_napstore_insights_ecf_salesreporting_extract_load_0_ecf_salesreporting_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
    ...
    livy_ecf_salesreporting_extract_load_0_ecf_salesreporting_sensor = LivySensor(
    conn_id='TECH_ISF_NAP_STORE_TEAM_NSP_ETL_LIVY_PROD',
    task_id='ecf_salesreporting_extract_load_0_ecf_salesreporting_sensor',
    batch_id="{{ task_instance.xcom_pull(task_ids='ecf_salesreporting_extract_load_0_ecf_salesreporting') }}")

    create_persistent_cluster_nsp_etl >> [livy_ecf_salesreporting_extract_load_0_ecf_salesreporting]
    livy_ecf_salesreporting_extract_load_0_ecf_salesreporting >> [livy_ecf_salesreporting_extract_load_0_ecf_salesreporting_sensor]
