# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        2ee5a0a1808b9ad19ab680e6845979092bec6bb9
# CI pipeline URL:      https://git.jwn.app/TM00787/app02432-store-analytics/APP02432-napstore-insights/-/pipelines/7021590
# CI commit timestamp:  2024-09-19T20:36:09+00:00
...
cron = '0 12 * * *'
dag_id = 'ecf_salesreporting_load_v2_2656_napstore_insights'
...
default_args = {
    'retries': 3,
    'description': 'ecf_salesreporting_load_v2_2656_napstore_insights DAG Description',
...
with DAG(
    ...
    parent_dag_name="ecf_salesreporting_load_v2_2656_napstore_insights",
    ...
    app_args=['@s3://tf-nap-prod-airflow-nsk-insights/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/user_config/argument_ecf_salesreporting_load_v2_2656_napstore_insights_m_load_postgres.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='12g',
    driver_cores=2,
    executor_memory='9g',
    executor_cores=5,
    session_name='ecf_salesreporting_load_v2_2656_napstore_insights_m_load_postgres_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
