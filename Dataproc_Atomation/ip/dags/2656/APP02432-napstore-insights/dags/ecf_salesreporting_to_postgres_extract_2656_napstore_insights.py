# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        9cb2c961ceac61753733b5b88f04d3f2b5fe0602
# CI pipeline URL:      https://git.jwn.app/TM00787/app02432-store-analytics/APP02432-napstore-insights/-/pipelines/6915791
# CI commit timestamp:  2024-09-09T12:11:02+00:00
...
default_args = {
    'retries': 3,
    'description': 'ecf_salesreporting_to_postgres_extract_2656_napstore_insights DAG Description',
...
with DAG(
    ...
    parent_dag_name="ecf_salesreporting_to_postgres_extract_2656_napstore_insights",
    ...
    livy_ecf_salesreporting_load_teradata_to_postgres = LivyOperator(
    task_id='ecf_salesreporting_load_teradata_to_postgres',
    ...
    app_args=['@s3://tf-nap-prod-airflow-nsk-insights/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/user_config/argument_ecf_salesreporting_to_postgres_extract_2656_napstore_insights_ecf_salesreporting_load_teradata_to_postgres.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='12g',
    driver_cores=2,
    executor_memory='9g',
    executor_cores=5,
    session_name='ecf_salesreporting_to_postgres_extract_2656_napstore_insights_ecf_salesreporting_load_teradata_to_postgres_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
    ...
    livy_ecf_salesreporting_load_teradata_to_postgres_sensor = LivySensor(
    conn_id='TECH_ISF_NAP_STORE_TEAM_NSP_ETL_LIVY_PROD',
    task_id='ecf_salesreporting_load_teradata_to_postgres_sensor',
    batch_id="{{ task_instance.xcom_pull(task_ids='ecf_salesreporting_load_teradata_to_postgres') }}")

    create_persistent_cluster_nsp_etl >> [livy_ecf_salesreporting_load_teradata_to_postgres]
    livy_ecf_salesreporting_load_teradata_to_postgres >> [livy_ecf_salesreporting_load_teradata_to_postgres_sensor]
