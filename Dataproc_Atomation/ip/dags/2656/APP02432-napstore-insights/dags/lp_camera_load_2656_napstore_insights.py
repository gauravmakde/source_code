...
default_args = {
    'retries': 3,
    'description': 'lp_camera_load_2656_napstore_insights DAG Description',
...
with DAG(
    ...
    parent_dag_name="lp_camera_load_2656_napstore_insights",
    ...
    livy_lpcamera_events_to_csv_load_0_stg = LivyOperator(
    task_id='lpcamera_events_to_csv_load_0_stg',
    ...
    app_args=['@s3://tf-nap-prod-airflow-nsk-insights/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/user_config/argument_lp_camera_load_2656_napstore_insights_lpcamera_events_to_csv_load_0_stg.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='12g',
    driver_cores=2,
    executor_memory='9g',
    executor_cores=5,
    session_name='lp_camera_load_2656_napstore_insights_lpcamera_events_to_csv_load_0_stg_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
    ...
    launch_lpcamera_events_to_csv_load_1_fct_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ISF_NAPSTORE_INSIGHTS_CONN_PROD',
    namespace='app02432',
    task_id='lpcamera_events_to_csv_load_1_fct_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='lpcamera-events-to-csv-load-1-fct-lp-camera-load-2656-napstore',
    nsk_cluster='nsk-miso-prod')
    ...
    create_persistent_cluster_nsp_etl >> [livy_lpcamera_events_to_csv_load_0_stg]
    livy_lpcamera_events_to_csv_load_0_stg >> [livy_lpcamera_events_to_csv_load_0_stg_sensor]
    livy_lpcamera_events_to_csv_load_0_stg_sensor >> [launch_lpcamera_events_to_csv_load_1_fct]
    launch_lpcamera_events_to_csv_load_1_fct >> [launch_lpcamera_events_to_csv_load_1_fct_sensor]
