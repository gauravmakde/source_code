...
default_args = {
    'retries': 3,
    'description': 'retailnext_load_2656_napstore_insights DAG Description',
...
with DAG(
    ...
    parent_dag_name="retailnext_load_2656_napstore_insights",
    ...
    livy_retailnext_load_load_0_stg_table = LivyOperator(
    task_id='retailnext_load_load_0_stg_table',
    ...
    app_args=['@s3://tf-nap-prod-airflow-nsk-insights/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/user_config/argument_retailnext_load_2656_napstore_insights_retailnext_load_load_0_stg_table.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='12g',
    driver_cores=2,
    executor_memory='9g',
    executor_cores=5,
    session_name='retailnext_load_2656_napstore_insights_retailnext_load_load_0_stg_table_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
    ...
    launch_retailnext_load_load_1_fct_table_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ISF_NAPSTORE_INSIGHTS_CONN_PROD',
    namespace='app02432',
    task_id='retailnext_load_load_1_fct_table_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='retailnext-load-load-1-fct-table-retailnext-load-2656-napstore',
    nsk_cluster='nsk-miso-prod')
    ...
    create_persistent_cluster_nsp_etl >> [livy_retailnext_load_load_0_stg_table]
    livy_retailnext_load_load_0_stg_table >> [livy_retailnext_load_load_0_stg_table_sensor]
    livy_retailnext_load_load_0_stg_table_sensor >> [launch_retailnext_load_load_1_fct_table]
    launch_retailnext_load_load_1_fct_table >> [launch_retailnext_load_load_1_fct_table_sensor]
