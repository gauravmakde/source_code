-- load historic out of order ORG worker data from S3 location in AVRO format to Teradata sink:
CREATE OR REPLACE TEMPORARY VIEW hr_org_details_input AS select * from s3_avro_input_for_org_details;
