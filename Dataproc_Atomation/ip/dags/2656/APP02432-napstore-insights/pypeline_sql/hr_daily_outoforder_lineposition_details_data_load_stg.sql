...
Task_Name=line_position_details_stage_load_6_lineposition_details_stg_tables;'
FOR SESSION VOLATILE;

-- load out of order line position worker data from S3 location in AVRO format to Teradata sink:
CREATE OR REPLACE TEMPORARY VIEW hr_lineposition_details_input 
AS select * from s3_avro_input_for_lineposition_details;
