...
cron = '0 13 * * *'
dag_id = 'credit_connectors_s3_parquet_preprod_3678_credit_insights'
...
with DAG(
    ...
    parent_dag_name="credit_connectors_s3_parquet_preprod_3678_credit_insights",
    ...
    app_args=['@s3://tf-nap-prod-credit-payments-isf-airflow/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/3678/credit/insights/user_config/argument_credit_connectors_s3_parquet_preprod_3678_credit_insights_credit_connectors_s3_parquet_stage_0_kafka_to_s3_parquet_job.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='12g',
    driver_cores=2,
    executor_memory='9g',
    executor_cores=5,
    session_name='credit_connectors_s3_parquet_preprod_3678_credit_insights_credit_connectors_s3_parquet_stage_0_kafka_to_s3_parquet_job_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
