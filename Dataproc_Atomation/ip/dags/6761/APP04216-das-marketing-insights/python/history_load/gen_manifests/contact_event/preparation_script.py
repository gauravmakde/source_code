...
manifest_s3_prefix_format = 'manifest/contact_event/ced_history_manifest_folder_part_{}.manifest'
...
def upload_data_to_s3(execution_plan, manifests, target_aws_role, target_bucket, initial_part):
    ...
    if append_execution_plan:
        current_execution_plan = load_exectuion_plan(target_aws_role, target_bucket,
                                                     'manifest/contact_event/execution_plan.json')
        ...
        current_execution_plan_td = load_exectuion_plan(target_aws_role, target_bucket,
                                                        'manifest/contact_event/execution_plan_td.json')
...
def exec():
    ...
    source_bucket_prefix_list = ['event_consumer/ced-contact-event-object-model-avro/']
    initial_part = 0
