...
cron = '0 1,9,19 * * *'
dag_id = 'stock_count_load_17610_DAS_SC_OUTBOUND_APP08649_insights_v2'
...
default_args = {
    'retries': 3,
    'description': 'stock_count_load_17610_DAS_SC_OUTBOUND_APP08649_insights_v2 DAG Description',
...
with DAG(
    ...
    parent_dag_name="stock_count_load_17610_DAS_SC_OUTBOUND_APP08649_insights_v2",
    ...
    livy_stock_count_v1_load_from_kafka_to_teradata_stg_table = LivyOperator(
    task_id='stock_count_v1_load_from_kafka_to_teradata_stg_table',
    ...
    app_args=['@s3://napstoreinvtry-prod-common-etl/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/17610/DAS_SC_OUTBOUND/APP08649_insights_v2/user_config/argument_stock_count_load_17610_DAS_SC_OUTBOUND_APP08649_insights_v2_stock_count_v1_load_from_kafka_to_teradata_stg_table.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='15g',
    driver_cores=2,
    executor_memory='12g',
    executor_cores=5,
    session_name='stock_count_load_17610_DAS_SC_OUTBOUND_APP08649_insights_v2_stock_count_v1_load_from_kafka_to_teradata_stg_table_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
    ...
    launch_stock_count_v1_load_from_stg_to_fct_table_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ISF_NAPSTORINVTRY_K8S_GUMBO_CONN_PROD',
    namespace='app08649',
    task_id='stock_count_v1_load_from_stg_to_fct_table_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='stock-count-v1-load-from-stg-to-fct-table-stock-count-load-1761',
    nsk_cluster='nsk-gumbo-prod')
    ...
    create_persistent_cluster_scoisf_etl >> [livy_stock_count_v1_load_from_kafka_to_teradata_stg_table]
    livy_stock_count_v1_load_from_kafka_to_teradata_stg_table >> [livy_stock_count_v1_load_from_kafka_to_teradata_stg_table_sensor]
    livy_stock_count_v1_load_from_kafka_to_teradata_stg_table_sensor >> [launch_stock_count_v1_load_from_stg_to_fct_table]
    launch_stock_count_v1_load_from_stg_to_fct_table >> [launch_stock_count_v1_load_from_stg_to_fct_table_sensor]
