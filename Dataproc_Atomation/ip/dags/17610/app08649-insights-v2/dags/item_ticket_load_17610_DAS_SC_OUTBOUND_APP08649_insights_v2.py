...
cron = '0 0,16,18,19,21 * * *'
dag_id = 'item_ticket_load_17610_DAS_SC_OUTBOUND_APP08649_insights_v2'
...
default_args = {
    'retries': 3,
    'description': 'item_ticket_load_17610_DAS_SC_OUTBOUND_APP08649_insights_v2 DAG Description',
...
with DAG(
    ...
    parent_dag_name="item_ticket_load_17610_DAS_SC_OUTBOUND_APP08649_insights_v2",
    ...
    livy_main_1_load_from_kafka_to_teradata_stg_table = LivyOperator(
    task_id='main_1_load_from_kafka_to_teradata_stg_table',
    ...
    app_args=['@s3://napstoreinvtry-prod-common-etl/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/17610/DAS_SC_OUTBOUND/APP08649_insights_v2/user_config/argument_item_ticket_load_17610_DAS_SC_OUTBOUND_APP08649_insights_v2_main_1_load_from_kafka_to_teradata_stg_table.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='15g',
    driver_cores=2,
    executor_memory='12g',
    executor_cores=5,
    session_name='item_ticket_load_17610_DAS_SC_OUTBOUND_APP08649_insights_v2_main_1_load_from_kafka_to_teradata_stg_table_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
    ...
    launch_main_1_load_from_stg_to_fct_table_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ISF_NAPSTORINVTRY_K8S_GUMBO_CONN_PROD',
    namespace='app08649',
    task_id='main_1_load_from_stg_to_fct_table_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='main-1-load-from-stg-to-fct-table-item-ticket-load-17610-das-sc',
    nsk_cluster='nsk-gumbo-prod')
    ...
    create_persistent_cluster_scoisf_etl >> [livy_main_1_load_from_kafka_to_teradata_stg_table]
    livy_main_1_load_from_kafka_to_teradata_stg_table >> [livy_main_1_load_from_kafka_to_teradata_stg_table_sensor]
    livy_main_1_load_from_kafka_to_teradata_stg_table_sensor >> [launch_main_1_load_from_stg_to_fct_table]
    launch_main_1_load_from_stg_to_fct_table >> [launch_main_1_load_from_stg_to_fct_table_sensor]
