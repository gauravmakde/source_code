...
default_args = {
    'retries': 3,
    'description': 'sco_backfill_inventory_rfid_program_event_fact_17610_DAS_SC_OUTBOUND_APP08649_insights_v2 DAG Description',
...
with DAG(
    ...
    parent_dag_name="sco_backfill_inventory_rfid_program_event_fact_17610_DAS_SC_OUTBOUND_APP08649_insights_v2",
    ...
    livy_main_job_1_load_csv_td_fct_step = LivyOperator(
    task_id='main_job_1_load_csv_td_fct_step',
    ...
    app_args=['@s3://napstoreinvtry-prod-common-etl/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/17610/DAS_SC_OUTBOUND/APP08649_insights_v2/user_config/argument_sco_backfill_inventory_rfid_program_event_fact_17610_DAS_SC_OUTBOUND_APP08649_insights_v2_main_job_1_load_csv_td_fct_step.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='12g',
    driver_cores=2,
    executor_memory='9g',
    executor_cores=5,
    session_name='sco_backfill_inventory_rfid_program_event_fact_17610_DAS_SC_OUTBOUND_APP08649_insights_v2_main_job_1_load_csv_td_fct_step_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
    ...
    livy_main_job_1_load_csv_td_fct_step_sensor = LivySensor(
    conn_id='TECH_ISF_NAPSTORINVTRY_LIVY_PROD',
    task_id='main_job_1_load_csv_td_fct_step_sensor',
    batch_id="{{ task_instance.xcom_pull(task_ids='main_job_1_load_csv_td_fct_step') }}")

    create_persistent_cluster_scoisf_etl >> [livy_main_job_1_load_csv_td_fct_step]
    livy_main_job_1_load_csv_td_fct_step >> [livy_main_job_1_load_csv_td_fct_step_sensor]
