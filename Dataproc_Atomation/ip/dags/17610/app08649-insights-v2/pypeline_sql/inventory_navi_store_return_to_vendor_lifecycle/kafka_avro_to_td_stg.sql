...
-- Description             : Reading Data from Source Kafka Topic and writing to INVENTORY_NAVI_STORE_RETURN_TO_VENDOR_LIFECYCLE_LDG table
...
insert overwrite table inventory_navi_store_return_to_vendor_created
...
--canceled event
insert overwrite table inventory_navi_store_return_to_vendor_canceled
partition(year, month, day, hour)
SELECT /*+ COALESCE(1) */
returnToVendorNumber,
createdSystemTime,
...
--shipped event
insert overwrite table inventory_navi_store_return_to_vendor_shipped
partition(year, month, day, hour)
SELECT /*+ COALESCE(1) */
returnToVendorNumber,
createdSystemTime,
...
insert overwrite table inventory_navi_store_return_to_vendor_lifecycle_ldg_table
SELECT
