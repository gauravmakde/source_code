...
----------------------------------------------------------------------------------------------------
-- Reading StoreTransferReceived data
----------------------------------------------------------------------------------------------------
create temporary view inventory_store_transfer_received as
select
      eventtype,
      eventtime,
      locationid,
 ...
 from (select element_at(src.headers, 'EventType') as eventtype,
         ...
         from kafkay_store_transfer_received_event_avro src 
        where element_at(src.headers, 'Nord-Test') is null
          and element_at(src.headers, 'Nord-Load') is null
          and element_at(src.headers, 'EventType') = 'StoreTransferReceived') t
where rn = 1;

create temporary view inventory_store_transfer_received_transfer_received_details as
select
      eventtype,
      eventtime,
      locationid,
 ...
 from inventory_store_transfer_received;

create temporary view inventory_store_transfer_received_product_details as
select 
 ...
 from inventory_store_transfer_received_transfer_received_details;
...
select
 ...
 from inventory_store_transfer_received_product_details;
