...
----------------------------------------------------------------------------------------------------
-- Reading StoreTransferReceivedAdjusted data
----------------------------------------------------------------------------------------------------
create temporary view inventory_store_transfer_received_adjusted as
select
      eventtype,
      eventtime,
      locationid,
      ...
      billoflading,
      cartonnumber,
      explode(transferreceiveddetails) as transferreceiveddetails
 from (select element_at(src.headers, 'EventType') as eventtype,
         ...
         from kafkay_store_transfer_received_adjusted_event_avro src 
        where element_at(src.headers, 'Nord-Test') is null
          and element_at(src.headers, 'Nord-Load') is null
          and element_at(src.headers, 'EventType') = 'StoreTransferReceivedAdjusted') t
where rn = 1;

create temporary view inventory_store_transfer_received_adjusted_transfer_received_details as
select
      eventtype,
      eventtime,
      locationid,
      ...
      billoflading,
      cartonnumber,
      transferreceiveddetails.transfernumber,
      explode(transferreceiveddetails.productdetails) as productdetails
 from inventory_store_transfer_received_adjusted;

create temporary view inventory_store_transfer_received_adjusted_product_details as
select 
 ...
 from inventory_store_transfer_received_adjusted_transfer_received_details;
...
select
 ...
 from inventory_store_transfer_received_adjusted_product_details;
