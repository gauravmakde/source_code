...
SELECT BATCH_ID
 , BATCH_DATE
 , '{db_env}_NAP_BASE_VWS.INVENTORY_NAVI_STORE_INVENTORY_ADJUSTED_FACT' as SOURCE_TABLE
...
FROM (SELECT COUNT(1) as FCT_CNT, BATCH_ID, BATCH_DATE
        FROM {db_env}_NAP_BASE_VWS.INVENTORY_NAVI_STORE_INVENTORY_ADJUSTED_FACT
