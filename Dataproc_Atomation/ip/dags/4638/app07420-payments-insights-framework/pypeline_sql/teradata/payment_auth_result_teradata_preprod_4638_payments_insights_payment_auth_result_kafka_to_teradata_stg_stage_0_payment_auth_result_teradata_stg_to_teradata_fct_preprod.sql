...
CREATE MULTISET VOLATILE TABLE TEMP_PAYMENT_AUTHORIZATION_RESULT_STG AS (
    SELECT DISTINCT *
    FROM PREPROD_NAP_STG.PAYMENT_AUTHORIZATION_RESULT_LDG
    QUALIFY
        row_number() OVER (
            PARTITION BY
...
MERGE INTO PREPROD_NAP_BASE_VWS.PAYMENT_AUTHORIZATION_RESULT_FACT AS PSR
...
MERGE INTO PREPROD_NAP_BASE_VWS.PAYMENT_BANK_CARD_AUTHORIZATION_RESULT_FACT AS PBC
USING TEMP_PAYMENT_AUTHORIZATION_RESULT_STG AS SRC
...
DELETE FROM PREPROD_NAP_STG.PAYMENT_AUTHORIZATION_RESULT_LDG;
