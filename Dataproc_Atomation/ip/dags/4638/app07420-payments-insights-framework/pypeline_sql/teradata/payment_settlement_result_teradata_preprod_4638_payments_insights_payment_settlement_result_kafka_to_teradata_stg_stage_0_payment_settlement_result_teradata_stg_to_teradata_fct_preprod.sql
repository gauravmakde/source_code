...
CREATE MULTISET VOLATILE TABLE SETTLEMENT_RESULT_STG_TEMP AS (
    SELECT DISTINCT *
    FROM PREPROD_NAP_STG.PAYMENT_SETTLEMENT_RESULT_LDG
...
MERGE INTO PREPROD_NAP_BASE_VWS.PAYMENT_SETTLEMENT_RESULT_FACT AS PSR
...
MERGE INTO PREPROD_NAP_BASE_VWS.PAYMENT_BANK_CARD_SETTLEMENT_RESULT_FACT AS PBC
USING SETTLEMENT_RESULT_STG_TEMP AS SRC
...
UPDATE PREPROD_NAP_BASE_VWS.PAYMENT_SETTLEMENT_RESULT_FACT
FROM (
SELECT
    ...
    B.TOKEN_VALUE,
    A.SETTLEMENT_AMOUNT
FROM PREPROD_NAP_BASE_VWS.PAYMENT_SETTLEMENT_RESULT_FACT A
INNER JOIN PREPROD_NAP_BASE_VWS.PAYMENT_BANK_CARD_SETTLEMENT_RESULT_FACT B
...
WHERE PREPROD_NAP_BASE_VWS.PAYMENT_SETTLEMENT_RESULT_FACT.SETTLEMENT_RESULT_RECEIVED_ID = C.SETTLEMENT_RESULT_RECEIVED_ID;
...
DELETE FROM PREPROD_NAP_STG.PAYMENT_SETTLEMENT_RESULT_LDG;
