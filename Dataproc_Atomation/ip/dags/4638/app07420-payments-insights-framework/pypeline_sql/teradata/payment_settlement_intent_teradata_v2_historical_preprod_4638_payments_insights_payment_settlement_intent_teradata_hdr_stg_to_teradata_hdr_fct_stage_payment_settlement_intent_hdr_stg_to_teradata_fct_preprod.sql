...
CREATE MULTISET VOLATILE TABLE PAYMENT_SETTLEMENT_HDR_TEMP AS (
    SELECT *
    FROM PREPROD_NAP_BASE_VWS.PAYMENT_SETTLEMENT_INTENT_HDR_V2_LDG
    QUALIFY
        ROW_NUMBER() OVER (
...
DELETE FROM PREPROD_NAP_BASE_VWS.PAYMENT_SETTLEMENT_INTENT_HDR_V2_FACT
WHERE TRANSACTION_ID IN (SELECT DISTINCT TRANSACTION_ID FROM PREPROD_NAP_BASE_VWS.PAYMENT_SETTLEMENT_INTENT_HDR_V2_LDG);

INSERT INTO PREPROD_NAP_BASE_VWS.PAYMENT_SETTLEMENT_INTENT_HDR_V2_FACT
(
  EVENT_ID,
  EVENT_TIME,
  ACTIVITY_DATE,
