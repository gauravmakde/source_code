...
DELETE FROM {db_env}_NAP_PYMNT_FRAUD_BASE_VWS.PAYMENT_CHARGEBACK_INFORMATION_FACT
WHERE CHARGEBACK_ID IN (SELECT DISTINCT CHARGEBACK_ID FROM {db_env}_NAP_PYMNT_FRAUD_STG.PAYMENT_CHARGEBACK_INFORMATION_LDG);

INSERT INTO {db_env}_NAP_PYMNT_FRAUD_BASE_VWS.PAYMENT_CHARGEBACK_INFORMATION_FACT
(
    DW_BATCH_DATE,
    DW_SYS_LOAD_TMSTP,
    DW_SYS_UPDT_TMSTP,
...
SELECT DISTINCT
    ...
    WORLDPAY_ENTRY_MODE,
    WORLDPAY_BANK_CARD_AUTHORIZATION_SOURCE
FROM {db_env}_NAP_PYMNT_FRAUD_STG.PAYMENT_CHARGEBACK_INFORMATION_LDG;

-- delete stg table
DELETE FROM {db_env}_NAP_PYMNT_FRAUD_STG.PAYMENT_CHARGEBACK_INFORMATION_LDG;
