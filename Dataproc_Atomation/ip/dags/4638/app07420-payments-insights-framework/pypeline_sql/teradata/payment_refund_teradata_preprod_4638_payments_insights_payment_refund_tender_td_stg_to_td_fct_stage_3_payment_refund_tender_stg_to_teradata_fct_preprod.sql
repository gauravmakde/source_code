...
CREATE MULTISET VOLATILE TABLE PAYMENT_REFUND_TENDER_TEMP AS (
    SELECT *
    FROM PREPROD_NAP_BASE_VWS.PAYMENT_REFUND_TENDER_LDG
    QUALIFY
        RANK() OVER (
...
DELETE FROM PREPROD_NAP_BASE_VWS.PAYMENT_REFUND_TENDER_FACT
WHERE EVENT_ID IN (SELECT DISTINCT EVENT_ID FROM PREPROD_NAP_BASE_VWS.PAYMENT_REFUND_TENDER_LDG);

INSERT INTO PREPROD_NAP_BASE_VWS.PAYMENT_REFUND_TENDER_FACT
(
  EVENT_ID,
  EVENT_TYPE,
  EVENT_TIME,
...
DELETE FROM PREPROD_NAP_BASE_VWS.PAYMENT_REFUND_TENDER_LDG;
