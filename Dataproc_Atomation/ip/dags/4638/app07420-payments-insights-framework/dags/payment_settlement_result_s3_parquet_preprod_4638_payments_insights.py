...
cron = None
dag_id = 'payment_settlement_result_s3_parquet_preprod_4638_payments_insights'
...
default_args = {
    'retries': 5,
    'description': 'payment_settlement_result_s3_parquet_preprod_4638_payments_insights DAG Description',
...
with DAG(
    ...
    parent_dag_name="payment_settlement_result_s3_parquet_preprod_4638_payments_insights",
    ...
    livy_payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job = LivyOperator(
    task_id='payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job',
    ...
    app_args=['@s3://tf-nap-prod-credit-payments-isf-airflow/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/4638/payments/insights/user_config/argument_payment_settlement_result_s3_parquet_preprod_4638_payments_insights_payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='12g',
    driver_cores=2,
    executor_memory='9g',
    executor_cores=5,
    session_name='payment_settlement_result_s3_parquet_preprod_4638_payments_insights_payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
    ...
    livy_payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job_sensor = LivySensor(
    conn_id='TECH_ISF_NAP_CREDIT_PAYMENTS_LIVY_V2_PROD',
    task_id='payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job_sensor',
    batch_id="{{ task_instance.xcom_pull(task_ids='payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job') }}")

    create_persistent_cluster_napcp_etl >> [livy_payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job]
    livy_payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job >> [livy_payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job_sensor]
