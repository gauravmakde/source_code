...
cron = None
dag_id = 'worldpay_card_networks_4638_payments_insights'
...
default_args = {
    'retries': 3,
    'description': 'worldpay_card_networks_4638_payments_insights DAG Description',
...
with DAG(
    ...
    parent_dag_name="worldpay_card_networks_4638_payments_insights",
    ...
    app_args=['@s3://tf-nap-prod-credit-payments-isf-airflow/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/4638/payments/insights/user_config/argument_worldpay_card_networks_4638_payments_insights_worldpay_card_networks_s3_to_teradata_stage_worldpay_card_networks_s3_to_teradata_job.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='12g',
    driver_cores=2,
    executor_memory='9g',
    executor_cores=5,
    session_name='worldpay_card_networks_4638_payments_insights_worldpay_card_networks_s3_to_teradata_stage_worldpay_card_networks_s3_to_teradata_job_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
