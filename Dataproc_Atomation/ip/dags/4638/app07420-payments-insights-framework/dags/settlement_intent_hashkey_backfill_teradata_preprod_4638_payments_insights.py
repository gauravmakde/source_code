...
cron = None
dag_id = 'settlement_intent_hashkey_backfill_teradata_preprod_4638_payments_insights'
...
default_args = {
    'retries': 5,
    'description': 'settlement_intent_hashkey_backfill_teradata_preprod_4638_payments_insights DAG Description',
...
with DAG(
    ...
    launch_settlement_intent_hashkey_backfill_teradata_stage_0_job_insert_update_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ISF_NAP_PAYMENTS_K8S_NSK_CONN_V2_PROD',
    namespace='app07420',
    task_id='settlement_intent_hashkey_backfill_teradata_stage_0_job_insert_update_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='settlement-intent-hashkey-backfill-teradata-stage-0-job-insert',
    nsk_cluster='nsk-gumbo-prod')
    ...
    launch_settlement_intent_hashkey_backfill_teradata_stage_0_job_insert_update >> [launch_settlement_intent_hashkey_backfill_teradata_stage_0_job_insert_update_sensor]
