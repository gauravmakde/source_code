...
cron = '0 17 * * *'
dag_id = 'afterpay_settlement_details_update_teradata_preprod_4638_payments_insights'
...
default_args = {
    'retries': 5,
    'description': 'afterpay_settlement_details_update_teradata_preprod_4638_payments_insights DAG Description',
...
with DAG(
    ...
    external_dag_id='payment_settlement_result_teradata_4638_payments_insights',
    timeout=7200,
    ...
    external_dag_id='payment_bin_teradata_4638_payments_insights',
    timeout=7200,
    allowed_states=['success'],
    failed_states=['failed'],
    execution_delta=timedelta(hours=1))
    ...
    launch_afterpay_settlement_update_teradata_stg_stage_0_job_insert_update_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ISF_NAP_PAYMENTS_K8S_NSK_CONN_V2_PROD',
    namespace='app07420',
    task_id='afterpay_settlement_update_teradata_stg_stage_0_job_insert_update_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='afterpay-settlement-update-teradata-stg-stage-0-job-insert-upda',
    nsk_cluster='nsk-gumbo-prod')
    ...
    launch_check_external_upstream_dependencies_sensor_0 >> [launch_afterpay_settlement_update_teradata_stg_stage_0_job_insert_update]
    launch_check_external_upstream_dependencies_sensor_1 >> [launch_afterpay_settlement_update_teradata_stg_stage_0_job_insert_update]
    launch_afterpay_settlement_update_teradata_stg_stage_0_job_insert_update >> [launch_afterpay_settlement_update_teradata_stg_stage_0_job_insert_update_sensor]
