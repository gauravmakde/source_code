...
cron = '0 17 * * *'
dag_id = 'afterpay_auth_details_update_teradata_4638_payments_insights'
...
default_args = {
    'retries': 3,
    'description': 'afterpay_auth_details_update_teradata_4638_payments_insights DAG Description',
