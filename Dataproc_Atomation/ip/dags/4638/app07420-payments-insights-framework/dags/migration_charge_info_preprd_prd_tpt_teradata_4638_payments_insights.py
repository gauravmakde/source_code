...
cron = None
dag_id = 'migration_charge_info_preprd_prd_tpt_teradata_4638_payments_insights'
...
default_args = {
    'retries': 3,
    'description': 'migration_charge_info_preprd_prd_tpt_teradata_4638_payments_insights DAG Description',
...
with DAG(
    ...
    launch_migrate_chargeback_info_data_preprd_to_prd_stage_insert_from_stg_to_fct_teradata_stage_job = launch_k8s_api_job_operator(
    dag=dag,
    ...
    launch_migrate_chargeback_info_data_preprd_to_prd_stage_insert_from_stg_to_fct_teradata_stage_job_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ISF_NAP_PAYMENTS_K8S_NSK_CONN_V2_PROD',
    namespace='app07420',
    task_id='migrate_chargeback_info_data_preprd_to_prd_stage_insert_from_stg_to_fct_teradata_stage_job_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='migrate-chargeback-info-data-preprd-to-prd-stage-insert-from-st',
    nsk_cluster='nsk-gumbo-prod')
    ...
    tpt_jdbc_export_migrate_chargeback_info_data_preprd_to_prd_stage_load_from_teradata_to_s3_tpt_stage_job_control_tbl >> [tpt_migrate_chargeback_info_data_preprd_to_prd_stage_load_from_teradata_to_s3_tpt_stage_job_export_tbl]
    ...
    launch_migrate_chargeback_info_data_preprd_to_prd_stage_insert_from_stg_to_fct_teradata_stage_job >> [launch_migrate_chargeback_info_data_preprd_to_prd_stage_insert_from_stg_to_fct_teradata_stage_job_sensor]
