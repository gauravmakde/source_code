...
cron = None
dag_id = 'authorization_result_hashkey_backfill_teradata_4638_payments_insights'
...
default_args = {
    'retries': 3,
    'description': 'authorization_result_hashkey_backfill_teradata_4638_payments_insights DAG Description',
