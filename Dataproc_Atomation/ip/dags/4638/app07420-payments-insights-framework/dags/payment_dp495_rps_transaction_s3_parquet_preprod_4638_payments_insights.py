...
cron = None
dag_id = 'payment_dp495_rps_transaction_s3_parquet_preprod_4638_payments_insights'
...
default_args = {
    'retries': 5,
    'description': 'payment_dp495_rps_transaction_s3_parquet_preprod_4638_payments_insights DAG Description',
...
with DAG(
    ...
    parent_dag_name="payment_dp495_rps_transaction_s3_parquet_preprod_4638_payments_insights",
    ...
    app_args=['@s3://tf-nap-prod-credit-payments-isf-airflow/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/4638/payments/insights/user_config/argument_payment_dp495_rps_transaction_s3_parquet_preprod_4638_payments_insights_s3_csv_to_s3_parquet_stage_0_s3_csv_to_s3_parquet_job.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='12g',
    driver_cores=2,
    executor_memory='9g',
    executor_cores=5,
    session_name='payment_dp495_rps_transaction_s3_parquet_preprod_4638_payments_insights_s3_csv_to_s3_parquet_stage_0_s3_csv_to_s3_parquet_job_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
