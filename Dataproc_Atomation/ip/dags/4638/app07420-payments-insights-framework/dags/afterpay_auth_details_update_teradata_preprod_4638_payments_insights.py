...
cron = '0 17 * * *'
dag_id = 'afterpay_auth_details_update_teradata_preprod_4638_payments_insights'
...
default_args = {
    'retries': 5,
    'description': 'afterpay_auth_details_update_teradata_preprod_4638_payments_insights DAG Description',
...
with DAG(
    ...
    external_dag_id='payment_auth_result_teradata_4638_payments_insights',
    timeout=7200,
    ...
    launch_afterpay_auth_update_teradata_stg_stage_0_job_insert_update_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ISF_NAP_PAYMENTS_K8S_NSK_CONN_V2_PROD',
    namespace='app07420',
    task_id='afterpay_auth_update_teradata_stg_stage_0_job_insert_update_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='afterpay-auth-update-teradata-stg-stage-0-job-insert-update-aft',
    nsk_cluster='nsk-gumbo-prod')
    ...
    launch_check_external_upstream_dependencies_sensor_0 >> [launch_afterpay_auth_update_teradata_stg_stage_0_job_insert_update]
    launch_check_external_upstream_dependencies_sensor_1 >> [launch_afterpay_auth_update_teradata_stg_stage_0_job_insert_update]
    launch_afterpay_auth_update_teradata_stg_stage_0_job_insert_update >> [launch_afterpay_auth_update_teradata_stg_stage_0_job_insert_update_sensor]
