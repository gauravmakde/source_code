...
cron = '0 */4 * * *'
dag_id = 'payment_settlement_intent_teradata_preprod_4638_payments_insights'
...
default_args = {
    'retries': 5,
    'description': 'payment_settlement_intent_teradata_preprod_4638_payments_insights DAG Description',
...
with DAG(
    ...
    parent_dag_name="payment_settlement_intent_teradata_preprod_4638_payments_insights",
    ...
    livy_payment_settlement_intent_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job = LivyOperator(
    ...
    app_args=['@s3://tf-nap-prod-credit-payments-isf-airflow/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/4638/payments/insights/user_config/argument_payment_settlement_intent_teradata_preprod_4638_payments_insights_payment_settlement_intent_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='12g',
    driver_cores=2,
    executor_memory='9g',
    executor_cores=5,
    session_name='payment_settlement_intent_teradata_preprod_4638_payments_insights_payment_settlement_intent_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
    ...
    livy_payment_settlement_intent_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job_sensor = LivySensor(
    conn_id='TECH_ISF_NAP_CREDIT_PAYMENTS_LIVY_V2_PROD',
    task_id='payment_settlement_intent_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job_sensor',
    batch_id="{{ task_instance.xcom_pull(task_ids='payment_settlement_intent_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job') }}")

    launch_payment_settlement_intent_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job = launch_k8s_api_job_operator(
    dag=dag,
    ...
    launch_payment_settlement_intent_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job_sensor = monitor_k8s_api_job_status(
    dag=dag,
    connection_id='TECH_ISF_NAP_PAYMENTS_K8S_NSK_CONN_V2_PROD',
    namespace='app07420',
    task_id='payment_settlement_intent_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job_sensor',
    poke_interval=100,
    time_out=1800,
    job_name='payment-settlement-intent-kafka-to-teradata-stg-stage-0-teradat',
    nsk_cluster='nsk-gumbo-prod')
    ...
    create_persistent_cluster_napcp_etl >> [livy_payment_settlement_intent_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job]
    livy_payment_settlement_intent_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job >> [livy_payment_settlement_intent_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job_sensor]
    livy_payment_settlement_intent_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job_sensor >> [launch_payment_settlement_intent_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job]
    launch_payment_settlement_intent_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job >> [launch_payment_settlement_intent_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job_sensor]
