...
cron = None
dag_id = 'authorization_hashkey_backfill_teradata_4638_payments_insights'
...
default_args = {
    'retries': 3,
    'description': 'authorization_hashkey_backfill_teradata_4638_payments_insights DAG Description',
