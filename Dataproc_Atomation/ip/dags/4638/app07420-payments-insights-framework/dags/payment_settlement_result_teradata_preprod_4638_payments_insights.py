...
cron = '0 10-16/2 * * *'
dag_id = 'payment_settlement_result_teradata_preprod_4638_payments_insights'
...
with DAG(
    ...
    parent_dag_name="payment_settlement_result_teradata_preprod_4638_payments_insights",
    ...
    app_args=['@s3://tf-nap-prod-credit-payments-isf-airflow/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/4638/payments/insights/user_config/argument_payment_settlement_result_teradata_preprod_4638_payments_insights_payment_settlement_result_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job.json', '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
    driver_memory='12g',
    driver_cores=2,
    executor_memory='9g',
    executor_cores=5,
    session_name='payment_settlement_result_teradata_preprod_4638_payments_insights_payment_settlement_result_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job_'+CURRENT_TIMESTAMP.strftime('%Y%m%d_%H%M%S'),
