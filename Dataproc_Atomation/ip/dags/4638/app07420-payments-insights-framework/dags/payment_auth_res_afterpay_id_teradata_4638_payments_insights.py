...
cron = None
dag_id = 'payment_auth_res_afterpay_id_teradata_4638_payments_insights'
...
default_args = {
    'retries': 3,
    'description': 'payment_auth_res_afterpay_id_teradata_4638_payments_insights DAG Description',
