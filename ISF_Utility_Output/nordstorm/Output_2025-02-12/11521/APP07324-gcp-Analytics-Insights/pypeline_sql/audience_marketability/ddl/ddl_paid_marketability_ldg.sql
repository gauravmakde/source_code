/*
Table: T2DL_DAS_MKTG_AUDIENCE.paid_marketability_ldg
...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP('t2dl_das_bie_dev', 'paid_marketability_ldg', OUT_RETURN_MSG);

create multiset table {mktg_audience_t2_schema}.paid_marketability_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
