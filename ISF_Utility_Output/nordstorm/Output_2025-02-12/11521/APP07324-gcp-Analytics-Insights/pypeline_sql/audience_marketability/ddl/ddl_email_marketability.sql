/*
Table: T2DL_DAS_MKTG_AUDIENCE.email_marketability
Owner: Sophie Wang, Amanda Van Orsdale, Sushmitha Palleti, Nicole Miao
Modification Date: 2023-05-0
Description: This table attributes daily touches to their respective conversion orders and oder details at an ACP ID level, this table will then be used to determine the % cuastomer from this data set as marketable through email Platforms
*/
...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP('t2dl_das_bie_dev', 'email_marketability', OUT_RETURN_MSG);

create multiset table {mktg_audience_t2_schema}.email_marketability
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
