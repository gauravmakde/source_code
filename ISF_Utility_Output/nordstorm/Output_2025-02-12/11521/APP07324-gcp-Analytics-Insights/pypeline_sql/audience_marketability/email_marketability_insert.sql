...
Task_Name=email_marketability_insert;'
FOR SESSION VOLATILE;


DELETE FROM  {mktg_audience_t2_schema}.TPT_CONTROL_TBL
where job_name = 'email_marketability_ldg'  -- matches job name from tpt_load_ldg stage on .json file
;
...
VALUES (
	'email_marketability_ldg',  -- matches job name from tpt_load_ldg stage on .json file
	'{mktg_audience_t2_schema}',
	'email_marketability_ldg',  -- landing table name
	'T',
	 '*',
	'Y',
	'1',
