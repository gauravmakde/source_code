...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{fls_traffic_model_t2_schema}', 'wifi_config_change_correction_ldg', OUT_RETURN_MSG);

create multiset table {fls_traffic_model_t2_schema}.wifi_config_change_correction_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
