...
CREATE MULTISET TABLE {fls_traffic_model_t2_schema}.fls_traffic_model_calibration_coeff
    , FALLBACK
    , NO BEFORE JOURNAL
    , NO AFTER JOURNAL
    , CHECKSUM = DEFAULT
...
COMMENT ON {fls_traffic_model_t2_schema}.fls_traffic_model_calibration_coeff IS 'FLS model calibration based on store region';
