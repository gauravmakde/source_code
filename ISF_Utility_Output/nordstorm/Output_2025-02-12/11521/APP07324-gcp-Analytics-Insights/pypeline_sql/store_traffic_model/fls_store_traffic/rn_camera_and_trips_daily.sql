...
DELETE
FROM {fls_traffic_model_t2_schema}.rn_camera_and_trips_daily
WHERE day_date between {start_date} and {end_date};

insert into {fls_traffic_model_t2_schema}.rn_camera_and_trips_daily
select store_num
     , day_date
     , channel
     , store_type_code
...
--COLLECT STATS
COLLECT STATISTICS COLUMN (store_num), COLUMN (day_date) ON {fls_traffic_model_t2_schema}.rn_camera_and_trips_daily;
