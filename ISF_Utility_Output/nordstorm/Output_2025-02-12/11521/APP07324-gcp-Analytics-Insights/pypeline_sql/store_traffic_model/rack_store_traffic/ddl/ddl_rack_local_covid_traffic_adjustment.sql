...
CREATE MULTISET TABLE {fls_traffic_model_t2_schema}.rack_local_covid_traffic_adjustment
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
-- Table Comment
COMMENT ON  {fls_traffic_model_t2_schema}.rack_local_covid_traffic_adjustment IS 'Location based COVID adjustment for rack store traffic';
