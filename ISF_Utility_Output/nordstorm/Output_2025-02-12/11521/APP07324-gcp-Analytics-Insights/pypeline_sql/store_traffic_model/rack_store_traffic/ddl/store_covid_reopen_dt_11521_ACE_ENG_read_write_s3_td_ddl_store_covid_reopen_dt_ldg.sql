...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('T2DL_DAS_FLS_TRAFFIC_MODEL', 'store_covid_reopen_dt_ldg', OUT_RETURN_MSG);

create multiset table T2DL_DAS_FLS_TRAFFIC_MODEL.store_covid_reopen_dt_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
