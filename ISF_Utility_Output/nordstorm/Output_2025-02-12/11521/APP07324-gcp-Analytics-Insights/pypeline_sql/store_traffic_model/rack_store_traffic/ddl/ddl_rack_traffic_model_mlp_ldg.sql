...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{fls_traffic_model_t2_schema}', 'rack_traffic_model_mlp_ldg', OUT_RETURN_MSG);

create multiset table {fls_traffic_model_t2_schema}.rack_traffic_model_mlp_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
