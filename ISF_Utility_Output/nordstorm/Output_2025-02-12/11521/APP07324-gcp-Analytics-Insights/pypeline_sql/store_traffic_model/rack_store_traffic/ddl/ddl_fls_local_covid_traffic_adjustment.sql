...
CREATE MULTISET TABLE {fls_traffic_model_t2_schema}.fls_local_covid_traffic_adjustment
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
-- Table Comment
COMMENT ON  {fls_traffic_model_t2_schema}.fls_local_covid_traffic_adjustment IS 'location based COVID adjustment applied to traffic'; 
