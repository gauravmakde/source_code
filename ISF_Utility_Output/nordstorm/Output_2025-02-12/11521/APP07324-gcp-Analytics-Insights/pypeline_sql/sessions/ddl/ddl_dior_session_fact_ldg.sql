SET QUERY_BAND = 'App_ID=APP07324;
     ...
     Task_Name=ddl_dior_session_fact_ldg;'
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{sessions_t2_schema}', 'dior_session_fact_ldg', OUT_RETURN_MSG);

create multiset table {sessions_t2_schema}.dior_session_fact_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
