SET QUERY_BAND = 'App_ID=APP07324;
     ...
     Task_Name=dior_session_fact_daily_insert;'
     FOR SESSION VOLATILE;


DELETE FROM  {sessions_t2_schema}.TPT_CONTROL_TBL 
where job_name = 'dior_session_fact_daily_ldg'  -- matches job name from tpt_load_ldg stage on .json file
;
...
VALUES (
	'dior_session_fact_daily_ldg',  -- matches job name from tpt_load_ldg stage on .json file
	'{sessions_t2_schema}',
	'dior_session_fact_daily_ldg',  -- landing table name
	'T',
	 '*', 
	'Y',
	'1',
