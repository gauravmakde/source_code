...
delete 
from    {sessions_t2_schema}.dior_session_fact_daily
where   activity_date_pacific between {start_date} and {end_date}
;

insert into {sessions_t2_schema}.dior_session_fact_daily
select distinct  
    ...
    , sus_bot_flag
    , bot_demand_flag
from    {sessions_t2_schema}.dior_session_fact_daily_ldg
where   activity_date_pacific between {start_date} and {end_date}
;
...
on {sessions_t2_schema}.dior_session_fact_daily
;
