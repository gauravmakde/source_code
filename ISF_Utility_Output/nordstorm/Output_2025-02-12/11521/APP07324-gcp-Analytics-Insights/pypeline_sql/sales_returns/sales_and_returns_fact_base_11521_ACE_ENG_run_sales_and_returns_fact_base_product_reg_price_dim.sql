...
delete from T2DL_DAS_SALES_RETURNS.product_reg_price_dim;


insert into T2DL_DAS_SALES_RETURNS.product_reg_price_dim  --t2dl_das_sales_returns.product_reg_price_dim
select
prc_beg.rms_sku_num,
