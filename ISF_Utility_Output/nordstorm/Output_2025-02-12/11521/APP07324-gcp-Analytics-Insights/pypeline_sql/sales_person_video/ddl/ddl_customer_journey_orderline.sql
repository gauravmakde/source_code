SET QUERY_BAND = 'App_ID=APP07324;
     ...
     Task_Name=ddl_customer_journey_orderline;'
...
*/
CALL SYS_MGMT.DROP_IF_EXISTS_SP('{spv_t2_schema}', 'customer_journey_orderline', OUT_RETURN_MSG);

create multiset table {spv_t2_schema}.customer_journey_orderline
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
    ...
    , click_spv_time_start                  TIMESTAMP(0) WITH TIME ZONE
    , click_spv_time_end                    TIMESTAMP(0) WITH TIME ZONE
    ...
    , add_or_remove_time                    TIMESTAMP(0) WITH TIME ZONE
