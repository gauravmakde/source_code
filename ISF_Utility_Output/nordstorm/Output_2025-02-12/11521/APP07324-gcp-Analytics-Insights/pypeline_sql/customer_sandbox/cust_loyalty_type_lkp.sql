SET QUERY_BAND = 'App_ID=APP08737;
     DAG_ID=cust_loyalty_type_lkp_11521_ACE_ENG;
     Task_Name=cust_loyalty_type_lkp;'
...
Notes:
-- Loyalty Type Look-up table for microstrategy customer sandbox
*/
...
INSERT INTO {str_t2_schema}.cust_loyalty_type_lkp
    ...
    FROM
         (SELECT DISTINCT COALESCE(cust_loyalty_type, 'Unknown') as cust_loyalty_type_desc  
