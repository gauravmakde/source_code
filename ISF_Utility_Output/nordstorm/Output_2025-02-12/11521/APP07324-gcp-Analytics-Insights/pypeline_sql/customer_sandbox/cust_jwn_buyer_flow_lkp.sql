...
DELETE
FROM {str_t2_schema}.cust_jwn_buyer_flow_lkp
;

INSERT INTO {str_t2_schema}.cust_jwn_buyer_flow_lkp
...
COLLECT STATISTICS COLUMN (cust_jwn_buyer_flow_num),
                   COLUMN (cust_jwn_buyer_flow_desc)
ON {str_t2_schema}.cust_jwn_buyer_flow_lkp ;
