SET QUERY_BAND = 'App_ID=APP08737;
     DAG_ID=customer_store_distance_buckets_11521_ACE_ENG;
     Task_Name=customer_store_distance_buckets;'
...
Notes:
-- Customer Store Distance Fact table to support store distance look ups for sandbox
*/
/************************************************************************************
...
--drop table store_latlong_driver;
...
select a.zip_code
    ...
    ,zip_location.ST_SPHERICALDISTANCE(store_location)*0.62137/1000 As zip_store_distance
...
select a.acp_id
    ...
    ,custlocation.ST_SPHERICALDISTANCE(nord_store_loc)*0.62137/1000 As nord_sol_distance
    ...
    ,custlocation.ST_SPHERICALDISTANCE(rack_store_loc)*0.62137/1000 As rack_sol_distance
