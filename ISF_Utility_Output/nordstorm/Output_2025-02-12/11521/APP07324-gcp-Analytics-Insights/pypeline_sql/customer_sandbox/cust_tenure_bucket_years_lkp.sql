SET QUERY_BAND = 'App_ID=APP08737;
     DAG_ID=cust_tenure_bucket_years_lkp_11521_ACE_ENG;
     Task_Name=cust_tenure_bucket_years_lkp;'
...
Notes:
-- Customer Tenure Look-up table for microstrategy customer sandbox
*/
...
INSERT INTO {str_t2_schema}.cust_tenure_bucket_years_lkp
    ...
    FROM
         (SELECT DISTINCT COALESCE(cust_tenure_bucket_years, 'Unknown') as cust_tenure_bucket_years_desc  
