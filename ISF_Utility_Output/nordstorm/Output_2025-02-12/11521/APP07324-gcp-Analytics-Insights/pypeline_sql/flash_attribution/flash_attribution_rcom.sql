...
--DROP TABLE IF EXISTS {hive_schema}.flashoverviewtable_sessionlogic_customergrouping;
create table if not exists {hive_schema}.flashoverviewtable_sessionlogic_customergrouping (
...
) using parquet location 's3://{s3_bucket_root_var}/flash_attribution_test/flashoverviewtable_sessionlogic_customergrouping' partitioned by (activity_date_partition);


--DROP TABLE IF EXISTS {hive_schema}.flashoverviewtable_sessionlogic_merchgrouping;
create table if not exists {hive_schema}.flashoverviewtable_sessionlogic_merchgrouping (
flash_session_flag int
, digitalcontents_id string
, brand_name string
, div_desc string
...
, direct_order_demand decimal(36, 6)
, activity_date_partition date
) using parquet location 's3://{s3_bucket_root_var}/flash_attribution_test/flashoverviewtable_sessionlogic_merchgrouping' partitioned by (activity_date_partition);

--DROP TABLE IF EXISTS {hive_schema}.flashoverviewtable_eventlogic_merchgrouping;
create table if not exists {hive_schema}.flashoverviewtable_eventlogic_merchgrouping (
flash_session_flag int
, digitalcontents_id string
, brand_name string
, div_desc string
...
, direct_order_demand decimal(36, 6)
, activity_date_partition date
) using parquet location 's3://{s3_bucket_root_var}/flash_attribution_test/flashoverviewtable_eventlogic_merchgrouping' partitioned by (activity_date_partition);


--DROP TABLE IF EXISTS {hive_schema}.flashoverviewtable_eventlogic_customergrouping;
create table if not exists {hive_schema}.flashoverviewtable_eventlogic_customergrouping (
flash_session_flag int
, digitalcontents_id string
, engagement_cohort string
, loyalty_status string
...
, direct_order_demand decimal(36, 6)
, activity_date_partition date
) using parquet location 's3://{s3_bucket_root_var}/flash_attribution_test/flashoverviewtable_eventlogic_customergrouping' partitioned by (activity_date_partition);
...
from acp_event_intermediate.session_evt_expanded_attributes_parquet seeap 
	...
	and seeap.activity_date_partition between {start_date} and {end_date}
);
...
and bsa.activity_date_partition between {start_date} and {end_date}
...
where spdfa.activity_date_partition between {start_date} + 12 and {end_date}
);
...
where pobs.activity_date_partition between {start_date} + 12 and {end_date}
group by 1,2,3,4,5
); 
...
where testing.activity_date_partition between {start_date} + 12 and {end_date}
...
insert OVERWRITE TABLE {hive_schema}.flashoverviewtable_sessionlogic_customergrouping PARTITION (activity_date_partition) 
select *
from step9_flashoverviewtable_sessionlogic_customergrouping
;

insert OVERWRITE TABLE {hive_schema}.flashoverviewtable_sessionlogic_merchgrouping PARTITION (activity_date_partition) 
select *
from step9_flashoverviewtable_sessionlogic_merchgrouping
;


MSCK REPAIR table {hive_schema}.flashoverviewtable_sessionlogic_customergrouping
;

MSCK REPAIR table {hive_schema}.flashoverviewtable_sessionlogic_merchgrouping
;
...
where alsl.activity_date_partition between  {start_date} + 12 and {end_date}
), already_done_attribution as (
select 
session_cust_id
, activity_date_partition
...
insert OVERWRITE TABLE {hive_schema}.flashoverviewtable_eventlogic_customergrouping PARTITION (activity_date_partition) 
select *
from step9_flashoverviewtable_eventlogic_customergrouping
;

insert OVERWRITE TABLE {hive_schema}.flashoverviewtable_eventlogic_merchgrouping PARTITION (activity_date_partition) 
select *
from step9_flashoverviewtable_eventlogic_merchgrouping
;


MSCK REPAIR table {hive_schema}.flashoverviewtable_eventlogic_customergrouping
;

MSCK REPAIR table {hive_schema}.flashoverviewtable_eventlogic_merchgrouping
;