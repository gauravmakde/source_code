...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_bie_dev', 'nmn_brand_ldg', OUT_RETURN_MSG);

create multiset table {kpi_scorecard_t2_schema}.nmn_brand_ldg
    , fallback
    , no before journal
    , no after journal
    , checksum = default
