 ...
 * Distance to Rack store-of-loyalty
 * ***/
delete from T2DL_DAS_STRATEGY.customer_store_distance_buckets;

insert into T2DL_DAS_STRATEGY.customer_store_distance_buckets
select a.acp_id
     , a.billing_postal_code
     , a.closest_store
...
COLLECT STATISTICS COLUMN (acp_id) ON T2DL_DAS_STRATEGY.customer_store_distance_buckets;
COLLECT STATISTICS COLUMN (closest_store_dist_bucket) ON T2DL_DAS_STRATEGY.customer_store_distance_buckets;
COLLECT STATISTICS COLUMN (nord_sol_dist_bucket) ON T2DL_DAS_STRATEGY.customer_store_distance_buckets;
COLLECT STATISTICS COLUMN (rack_sol_dist_bucket) ON T2DL_DAS_STRATEGY.customer_store_distance_buckets;
