...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{recommendations_t2_schema}', 'recs_funnel_daily_ldg', OUT_RETURN_MSG);

create multiset table {recommendations_t2_schema}.recs_funnel_daily_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
