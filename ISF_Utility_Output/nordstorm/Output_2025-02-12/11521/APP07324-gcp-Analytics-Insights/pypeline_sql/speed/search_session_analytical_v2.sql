...
create table if not exists {hive_schema}.search_session_analytical_v2
...
using PARQUET
location 's3://{s3_bucket_root_var}/search_session_analytical_v2/'
partitioned by (activity_date_partition);


MSCK REPAIR table {hive_schema}.search_session_analytical_v2;
...
insert
    OVERWRITE TABLE {hive_schema}.search_session_analytical_v2 PARTITION (activity_date_partition)
select
/*+ REPARTITION(100) */
*
