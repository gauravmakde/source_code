...
create table if not exists {hive_schema}.session_product_discovery_funnel_intermediate (
    channel string, 
    experience string, 
...
using ORC
location 's3://{s3_bucket_root_var}/session_product_discovery_funnel_intermediate' 
...
insert OVERWRITE TABLE {hive_schema}.session_product_discovery_funnel_intermediate PARTITION (activity_date_partition) 
select *
from final_view;

MSCK REPAIR table {hive_schema}.session_product_discovery_funnel_intermediate;  