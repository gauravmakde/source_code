...
create table if not exists {hive_schema}.perso_engine_atbwl_v2(
...
using PARQUET
location 's3://{perso_s3_bucket_root_var}/perso_engine_atbwl_v2'
...
insert OVERWRITE TABLE {hive_schema}.perso_engine_atbwl_v2 PARTITION (interaction_date)
select * from output;
