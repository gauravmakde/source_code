...
CREATE MULTISET TABLE {real_estate_t2_schema}.re_store_trade_area_attributes
     ,FALLBACK
     ,NO BEFORE JOURNAL
     ,NO AFTER JOURNAL
     ,CHECKSUM = DEFAULT
...
-- Table Comment
COMMENT ON  {real_estate_t2_schema}.re_store_trade_area_attributes IS 'Store level demographic attributes';
