SET QUERY_BAND = 'App_ID=APP07324;
     ...
     Task_Name=ddl_re_zip_code_demographic_attributes_ldg;'
...
Modified: 2023-05-09
Note:
- This landing table is created as part of the re_zip_code_demographic_attributes job that loads
data from S3 to teradata. The landing table is dropped when the job completes.

*/

CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{real_estate_t2_schema}', 're_zip_code_demographic_attributes_ldg', OUT_RETURN_MSG);

CREATE MULTISET TABLE {real_estate_t2_schema}.re_zip_code_demographic_attributes_ldg
	 ,FALLBACK
     ,NO BEFORE JOURNAL
     ,NO AFTER JOURNAL
     ,CHECKSUM = DEFAULT
