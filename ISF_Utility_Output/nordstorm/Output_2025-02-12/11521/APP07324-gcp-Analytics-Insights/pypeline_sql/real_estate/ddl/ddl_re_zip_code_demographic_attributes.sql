SET QUERY_BAND = 'App_ID=APP07324;
     DAG_ID=ddl_re_zip_code_demographic_attributes_11521_ACE_ENG;
     Task_Name=ddl_re_zip_code_demographic_attributes;'
     FOR SESSION VOLATILE;

/*

Table: T2DL_DAS_REAL_ESTATE.re_zip_code_demographic_attributes
Owner: Rujira Achawanantakun
Modified: 2023-05-09
Note:
- This ddl is used to create re_zip_code_demographic_attributes table structure into tier 2 datalab.

*/

CREATE MULTISET TABLE {real_estate_t2_schema}.re_zip_code_demographic_attributes
	 ,FALLBACK
     ,NO BEFORE JOURNAL
     ,NO AFTER JOURNAL
     ,CHECKSUM = DEFAULT
...
PRIMARY INDEX(zip_code, data_year)
;

-- Table Comment
COMMENT ON  {real_estate_t2_schema}.re_zip_code_demographic_attributes IS 'Demographic attributes by zip code';
