...
CREATE MULTISET TABLE T2DL_DAS_REAL_ESTATE.re_zip_code_demographic_attributes
	 ,FALLBACK
     ,NO BEFORE JOURNAL
     ,NO AFTER JOURNAL
     ,CHECKSUM = DEFAULT
...
-- Table Comment
COMMENT ON  T2DL_DAS_REAL_ESTATE.re_zip_code_demographic_attributes IS 'Demographic attributes by zip code';
