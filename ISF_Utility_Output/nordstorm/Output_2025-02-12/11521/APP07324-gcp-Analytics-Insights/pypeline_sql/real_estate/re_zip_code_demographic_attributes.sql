SET QUERY_BAND = 'App_ID=APP07324;
     ...
     Task_Name=re_zip_code_demographic_attributes;'
...
update {real_estate_t2_schema}.re_zip_code_demographic_attributes_ldg
set zip_code = LPAD(TRIM(zip_code), 5, '0')
where REGEXP_SIMILAR(TRIM(zip_code), '[0-9]+') = 1;

-- delete data from a landing table
delete
from {real_estate_t2_schema}.re_zip_code_demographic_attributes
;

-- insert data from a staging table to a landing table
insert into {real_estate_t2_schema}.re_zip_code_demographic_attributes
    select
    zip_code
    ,data_year
	...
	from {real_estate_t2_schema}.re_zip_code_demographic_attributes_ldg
;

-- drop staging table
drop table {real_estate_t2_schema}.re_zip_code_demographic_attributes_ldg;
