SET QUERY_BAND = 'App_ID=APP07324;
     ...
     Task_Name=re_store_trade_area_attributes_load;'
...
Modified: 2023-05-05
Note:
- This sql is used to read re_store_trade_area_attributes_ldg data from S3 and load it into
the staging table in tie 2 datalab.

*/

-- load data from s3 to a temp table
create or replace temporary view re_store_trade_area_attributes_ldg_csv USING CSV
OPTIONS (
    path "s3://analytics-insights-triggers/real_estate/RE_Store_Trade_Area_Attributes_latest.csv",
    sep ",",
    header "true"
)
;
...
insert into table re_store_trade_area_attributes_ldg_temp
    select
        store_number
        ,data_year
        ,ta_avg_drivedistance
        ,ta_avg_drivetime
        ...
        ,total_hotels
	from re_store_trade_area_attributes_ldg_csv
;