SET QUERY_BAND = 'App_ID=APP07324;
     ...
     Task_Name=re_store_trade_area_attributes;'
...
delete
from {real_estate_t2_schema}.re_store_trade_area_attributes
;

-- insert data from a staging table to a landing table
insert into {real_estate_t2_schema}.re_store_trade_area_attributes
    select
    store_number
	,data_year
	...
	from {real_estate_t2_schema}.re_store_trade_area_attributes_ldg
;
-- drop staging table
drop table {real_estate_t2_schema}.re_store_trade_area_attributes_ldg;
