...
AND order_date_pacific between {start_date}-180 and {end_date}
...
DELETE FROM {clarity_schema}.finance_sales_census_fact WHERE business_day_date BETWEEN {start_date} AND {end_date};

INSERT INTO {clarity_schema}.finance_sales_census_fact
(
    business_day_date
    ,business_unit_desc
    ,store_num
