...
DAG_ID=ddl_cco_customer_level_attributes_fy_daily_11521_ACE_ENG;
Task_Name=run_teradata_ddl_cco_customer_level_attributes_fy;'
FOR SESSION VOLATILE;

--drop table {cco_t2_schema}.cco_customer_level_attributes_fy;

CREATE MULTISET TABLE {cco_t2_schema}.cco_customer_level_attributes_fy ,FALLBACK ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
