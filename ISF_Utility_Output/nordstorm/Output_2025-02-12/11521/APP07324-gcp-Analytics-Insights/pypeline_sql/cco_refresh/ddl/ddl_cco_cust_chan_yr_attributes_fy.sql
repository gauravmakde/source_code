...
DAG_ID=ddl_cco_cust_chan_yr_attributes_fy_daily_11521_ACE_ENG;
Task_Name=run_teradata_ddl_cco_cust_chan_yr_attributes_fy;'
FOR SESSION VOLATILE;


DROP TABLE {cco_t2_schema}.cco_cust_chan_yr_attributes_fy;

CREATE MULTISET TABLE {cco_t2_schema}.cco_cust_chan_yr_attributes_fy ,FALLBACK ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
