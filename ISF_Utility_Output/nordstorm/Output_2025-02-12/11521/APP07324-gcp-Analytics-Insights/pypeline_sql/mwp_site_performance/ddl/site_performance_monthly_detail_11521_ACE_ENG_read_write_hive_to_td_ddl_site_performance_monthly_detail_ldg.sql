SET QUERY_BAND = 'App_ID=APP08715;
     ...
     Task_Name=ddl_site_performance_monthly_detail_ldg;'
     FOR SESSION VOLATILE;

/*

T2/Table Name: T2DL_DAS_DIGENG.site_performance_monthly_detail_ldg
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('T2DL_DAS_DIGENG', 'site_performance_monthly_detail_ldg', OUT_RETURN_MSG);

CREATE MULTISET TABLE T2DL_DAS_DIGENG.site_performance_monthly_detail_ldg
	 ,FALLBACK
     ,NO BEFORE JOURNAL
     ,NO AFTER JOURNAL
     ,CHECKSUM = DEFAULT
