...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{mwp_t2_schema}', 'site_performance_monthly_detail_ldg', OUT_RETURN_MSG);

CREATE MULTISET TABLE {mwp_t2_schema}.site_performance_monthly_detail_ldg
	 ,FALLBACK
     ,NO BEFORE JOURNAL
     ,NO AFTER JOURNAL
     ,CHECKSUM = DEFAULT
