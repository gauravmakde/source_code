...
T2/Table Name: T2DL_DAS_DIGENG.speed_session_active_user_ldg
...
SET QUERY_BAND = 'App_ID=APP08742;
     ...
     Task_Name=usl_digital_funnel_ldg;' --- DAG_ID & Task_Name needs updating
     FOR SESSION VOLATILE;


CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{usl_t2_schema}', 'usl_digital_funnel_ldg', OUT_RETURN_MSG);

create multiset table {usl_t2_schema}.usl_digital_funnel_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
