...
SET QUERY_BAND = 'App_ID=app08818;
     DAG_ID=sales_fact_financial_vw_11521_ACE_ENG;
     Task_Name=sales_fact_financial_vw;'
     FOR SESSION VOLATILE;


/*
T2/Table Name: T2DL_DAS_USL.sales_fact_financial_vw
...
REPLACE VIEW T2DL_DAS_USL.sales_fact_financial_vw
AS
LOCK ROW FOR ACCESS
