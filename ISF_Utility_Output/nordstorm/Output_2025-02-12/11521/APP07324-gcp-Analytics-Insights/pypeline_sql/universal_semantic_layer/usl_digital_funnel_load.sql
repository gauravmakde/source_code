...
create table if not exists {hive_schema}.usl_digital_funnel
(
 channel  varchar(32)
...
location 's3://{s3_bucket_root_var}/usl_digital_funnel/'
...
where f.activity_date_partition BETWEEN {start_date} and {end_date}
...
insert overwrite table {hive_schema}.usl_digital_funnel partition (activity_date_partition)
...
msck repair table {hive_schema}.usl_digital_funnel;
...
,dw_sys_load_tmstp
,activity_date_partition 
from {hive_schema}.usl_digital_funnel
