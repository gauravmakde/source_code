...
/********* Step I-B-i: Start & End dates *********/

--drop table date_lookup;
create multiset volatile table date_lookup as (
select 
   date'{buyer_fy_start_date1}' yr0_start_dt  --2018-02-04
  ,date'{buyer_fy_end_date1}' yr0_end_dt --2019-02-02
  ,date'{buyer_fy_start_date2}' yr1_start_dt --2019-02-03
  ,date'{buyer_fy_end_date2}' yrN_end_dt --2023-04-29
--from realigned_calendar
) with data primary index(yr1_start_dt) on commit preserve rows;

/********* Step I-B-ii: Generate names for the earliest rolling-12-mo period *********/
...
on  
{cco_t2_schema}.cco_buyer_flow_fy;
