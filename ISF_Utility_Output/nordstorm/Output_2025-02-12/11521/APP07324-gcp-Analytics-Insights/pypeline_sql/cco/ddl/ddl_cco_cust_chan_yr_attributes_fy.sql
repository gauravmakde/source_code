SET QUERY_BAND = 'App_ID=APP08240;
     DAG_ID=ddl_cco_cust_chan_yr_attributes_fy_11521_ACE_ENG;
     Task_Name=ddl_cco_cust_chan_yr_attributes_fy;'
...
This file creates the production table T2DL_DAS_STRATEGY.cco_cust_chan_yr_attributes_fy
*/

--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_bie_dev', 'cco_cust_chan_yr_attributes_fy', OUT_RETURN_MSG);

create MULTISET table {cco_t2_schema}.cco_cust_chan_yr_attributes_fy,--NO FALLBACK ,
     CHECKSUM = DEFAULT,
