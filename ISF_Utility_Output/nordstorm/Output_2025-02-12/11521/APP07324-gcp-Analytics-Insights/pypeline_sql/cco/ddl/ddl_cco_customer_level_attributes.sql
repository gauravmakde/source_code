SET QUERY_BAND = 'App_ID=APP08240;
     DAG_ID=ddl_cco_customer_level_attributes_11521_ACE_ENG;
     Task_Name=ddl_cco_customer_level_attributes;'
...
This file creates the production table T2DL_DAS_STRATEGY.cco_customer_level_attributes
*/

--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_bie_dev', 'cco_customer_level_attributes', OUT_RETURN_MSG);

create MULTISET table {cco_t2_schema}.cco_customer_level_attributes,--NO FALLBACK ,
     CHECKSUM = DEFAULT,
