SET QUERY_BAND = 'App_ID=APP09117;
     DAG_ID="ddl_location_inventory_tracking_fls_11521_ACE_ENG";
     Task_Name=ddl_location_inventory_tracking_fls;'
...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_bie_dev', 'location_inventory_tracking_fls', OUT_RETURN_MSG);



CREATE TABLE {location_inventory_tracking_t2_schema}.location_inventory_tracking_fls (
...
COMMENT ON  {location_inventory_tracking_t2_schema}.location_inventory_tracking_fls IS 'Location-Dept-Class-Month aggregation at past, current and + 5 months to aid location allocators in daily process. Also provide Inventory Positioning leadership visibility via Inventory Health dashboard. Specific to FLS';
