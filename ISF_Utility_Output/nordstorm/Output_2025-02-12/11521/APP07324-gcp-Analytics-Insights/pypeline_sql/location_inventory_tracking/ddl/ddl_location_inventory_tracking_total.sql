SET QUERY_BAND = 'App_ID=APP09117;
     DAG_ID="ddl_location_inventory_tracking_total_11521_ACE_ENG";
     Task_Name=ddl_location_inventory_tracking_total;'
...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_bie_dev', 'location_inventory_tracking_total', OUT_RETURN_MSG);



CREATE TABLE {location_inventory_tracking_t2_schema}.location_inventory_tracking_total (
...
--,total_jwn_demand_store_fulfilled_units_ty int
,total_jwn_returns_total_units_ty int
,total_jwn_demand_regular_units_ty int
,total_jwn_operational_gmv_regular_units_ty int
...
--,rp_jwn_demand_store_fulfilled_units_ty int
...
--,nrp_jwn_demand_store_fulfilled_units_ty int
...
,total_jwn_demand_regular_units_ly int
,total_jwn_operational_gmv_regular_units_ly int
...
,sff_sales_forecast_u decimal (12,2)
...
COMMENT ON  {location_inventory_tracking_t2_schema}.location_inventory_tracking_total IS 'Location-Dept-Class-Month aggregation at past, current and + 5 months to aid location allocators in daily process. Also provide Inventory Positioning leadership visibility via Inventory Health dashboard.';
