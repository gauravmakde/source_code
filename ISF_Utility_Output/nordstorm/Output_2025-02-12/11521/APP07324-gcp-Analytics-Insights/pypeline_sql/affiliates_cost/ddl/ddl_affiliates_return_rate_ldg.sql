SET QUERY_BAND = 'App_ID=APP08823;
     ...
     Task_Name=ddl_affiliates_return_rate_ldg;'
     FOR SESSION VOLATILE;

/*

T2/Table Name: T2DL_DAS_FUNNEL_IO.affiliates_return_rate_ldg
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{funnel_io_t2_schema}', 'affiliates_return_rate_ldg', OUT_RETURN_MSG);

CREATE MULTISET TABLE {funnel_io_t2_schema}.affiliates_return_rate_ldg
    , FALLBACK
    , NO BEFORE JOURNAL
    , NO AFTER JOURNAL
    , CHECKSUM = DEFAULT
