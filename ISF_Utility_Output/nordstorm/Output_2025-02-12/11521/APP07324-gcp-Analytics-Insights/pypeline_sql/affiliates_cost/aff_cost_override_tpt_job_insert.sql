SET QUERY_BAND = 'App_ID=APP08823;
     ...
     Task_Name=aff_cost_override_tpt_job_insert;'
     FOR SESSION VOLATILE;

DELETE FROM  {funnel_io_t2_schema}.TPT_CONTROL_TBL where job_name = 'tpt_affiliates_cost_override_ldg';
...
VALUES (
	'tpt_affiliates_cost_override_ldg',
	'{funnel_io_t2_schema}',
	'affiliates_cost_override_ldg',
	'T',
	 '*', 
	'Y',
	'1',
