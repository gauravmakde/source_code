...
DELETE FROM  {mta_t2_schema}.TPT_CONTROL_TBL where job_name = 'mta_mta_last_touch_ldg';

INSERT INTO {mta_t2_schema}.TPT_CONTROL_TBL (
  job_name,
  database_name,
  object_name,
  object_type,
...
DELETE FROM  {mta_t2_schema}.TPT_CONTROL_TBL where job_name = 'mta_mta_acp_scoring_fact_ldg';
