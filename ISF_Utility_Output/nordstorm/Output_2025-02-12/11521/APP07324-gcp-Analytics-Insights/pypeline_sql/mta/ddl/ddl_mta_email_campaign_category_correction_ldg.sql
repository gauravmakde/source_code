...
SET QUERY_BAND = 'App_ID=APP08300;
     ...
     Task_Name=mta_email_campaign_category_correction_ldg;'
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{mta_t2_schema}', 'mta_email_campaign_category_correction_ldg', OUT_RETURN_MSG);

create multiset table {mta_t2_schema}.mta_email_campaign_category_correction_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
