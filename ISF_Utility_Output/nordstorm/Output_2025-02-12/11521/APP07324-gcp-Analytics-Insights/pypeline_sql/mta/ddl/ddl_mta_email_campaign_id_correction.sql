...
SET QUERY_BAND = 'App_ID=APP08300;
     DAG_ID=ddl_mta_email_campaign_id_correction_11521_ACE_ENG;
     Task_Name=ddl_mta_email_campaign_id_correction;'
...
create multiset table {mta_t2_schema}.mta_email_campaign_id_correction
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  {mta_t2_schema}.mta_email_campaign_id_correction IS 'Email Campaign category corrections from the business';
