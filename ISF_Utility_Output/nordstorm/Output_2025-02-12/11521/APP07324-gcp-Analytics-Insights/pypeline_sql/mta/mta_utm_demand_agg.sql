...
COLLECT SUMMARY STATISTICS {mta_t2_schema}.MTA_ACP_SCORING_FACT;
...
WHERE   a.order_date_pacific BETWEEN {start_date} and {end_date}
) with data
...
DELETE FROM {mta_t2_schema}.mta_utm_demand_agg
WHERE   order_date_pacific BETWEEN {start_date} AND {end_date}
;

INSERT INTO {mta_t2_schema}.mta_utm_demand_agg
   SELECT
...
on {mta_t2_schema}.mta_utm_demand_agg
;
