...
T2/Table Name: T2DL_DAS_TECHEX.teradata_big_drop_list
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{techex_t2_schema}', 'teradata_big_drop_list', OUT_RETURN_MSG);

create multiset table {techex_t2_schema}.teradata_big_drop_list
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  {techex_t2_schema}.teradata_big_drop_list IS 'NAP Migration Big Drop List';
