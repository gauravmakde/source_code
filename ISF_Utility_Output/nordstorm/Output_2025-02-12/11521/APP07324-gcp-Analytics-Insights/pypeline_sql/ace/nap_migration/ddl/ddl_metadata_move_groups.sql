...
T2/Table Name: T2DL_DAS_TECHEX.metadata_move_groups
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{techex_t2_schema}', 'metadata_move_groups', OUT_RETURN_MSG);

create multiset table {techex_t2_schema}.metadata_move_groups
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  {techex_t2_schema}.metadata_move_groups IS 'NAP Migration move groups';
