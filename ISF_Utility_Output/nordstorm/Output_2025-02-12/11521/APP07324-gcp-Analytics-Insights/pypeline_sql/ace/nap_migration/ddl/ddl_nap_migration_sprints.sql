...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{techex_t2_schema}', 'nap_migration_sprints', OUT_RETURN_MSG);

create multiset table {techex_t2_schema}.nap_migration_sprints
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  {techex_t2_schema}.nap_migration_sprints IS 'NAP migration sprints';
