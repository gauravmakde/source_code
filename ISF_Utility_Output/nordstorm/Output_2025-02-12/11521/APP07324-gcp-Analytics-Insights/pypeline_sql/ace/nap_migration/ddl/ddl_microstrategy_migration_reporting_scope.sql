...
T2/Table Name: T2DL_DAS_TECHEX.microstrategy_migration_reporting_scope
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{techex_t2_schema}', 'microstrategy_migration_reporting_scope', OUT_RETURN_MSG);

create multiset table {techex_t2_schema}.microstrategy_migration_reporting_scope
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  {techex_t2_schema}.microstrategy_migration_reporting_scope IS 'Direct reporting objects for tableau dashboards';
