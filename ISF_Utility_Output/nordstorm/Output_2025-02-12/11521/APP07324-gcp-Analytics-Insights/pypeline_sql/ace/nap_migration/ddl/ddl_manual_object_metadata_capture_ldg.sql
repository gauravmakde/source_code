...
DAG_ID=ddl_nap_migration_manual_object_metadata_capture_11521_ACE_ENG;
     Task_Name=manual_object_metadata_capture_ldg;'
     FOR SESSION VOLATILE;

/*

T2/Table Name: T2DL_DAS_TECHEX.manual_object_metadata_capture_ldg
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{techex_t2_schema}', 'manual_object_metadata_capture_ldg', OUT_RETURN_MSG);

create multiset table {techex_t2_schema}.manual_object_metadata_capture_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  {techex_t2_schema}.manual_object_metadata_capture_ldg IS 'Object metadata captured by product teams';
