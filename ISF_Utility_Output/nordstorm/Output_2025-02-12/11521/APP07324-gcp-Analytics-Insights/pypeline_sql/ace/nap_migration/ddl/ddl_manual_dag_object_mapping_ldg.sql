...
SET QUERY_BAND = 'App_ID=APP08905;
     ...
     Task_Name=manual_dag_object_mapping_ldg;'
     FOR SESSION VOLATILE;

/*

T2/Table Name: T2DL_DAS_TECHEX.manual_dag_object_mapping_ldg
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{techex_t2_schema}', 'manual_dag_object_mapping_ldg', OUT_RETURN_MSG);

create multiset table {techex_t2_schema}.manual_dag_object_mapping_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  {techex_t2_schema}.manual_dag_object_mapping_ldg IS 'Source and Target objects by Dag_ID';
