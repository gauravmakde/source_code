...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{techex_t2_schema}', 'nap_migration_move_groups_ldg', OUT_RETURN_MSG);

create multiset table {techex_t2_schema}.nap_migration_move_groups_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
