SET QUERY_BAND = 'App_ID=APP07324;
     ...
     Task_Name=t2dl_das_trust_emp;'
     FOR SESSION VOLATILE;

CALL SYS_MGMT.create_if_not_exists('{tru_t2_schema}', 'tpt_control_tbl',
'CREATE MULTISET TABLE {tru_t2_schema}.TPT_CONTROL_TBL ,FALLBACK ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
     ...
     (
      ...
      DAG_ID VARCHAR(250) CHARACTER SET UNICODE NOT CASESPECIFIC,
      TASK_NAME VARCHAR(250) CHARACTER SET UNICODE NOT CASESPECIFIC)
UNIQUE PRIMARY INDEX ( job_name )', 
OUT_RETURN_MSG);

CALL SYS_MGMT.create_if_not_exists('{tru_t2_schema}', 'TPT_JOB_LOG', 
'CREATE MULTISET TABLE {tru_t2_schema}.TPT_JOB_LOG ,FALLBACK ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
     DEFAULT MERGEBLOCKRATIO,
