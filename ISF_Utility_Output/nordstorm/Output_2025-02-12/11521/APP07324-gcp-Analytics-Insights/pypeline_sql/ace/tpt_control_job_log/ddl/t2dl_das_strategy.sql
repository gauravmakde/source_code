SET QUERY_BAND = 'App_ID=APP07324;
     ...
     Task_Name=t2dl_das_strategy;'
     FOR SESSION VOLATILE;

CALL SYS_MGMT.create_if_not_exists('{str_t2_schema}', 'tpt_control_tbl', 
'CREATE MULTISET TABLE {str_t2_schema}.TPT_CONTROL_TBL ,FALLBACK ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
...
CALL SYS_MGMT.create_if_not_exists('{str_t2_schema}', 'TPT_JOB_LOG', 
'CREATE MULTISET TABLE {str_t2_schema}.TPT_JOB_LOG ,FALLBACK ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
     DEFAULT MERGEBLOCKRATIO,
