SET QUERY_BAND = 'App_ID=APP08905;
     ...
     Task_Name=ddl_techex_pd_incidents;'
     FOR SESSION VOLATILE;


create multiset table {techex_t2_schema}.techex_pd_incidents
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  {techex_t2_schema}.techex_pd_incidents IS 'Contains PagerDuty incidents.';
