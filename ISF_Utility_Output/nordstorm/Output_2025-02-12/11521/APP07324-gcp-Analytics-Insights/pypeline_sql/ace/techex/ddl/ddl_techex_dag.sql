SET QUERY_BAND = 'App_ID=APP08905;
     DAG_ID=ddl_techex_dag_11521_ACE_ENG;
     Task_Name=ddl_techex_dag;'
     FOR SESSION VOLATILE;

create multiset table {techex_t2_schema}.techex_dag
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  {techex_t2_schema}.techex_dag IS 'Contains all DAG ID information for Production Airflow DAGs';
