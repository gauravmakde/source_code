SET QUERY_BAND = 'App_ID=APP08905;
     ...
     Task_Name=ddl_techex_appid_nerds_info;' 
	 FOR SESSION VOLATILE;


create multiset table {techex_t2_schema}.techex_appid_nerds_info,
fallback,
no before journal,
no
after
...
COMMENT ON  {techex_t2_schema}.techex_appid_nerds_info IS 'Contains NERDS information for AppID.';
