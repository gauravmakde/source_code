...
REPLACE VIEW T2DL_DAS_REMOTE_SELLING.NORDSTROM_ON_FUNNEL_VW
AS
LOCK ROW FOR ACCESS
...
FROM T2DL_DAS_REMOTE_SELLING.NORDSTROM_ON_DIGITAL_DAILY dig
...
FROM T2DL_DAS_REMOTE_SELLING.remote_sell_transactions sls
...
FROM T2DL_DAS_REMOTE_SELLING.remote_sell_transactions rtn
...
GRANT SELECT ON T2DL_DAS_REMOTE_SELLING.NORDSTROM_ON_FUNNEL_VW TO PUBLIC;
