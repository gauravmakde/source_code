SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=nmn_rack_tiktok_data;'
     FOR SESSION VOLATILE;


/*
Table: T2DL_DAS_FUNNEL_IO.rack_tiktok_data
...
AND     file_name = 'nmn_rack_tiktok'
;

INSERT INTO {nmn_t2_schema}.rack_nmn_cost_data
SELECT DISTINCT
    stats_date
    ,'nmn_rack_tiktok' AS file_name
    , sourcetype
    , currency
    , sourcename
    , media_type
...
FROM  {nmn_t2_schema}.nmn_rack_tiktok_data_ldg
