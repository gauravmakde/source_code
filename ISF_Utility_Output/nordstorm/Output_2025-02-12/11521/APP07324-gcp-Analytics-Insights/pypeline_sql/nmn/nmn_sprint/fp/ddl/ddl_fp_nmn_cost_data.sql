SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=ddl_fp_nmn_cost_data;'
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{nmn_t2_schema}', 'fp_nmn_cost_data', OUT_RETURN_MSG);


create multiset table {nmn_t2_schema}.fp_nmn_cost_data
    , fallback
    , no before journal
    , no after journal
    , checksum = default
...
COMMENT ON  {nmn_t2_schema}.fp_nmn_cost_data IS 'NMN Data loads for FP';
