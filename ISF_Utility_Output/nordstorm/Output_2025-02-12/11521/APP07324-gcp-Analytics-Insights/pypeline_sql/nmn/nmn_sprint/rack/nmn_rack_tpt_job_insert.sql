...
DELETE FROM  {nmn_t2_schema}.TPT_CONTROL_TBL where job_name = 'nmn_rack_nmn_rack_criteo_data_ldg';
...
VALUES (
 ...
 DELETE FROM  {nmn_t2_schema}.TPT_CONTROL_TBL where job_name = 'nmn_rack_nmn_rack_dv_three_sixty_data_ldg';
...
DELETE FROM  {nmn_t2_schema}.TPT_CONTROL_TBL where job_name = 'nmn_rack_nmn_rack_meta_data_ldg';
...
DELETE FROM  {nmn_t2_schema}.TPT_CONTROL_TBL where job_name = 'nmn_rack_nmn_rack_tiktok_data_ldg';
...
VALUES (
 ...
 DELETE FROM  {nmn_t2_schema}.TPT_CONTROL_TBL where job_name = 'nmn_rack_nmn_rack_pinterest_data_ldg';
