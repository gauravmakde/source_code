SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=ddl_nmn_fp_meta_data_ldg;'
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{nmn_t2_schema}', 'nmn_fp_meta_data_ldg', OUT_RETURN_MSG);

create multiset table {nmn_t2_schema}.nmn_fp_meta_data_ldg
    , fallback
    , no before journal
    , no after journal
    , checksum = default
