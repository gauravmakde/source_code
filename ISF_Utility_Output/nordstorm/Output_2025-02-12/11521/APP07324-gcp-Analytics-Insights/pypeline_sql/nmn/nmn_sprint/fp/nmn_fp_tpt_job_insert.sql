...
DELETE FROM  {nmn_t2_schema}.TPT_CONTROL_TBL where job_name = 'nmn_fp_nmn_fp_google_ads_data_ldg';
...
DELETE FROM  {nmn_t2_schema}.TPT_CONTROL_TBL where job_name = 'nmn_fp_nmn_fp_criteo_data_ldg';
...
VALUES (
 ...
 DELETE FROM  {nmn_t2_schema}.TPT_CONTROL_TBL where job_name = 'nmn_fp_nmn_fp_dv_three_sixty_data_ldg';
...
DELETE FROM  {nmn_t2_schema}.TPT_CONTROL_TBL where job_name = 'nmn_fp_nmn_fp_meta_data_ldg';
...
DELETE FROM  {nmn_t2_schema}.TPT_CONTROL_TBL where job_name = 'nmn_fp_nmn_fp_tiktok_data_ldg';
...
VALUES (
 ...
 DELETE FROM  {nmn_t2_schema}.TPT_CONTROL_TBL where job_name = 'nmn_fp_nmn_fp_pinterest_data_ldg';
