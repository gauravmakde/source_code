SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=ddl_nmn_rack_nmn_cost_data;'
     FOR SESSION VOLATILE;
/*

T2/Table Name: T2DL_DAS_FUNNEL_IO.fp_funnel_cost_fact
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{nmn_t2_schema}', 'rack_nmn_cost_data', OUT_RETURN_MSG);

create multiset table {nmn_t2_schema}.rack_nmn_cost_data
    , fallback
    , no before journal
    , no after journal
    , checksum = default
    ...
    , MAP = TD_MAP1
     (
      ...
      currency CHAR(30) CHARACTER SET UNICODE NOT CASESPECIFIC COMPRESS ('USD', 'CAD'),
...
COMMENT ON  {nmn_t2_schema}.rack_nmn_cost_data IS 'NMN Data loads for Rack';
