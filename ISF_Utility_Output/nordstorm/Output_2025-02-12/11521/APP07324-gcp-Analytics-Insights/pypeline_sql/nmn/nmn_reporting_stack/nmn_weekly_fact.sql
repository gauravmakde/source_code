...
FROM {nmn_t2_schema}.CAMPAIGN_ATTRIBUTED_SALES_FACT a
...
FROM {nmn_t2_schema}.CAMPAIGN_ATTRIBUTED_FUNNEL_FACT a
...
delete {nmn_t2_schema}.nmn_weekly_fact where week_idnt between (select week_idnt from _variable) and (select week_idnt from _variable_1);

INSERT INTO {nmn_t2_schema}.nmn_weekly_fact
...
on {nmn_t2_schema}.nmn_weekly_fact;
