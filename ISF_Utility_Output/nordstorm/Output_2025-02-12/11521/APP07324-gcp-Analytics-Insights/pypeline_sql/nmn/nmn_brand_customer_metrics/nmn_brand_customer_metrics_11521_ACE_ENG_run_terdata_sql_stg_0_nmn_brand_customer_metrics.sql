...
FROM PRD_NAP_USR_VWS.DAY_CAL_454_DIM
where month_idnt between (select month_start from date_mapping where day_date= current_date()) and (select month_end from date_mapping where day_date=current_date())
