...
DELETE from {nmn_t2_schema}.nmn_brand_subdiv_customer_metrics where month_idnt=(select month_idnt from _variables);
insert into {nmn_t2_schema}.nmn_brand_subdiv_customer_metrics select a.*,Current_Timestamp AS dw_sys_load_tmstp from final_insert a;
