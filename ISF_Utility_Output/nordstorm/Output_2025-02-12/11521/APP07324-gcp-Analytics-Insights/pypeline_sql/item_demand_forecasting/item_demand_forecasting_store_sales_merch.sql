...
*/
DELETE FROM {ip_forecast_t2_schema}.IDF_STORE_SALE_MERCH
WHERE (week_start_date >= {START_DATE} AND week_start_date <= {END_DATE});
 
 
INSERT INTO {ip_forecast_t2_schema}.IDF_STORE_SALE_MERCH
with wk as (
    SELECT distinct
...
on {ip_forecast_t2_schema}.IDF_STORE_SALE_MERCH;
