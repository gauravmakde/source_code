...
*/  
DELETE FROM {ip_forecast_t2_schema}.IDF_ONLINE_SALE_HIST
WHERE (week_start_date >= {START_DATE} AND week_start_date <= {END_DATE});

INSERT INTO {ip_forecast_t2_schema}.IDF_ONLINE_SALE_HIST
with wk as (
    SELECT distinct
...
on {ip_forecast_t2_schema}.IDF_ONLINE_SALE_HIST;
