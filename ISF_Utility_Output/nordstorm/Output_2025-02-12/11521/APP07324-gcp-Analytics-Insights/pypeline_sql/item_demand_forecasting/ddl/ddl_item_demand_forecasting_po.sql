...
*/
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_bie_dev', 'IDF_PO', OUT_RETURN_MSG);
create multiset table {ip_forecast_t2_schema}.IDF_PO
	,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
    ...
    last_updated_utc DATE,
		allocated_qty_online DECIMAL(38,6),
    received_qty_online DECIMAL(38,6),
    allocated_qty_store DECIMAL(38,6),
	  received_qty_store DECIMAL(38,6),
...
COMMENT ON  {ip_forecast_t2_schema}.IDF_PO IS 'item demand forecasting - includes online and store po table - CC x week' ;
