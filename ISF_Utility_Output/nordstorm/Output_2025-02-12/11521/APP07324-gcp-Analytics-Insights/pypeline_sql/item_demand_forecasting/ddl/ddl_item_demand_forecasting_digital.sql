...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_bie_dev', 'IDF_DIGITAL', OUT_RETURN_MSG);

create multiset table {ip_forecast_t2_schema}.IDF_DIGITAL
	,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
    ...
    averagerating DECIMAL(38,6),
    product_views DECIMAL(38,6),
    add_to_bag DECIMAL(38,6),
...
COMMENT ON  {ip_forecast_t2_schema}.IDF_DIGITAL IS 'item demand forecasting digital table - CC x week' ;
