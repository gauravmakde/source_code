...
SET QUERY_BAND = 'App_ID=APP08073;
     ...
     Task_Name=create_store_sales_hist;'
...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_bie_dev', 'IDF_STORE_SALE_HIST', OUT_RETURN_MSG);
create multiset table {ip_forecast_t2_schema}.IDF_STORE_SALE_HIST
	,fallback
    ,no before journal
    ,no after journal
    ,checksum = default 
	...
	store_take_demand FLOAT,
	owned_demand FLOAT,
	employee_demand FLOAT,
...
COMMENT ON  {ip_forecast_t2_schema}.IDF_STORE_SALE_HIST IS 'item demand forecasting historical store sales table - CC x week' ;
