...
/*
T2/Table Name:T2DL_DAS_TRUST_EMP.employee_purchase_audit
...
*/
CREATE MULTISET VOLATILE TABLE employee_purchase_audit_orders AS (
select
    distinct
...
where rtdf.business_day_date >= CURRENT_DATE - 100
and employee_discount_flag = 1
and employee_discount_num in (
'10381911',
'11405024',
'30176067',
'30176088',
...
*/
DELETE
FROM    {trust_emp_t2_schema}.employee_purchase_audit
WHERE   business_date >= {start_date}
AND     business_date <= {end_date}
;


INSERT INTO {trust_emp_t2_schema}.employee_purchase_audit
SELECT
        first_name,
        last_name,
        discount_percent,
