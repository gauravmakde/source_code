...
Table: {trust_engine_t2_schema}.chargeback_load
       {trust_engine_t2_schema}.chargeback_transaction
...
create multiset volatile table chargeback_tab as (
	...
	from {trust_engine_t2_schema}.chargeback_load cl
	where not exists (select 1
                      from {trust_engine_t2_schema}.chargeback t
...
insert into {trust_engine_t2_schema}.chargeback
    select *
    from chargeback_tab
    QUALIFY ROW_NUMBER()
...
insert into {trust_engine_t2_schema}.chargeback_transaction
    select distinct
        b.case_id,
        b.loss_type_cd,
        b.loss_type,
    ...
    where not exists (select 1
                      from {trust_engine_t2_schema}.chargeback_transaction t
...
-- drop staging table
drop table {trust_engine_t2_schema}.chargeback_load;
