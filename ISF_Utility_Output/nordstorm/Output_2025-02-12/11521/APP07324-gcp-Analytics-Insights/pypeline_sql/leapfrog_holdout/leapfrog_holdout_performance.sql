...
from {deg_t2_schema}.leapfrog_session_active_audience a 
left join {deg_t2_schema}.leapfrog_segmented_audience_trips b 
...
where a.activity_date_partition between {start_date} and {end_date}
...
*/
DELETE 
FROM    {deg_t2_schema}.leapfrog_holdout_performance
WHERE   activity_date_partition >= {start_date}
AND     activity_date_partition <= {end_date}
;


INSERT INTO {deg_t2_schema}.leapfrog_holdout_performance
...
on {deg_t2_schema}.leapfrog_holdout_performance;
