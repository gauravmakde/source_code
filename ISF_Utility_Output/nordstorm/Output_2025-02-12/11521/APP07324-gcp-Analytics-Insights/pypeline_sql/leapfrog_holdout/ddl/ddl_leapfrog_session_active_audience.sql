...
SET QUERY_BAND = 'App_ID=app08742;
     ...
     Task_Name=ddl_leapfrog_session_active_audience;'
...
create multiset table {deg_t2_schema}.leapfrog_session_active_audience 
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  {deg_t2_schema}.leapfrog_session_active_audience IS 'The table that showed user level agg info based on SPEED';
