SET QUERY_BAND = 'App_ID=APP02602;
     DAG_ID=ddl_empdisc_regular_month_summary_11521_ACE_ENG;
     Task_Name=ddl_empdisc_regular_month_summary;'
...
Date Created/Modified: 4/20/2024

Note:
-- Purpose of the table: Employee discount summary by year, regular month, data_source, channel, and merchant
-- Update Cadence: Daily
*/
/*
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('T2DL_DAS_TRUST_EMP', 'empdisc_regular_month_summary{t2_test}', OUT_RETURN_MSG);
*/
create multiset table T2DL_DAS_TRUST_EMP.empdisc_regular_month_summary{t2_test}
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON T2DL_DAS_TRUST_EMP.empdisc_regular_month_summary{t2_test} IS 'Employee discount summary by year, month, data_source, channel, and merchant';
