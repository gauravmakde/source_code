SET QUERY_BAND = 'App_ID=APP09211;
     ...
     Task_Name=ddl_google_iqv_brand_comp_ldg;'
...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{mmm_t2_schema}', 'google_iqv_brand_comp_ldg', OUT_RETURN_MSG);

create multiset table {mmm_t2_schema}.google_iqv_brand_comp_ldg
    , fallback
    , no before journal
    , no after journal
    , checksum = default
