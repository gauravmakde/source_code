...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('T2DL_DAS_MMM', 'app_push_nord', OUT_RETURN_MSG);

create multiset table T2DL_DAS_MMM.app_push_nord
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  T2DL_DAS_MMM.app_push_nord IS 'app_push Nordstrom Data for MMM Data Consolidation';
