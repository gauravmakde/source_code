...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{mmm_t2_schema}', 'paid_events_ldg', OUT_RETURN_MSG);

create multiset table {mmm_t2_schema}.paid_events_ldg
    , fallback
    , no before journal
    , no after journal
    , checksum = default
