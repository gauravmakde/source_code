SET QUERY_BAND = 'App_ID=APP09211;
     ...
     Task_Name=ddl_app_push_nord_ldg;'
...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_mmm', 'app_push_nord_ldg', OUT_RETURN_MSG);

create multiset table {mmm_t2_schema}.app_push_nord_ldg
    , fallback
    , no before journal
    , no after journal
    , checksum = default
