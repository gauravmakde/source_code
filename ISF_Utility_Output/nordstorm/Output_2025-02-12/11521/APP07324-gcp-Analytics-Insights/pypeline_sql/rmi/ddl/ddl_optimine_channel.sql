SET QUERY_BAND = 'App_ID=APP09044;
     ...
     Task_Name=ddl_optimine_channel;'
...
--drop table {kpi_scorecard_t2_schema}.optimine_channel;


create multiset table {kpi_scorecard_t2_schema}.optimine_channel
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
...
COMMENT ON  {kpi_scorecard_t2_schema}.optimine_channel IS 'optimine_channel Data for RMI Automation';
