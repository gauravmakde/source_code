SET QUERY_BAND = 'App_ID=APP09044;
     ...
     Task_Name=ddl_media_pacing_report_ldg;'
...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_bie_dev', 'media_pacing_report_ldg', OUT_RETURN_MSG);

create multiset table {kpi_scorecard_t2_schema}.media_pacing_report_ldg
    ,fallback
    ,no before journal
    ,no after journal
    ,checksum = default
