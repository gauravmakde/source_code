SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=rack_verizon_data;'
     FOR SESSION VOLATILE;


/*
Table: T2DL_DAS_FUNNEL_IO.rack_verizon_data
...
FROM  {funnel_io_t2_schema}.rack_verizon_data_ldg
