SET QUERY_BAND = 'App_ID=APP08133;
     DAG_ID=ddl_rack_facebook_reach_and_freq_11521_ACE_ENG;
     Task_Name=ddl_rack_facebook_reach_and_freq_ldg;'
     FOR SESSION VOLATILE;

/*
T2/Table Name: T2DL_DAS_FUNNEL_IO.nmn_rack_facebook_reach_and_freq_ldg
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{funnel_io_t2_schema}', 'nmn_rack_facebook_reach_and_freq_ldg', OUT_RETURN_MSG);

create multiset table {funnel_io_t2_schema}.nmn_rack_facebook_reach_and_freq_ldg
    , fallback
    , no before journal
    , no after journal
    , checksum = default
