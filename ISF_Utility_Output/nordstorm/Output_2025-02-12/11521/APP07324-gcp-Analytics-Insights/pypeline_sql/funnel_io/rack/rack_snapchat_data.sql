SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=rack_snapchat_data;'
     FOR SESSION VOLATILE;


/*
Table: T2DL_DAS_FUNNEL_IO.rack_snapchat_data
...
AND     file_name = 'rack_snapchat'
;

INSERT INTO {funnel_io_t2_schema}.rack_funnel_cost_fact
SELECT DISTINCT
    stats_date
    , 'rack_snapchat' AS file_name
    , sourcetype
    , currency
    , sourcename
    , media_type
...
FROM  {funnel_io_t2_schema}.rack_snapchat_data_ldg
