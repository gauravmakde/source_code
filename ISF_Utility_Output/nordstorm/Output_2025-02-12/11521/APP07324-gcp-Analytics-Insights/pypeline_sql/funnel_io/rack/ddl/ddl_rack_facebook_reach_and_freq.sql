SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=ddl_rack_facebook_reach_and_freq;'
     FOR SESSION VOLATILE;

/*

T2/Table Name: T2DL_DAS_FUNNEL_IO.nmn_rack_facebook_reach_and_freq
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{funnel_io_t2_schema}', 'nmn_rack_facebook_reach_and_freq', OUT_RETURN_MSG);


CREATE MULTISET TABLE {funnel_io_t2_schema}.nmn_rack_facebook_reach_and_freq,
     FALLBACK ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
