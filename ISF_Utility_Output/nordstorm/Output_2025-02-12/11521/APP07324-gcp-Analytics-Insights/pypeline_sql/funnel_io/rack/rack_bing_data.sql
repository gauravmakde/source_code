SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=rack_bing_data;'
     FOR SESSION VOLATILE;


/*
Table: T2DL_DAS_FUNNEL_IO.rack_bing_data
...
FROM  {funnel_io_t2_schema}.rack_bing_data_ldg
