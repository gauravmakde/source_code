SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=rack_adwords_data;'
     FOR SESSION VOLATILE;

/*
Table: T2DL_DAS_FUNNEL_IO.rack_adwords_data
...
FROM  {funnel_io_t2_schema}.rack_adwords_data_ldg
