...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{funnel_io_t2_schema}', 'nmn_fp_pinterest_data_ldg', OUT_RETURN_MSG);

create multiset table {funnel_io_t2_schema}.nmn_fp_pinterest_data_ldg
    , fallback
    , no before journal
    , no after journal
    , checksum = default
