SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=fp_pinterest_data;'
     FOR SESSION VOLATILE;

/*
Table: T2DL_DAS_FUNNEL_IO.fp_pinterest_data
...
AND     file_name = 'fp_pinterest'
;

INSERT INTO {funnel_io_t2_schema}.fp_funnel_cost_fact
SELECT DISTINCT
    stats_date
    , 'fp_pinterest' AS file_name    
    , sourcetype
    , currency
    , sourcename
    , media_type
...
FROM  {funnel_io_t2_schema}.fp_pinterest_data_ldg
