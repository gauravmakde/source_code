SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=fp_snapchat_data;'
     FOR SESSION VOLATILE;

/*
Table: T2DL_DAS_FUNNEL_IO.fp_snapchat_data
...
FROM  {funnel_io_t2_schema}.fp_snapchat_data_ldg
