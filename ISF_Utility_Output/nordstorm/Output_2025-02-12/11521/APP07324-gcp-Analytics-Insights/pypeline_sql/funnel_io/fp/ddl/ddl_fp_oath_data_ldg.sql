SET QUERY_BAND = 'App_ID=APP08133;
     ...
     Task_Name=ddl_fp_oath_data_ldg;'
     FOR SESSION VOLATILE;

/*

T2/Table Name: T2DL_DAS_FUNNEL_IO.fp_oath_data_ldg
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{funnel_io_t2_schema}', 'fp_oath_data_ldg', OUT_RETURN_MSG);

create multiset table {funnel_io_t2_schema}.fp_oath_data_ldg
    , fallback
    , no before journal
    , no after journal
    , checksum = default
