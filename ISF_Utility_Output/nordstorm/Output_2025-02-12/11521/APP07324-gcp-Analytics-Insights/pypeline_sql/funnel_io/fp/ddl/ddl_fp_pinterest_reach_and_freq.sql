SET QUERY_BAND = 'App_ID=APP08133;
     DAG_ID=ddl_fp_pinterest_reach_and_freq_11521_ACE_ENG;
     Task_Name=ddl_fp_pinterest_reach_and_freq;'
     FOR SESSION VOLATILE;

/*


T2/Table Name: T2DL_DAS_FUNNEL_IO.nmn_fp_pinterest_reach_and_freq
...
--CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{funnel_io_t2_schema}', 'nmn_fp_pinterest_reach_and_freq', OUT_RETURN_MSG);

CREATE MULTISET TABLE {funnel_io_t2_schema}.nmn_fp_pinterest_reach_and_freq,
     FALLBACK ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
