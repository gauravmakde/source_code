SET QUERY_BAND = 'App_ID=APP08133;
     DAG_ID=ddl_fp_funnel_cost_fact_11521_ACE_ENG;
     Task_Name=ddl_fp_funnel_cost_fact;'
...
create multiset table {funnel_io_t2_schema}.fp_funnel_cost_fact
    , fallback
    , no before journal
    , no after journal
    , checksum = default
...
COMMENT ON  {funnel_io_t2_schema}.fp_funnel_cost_fact IS 'Funnel IO platform loads for FP';
