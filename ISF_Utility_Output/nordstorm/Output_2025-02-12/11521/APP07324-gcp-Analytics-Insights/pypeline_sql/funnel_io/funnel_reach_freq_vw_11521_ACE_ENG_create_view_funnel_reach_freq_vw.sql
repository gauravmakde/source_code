...
CREATE VIEW T2DL_DAS_FUNNEL_IO.funnel_reach_freq_vw
AS
LOCK ROW FOR ACCESS
SELECT day_date,
       data_source_type,
...
from(
       ...
       NULL as avg_daily_reach,
       NULL as avg_daily_freq
       from T2DL_DAS_FUNNEL_IO.nmn_fp_facebook_reach_and_freq a
       inner join (
       	Select campaign_id,
       		   campaign_name
       ...
       NULL as avg_daily_reach,
       NULL as avg_daily_freq
       from T2DL_DAS_FUNNEL_IO.nmn_rack_facebook_reach_and_freq a
       inner join (
       	Select campaign_id,
       		   campaign_name
