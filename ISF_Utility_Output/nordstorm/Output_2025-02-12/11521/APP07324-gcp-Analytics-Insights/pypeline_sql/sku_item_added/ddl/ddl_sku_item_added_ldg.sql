SET QUERY_BAND = 'App_ID=APP07324;
     ...
     Task_Name=ddl_sku_item_added_ldg;'
     FOR SESSION VOLATILE;

/******************************************************************************

Table definition for T2DL_DAS_SCALED_EVENTS.sku_item_added_ldg

*******************************************************************************/ 
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{scaled_events_t2_schema}', 'sku_item_added_ldg', OUT_RETURN_MSG); 

CREATE MULTISET TABLE {scaled_events_t2_schema}.sku_item_added_ldg
    , FALLBACK
    , NO BEFORE JOURNAL
    , NO AFTER JOURNAL
    , CHECKSUM = DEFAULT
