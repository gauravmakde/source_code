SET QUERY_BAND = 'App_ID=APP07324;
     DAG_ID=ddl_competitor_price_matching_dev_11521_ACE_ENG;  
     Task_Name=competitor_price_match_tpt_job_insert;'
     FOR SESSION VOLATILE;

DELETE FROM  {price_matching_t2_schema}.TPT_CONTROL_TBL 
where job_name = 'competitor_price_match_dump_ldg'  
;
...
VALUES (
	'competitor_price_match_dump_ldg',  
