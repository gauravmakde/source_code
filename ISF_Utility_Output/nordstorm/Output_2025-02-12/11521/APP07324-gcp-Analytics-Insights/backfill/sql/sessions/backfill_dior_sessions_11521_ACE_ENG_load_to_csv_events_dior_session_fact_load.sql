...
create table if not exists ace_etl.dior_session_fact 
(
...
using ORC
location 's3://ace-etl/dior_session_fact/'
...
SELECT DISTINCT
 ...
 (   SELECT
    ...
    WHERE 1=1
        ...
        AND asf.activity_date_pacific BETWEEN '2024-07-01' and '2024-07-19'
...
where activity_date BETWEEN '2024-07-01' and '2024-07-19'
)
 s
...
where activity_date between '2024-07-01' and '2024-07-19' and activity_date not in (select distinct activity_date_pacific
...
insert overwrite table ace_etl.dior_session_fact partition (activity_date_pacific)
...
insert into table ace_etl.dior_session_fact partition (activity_date_pacific)
select /*+ REPARTITION(100) */
      session_id	  
    , channelcountry               
    , channel                       
...
msck repair table ace_etl.dior_session_fact;
...
select 
    ...
    , sus_bot_flag
    , bot_demand_flag 	
from ace_etl.dior_session_fact where activity_date_pacific BETWEEN '2024-07-01' and '2024-07-19'
;
