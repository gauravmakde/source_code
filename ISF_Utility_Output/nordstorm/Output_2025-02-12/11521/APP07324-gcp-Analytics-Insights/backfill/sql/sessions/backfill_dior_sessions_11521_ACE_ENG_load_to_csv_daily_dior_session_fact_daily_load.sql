...
create table if not exists ace_etl.dior_session_fact_daily 
(
...
using ORC
location 's3://ace-etl/dior_session_fact_daily/'
...
from ace_etl.dior_session_fact
...
insert overwrite table ace_etl.dior_session_fact_daily partition (activity_date_pacific)
...
msck repair table ace_etl.dior_session_fact_daily;
...
select 
    ...
    , sus_bot_flag
    , bot_demand_flag	
from ace_etl.dior_session_fact_daily where activity_date_pacific BETWEEN '2024-07-01' and '2024-07-19'
;
