...
WHERE order_date_pacific BETWEEN '2024-08-18' AND '2024-08-18'
...
WHERE   activity_date_pacific >= '2024-08-18'
AND     activity_date_pacific <= '2024-08-18'
;


INSERT INTO T2DL_DAS_MTA.mkt_utm_agg
SELECT
