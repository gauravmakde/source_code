...
WHERE finance_detail in ('EMAIL_MARKETING','EMAIL_TRANSACT','EMAIL_TRIGGER')
  ...
  AND channelcountry = 'US'
	AND   activity_date_pacific BETWEEN '2024-01-01' AND '2024-03-30'
...
WHERE last_updated_date IS NOT NULL
	...
	AND   a.last_updated_date BETWEEN '2024-01-01' AND '2024-03-30'
...
left join T2DL_DAS_MTA.mta_email_campaign_category_correction c 
	on a.campaign_name = c.campaign_name
left join T2DL_DAS_MTA.mta_email_campaign_id_correction d
...
*/
DELETE 
FROM    T2DL_DAS_MTA.mta_email_performance
WHERE deploy_date between '2024-01-01' and '2024-03-30' 
;


INSERT INTO T2DL_DAS_MTA.mta_email_performance
...
on T2DL_DAS_MTA.mta_email_performance;
