...
create table if not exists ace_etl.mta_touches (
    order_number string
...
using ORC
location 's3://ace-etl/mta/touches/'
partitioned by (order_date_pacific);

msck repair table ace_etl.mta_touches;
    ...
    (
        ...
        (
            ...
            from(
                ...
                where event_date_pacific between date_sub(date'2024-05-16',30) and date(date'2024-05-22')
...
(
    ...
    from(
        ...
        where (cpa.businessdate is null
               or cpa.businessdate between date'2024-05-16' and date'2024-05-22')
...
(
    ...
    (
        ...
        and a.event_date_pacific between date_sub(date'2024-05-16',30) and date(date'2024-05-22')
    ) arrive
...
where   businessdate between date'2024-05-16' and date'2024-05-22'
;
...
(
    ...
    (
        ...
        where event_date_pacific between date(date'2024-05-16') and date(date'2024-05-22')
    ...
    where o.event_date_pacific between date(date'2024-05-16') and date(date'2024-05-22')
    and o.platform <> 'POS'
...
insert overwrite table ace_etl.mta_touches partition (order_date_pacific)
