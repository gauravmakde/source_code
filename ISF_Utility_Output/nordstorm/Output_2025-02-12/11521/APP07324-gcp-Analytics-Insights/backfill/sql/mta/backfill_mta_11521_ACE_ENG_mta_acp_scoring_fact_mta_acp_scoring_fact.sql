...
collect statistics COLUMN(order_date_pacific)
                 , COLUMN(partition)
on T2DL_DAS_MTA.mta_acp_scoring_fact_ldg;

-- insert to main
insert into T2DL_DAS_MTA.mta_acp_scoring_fact
...
from T2DL_DAS_MTA.mta_acp_scoring_fact_ldg m
where   order_date_pacific between date'2024-05-16' and date'2024-05-22'
;
collect statistics COLUMN(order_date_pacific)
                 ...
                 , COLUMN(partition)
on T2DL_DAS_MTA.mta_acp_scoring_fact
;
-- drop landing table
drop table T2DL_DAS_MTA.mta_acp_scoring_fact_ldg
;
