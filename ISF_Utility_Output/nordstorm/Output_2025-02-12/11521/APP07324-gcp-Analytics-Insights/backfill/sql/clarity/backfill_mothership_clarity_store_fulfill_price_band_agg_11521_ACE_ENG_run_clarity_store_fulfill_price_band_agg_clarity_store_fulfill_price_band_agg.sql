...
where eff_end_tmstp >= cast(date'2024-02-04' as date) and eff_begin_tmstp <= cast(date'2024-05-04' as date)
...
where 1=1
and demand_date between date'2024-02-04' and date'2024-05-04'
...
DELETE FROM PRD_NAP_DSA_AI_BASE_VWS.store_fulfill_price_bands_agg WHERE demand_date BETWEEN date'2024-02-04' AND date'2024-05-04';
