...
and year_num in (select distinct year_num from PRD_NAP_BASE_VWS.DAY_CAL where day_date between date'2023-01-29' AND date'2023-04-29')
)
...
where 1=1
and execution_qtr_end_dt >= date'2023-01-29' and execution_qtr_start_dt <= date'2023-04-29'
)
...
where business_day_date between date'2023-01-29' and date'2023-04-29'
...
where activity_date_pacific between date'2023-01-29'-30 and date'2023-04-29' --need to account for lag between order and sale (for opgmv and margin)
...
where activity_date between date'2023-01-29'-30 and date'2023-04-29'
...
where 1=1
and demand_date between date'2023-01-29' AND date'2023-04-29'
...
where eff_end_tmstp >= cast(date'2023-01-29' as date) and eff_begin_tmstp <= cast(date'2023-04-29' as date)
...
where 1=1
and business_day_date between date'2023-01-29' AND date'2023-04-29'
and business_day_date between '2021-01-31' and current_date-1
and zero_value_unit_ind ='N' --remove Gift with Purchase and Beauty (Smart) Sample
and not (business_unit_country='CA' and business_day_date > '2023-02-25')-- fiscal month 202301 and prior
)
...
DELETE FROM PRD_NAP_DSA_AI_BASE_VWS.finance_sales_demand_fact WHERE tran_date BETWEEN date'2023-01-29' AND date'2023-04-29';

INSERT INTO PRD_NAP_DSA_AI_BASE_VWS.finance_sales_demand_fact
(
  tran_date  
  ,business_unit_desc
  ,store_num
