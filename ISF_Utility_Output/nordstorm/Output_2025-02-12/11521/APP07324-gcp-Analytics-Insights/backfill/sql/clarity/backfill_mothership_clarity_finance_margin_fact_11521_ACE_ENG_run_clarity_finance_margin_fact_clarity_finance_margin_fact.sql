...
and year_num in (select distinct year_num from PRD_NAP_BASE_VWS.DAY_CAL where day_date between date'2022-07-31' and date'2022-10-29')
)
...
where 1=1
and execution_qtr_end_dt >= date'2022-07-31' and execution_qtr_start_dt <= date'2022-10-29'
...
where business_day_date between date'2022-07-31' and date'2022-10-29'
...
where activity_date_pacific between date'2022-07-31'-30 and date'2022-10-29' --need to account for lag between order and sale (for opgmv and margin)
...
where activity_date between date'2022-07-31'-30 and date'2022-10-29'
...
where 1=1
and business_day_date between date'2022-07-31' and date'2022-10-29'
and business_day_date between '2021-01-31' and current_date-1
...
DELETE FROM PRD_NAP_DSA_AI_BASE_VWS.finance_margin_fact WHERE business_day_date BETWEEN date'2022-07-31' AND date'2022-10-29';


INSERT INTO PRD_NAP_DSA_AI_BASE_VWS.finance_margin_fact
(
  business_day_date
  ,business_unit_desc
  ,store_num
