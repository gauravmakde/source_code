...
where eff_end_tmstp >= cast(date'2022-01-30' as date) and eff_begin_tmstp <= cast(date'2023-01-28' as date)
...
where 1=1
and demand_date between date'2022-01-30' and date'2023-01-28'
...
DELETE FROM PRD_NAP_DSA_AI_BASE_VWS.finance_sales_demand_price_bands_agg WHERE tran_date BETWEEN date'2022-01-30' AND date'2023-01-28';

INSERT INTO PRD_NAP_DSA_AI_BASE_VWS.finance_sales_demand_price_bands_agg
(
  tran_date
  ,business_unit_desc
  ,channel
