...
DELETE FROM T2DL_DAS_INV_POSITION_FORECAST.IDF_STORE_SALE
WHERE (week_start_date >= '2021-06-13' AND week_start_date <= '2021-06-27');
   
INSERT INTO T2DL_DAS_INV_POSITION_FORECAST.IDF_STORE_SALE
with store as (
    select
        store_num,
        case 
...
on T2DL_DAS_INV_POSITION_FORECAST.IDF_STORE_SALE;
