...
*/
DELETE FROM T2DL_DAS_INV_POSITION_FORECAST.IDF_ONLINE_INV
WHERE (week_start_date >= '2021-06-13' AND week_start_date <= '2021-06-27');

INSERT INTO T2DL_DAS_INV_POSITION_FORECAST.IDF_ONLINE_INV
with sku as (
    select distinct
        psd.rms_sku_num,
        psd.epm_choice_num,
...
on T2DL_DAS_INV_POSITION_FORECAST.IDF_ONLINE_INV;
