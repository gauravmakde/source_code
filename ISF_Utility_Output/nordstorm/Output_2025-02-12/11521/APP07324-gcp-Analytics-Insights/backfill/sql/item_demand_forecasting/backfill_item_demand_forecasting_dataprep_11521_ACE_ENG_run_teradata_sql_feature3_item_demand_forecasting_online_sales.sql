...
*/  
DELETE FROM T2DL_DAS_INV_POSITION_FORECAST.IDF_ONLINE_SALE  
WHERE (week_start_date >= '2021-06-13' AND week_start_date <= '2021-06-27');

INSERT INTO T2DL_DAS_INV_POSITION_FORECAST.IDF_ONLINE_SALE
with wk as (
    SELECT distinct
...
on T2DL_DAS_INV_POSITION_FORECAST.IDF_ONLINE_SALE;
