...
from prd_nap_usr_vws.product_sku_dim_hist EXPAND ON
        ...
        BY interval '1' day 
        for PERIOD(CAST(date '2024-08-23' AS TIMESTAMP(0)), CAST(date '2024-08-23' AS TIMESTAMP(0)) + interval '1' day)
...
WHERE order_date_pacific between date '2024-08-23' and date '2024-08-23'
...
where 1 = 1
	and event_date_pacific between date '2024-08-23' and date '2024-08-23'
...
where channel_country = 'US'
	and day_date between date '2024-08-23' and date '2024-08-23'
) sub
left join cc_lkp cl 
on sub.cc = cl.cc
group by 1,2,3
...
from T2DL_DAS_DIGITALMERCH_FLASH.digital_inventory_age a
...
create multiset volatile table los_tbl as (
       ...
       where channel_country = 'US'
            and los.day_date between date '2024-08-23' and date '2024-08-23'
       group by 1,2,3
...
--CREATE MULTISET TABLE T2DL_DAS_DIGITALMERCH_FLASH.digital_merch_table AS (
INSERT INTO T2DL_DAS_DIGITALMERCH_FLASH.digital_merch_table
SELECT 
base.day_date,
...
on T2DL_DAS_DIGITALMERCH_FLASH.digital_merch_table;
