...
DROP TABLE IF EXISTS ace_etl.digital_merch_table_as_is;
create table if not exists ace_etl.digital_merch_table_as_is (
    ...
    ,rk      integer
) using PARQUET location 's3://ace-etl/digital_merch_table_as_is'
;


insert OVERWRITE TABLE ace_etl.digital_merch_table_as_is
select *
from (
...
-- MSCK REPAIR table ace_etl.digital_merch_table_as_is;
