...
where a.activity_date_pacific between date '2022-01-30' and date '2022-04-30'
group by 1,2,3,4
...
from cust_billing c
     where day_date <= date '2022-04-30'
) sub
...
create volatile multiset table customer_aec_lkp as (
    ...
    where execution_qtr in (select quarter_num from prd_nap_usr_vws.day_cal where day_date between date '2022-01-30' and date '2022-04-30')
...
INSERT INTO T2DL_DAS_DIGITALMERCH_FLASH.customer_attributes_table
select distinct  a.*
...
ON T2DL_DAS_DIGITALMERCH_FLASH.customer_attributes_table;
