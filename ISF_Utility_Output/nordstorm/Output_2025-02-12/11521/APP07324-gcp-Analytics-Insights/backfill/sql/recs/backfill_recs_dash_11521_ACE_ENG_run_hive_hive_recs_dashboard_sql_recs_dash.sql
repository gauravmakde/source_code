...
where to_date(day_date, 'MM/dd/yyyy') between '2024-02-12' and '2024-02-21'
;
...
create table if not exists ace_etl.recs_total_level
(
...
using PARQUET
location 's3://ace-etl/recs_total_level/'
;


insert overwrite table ace_etl.recs_total_level
select *
from Total_level
;

create table if not exists ace_etl.recs_level1
(
    aggregation_level string,
	activity_date date,
	channel string,
...
using PARQUET
location 's3://ace-etl/recs_level1/'
;

insert overwrite table ace_etl.recs_level1
select *
from Level1
;

create table if not exists ace_etl.recs_level2
(
    aggregation_level string,
	activity_date date,
	channel string,
...
using PARQUET
location 's3://ace-etl/recs_level2/'
;

insert overwrite table ace_etl.recs_level2
select *
from Level2
;

create table if not exists ace_etl.recs_level3
(
    aggregation_level string,
	activity_date date,
	channel string,
...
using PARQUET
location 's3://ace-etl/recs_level3/'
;

insert overwrite table ace_etl.recs_level3
select *
from Level3
;

create table if not exists ace_etl.recs_level4
(
    aggregation_level string,
	activity_date date,
	channel string,
...
using PARQUET
location 's3://ace-etl/recs_level4/'
;


insert overwrite table ace_etl.recs_level4
select *
from Level4
;

create table if not exists ace_etl.recs_dash
(
    aggregation_level string,
	activity_date date,
	channel string,
...
using PARQUET
location 's3://ace-etl/recs_dash/'
partitioned by (activity_date_partition);

insert overwrite table ace_etl.recs_dash partition (activity_date_partition)
select *
from ace_etl.recs_total_level
union all
select *
from ace_etl.recs_level1
union all
select *
from ace_etl.recs_level2
union all
select *
from ace_etl.recs_level3
union all
select *
from ace_etl.recs_level4
;

MSCK REPAIR TABLE ace_etl.recs_dash;