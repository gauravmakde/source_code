...
on T2DL_DAS_DIGENG.session_active_user_ldg
;

delete
from    T2DL_DAS_DIGENG.session_active_user
where    activity_date_partition between date'2022-12-28' and date'2023-01-27'
;

insert into T2DL_DAS_DIGENG.session_active_user
select  
...
from    T2DL_DAS_DIGENG.session_active_user_ldg
where   activity_date_partition between date'2022-12-28' and date'2023-01-27'
;
...
COLLECT STATISTICS  COLUMN (PARTITION),
                    COLUMN (activity_date_partition,channel,experience,recognized_in_period,new_recognized_in_period,new_in_period), -- column names used for primary index
                    COLUMN (activity_date_partition)  -- column names used for partition
on T2DL_DAS_DIGENG.session_active_user
;
