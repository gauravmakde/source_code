...
*******************************************************************************/ 
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('T2DL_DAS_SCALED_EVENTS', 'sku_item_added_ldg', OUT_RETURN_MSG); 

CREATE MULTISET TABLE T2DL_DAS_SCALED_EVENTS.sku_item_added_ldg
    , FALLBACK
    , NO BEFORE JOURNAL
    , NO AFTER JOURNAL
    , CHECKSUM = DEFAULT
