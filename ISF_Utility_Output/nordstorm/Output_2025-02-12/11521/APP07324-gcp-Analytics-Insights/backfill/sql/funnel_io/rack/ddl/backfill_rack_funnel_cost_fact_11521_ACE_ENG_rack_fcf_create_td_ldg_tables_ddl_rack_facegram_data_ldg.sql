...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('T2DL_DAS_FUNNEL_IO', 'rack_facegram_data_ldg', OUT_RETURN_MSG);

create multiset table T2DL_DAS_FUNNEL_IO.rack_facegram_data_ldg
    , fallback
    , no before journal
    , no after journal
    , checksum = default
