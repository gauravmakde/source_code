...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('T2DL_DAS_FUNNEL_IO', 'fp_dv_three_sixty_data_ldg', OUT_RETURN_MSG);

create multiset table T2DL_DAS_FUNNEL_IO.fp_dv_three_sixty_data_ldg
    , fallback
    , no before journal
    , no after journal
    , checksum = default
