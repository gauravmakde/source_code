...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('T2DL_DAS_TRUST_ENGINE_PROD', 'chargeback_load', OUT_RETURN_MSG);

CREATE MULTISET TABLE T2DL_DAS_TRUST_ENGINE_PROD.chargeback_load
	 ,FALLBACK
     ,NO BEFORE JOURNAL
     ,NO AFTER JOURNAL
     ,CHECKSUM = DEFAULT
