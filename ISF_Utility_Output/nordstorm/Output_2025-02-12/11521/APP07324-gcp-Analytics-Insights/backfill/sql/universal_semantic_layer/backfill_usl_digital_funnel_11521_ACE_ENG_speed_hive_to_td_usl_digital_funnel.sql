...
delete 
from    T2DL_DAS_USL.usl_digital_funnel 
where   activity_date_partition between date'2024-01-07' and date'2024-01-15' ;

insert into T2DL_DAS_USL.usl_digital_funnel
...
from T2DL_DAS_USL.usl_digital_funnel_ldg
where activity_date_partition between date'2024-01-07' and date'2024-01-15'
;
collect statistics column (activity_date_partition, channel, experience)
on T2DL_DAS_USL.usl_digital_funnel
;
