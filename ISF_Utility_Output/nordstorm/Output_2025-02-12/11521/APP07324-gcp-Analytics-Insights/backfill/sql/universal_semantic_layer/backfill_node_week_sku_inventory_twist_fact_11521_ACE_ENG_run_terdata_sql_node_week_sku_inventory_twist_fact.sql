...
where cal.day_date between '2022-02-27' and '2022-04-02'-- the filter we need to date selections
...
(select year_num
  ...
  where day_date between '2022-02-27' and '2022-04-02'
  group by 1,2,3,4
...
DELETE FROM T2DL_DAS_USL.node_week_sku_inventory_twist_fact
       WHERE week_num BETWEEN (SELECT week_num from prd_nap_usr_vws.day_cal where day_date = '2022-02-27' )
                      and (SELECT week_num from prd_nap_usr_vws.day_cal where day_date = '2022-04-02' );

INSERT INTO T2DL_DAS_USL.node_week_sku_inventory_twist_fact
...
COLLECT STATISTICS  COLUMN (store_number),
                    ...
                    COLUMN (color_num)
on T2DL_DAS_USL.node_week_sku_inventory_twist_fact;
