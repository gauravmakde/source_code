...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('T2DL_DAS_DIGENG', 'leapfrog_segmented_audience_trips_ldg', OUT_RETURN_MSG);

create multiset table T2DL_DAS_DIGENG.leapfrog_segmented_audience_trips_ldg
    ,fallback
    ,no before journal 
    ,no after journal
    ,checksum = default
