...
WHERE day_date between date'2024-01-20' and date'2024-02-05'
)
select 
...
(
	...
	where ORDER_DATE_PACIFIC between date'2024-01-20'-1 and date'2024-02-05'+1
) c 
on dtl.ORDER_NUM = c.order_num
where
	(dtl.order_date between date'2024-01-20' and date'2024-02-05'
		or dtl.tran_date between date'2024-01-20' and date'2024-02-05')
	and dtl.business_day_date >= date'2024-01-20' - 40	
...
where tran_date between date'2024-01-20' and date'2024-02-05'
...
*/
DELETE 
FROM    T2DL_DAS_DIGENG.customer_cohort_trips
WHERE   tran_date >= date'2024-01-20'
AND     tran_date <= date'2024-02-05'
;


INSERT INTO T2DL_DAS_DIGENG.customer_cohort_trips
...
on T2DL_DAS_DIGENG.customer_cohort_trips;
