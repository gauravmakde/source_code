...
inner join ace_etl.customer_cohort b 
...
where
    holdout_flag + leapfrogeligible_flag = 1
and activity_date_partition between (select quarter_start_day_date from q ) and '2024-05-14';
...
drop table if exists ace_etl.leapfrog_daily_base;

create table ace_etl.leapfrog_daily_base
using parquet
location 's3://ace-etl/leapfrog_daily_base/'
as select * from daily_base;

cache lazy table ace_etl.leapfrog_daily_base;
