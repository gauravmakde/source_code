...
SET QUERY_BAND = 'App_ID=app08742;
     ...
     Task_Name=leapfrog_session_active_user_load;'
...
WHERE
        ...
        ) between date'2024-01-20' and date'2024-03-01';
...
where
    holdout_flag + leapfrogeligible_flag = 1
and activity_date_partition between (select quarter_start_day_date from q ) and date'2024-03-01';
...
SELECT
        ...
        a.holdout_experimentname,
        a.holdout_variationname,
...
from
        ...
        and a.holdout_experimentname = m.holdout_experimentname
        and a.holdout_variationname=m.holdout_variationname
        ...
        and a.activity_date_partition = q.day_date
       	and a.holdout_experimentname = q.holdout_experimentname
        and a.holdout_variationname=q.holdout_variationname;

-- Writing output to teradata landing table.  
-- This sould match the "sql_table_reference" indicated on the .json file.
insert
        overwrite table leapfrog_session_active_user_output
select
        *
from
        final;