CALL SYS_MGMT.create_if_not_exists('{REPLACE_ME}', 'tpt_control_tbl', 
'CREATE MULTISET TABLE {REPLACE_ME}.TPT_CONTROL_TBL ,FALLBACK ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
...
CALL SYS_MGMT.create_if_not_exists('{REPLACE_ME}', 'TPT_JOB_LOG', 
'CREATE MULTISET TABLE {REPLACE_ME}.TPT_JOB_LOG ,FALLBACK ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
     DEFAULT MERGEBLOCKRATIO,
