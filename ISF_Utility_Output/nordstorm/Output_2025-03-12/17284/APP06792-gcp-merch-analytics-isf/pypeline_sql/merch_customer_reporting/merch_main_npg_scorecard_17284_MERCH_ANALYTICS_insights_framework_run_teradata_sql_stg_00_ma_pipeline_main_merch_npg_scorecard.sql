...
DELETE FROM T2DL_DAS_CUS.npg_scorecard where month_idnt = (SELECT DISTINCT month_idnt FROM PRD_NAP_USR_VWS.DAY_CAL_454_DIM WHERE day_date = CURRENT_DATE()-10);
INSERT INTO T2DL_DAS_CUS.npg_scorecard
SELECT * FROM npg_scorecard_data;

COLLECT STATISTICS COLUMN(month_idnt, dimension) ON T2DL_DAS_CUS.npg_scorecard;
