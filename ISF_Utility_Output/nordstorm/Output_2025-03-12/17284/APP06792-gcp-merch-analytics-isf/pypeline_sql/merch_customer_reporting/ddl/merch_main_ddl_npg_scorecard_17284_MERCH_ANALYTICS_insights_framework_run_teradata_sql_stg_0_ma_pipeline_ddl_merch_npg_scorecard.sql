CALL SYS_MGMT.DROP_IF_EXISTS_SP ('T2DL_DAS_CUS', 'npg_scorecard', OUT_RETURN_MSG);
CREATE MULTISET TABLE T2DL_DAS_CUS.npg_scorecard
    ,FALLBACK
	,NO BEFORE JOURNAL
	,NO AFTER JOURNAL
	,CHECKSUM = DEFAULT
...
GRANT SELECT ON T2DL_DAS_CUS.npg_scorecard TO PUBLIC;