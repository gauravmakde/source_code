...
DELETE FROM {environment_schema}.size_sku_loc_weekly{env_suffix} WHERE week_idnt IN (SELECT DISTINCT week_idnt FROM week_lkp);
INSERT INTO {environment_schema}.size_sku_loc_weekly{env_suffix}
SELECT *
FROM week_loc
;
