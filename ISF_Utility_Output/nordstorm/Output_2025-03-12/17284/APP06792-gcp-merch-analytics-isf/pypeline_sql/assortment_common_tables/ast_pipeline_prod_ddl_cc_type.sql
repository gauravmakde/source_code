...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{environment_schema}', 'sku_cc_lkp{env_suffix}', OUT_RETURN_MSG);
CREATE MULTISET TABLE {environment_schema}.sku_cc_lkp{env_suffix}, FALLBACK,
	NO BEFORE JOURNAL,
	NO AFTER JOURNAL,
	CHECKSUM = DEFAULT,
...
GRANT SELECT ON {environment_schema}.sku_cc_lkp{env_suffix} TO PUBLIC;


CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{environment_schema}', 'cc_type{env_suffix}', OUT_RETURN_MSG);
CREATE MULTISET TABLE {environment_schema}.cc_type{env_suffix}, FALLBACK,
	NO BEFORE JOURNAL,
	NO AFTER JOURNAL,
	CHECKSUM = DEFAULT,
	DEFAULT MERGEBLOCKRATIO,
...
GRANT SELECT ON {environment_schema}.cc_type{env_suffix} TO PUBLIC;