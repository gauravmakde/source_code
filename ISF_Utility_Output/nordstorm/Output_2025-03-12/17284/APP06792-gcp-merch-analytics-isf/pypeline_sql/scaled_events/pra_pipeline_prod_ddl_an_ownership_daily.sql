...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{environment_schema}', 'ANNIVERSARY_OWNERSHIP_DAILY', OUT_RETURN_MSG);
CREATE MULTISET TABLE {environment_schema}.ANNIVERSARY_OWNERSHIP_DAILY
    , FALLBACK
    , NO BEFORE JOURNAL
    , NO AFTER JOURNAL
    , CHECKSUM = DEFAULT
...
GRANT SELECT ON {environment_schema}.ANNIVERSARY_OWNERSHIP_DAILY TO PUBLIC;
