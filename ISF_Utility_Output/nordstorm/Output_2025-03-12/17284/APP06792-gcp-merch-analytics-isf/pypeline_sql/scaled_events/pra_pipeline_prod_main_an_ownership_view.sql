REPLACE VIEW {environment_schema}.AN_OWNERSHIP_VW
AS
LOCK ROW FOR ACCESS
...
INNER JOIN {environment_schema}.ANNIVERSARY_SKU an_sku
    ON apo.sku_idnt = an_sku.sku_idnt
    AND an_sku.country = 'US' AND an_sku.ty_ly_ind = 'TY'
...
GRANT SELECT ON {environment_schema}.AN_OWNERSHIP_VW TO PUBLIC;
