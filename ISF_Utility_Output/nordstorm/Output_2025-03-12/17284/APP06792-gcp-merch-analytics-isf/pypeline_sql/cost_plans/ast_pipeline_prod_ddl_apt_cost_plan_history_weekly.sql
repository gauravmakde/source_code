...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{environment_schema}', 'merch_assortment_supplier_cluster_plan_history_weekly', OUT_RETURN_MSG);
CREATE MULTISET TABLE {environment_schema}.merch_assortment_supplier_cluster_plan_history_weekly ,FALLBACK , 
	NO BEFORE JOURNAL,
	NO AFTER JOURNAL,
	CHECKSUM = DEFAULT,
...
(
    ...
    ,snapshot_plan_week_idnt INTEGER 
