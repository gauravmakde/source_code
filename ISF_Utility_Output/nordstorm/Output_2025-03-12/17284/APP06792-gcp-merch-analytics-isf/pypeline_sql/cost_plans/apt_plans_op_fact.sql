...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{environment_schema}', 'merch_assortment_supplier_cluster_plan_op_fact{env_suffix}', OUT_RETURN_MSG);
CREATE MULTISET TABLE {environment_schema}.merch_assortment_supplier_cluster_plan_op_fact{env_suffix} ,FALLBACK , 
	NO BEFORE JOURNAL,
	NO AFTER JOURNAL,
	CHECKSUM = DEFAULT,
...
INSERT INTO {environment_schema}.merch_assortment_supplier_cluster_plan_op_fact{env_suffix}
SELECT *
FROM t2dl_das_apt_cost_reporting.merch_assortment_supplier_cluster_plan_history
WHERE CAST(rcd_update_timestamp AS DATE) = '2023-01-28'
;
