...
Author(s):       Sara Scott
*/
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_open_to_buy', 'xref_po_daily', OUT_RETURN_MSG);
CREATE MULTISET TABLE t2dl_das_open_to_buy.xref_po_daily
    ,FALLBACK
	,NO BEFORE JOURNAL
	,NO AFTER JOURNAL
	,CHECKSUM = DEFAULT
...
GRANT SELECT ON t2dl_das_open_to_buy.xref_po_daily TO PUBLIC;