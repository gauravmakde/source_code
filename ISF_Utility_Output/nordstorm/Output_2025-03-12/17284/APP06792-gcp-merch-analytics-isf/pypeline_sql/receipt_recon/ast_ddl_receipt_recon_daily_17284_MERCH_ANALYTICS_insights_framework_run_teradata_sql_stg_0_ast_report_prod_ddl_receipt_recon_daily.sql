CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_open_to_buy', 'receipt_recon_daily', OUT_RETURN_MSG);
CREATE MULTISET TABLE t2dl_das_open_to_buy.receipt_recon_daily
        ,FALLBACK
	,NO BEFORE JOURNAL
	,NO AFTER JOURNAL
	,CHECKSUM = DEFAULT
...
--COMMIT;
GRANT SELECT ON t2dl_das_open_to_buy.receipt_recon_daily TO PUBLIC;