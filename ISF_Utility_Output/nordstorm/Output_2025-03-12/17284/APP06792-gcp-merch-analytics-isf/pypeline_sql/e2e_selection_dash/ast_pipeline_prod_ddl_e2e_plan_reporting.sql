...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{environment_schema}', 'e2e_selection_planning{env_suffix}', OUT_RETURN_MSG);
CREATE MULTISET TABLE {environment_schema}.e2e_selection_planning{env_suffix} ,FALLBACK , 
	NO BEFORE JOURNAL,
	NO AFTER JOURNAL,
	CHECKSUM = DEFAULT,
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{environment_schema}', 'sel_dept_category_plan_history{env_suffix}', OUT_RETURN_MSG);
CREATE MULTISET TABLE {environment_schema}.sel_dept_category_plan_history{env_suffix} ,FALLBACK , 
	NO BEFORE JOURNAL,
	NO AFTER JOURNAL,
	CHECKSUM = DEFAULT,
	DEFAULT MERGEBLOCKRATIO,
