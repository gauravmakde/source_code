...
delete from {environment_schema}.price_band_weekly{env_suffix}
--delete from t3dl_ace_pra.price_band_weekly -- this line exists only for testing purposes
;

insert into {environment_schema}.price_band_weekly{env_suffix}
...
on {environment_schema}.price_band_weekly{env_suffix}
