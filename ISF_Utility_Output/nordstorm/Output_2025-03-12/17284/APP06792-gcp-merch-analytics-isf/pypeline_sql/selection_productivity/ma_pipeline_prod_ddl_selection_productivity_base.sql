...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{environment_schema}', 'selection_productivity_base{env_suffix}', OUT_RETURN_MSG); 
CREATE MULTISET TABLE {environment_schema}.selection_productivity_base{env_suffix} ,FALLBACK ,
		NO BEFORE JOURNAL,
	NO AFTER JOURNAL,
	CHECKSUM = DEFAULT,
...
GRANT SELECT ON {environment_schema}.selection_productivity_base{env_suffix} TO PUBLIC;
