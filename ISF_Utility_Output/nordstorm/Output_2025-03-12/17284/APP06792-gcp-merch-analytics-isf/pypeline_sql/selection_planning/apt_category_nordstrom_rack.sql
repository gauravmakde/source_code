...
SELECT 
	...
	(SUM(EOH_REGULAR_UNITS + EOH_CLEARANCE_UNITS + BOH_REGULAR_UNITS + BOH_CLEARANCE_UNITS) / 2) AS "Avg Inv U",
	(SUM(EOH_REGULAR_COST + EOH_CLEARANCE_COST + BOH_REGULAR_COST + BOH_CLEARANCE_COST) / 2) AS "Avg Inv C",
...
FROM T2DL_DAS_APT.RACK_CATEGORY_HIST
WHERE COUNTRY = 'US'
