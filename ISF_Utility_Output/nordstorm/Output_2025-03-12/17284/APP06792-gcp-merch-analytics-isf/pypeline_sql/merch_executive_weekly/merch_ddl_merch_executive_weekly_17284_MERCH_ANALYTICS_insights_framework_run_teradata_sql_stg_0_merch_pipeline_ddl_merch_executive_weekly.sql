...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('T2DL_DAS_IN_SEASON_MANAGEMENT_REPORTING', 'merch_executive_weekly', OUT_RETURN_MSG);
CREATE MULTISET TABLE T2DL_DAS_IN_SEASON_MANAGEMENT_REPORTING.merch_executive_weekly, FALLBACK,
	NO BEFORE JOURNAL,
	NO AFTER JOURNAL,
	CHECKSUM = DEFAULT,
...
Grant SELECT ON T2DL_DAS_IN_SEASON_MANAGEMENT_REPORTING.merch_executive_weekly TO PUBLIC;