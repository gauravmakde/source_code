...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{environment_schema}', 'SUPPLIER_PROFITABILITY_EXPECTATION_CHANNEL_WEEK_DEPT', OUT_RETURN_MSG);
CREATE MULTISET TABLE {environment_schema}.SUPPLIER_PROFITABILITY_EXPECTATION_CHANNEL_WEEK_DEPT
  ,FALLBACK ,
	NO BEFORE JOURNAL,
	NO AFTER JOURNAL,
	CHECKSUM = DEFAULT,
...
GRANT SELECT ON {environment_schema}.SUPPLIER_PROFITABILITY_EXPECTATION_CHANNEL_WEEK_DEPT TO PUBLIC;
