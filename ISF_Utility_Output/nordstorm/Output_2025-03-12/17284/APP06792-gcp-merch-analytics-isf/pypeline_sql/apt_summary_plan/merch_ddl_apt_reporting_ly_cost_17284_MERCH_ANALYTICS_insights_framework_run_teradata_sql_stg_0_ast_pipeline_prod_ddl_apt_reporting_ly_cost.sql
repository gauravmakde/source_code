...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_apt_cost_reporting', 'category_priceband_cost_ly', OUT_RETURN_MSG);
CREATE MULTISET TABLE t2dl_das_apt_cost_reporting.category_priceband_cost_ly ,FALLBACK ,
	NO BEFORE JOURNAL,
	NO AFTER JOURNAL,
	CHECKSUM = DEFAULT,
...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('t2dl_das_apt_cost_reporting', 'category_suppliergroup_cost_ly', OUT_RETURN_MSG);
CREATE MULTISET TABLE t2dl_das_apt_cost_reporting.category_suppliergroup_cost_ly ,FALLBACK ,
	NO BEFORE JOURNAL,
	NO AFTER JOURNAL,
	CHECKSUM = DEFAULT,
	DEFAULT MERGEBLOCKRATIO,
