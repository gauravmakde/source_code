...
CALL SYS_MGMT.DROP_IF_EXISTS_SP ('{environment_schema}', 'adoption_staging{env_suffix}', OUT_RETURN_MSG);
CREATE MULTISET TABLE {environment_schema}.adoption_staging{env_suffix}
	,fallback
	,NO BEFORE JOURNAL
	,NO AFTER JOURNAL
	,CHECKSUM = DEFAULT
...
CALL SYS_MGMT.S3_TPT_LOAD ('{environment_schema}','adoption_staging{env_suffix}','us-west-2','size-curve','adoption/','adoption_extract.csv','2C',OUT_MESSAGE); 