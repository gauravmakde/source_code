...
dag_id = 'gcp_merch_main_los_daily_agg_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_main_los_daily_agg_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    live_on_site_live_on_site_merch_main_los_daily_agg_17284_MERCH_ANALYTICS_insights_framework_run_teradata_sql_stg_0_ma_pipeline_prod_main_los_daily_agg = open( os.path.join(sql_path, 'live_on_site/live_on_site/merch_main_los_daily_agg_17284_MERCH_ANALYTICS_insights_framework_run_teradata_sql_stg_0_ma_pipeline_prod_main_los_daily_agg.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": live_on_site_live_on_site_merch_main_los_daily_agg_17284_MERCH_ANALYTICS_insights_framework_run_teradata_sql_stg_0_ma_pipeline_prod_main_los_daily_agg,
                "useLegacySql": False
            }
        },
