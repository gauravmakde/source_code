# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        f4782001e95bd3cb02af261574987384503284eb
# CI pipeline URL:      https://git.jwn.app/TM01310/APP06792-gcp-merch-analytics-isf/-/pipelines/8808371
# CI commit timestamp:  2025-03-11T11:44:04-07:00
...
dag_id = 'gcp_merch_ddl_los_daily_agg_17284_MERCH_ANALYTICS_insights_framework'
...
default_args = {
    ...
    'description': 'merch_ddl_los_daily_agg_17284_MERCH_ANALYTICS_insights_framework DAG Description',
...
with DAG(
    ...
    live_on_site_live_on_site_ddl_merch_ddl_los_daily_agg_17284_MERCH_ANALYTICS_insights_framework_run_teradata_sql_stg_0_ma_pipeline_prod_ddl_los_daily_agg = open( os.path.join(sql_path, 'live_on_site/live_on_site/ddl/merch_ddl_los_daily_agg_17284_MERCH_ANALYTICS_insights_framework_run_teradata_sql_stg_0_ma_pipeline_prod_ddl_los_daily_agg.sql'),"r").read()
    ...
    launch_run_teradata_sql_stg_0_job_0 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": live_on_site_live_on_site_ddl_merch_ddl_los_daily_agg_17284_MERCH_ANALYTICS_insights_framework_run_teradata_sql_stg_0_ma_pipeline_prod_ddl_los_daily_agg,
                "useLegacySql": False
            }
        },
...
creds_setup >> fetch_batch_run_id_task >> launch_run_teradata_sql_stg_0_job_0 >> pelican_validator >> pelican_sensor