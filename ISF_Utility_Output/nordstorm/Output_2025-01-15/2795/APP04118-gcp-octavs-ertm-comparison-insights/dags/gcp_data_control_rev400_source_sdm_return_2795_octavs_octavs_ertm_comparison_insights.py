# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        0f891d47b5c770407ae9e15d77b51f1058057a60
# CI pipeline URL:      https://git.jwn.app/TM01051/APP04118-gcp-octavs-ertm-comparison-insights/-/pipelines/7558081
# CI commit timestamp:  2024-11-19T11:36:20-08:00
...
root_path = path.dirname(__file__).split('APP04118-gcp-octavs-ertm-comparison-insights')[0] + 'APP04118-gcp-octavs-ertm-comparison-insights/'
...
dag_id = 'gcp_data_control_rev400_source_sdm_return_2795_octavs_octavs_ertm_comparison_insights'
...
default_args = {
    ...
    'description': 'data_control_rev400_source_sdm_return_2795_octavs_octavs_ertm_comparison_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="generate_rev400_return_report_job")   
    generate_rev400_return_report_job = DataprocCreateBatchOperator(
            task_id = "generate_rev400_return_report_job",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_data_control_rev400_source_sdm_return_2795_octavs_octavs_ertm_comparison_insights_generate_rev400_return_report_job.json",
...
creds_setup >> fetch_batch_run_id_task >>[generate_rev400_return_report_job]
    generate_rev400_return_report_job >> pelican_validator >> pelican_sensor