...
dag_id = 'gcp_data_control_rev400_source_sdm_2795_octavs_octavs_ertm_comparison_insights'
...
default_args = {
    ...
    'description': 'data_control_rev400_source_sdm_2795_octavs_octavs_ertm_comparison_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="generate_rev400_report_job")   
    generate_rev400_report_job = DataprocCreateBatchOperator(
            task_id = "generate_rev400_report_job",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_data_control_rev400_source_sdm_2795_octavs_octavs_ertm_comparison_insights_generate_rev400_report_job.json",
...
creds_setup >> fetch_batch_run_id_task >>[generate_rev400_report_job]
    generate_rev400_report_job >> pelican_validator >> pelican_sensor