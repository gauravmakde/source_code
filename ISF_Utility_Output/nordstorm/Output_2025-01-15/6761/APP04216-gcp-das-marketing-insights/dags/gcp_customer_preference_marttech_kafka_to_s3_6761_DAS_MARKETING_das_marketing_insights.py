...
dag_id = 'gcp_customer_preference_marttech_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'customer_preference_marttech_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_cpp_marttech_object_model_kafka_to_s3")   
    load_cpp_marttech_object_model_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_cpp_marttech_object_model_kafka_to_s3",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_customer_preference_marttech_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_cpp_marttech_object_model_kafka_to_s3.json",
...
launch_extracted_and_audit_files_copy_to_s3_path_folders = launch_k8s_api_job_operator(
    ...
    container_command=['/home/nonroot/docker-entrypoint.sh', 'python/utils/src/bulk_s3_copy.py', '--s3_source_bucket_env_name', 'S3_MKTG_BUCKET', '--s3_target_bucket_env_name', 'S3_MKTG_BUCKET', '--source_to_target_path_pair', "{'source': 'isf/data/customer_preference_marttech/cpp_marttech_data_extract/', 'target': 'isf/data/customer_preference_marttech/incremental/year=<year>/month=<month>/day=<day>/hour=<hour>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/customer_preference_marttech/cpp_marttech_final_count/', 'target': 'isf/audit/customer_preference_marttech/incremental/year=<year>/month=<month>/day=<day>/hour=<hour>/'}", '--base_date_iso_env_name', 'DAG_EXECUTION_DATE'],
...
creds_setup >> fetch_batch_run_id_task >>[load_cpp_marttech_object_model_kafka_to_s3]
    load_cpp_marttech_object_model_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folders]
