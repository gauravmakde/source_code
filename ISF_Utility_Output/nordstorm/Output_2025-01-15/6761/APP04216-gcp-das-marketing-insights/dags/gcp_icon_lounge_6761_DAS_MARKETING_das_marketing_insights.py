...
dag_id = 'gcp_icon_lounge_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'icon_lounge_6761_DAS_MARKETING_das_marketing_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="read_s3_to_teradata_job_0")   
    read_s3_to_teradata_job_0 = DataprocCreateBatchOperator(
            task_id = "read_s3_to_teradata_job_0",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_icon_lounge_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_job_0.json",
...
icon_lounge_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_stg_to_fct = open(
    os.path.join(sql_path, 'icon_lounge_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_stg_to_fct.sql'),
    "r").read()

    launch_read_s3_to_teradata_job_1 = BigQueryInsertJobOperator(
        task_id = "read_s3_to_teradata_job_1",
        configuration = 
        {
            "query": 
            {
                "query": icon_lounge_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_stg_to_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
launch_s3_bucket_move_files_to_s3_path_folders = launch_k8s_api_job_operator(
    dag=dag,
    connection_id='k8s_connection',
    namespace='app04216',
    task_id='s3_bucket_move_files_to_s3_path_folders',
    job_name='s3-bucket-move-files-to-s3-path-folders-icon-lounge-6761-das-ma',
    macros=None,
    ...
    container_command=['/home/nonroot/docker-entrypoint.sh', 'python/utils/src/bulk_s3_copy.py', '--s3_source_bucket_env_name', 'S3_ICON_LOUNGE_BUCKET', '--s3_target_bucket_env_name', 'S3_ICON_LOUNGE_BUCKET', '--source_to_target_path_pair', "{'source': 'tokenized/', 'target': 'backup/'}"],
...
creds_setup >> fetch_batch_run_id_task >>[read_s3_to_teradata_job_0]
    read_s3_to_teradata_job_0 >>[launch_read_s3_to_teradata_job_1]
    launch_read_s3_to_teradata_job_1 >>[launch_s3_bucket_move_files_to_s3_path_folders]
    launch_s3_bucket_move_files_to_s3_path_folders >> pelican_validator >> pelican_sensor