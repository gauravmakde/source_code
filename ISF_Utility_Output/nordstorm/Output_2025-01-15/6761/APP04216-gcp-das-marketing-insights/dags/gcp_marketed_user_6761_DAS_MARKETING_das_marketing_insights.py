...
dag_id = 'gcp_marketed_user_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'marketed_user_6761_DAS_MARKETING_das_marketing_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="read_s3_to_teradata_s3_to_stg")   
    read_s3_to_teradata_s3_to_stg = DataprocCreateBatchOperator(
            task_id = "read_s3_to_teradata_s3_to_stg",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_marketed_user_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_s3_to_stg.json",
...
marketed_user_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_stg_to_fct = open(
    os.path.join(sql_path, 'marketed_user_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_stg_to_fct.sql'),
    "r").read()

    launch_read_s3_to_teradata_stg_to_fct = BigQueryInsertJobOperator(
        task_id = "read_s3_to_teradata_stg_to_fct",
        configuration = 
        {
            "query": 
            {
                "query": marketed_user_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_stg_to_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[read_s3_to_teradata_s3_to_stg]
    read_s3_to_teradata_s3_to_stg >>[launch_read_s3_to_teradata_stg_to_fct]
    launch_read_s3_to_teradata_stg_to_fct >> pelican_validator >> pelican_sensor