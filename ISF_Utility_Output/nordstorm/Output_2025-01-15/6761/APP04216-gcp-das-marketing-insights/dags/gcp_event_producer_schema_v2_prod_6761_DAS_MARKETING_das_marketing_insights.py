...
dag_id = 'gcp_event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights DAG Description',
...
with DAG(
    ...
    event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr_history.sql,apps_event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr_history,apps_etl_framework_airflow_nsk_dag_job_artifacts_prod_6761_DAS_MARKETING_das_marketing_insights_sql_event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr,apps_etl_framework_airflow_nsk_dag_job_artifacts_prod_6761_DAS_MARKETING_das_marketing_insights_sql_event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr_delta = open( os.path.join(sql_path, 'event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr_history.sql,apps/event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr_history.sql,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/6761/DAS_MARKETING/das_marketing_insights/sql/event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr.sql,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/6761/DAS_MARKETING/das_marketing_insights/sql/event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr_delta.sql'),"r").read()

    launch_write_to_insight_event_stg_0_job_0 = BigQueryInsertJobOperator(
        task_id = "write_to_insight_event_stg_0_job_0",
        configuration = 
        {
            "query": 
            {
                "query": event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr_history.sql,apps_event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr_history,apps_etl_framework_airflow_nsk_dag_job_artifacts_prod_6761_DAS_MARKETING_das_marketing_insights_sql_event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr,apps_etl_framework_airflow_nsk_dag_job_artifacts_prod_6761_DAS_MARKETING_das_marketing_insights_sql_event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights_write_to_insight_event_stg_0_cpp_ebr_delta,
                "useLegacySql": False
            }
        },
...
launch_write_to_insight_event_stg_0_job_1 = launch_k8s_api_job_operator(
    dag=dag,
    connection_id='k8s_connection',
    namespace='app04216',
    task_id='write_to_insight_event_stg_0_job_1',
    job_name='write-to-insight-event-stg-0-job-1-event-producer-schema-v2-pro',
    macros=None,
    container_image='artifactory.nordstrom.com/docker/app08499/insights-framework/insights-event-producer:0.8.1',
    container_command=['java', '-jar', '/home/nonroot/insights-event-producer-all.jar', '--kafka_cluster_name', 'MEADOW', '--env', 'PROD', '--kpi_table_name', 'CPP_EBR_TRAN_DELTA_LDG', '--delta_column', 'dw_sys_updt_tmstp', '--producer_topic', 'cpp_ebr_insight_event_avro_v2', '--database_name', 'PRD_NAP_STG', '--teradata_host_name', 'tdnapprod.nordstrom.net', '--kafka_vault_path', 'nordsecrets/application/APP04216/6761/das_marketing/das-marketing-insights/prod/kafka/oauth_credentials', '--teradata_vault_path', 'nordsecrets/application/APP04216/6761/das_marketing/das-marketing-insights/prod/teradata/teradta_db_credentials', '--vault_host', 'https://vpce-01f9458aff654a035-ng0ubact.vpce-svc-00627e41a40fb1e3c.us-west-2.vpce.amazonaws.com:8200', '--extract_start_timestamp', 'CURRENT_DAY_START_TIMESTAMP', '--extract_end_timestamp', 'CURRENT_DAY_END_TIMESTAMP', '--statsd_host', 'gostatsd.kube-system.svc', '--statsd_port', '8128', '--auth_mechanism', 'OAUTHBEARER', '--retry_backoff_ms', '500', '--request_timeout_ms', '20000'],
    resources={'limits': {'cpu': 5, 'memory': '6Gi' },'requests': {'cpu': 3, 'memory': '2Gi'}},
    common_envs=[],
    task_envs=[{'name': 'TIER', 'value': '3'}, {'name': 'STATSD_HOST', 'value': 'gostatsd.kube-system.svc'}, {'name': 'STATSD_PORT', 'value': '8128'}, {'name': 'APP_ID', 'value': 'APP04216'}, {'name': 'NEW_RELIC_APP_NAME', 'value': 'onehop-insights-framework-APP04216-PROD'}, {'name': 'ENV', 'value': 'PROD'}, {'name': 'VAULT_ROLE_ID', 'valueFrom': {'secretKeyRef': {'key': 'roleid', 'name': 'vault'}}}, {'name': 'VAULT_SECRET', 'valueFrom': {'secretKeyRef': {'key': 'secret', 'name': 'vault'}}}, {'name': 'DAG_ID', 'value': 'event_producer_schema_v2_prod_6761_DAS_MARKETING_das_marketing_insights'}],
...
creds_setup >> fetch_batch_run_id_task >> launch_write_to_insight_event_stg_0_job_0 >>[launch_write_to_insight_event_stg_0_job_1]
    launch_write_to_insight_event_stg_0_job_1 >> pelican_validator >> pelican_sensor