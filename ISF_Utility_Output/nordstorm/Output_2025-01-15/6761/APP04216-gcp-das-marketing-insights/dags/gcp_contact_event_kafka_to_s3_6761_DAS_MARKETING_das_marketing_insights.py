...
dag_id = 'gcp_contact_event_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'contact_event_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_event_bounced_object_model_kafka_to_s3")   
    load_event_bounced_object_model_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_event_bounced_object_model_kafka_to_s3",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_contact_event_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_event_bounced_object_model_kafka_to_s3.json",
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_event_clicked_object_model_kafka_to_s3")   
    load_event_clicked_object_model_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_event_clicked_object_model_kafka_to_s3",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_contact_event_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_event_clicked_object_model_kafka_to_s3.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_event_opened_object_model_kafka_to_s3")   
    load_event_opened_object_model_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_event_opened_object_model_kafka_to_s3",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_contact_event_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_event_opened_object_model_kafka_to_s3.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_event_sent_object_model_kafka_to_s3")   
    load_event_sent_object_model_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_event_sent_object_model_kafka_to_s3",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_contact_event_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_event_sent_object_model_kafka_to_s3.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_event_unsubscribed_object_model_kafka_to_s3")   
    load_event_unsubscribed_object_model_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_event_unsubscribed_object_model_kafka_to_s3",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_contact_event_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_event_unsubscribed_object_model_kafka_to_s3.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
launch_extracted_and_audit_files_copy_to_s3_path_folder = launch_k8s_api_job_operator(
    dag=dag,
    connection_id='k8s_connection',
    namespace='app04216',
    task_id='extracted_and_audit_files_copy_to_s3_path_folder',
    job_name='extracted-and-audit-files-copy-to-s3-path-folder-contact-event',
    ...
    container_command=['/home/nonroot/docker-entrypoint.sh', 'python/utils/src/bulk_s3_copy.py', '--s3_source_bucket_env_name', 'S3_MKTG_BUCKET', '--s3_target_bucket_env_name', 'S3_MKTG_BUCKET', '--source_to_target_path_pair', "{'source': 'isf/data/contact_event/event_bounced_data_extract/', 'target': 'isf/data/contact_event/eventBounced/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/data/contact_event/event_clicked_data_extract/', 'target': 'isf/data/contact_event/eventClicked/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/data/contact_event/event_opened_data_extract/', 'target': 'isf/data/contact_event/eventOpened/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/data/contact_event/event_sent_data_extract/', 'target': 'isf/data/contact_event/eventSent/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/data/contact_event/event_unsubscribed_data_extract/', 'target': 'isf/data/contact_event/eventUnsubscribed/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/contact_event/event_bounced_final_count/', 'target': 'isf/audit/contact_event/eventBounced/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/contact_event/event_clicked_final_count/', 'target': 'isf/audit/contact_event/eventClicked/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/contact_event/event_opened_final_count/', 'target': 'isf/audit/contact_event/eventOpened/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/contact_event/event_sent_final_count/', 'target': 'isf/audit/contact_event/eventSent/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/contact_event/event_unsubscribed_final_count/', 'target': 'isf/audit/contact_event/eventUnsubscribed/year=<year>/month=<month>/day=<day>/'}", '--base_date_iso_env_name', 'DAG_EXECUTION_DATE'],
...
creds_setup >> fetch_batch_run_id_task >>[load_event_bounced_object_model_kafka_to_s3, load_event_clicked_object_model_kafka_to_s3, load_event_opened_object_model_kafka_to_s3, load_event_sent_object_model_kafka_to_s3, load_event_unsubscribed_object_model_kafka_to_s3]
    load_event_bounced_object_model_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folder]
    load_event_clicked_object_model_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folder]
    load_event_opened_object_model_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folder]
    load_event_sent_object_model_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folder]
    load_event_unsubscribed_object_model_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folder]
    launch_extracted_and_audit_files_copy_to_s3_path_folder >> pelican_validator >> pelican_sensor