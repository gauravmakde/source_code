...
dag_id = 'gcp_marketing_mix_model_s3_copy_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'marketing_mix_model_s3_copy_6761_DAS_MARKETING_das_marketing_insights DAG Description',
...
with DAG(
    ...
    external_dag_id='gcp_marketing_mix_model_inventory_merch_kpi_teradata_6761_DAS_MARKETING_das_marketing_insights',
    timeout=7200,
    ...
    external_dag_id='gcp_marketing_mix_model_customer_kpi_teradata_6761_DAS_MARKETING_das_marketing_insights',
    timeout=7200,
    ...
    launch_check_external_upstream_dependencies_sensor_2 = ExternalTaskSensor(
    dag=dag,
    task_id='check_external_upstream_dependencies_2',
    external_dag_id='gcp_marketing_mix_model_finance_kpi_teradata_6761_DAS_MARKETING_das_marketing_insights',
    timeout=7200,
    ...
    launch_check_external_upstream_dependencies_sensor_3 = ExternalTaskSensor(
    dag=dag,
    task_id='check_external_upstream_dependencies_3',
    external_dag_id='gcp_marketing_mix_model_finance_kpi_teradata_6761_DAS_MARKETING_das_marketing_insights',
    timeout=7200,
    ...
    launch_check_external_upstream_dependencies_sensor_4 = ExternalTaskSensor(
    dag=dag,
    task_id='check_external_upstream_dependencies_4',
    external_dag_id='gcp_marketing_mix_model_traffic_kpi_teradata_6761_DAS_MARKETING_das_marketing_insights',
    timeout=7200,
    ...
    launch_check_external_upstream_dependencies_sensor_5 = ExternalTaskSensor(
    dag=dag,
    task_id='check_external_upstream_dependencies_5',
    external_dag_id='gcp_marketing_mix_model_store_realestate_teradata_6761_DAS_MARKETING_das_marketing_insights',
    timeout=7200,
    ...
    launch_check_external_upstream_dependencies_sensor_6 = ExternalTaskSensor(
    dag=dag,
    task_id='check_external_upstream_dependencies_6',
    external_dag_id='gcp_marketing_mix_model_store_hrs_teradata_6761_DAS_MARKETING_das_marketing_insights',
    timeout=7200,
    ...
    launch_check_external_upstream_dependencies_sensor_7 = ExternalTaskSensor(
    dag=dag,
    task_id='check_external_upstream_dependencies_7',
    external_dag_id='gcp_marketing_mix_model_loyalty_redemption_teradata_6761_DAS_MARKETING_das_marketing_insights',
    timeout=7200,
    ...
    launch_check_external_upstream_dependencies_sensor_8 = ExternalTaskSensor(
    dag=dag,
    task_id='check_external_upstream_dependencies_8',
    external_dag_id='gcp_marketing_mix_model_delivery_speed_teradata_6761_DAS_MARKETING_das_marketing_insights',
    timeout=7200,
    ...
    launch_check_external_upstream_dependencies_sensor_9 = ExternalTaskSensor(
    dag=dag,
    task_id='check_external_upstream_dependencies_9',
    external_dag_id='gcp_marketing_mix_model_customer_satisfaction_teradata_6761_DAS_MARKETING_das_marketing_insights',
    timeout=7200,
    ...
    launch_s3_bucket_csv_files_copy_to_s3_path_folders = launch_k8s_api_job_operator(
    dag=dag,
    connection_id='k8s_connection',
    namespace='app04216',
    task_id='s3_bucket_csv_files_copy_to_s3_path_folders',
    job_name='s3-bucket-csv-files-copy-to-s3-path-folders-marketing-mix-model',
    macros=None,
    ...
    container_command=['/home/nonroot/docker-entrypoint.sh', 'python/utils/src/bulk_s3_copy.py', '--s3_source_bucket_env_name', 'S3_MMM_BUCKET', '--s3_target_bucket_env_name', 'S3_OPTIMINE_BUCKET', '--source_to_target_path_pair', "{'source': 'Nordstrom/Outbound/delta_load/weekly_refresh/year=<year>/month=<month>/day=<day>/', 'target': 'Nordstrom/Outbound/'}"],
...
creds_setup >> fetch_batch_run_id_task >> launch_check_external_upstream_dependencies_sensor_0 >>[launch_s3_bucket_csv_files_copy_to_s3_path_folders]
    launch_check_external_upstream_dependencies_sensor_1 >>[launch_s3_bucket_csv_files_copy_to_s3_path_folders]
    launch_check_external_upstream_dependencies_sensor_2 >>[launch_s3_bucket_csv_files_copy_to_s3_path_folders]
    launch_check_external_upstream_dependencies_sensor_3 >>[launch_s3_bucket_csv_files_copy_to_s3_path_folders]
    launch_check_external_upstream_dependencies_sensor_4 >>[launch_s3_bucket_csv_files_copy_to_s3_path_folders]
    launch_check_external_upstream_dependencies_sensor_5 >>[launch_s3_bucket_csv_files_copy_to_s3_path_folders]
    launch_check_external_upstream_dependencies_sensor_6 >>[launch_s3_bucket_csv_files_copy_to_s3_path_folders]
    launch_check_external_upstream_dependencies_sensor_7 >>[launch_s3_bucket_csv_files_copy_to_s3_path_folders]
    launch_check_external_upstream_dependencies_sensor_8 >>[launch_s3_bucket_csv_files_copy_to_s3_path_folders]
    launch_check_external_upstream_dependencies_sensor_9 >>[launch_s3_bucket_csv_files_copy_to_s3_path_folders]
    launch_s3_bucket_csv_files_copy_to_s3_path_folders >> pelican_validator >> pelican_sensor