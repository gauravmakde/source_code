...
dag_id = 'gcp_loyalty_member_note_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'loyalty_member_note_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_loyalty_note_object_model_kafka_to_s3")   
    load_loyalty_note_object_model_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_loyalty_note_object_model_kafka_to_s3",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_loyalty_member_note_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_loyalty_note_object_model_kafka_to_s3.json",
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_giftcard_object_model_kafka_to_s3")   
    load_giftcard_object_model_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_giftcard_object_model_kafka_to_s3",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_loyalty_member_note_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_giftcard_object_model_kafka_to_s3.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_giftcard_transaction_object_model_kafka_to_s3")   
    load_giftcard_transaction_object_model_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_giftcard_transaction_object_model_kafka_to_s3",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_loyalty_member_note_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_giftcard_transaction_object_model_kafka_to_s3.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
launch_extracted_and_audit_files_copy_to_s3_path_folder = launch_k8s_api_job_operator(
    ...
    job_name='extracted-and-audit-files-copy-to-s3-path-folder-loyalty-member',
    ...
    container_command=['/home/nonroot/docker-entrypoint.sh', 'python/utils/src/bulk_s3_copy.py', '--s3_source_bucket_env_name', 'S3_MKTG_BUCKET', '--s3_target_bucket_env_name', 'S3_MKTG_BUCKET', '--source_to_target_path_pair', "{'source': 'isf/data/loyalty_note/loyalty_note_data_extract/', 'target': 'isf/data/loyalty_note/incremental/year=<year>/month=<month>/day=<day>/hour=<hour>/'}", '--source_to_target_path_pair', "{'source': 'isf/data/giftcard/giftcard_data_extract/', 'target': 'isf/data/giftcard/incremental/year=<year>/month=<month>/day=<day>/hour=<hour>/'}", '--source_to_target_path_pair', "{'source': 'isf/data/gift_card_transaction/giftcard_transaction_data_extract/', 'target': 'isf/data/gift_card_transaction/incremental/year=<year>/month=<month>/day=<day>/hour=<hour>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/loyalty_note/loyalty_note_final_count/', 'target': 'isf/audit/loyalty_note/incremental/year=<year>/month=<month>/day=<day>/hour=<hour>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/giftcard/giftcard_final_count/', 'target': 'isf/audit/giftcard/incremental/year=<year>/month=<month>/day=<day>/hour=<hour>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/gift_card_transaction/giftcard_transaction_final_count/', 'target': 'isf/audit/gift_card_transaction/incremental/year=<year>/month=<month>/day=<day>/hour=<hour>/'}", '--base_date_iso_env_name', 'DAG_EXECUTION_DATE'],
...
creds_setup >> fetch_batch_run_id_task >>[load_giftcard_object_model_kafka_to_s3, load_giftcard_transaction_object_model_kafka_to_s3, load_loyalty_note_object_model_kafka_to_s3]
    load_loyalty_note_object_model_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folder]
    load_giftcard_object_model_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folder]
    load_giftcard_transaction_object_model_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folder]
