...
dag_id = 'gcp_rsvp_onetime_load_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'rsvp_onetime_load_6761_DAS_MARKETING_das_marketing_insights DAG Description',
...
with DAG(
    ...
    rsvp_onetime_load_6761_DAS_MARKETING_das_marketing_insights_clear_ldg_data_clear_ldg = open(
    os.path.join(sql_path, 'rsvp_onetime_load_6761_DAS_MARKETING_das_marketing_insights_clear_ldg_data_clear_ldg.sql'),
    "r").read()

    launch_clear_ldg_data_job_0 = BigQueryInsertJobOperator(
        task_id = "clear_ldg_data_job_0",
        configuration = 
        {
            "query": 
            {
                "query": rsvp_onetime_load_6761_DAS_MARKETING_das_marketing_insights_clear_ldg_data_clear_ldg,
                "useLegacySql": False
            }
        },
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_rsvp_onetime_load_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_job_0.json",
...
rsvp_onetime_load_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_stg_to_fct = open(
    os.path.join(sql_path, 'rsvp_onetime_load_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_stg_to_fct.sql'),
    "r").read()
    ...
    launch_read_s3_to_teradata_job_1 = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": rsvp_onetime_load_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_stg_to_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >> launch_clear_ldg_data_job_0 >>[read_s3_to_teradata_job_0]
    read_s3_to_teradata_job_0 >>[launch_read_s3_to_teradata_job_1]
    launch_read_s3_to_teradata_job_1 >> pelican_validator >> pelican_sensor