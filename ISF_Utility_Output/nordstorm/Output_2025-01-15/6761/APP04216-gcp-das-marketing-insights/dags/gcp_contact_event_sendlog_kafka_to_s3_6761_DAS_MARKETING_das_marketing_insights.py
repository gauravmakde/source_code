...
dag_id = 'gcp_contact_event_sendlog_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'contact_event_sendlog_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights DAG Description',
...
with DAG(
    ...
    external_dag_id='gcp_cpp_unsubscribe_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights',
    timeout=1800,
    ...
    external_dag_id='gcp_contact_event_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights',
    timeout=1800,
    execution_date_fn=get_most_recent_dag_run,
    retries=1)

session_name=get_batch_id(dag_id=dag_id,task_id="load_contact_event_sendlog_object_model_kafka_to_s3")   
    load_contact_event_sendlog_object_model_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_contact_event_sendlog_object_model_kafka_to_s3",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_contact_event_sendlog_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_contact_event_sendlog_object_model_kafka_to_s3.json",
...
launch_extracted_and_audit_files_copy_to_s3_path_folder = launch_k8s_api_job_operator(
    ...
    container_command=['/home/nonroot/docker-entrypoint.sh', 'python/utils/src/bulk_s3_copy.py', '--s3_source_bucket_env_name', 'S3_MKTG_BUCKET', '--s3_target_bucket_env_name', 'S3_MKTG_BUCKET', '--source_to_target_path_pair', "{'source': 'isf/data/contact_event_sendlog/contact_event_sendlog_data_extract/', 'target': 'isf/data/contact_event_sendlog/contact_event_send_log/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/contact_event_sendlog/contact_event_sendlog_final_count/', 'target': 'isf/audit/contact_event_sendlog/contact_event_send_log/year=<year>/month=<month>/day=<day>/'}", '--base_date_iso_env_name', 'DAG_EXECUTION_DATE'],
...
creds_setup >> fetch_batch_run_id_task >> launch_check_external_upstream_dependencies_sensor_0 >>    launch_check_external_upstream_dependencies_sensor_1 >>[load_contact_event_sendlog_object_model_kafka_to_s3]
    load_contact_event_sendlog_object_model_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folder]
