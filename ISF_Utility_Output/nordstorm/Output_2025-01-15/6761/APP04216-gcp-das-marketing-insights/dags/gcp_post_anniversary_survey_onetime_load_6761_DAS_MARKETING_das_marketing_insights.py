...
dag_id = 'gcp_post_anniversary_survey_onetime_load_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'post_anniversary_survey_onetime_load_6761_DAS_MARKETING_das_marketing_insights DAG Description',
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_post_anniversary_survey_onetime_load_6761_DAS_MARKETING_das_marketing_insights_read_s3_to_teradata_job_0.json",
...
creds_setup >> fetch_batch_run_id_task >>[read_s3_to_teradata_job_0]
    read_s3_to_teradata_job_0 >> pelican_validator >> pelican_sensor