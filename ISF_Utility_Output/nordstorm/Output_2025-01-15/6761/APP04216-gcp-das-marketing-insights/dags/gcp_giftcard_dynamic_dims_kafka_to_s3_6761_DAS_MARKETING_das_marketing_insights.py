...
dag_id = 'gcp_giftcard_dynamic_dims_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'giftcard_dynamic_dims_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_alt_merchant_kafka_to_s3")   
    load_alt_merchant_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_alt_merchant_kafka_to_s3",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_giftcard_dynamic_dims_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_alt_merchant_kafka_to_s3.json",
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_funding_kafka_to_s3")   
    load_funding_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_funding_kafka_to_s3",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_giftcard_dynamic_dims_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_funding_kafka_to_s3.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_merchant_kafka_to_s3")   
    load_merchant_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_merchant_kafka_to_s3",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_giftcard_dynamic_dims_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_merchant_kafka_to_s3.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
session_name=get_batch_id(dag_id=dag_id,task_id="load_promotion_kafka_to_s3")   
    load_promotion_kafka_to_s3 = DataprocCreateBatchOperator(
            task_id = "load_promotion_kafka_to_s3",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_giftcard_dynamic_dims_kafka_to_s3_6761_DAS_MARKETING_das_marketing_insights_load_promotion_kafka_to_s3.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
launch_extracted_and_audit_files_copy_to_s3_path_folders = launch_k8s_api_job_operator(
    ...
    job_name='extracted-and-audit-files-copy-to-s3-path-folders-giftcard-dyna',
    ...
    container_command=['/home/nonroot/docker-entrypoint.sh', 'python/utils/src/bulk_s3_copy.py', '--s3_source_bucket_env_name', 'S3_MKTG_BUCKET', '--s3_target_bucket_env_name', 'S3_MKTG_BUCKET', '--source_to_target_path_pair', "{'source': 'isf/data/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_alt_merchant/alt_merchant_data_extract/', 'target': 'isf/data/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_alt_merchant/incremental/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_alt_merchant/alt_merchant_final_count/', 'target': 'isf/audit/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_alt_merchant/incremental/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/data/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_funding_class/funding_data_extract/', 'target': 'isf/data/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_funding_class/incremental/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_funding_class/funding_final_count/', 'target': 'isf/audit/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_funding_class/incremental/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/data/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_merchant/merchant_data_extract/', 'target': 'isf/data/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_merchant/incremental/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_merchant/merchant_final_count/', 'target': 'isf/audit/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_merchant/incremental/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/data/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_promotion/promotion_data_extract/', 'target': 'isf/data/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_promotion/incremental/year=<year>/month=<month>/day=<day>/'}", '--source_to_target_path_pair', "{'source': 'isf/audit/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_promotion/promotion_final_count/', 'target': 'isf/audit/gift_card_marketing/daily/gift_card_dynamic_dims/gift_card_promotion/incremental/year=<year>/month=<month>/day=<day>/'}", '--base_date_iso_env_name', 'DAG_EXECUTION_DATE'],
...
launch_save_status_of_the_dag_to_file_on_s3 = launch_k8s_api_job_operator(
    dag=dag,
    connection_id='k8s_connection',
    namespace='app04216',
    task_id='save_status_of_the_dag_to_file_on_s3',
    job_name='save-status-of-the-dag-to-file-on-s3-giftcard-dynamic-dims-kafk',
    macros={'DAG_EXECUTION_DATE': 'execution_date'},
    container_image='artifactory.nordstrom.com/docker/app04216/tm00989-app04216-das-marketing-insights/prod/python/utils:1.3.18',
    container_command=['/home/nonroot/docker-entrypoint.sh', 'python/utils/src/save_status_of_the_dag.py', '--s3_bucket', 'S3_MKTG_BUCKET', '--dag_name', 'giftcard_dynamic_dims_kafka_to_s3', '--base_date_iso_env_name', 'DAG_EXECUTION_DATE'],
    resources={'limits': {'cpu': 5, 'memory': '6Gi' },'requests': {'cpu': 3, 'memory': '2Gi'}},
    common_envs=[],
    task_envs=[{'name': 'S3_MKTG_BUCKET', 'value': 'tf-das-marketing-prod-teradata-stage'}, {'name': 'S3_MMM_BUCKET', 'value': 'prod-mmm-marketing-mix-model'}, {'name': 'S3_OPTIMINE_BUCKET', 'value': 'prod-mft-optimine'}, {'name': 'S3_ICON_LOUNGE_BUCKET', 'value': 'prod-icon-lounge'}, {'name': 'ENV', 'value': 'production'}, {'name': 'TD_ENV', 'value': 'PRD'}, {'name': 'TD_HOST', 'value': 'tdnapprod.nordstrom.net'}, {'name': 'TD_VAULT_PATH', 'value': 'data/application/APP04216/6761/das_marketing/das-marketing-insights/prod/teradata/teradta_db_credentials'}, {'name': 'NR_VAULT_PATH', 'value': 'data/application/APP04216/6761/das_marketing/das-marketing-insights/prod/newrelic/newrelic_ingest_key'}, {'name': 'MAIL_SA_VAULT_PATH', 'value': 'data/application/APP04216/6761/das_marketing/das-marketing-insights/prod/service_account/sa_credentials'}, {'name': 'VAULT_PATH', 'value': 'vpce-01f9458aff654a035-ng0ubact.vpce-svc-00627e41a40fb1e3c.us-west-2.vpce.amazonaws.com'}, {'name': 'VAULT_PORT', 'value': '8200'}, {'name': 'VAULT_ROLE_ID', 'valueFrom': {'secretKeyRef': {'key': 'roleid', 'name': 'vault'}}}, {'name': 'VAULT_SECRET', 'valueFrom': {'secretKeyRef': {'key': 'secret', 'name': 'vault'}}}],
    metadata={'annotations': {'kube2iam.beta.nordstrom.net/role': 'arn:aws:iam::699296113972:role/k8s/tf-k8s-controlled-role'}, 'labels': {'nap_domain': 'onehop-etl', 'nap_project': 'insights-framework', 'customer_team_name': 'DAS_MARKETING', 'customer_project_name': 'das_marketing_insights'}},
...
creds_setup >> fetch_batch_run_id_task >>[load_alt_merchant_kafka_to_s3, load_funding_kafka_to_s3, load_merchant_kafka_to_s3, load_promotion_kafka_to_s3]
    load_alt_merchant_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folders]
    load_funding_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folders]
    load_merchant_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folders]
    load_promotion_kafka_to_s3 >>[launch_extracted_and_audit_files_copy_to_s3_path_folders]
    launch_extracted_and_audit_files_copy_to_s3_path_folders >>[launch_save_status_of_the_dag_to_file_on_s3]
    launch_save_status_of_the_dag_to_file_on_s3 >> pelican_validator >> pelican_sensor