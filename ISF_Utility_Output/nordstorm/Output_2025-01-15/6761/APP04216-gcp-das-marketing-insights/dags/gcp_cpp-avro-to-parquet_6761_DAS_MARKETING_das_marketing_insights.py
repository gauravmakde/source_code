...
dag_id = 'cpp-avro-to-parquet_6761_DAS_MARKETING_das_marketing_insights'
...
default_args = {
    ...
    'description': 'cpp-avro-to-parquet_6761_DAS_MARKETING_das_marketing_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="cpp_kafka_to_parquet_merge_data")   
    cpp_kafka_to_parquet_merge_data = DataprocCreateBatchOperator(
            task_id = "cpp_kafka_to_parquet_merge_data",
...
session_name=get_batch_id(dag_id=dag_id,task_id="cpp_kafka_to_parquet_copy_from_temp_folder")   
    cpp_kafka_to_parquet_copy_from_temp_folder = DataprocCreateBatchOperator(
            task_id = "cpp_kafka_to_parquet_copy_from_temp_folder",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
...
session_name=get_batch_id(dag_id=dag_id,task_id="cpp_kafka_to_parquet_remove_temp_folder")   
    cpp_kafka_to_parquet_remove_temp_folder = DataprocCreateBatchOperator(
            task_id = "cpp_kafka_to_parquet_remove_temp_folder",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
...
creds_setup >> fetch_batch_run_id_task >>[cpp_kafka_to_parquet_merge_data]
    cpp_kafka_to_parquet_merge_data >>[cpp_kafka_to_parquet_copy_from_temp_folder]
    cpp_kafka_to_parquet_copy_from_temp_folder >>[cpp_kafka_to_parquet_remove_temp_folder]
    cpp_kafka_to_parquet_remove_temp_folder >> pelican_validator >> pelican_sensor