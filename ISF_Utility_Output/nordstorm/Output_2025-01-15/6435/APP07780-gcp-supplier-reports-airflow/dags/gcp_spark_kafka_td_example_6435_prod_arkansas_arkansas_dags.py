...
dag_id = 'gcp_spark_kafka_td_example_6435_prod_arkansas_arkansas_dags'
...
default_args = {
    ...
    'description': 'spark_kafka_td_example_6435_prod_arkansas_arkansas_dags DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="read_kafka_write_td_stage_1_job_1")   
    read_kafka_write_td_stage_1_job_1 = DataprocCreateBatchOperator(
            task_id = "read_kafka_write_td_stage_1_job_1",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_spark_kafka_td_example_6435_prod_arkansas_arkansas_dags_read_kafka_write_td_stage_1_job_1.json",
...
creds_setup >> fetch_batch_run_id_task >>[read_kafka_write_td_stage_1_job_1]
    read_kafka_write_td_stage_1_job_1 >> pelican_validator >> pelican_sensor