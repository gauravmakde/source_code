# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        71f3659e45c55b996dd64e0c99e2bdc77024e038
# CI pipeline URL:      https://git.jwn.app/TM00156/app01396-supplier-reports/APP07780-gcp-supplier-reports-airflow/-/pipelines/5509459
# CI commit timestamp:  2024-03-06T09:20:23-06:00
...
dag_id = 'gcp_spark_s3_example_6435_prod_arkansas_arkansas_dags'
...
default_args = {
    ...
    'description': 'spark_s3_example_6435_prod_arkansas_arkansas_dags DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="read_write_kafka_jdbc_s3_stage_0_job_1")   
    read_write_kafka_jdbc_s3_stage_0_job_1 = DataprocCreateBatchOperator(
            task_id = "read_write_kafka_jdbc_s3_stage_0_job_1",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_spark_s3_example_6435_prod_arkansas_arkansas_dags_read_write_kafka_jdbc_s3_stage_0_job_1.json",
...
creds_setup >> fetch_batch_run_id_task >>[read_write_kafka_jdbc_s3_stage_0_job_1]
    read_write_kafka_jdbc_s3_stage_0_job_1 >> pelican_validator >> pelican_sensor