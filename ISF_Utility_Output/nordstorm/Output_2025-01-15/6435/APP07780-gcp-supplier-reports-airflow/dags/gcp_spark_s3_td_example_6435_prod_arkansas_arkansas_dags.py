...
dag_id = 'gcp_spark_s3_td_example_6435_prod_arkansas_arkansas_dags'
...
default_args = {
    ...
    'description': 'spark_s3_td_example_6435_prod_arkansas_arkansas_dags DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="read_write_s3_td_stage_0_job_1")   
    read_write_s3_td_stage_0_job_1 = DataprocCreateBatchOperator(
            task_id = "read_write_s3_td_stage_0_job_1",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_spark_s3_td_example_6435_prod_arkansas_arkansas_dags_read_write_s3_td_stage_0_job_1.json",
...
creds_setup >> fetch_batch_run_id_task >>[read_write_s3_td_stage_0_job_1]
    read_write_s3_td_stage_0_job_1 >> pelican_validator >> pelican_sensor