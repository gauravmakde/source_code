...
dag_id = 'gcp_teradata_engine_example_6435_prod_arkansas_arkansas_dags'
...
default_args = {
    ...
    'description': 'teradata_engine_example_6435_prod_arkansas_arkansas_dags DAG Description',
...
with DAG(
    ...
    teradata_example = open(
    os.path.join(sql_path, 'teradata_example.sql'),
    "r").read()
...
creds_setup >> fetch_batch_run_id_task >> launch_run_terdata_sql_stg_0_job_0 >> pelican_validator >> pelican_sensor