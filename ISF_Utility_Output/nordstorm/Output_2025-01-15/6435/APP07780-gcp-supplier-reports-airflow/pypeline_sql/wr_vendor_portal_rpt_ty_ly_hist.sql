...
sel sb.week_num as wk_idnt,
		...
		cast(0 as decimal(20,2)) as f_ly_total_soh_amt,
		cast(0 as decimal(12,0)) as f_ly_total_soh_qty,
		cast(0 as decimal(12,0)) as f_ly_soh_rglr_qty,
