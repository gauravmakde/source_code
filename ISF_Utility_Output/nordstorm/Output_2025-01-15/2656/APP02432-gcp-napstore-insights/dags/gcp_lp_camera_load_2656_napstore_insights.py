...
dag_id = 'gcp_lp_camera_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="lpcamera_events_to_csv_load_0_stg")   
    lpcamera_events_to_csv_load_0_stg = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_lp_camera_load_2656_napstore_insights_lpcamera_events_to_csv_load_0_stg.json",
...
lp_camera_load_fct = open(
    os.path.join(sql_path, 'lp_camera_load_fct.sql'),
    "r").read()

    launch_lpcamera_events_to_csv_load_1_fct = BigQueryInsertJobOperator(
        task_id = "lpcamera_events_to_csv_load_1_fct",
        configuration = 
        {
            "query": 
            {
                "query": lp_camera_load_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[lpcamera_events_to_csv_load_0_stg]
    lpcamera_events_to_csv_load_0_stg >>[launch_lpcamera_events_to_csv_load_1_fct]
    launch_lpcamera_events_to_csv_load_1_fct >> pelican_validator >> pelican_sensor