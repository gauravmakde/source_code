...
session_name=get_batch_id(dag_id=dag_id,task_id="wfm_workforce_employee_load_0_stg_table")   
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_wfm_workforce_employee_load_2656_napstore_insights_wfm_workforce_employee_load_0_stg_table.json",
...
wfm_workforce_employee_load_fact = open(
    os.path.join(sql_path, 'wfm_workforce_employee_load_fact.sql'),
    "r").read()
    ...
    launch_wfm_workforce_employee_load_1_fct_table = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": wfm_workforce_employee_load_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
