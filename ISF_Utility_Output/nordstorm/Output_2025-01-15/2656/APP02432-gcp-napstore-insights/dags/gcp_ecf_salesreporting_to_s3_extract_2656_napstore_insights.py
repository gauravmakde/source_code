...
dag_id = 'gcp_ecf_salesreporting_to_s3_extract_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="ecf_salesreporting_extract_load_0_ecf_salesreporting")   
    ecf_salesreporting_extract_load_0_ecf_salesreporting = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_ecf_salesreporting_to_s3_extract_2656_napstore_insights_ecf_salesreporting_extract_load_0_ecf_salesreporting.json",
...
creds_setup >> fetch_batch_run_id_task >>[ecf_salesreporting_extract_load_0_ecf_salesreporting]
    ecf_salesreporting_extract_load_0_ecf_salesreporting >> pelican_validator >> pelican_sensor