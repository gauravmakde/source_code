...
dag_id = 'gcp_eta_markets_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="eta_markets_data_load_load_0_node_s3_ldg")   
    eta_markets_data_load_load_0_node_s3_ldg = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_eta_markets_load_2656_napstore_insights_eta_markets_data_load_load_0_node_s3_ldg.json",
...
eta_markets_node_load_dim = open(
    os.path.join(sql_path, 'eta_markets_node_load_dim.sql'),
    "r").read()

    launch_eta_markets_data_load_load_1_node_dim_table = BigQueryInsertJobOperator(
        task_id = "eta_markets_data_load_load_1_node_dim_table",
        configuration = 
        {
            "query": 
            {
                "query": eta_markets_node_load_dim,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
session_name=get_batch_id(dag_id=dag_id,task_id="eta_markets_data_load_load_2_postal_s3_ldg")   
    eta_markets_data_load_load_2_postal_s3_ldg = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_eta_markets_load_2656_napstore_insights_eta_markets_data_load_load_2_postal_s3_ldg.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
eta_markets_postal_load_dim = open(
    os.path.join(sql_path, 'eta_markets_postal_load_dim.sql'),
    "r").read()

    launch_eta_markets_data_load_load_3_postal_dim_table = BigQueryInsertJobOperator(
        task_id = "eta_markets_data_load_load_3_postal_dim_table",
        configuration = 
        {
            "query": 
            {
                "query": eta_markets_postal_load_dim,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[eta_markets_data_load_load_0_node_s3_ldg]
    eta_markets_data_load_load_0_node_s3_ldg >>[launch_eta_markets_data_load_load_1_node_dim_table]
    launch_eta_markets_data_load_load_1_node_dim_table >>[eta_markets_data_load_load_2_postal_s3_ldg]
    eta_markets_data_load_load_2_postal_s3_ldg >>[launch_eta_markets_data_load_load_3_postal_dim_table]
    launch_eta_markets_data_load_load_3_postal_dim_table >> pelican_validator >> pelican_sensor