...
dag_id = 'gcp_hr_worker_compensation_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="hr_worker_compensation_load_orc_td_stg")   
    hr_worker_compensation_load_orc_td_stg = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_hr_worker_compensation_load_2656_napstore_insights_hr_worker_compensation_load_orc_td_stg.json",
...
hr_worker_compensation_load_teradata_stg_to_dim = open(
    os.path.join(sql_path, 'hr_worker_compensation_load_teradata_stg_to_dim.sql'),
    "r").read()

    launch_hr_worker_compensation_load_td_stg_to_dims = BigQueryInsertJobOperator(
        task_id = "hr_worker_compensation_load_td_stg_to_dims",
        configuration = 
        {
            "query": 
            {
                "query": hr_worker_compensation_load_teradata_stg_to_dim,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[hr_worker_compensation_load_orc_td_stg]
    hr_worker_compensation_load_orc_td_stg >>[launch_hr_worker_compensation_load_td_stg_to_dims]
    launch_hr_worker_compensation_load_td_stg_to_dims >> pelican_validator >> pelican_sensor