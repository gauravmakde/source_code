...
dag_id = 'gcp_stock_count_load_test_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="stock_count_load_from_kafka_to_teradata_stg_table")   
    stock_count_load_from_kafka_to_teradata_stg_table = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_stock_count_load_test_2656_napstore_insights_stock_count_load_from_kafka_to_teradata_stg_table.json",
...
stock_count_load_test_2656_napstore_insights_stock_count_stock_count_from_stg_to_fact = open(
    os.path.join(sql_path, 'stock_count_load_test_2656_napstore_insights_stock_count_stock_count_from_stg_to_fact.sql'),
    "r").read()

    launch_stock_count_load_from_stg_to_fct_table = BigQueryInsertJobOperator(
        task_id = "stock_count_load_from_stg_to_fct_table",
        configuration = 
        {
            "query": 
            {
                "query": stock_count_load_test_2656_napstore_insights_stock_count_stock_count_from_stg_to_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[stock_count_load_from_kafka_to_teradata_stg_table]
    stock_count_load_from_kafka_to_teradata_stg_table >>[launch_stock_count_load_from_stg_to_fct_table]
    launch_stock_count_load_from_stg_to_fct_table >> pelican_validator >> pelican_sensor