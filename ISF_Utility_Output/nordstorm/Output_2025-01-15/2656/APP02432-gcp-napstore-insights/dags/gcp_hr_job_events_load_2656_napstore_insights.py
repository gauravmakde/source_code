...
dag_id = 'gcp_hr_job_events_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="hr_job_events_load_0_stg_table")   
    hr_job_events_load_0_stg_table = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_hr_job_events_load_2656_napstore_insights_hr_job_events_load_0_stg_table.json",
...
hr_job_events_load_2656_napstore_insights_hr_job_events_hr_job_load_dim = open(
    os.path.join(sql_path, 'hr_job_events_load_2656_napstore_insights_hr_job_events_hr_job_load_dim.sql'),
    "r").read()

    launch_hr_job_events_load_1_dim_table = BigQueryInsertJobOperator(
        task_id = "hr_job_events_load_1_dim_table",
        configuration = 
        {
            "query": 
            {
                "query": hr_job_events_load_2656_napstore_insights_hr_job_events_hr_job_load_dim,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[hr_job_events_load_0_stg_table]
    hr_job_events_load_0_stg_table >>[launch_hr_job_events_load_1_dim_table]
    launch_hr_job_events_load_1_dim_table >> pelican_validator >> pelican_sensor