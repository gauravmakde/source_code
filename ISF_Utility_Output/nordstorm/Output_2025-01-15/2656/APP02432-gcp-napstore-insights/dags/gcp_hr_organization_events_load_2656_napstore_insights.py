...
session_name=get_batch_id(dag_id=dag_id,task_id="hr_org_events_load_0_stg_tables")   
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_hr_organization_events_load_2656_napstore_insights_hr_org_events_load_0_stg_tables.json",
...
hr_organization_load_dim = open(
    os.path.join(sql_path, 'hr_organization_load_dim.sql'),
    "r").read()
    ...
    launch_hr_org_events_load_1_dim_tables = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": hr_organization_load_dim,
                "useLegacySql": False
            }
        },
        project_id = project_id,
