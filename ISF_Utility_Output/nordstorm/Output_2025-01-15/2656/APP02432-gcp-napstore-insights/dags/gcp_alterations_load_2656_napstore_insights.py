...
dag_id = 'gcp_alterations_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="alterations_load_load_0_stg_table")   
    alterations_load_load_0_stg_table = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_alterations_load_2656_napstore_insights_alterations_load_load_0_stg_table.json",
...
alterations_load_fct = open(
    os.path.join(sql_path, 'alterations_load_fct.sql'),
    "r").read()

    launch_alterations_load_load_1_fct_table = BigQueryInsertJobOperator(
        task_id = "alterations_load_load_1_fct_table",
        configuration = 
        {
            "query": 
            {
                "query": alterations_load_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[alterations_load_load_0_stg_table]
    alterations_load_load_0_stg_table >>[launch_alterations_load_load_1_fct_table]
    launch_alterations_load_load_1_fct_table >> pelican_validator >> pelican_sensor