...
dag_id = 'gcp_wage_rate_to_s3_extract_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="wage_rate_extract_load_0_employee_pay_rate")   
    wage_rate_extract_load_0_employee_pay_rate = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_wage_rate_to_s3_extract_2656_napstore_insights_wage_rate_extract_load_0_employee_pay_rate.json",
...
session_name=get_batch_id(dag_id=dag_id,task_id="wage_rate_extract_load_1_hr_worker")   
    wage_rate_extract_load_1_hr_worker = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_wage_rate_to_s3_extract_2656_napstore_insights_wage_rate_extract_load_1_hr_worker.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
session_name=get_batch_id(dag_id=dag_id,task_id="wage_rate_extract_load_2_hr_timeblock")   
    wage_rate_extract_load_2_hr_timeblock = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_wage_rate_to_s3_extract_2656_napstore_insights_wage_rate_extract_load_2_hr_timeblock.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
creds_setup >> fetch_batch_run_id_task >>[wage_rate_extract_load_0_employee_pay_rate]
    wage_rate_extract_load_0_employee_pay_rate >>[wage_rate_extract_load_1_hr_worker]
    wage_rate_extract_load_1_hr_worker >>[wage_rate_extract_load_2_hr_timeblock]
    wage_rate_extract_load_2_hr_timeblock >> pelican_validator >> pelican_sensor