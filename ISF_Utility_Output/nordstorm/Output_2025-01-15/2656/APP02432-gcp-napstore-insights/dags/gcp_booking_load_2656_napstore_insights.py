           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_booking_load_2656_napstore_insights_booking_load_load_0_stg_table.json",
...
booking_load_fact = open(
    os.path.join(sql_path, 'booking_load_fact.sql'),
    "r").read()
