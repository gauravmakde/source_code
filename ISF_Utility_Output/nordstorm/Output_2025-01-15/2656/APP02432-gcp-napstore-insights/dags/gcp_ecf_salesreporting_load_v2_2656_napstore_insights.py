...
# CI pipeline URL:      https://git.jwn.app/TM00787/app02432-store-analytics/APP02432-gcp-napstore-insights/-/pipelines/7021590
...
dag_id = 'gcp_ecf_salesreporting_load_v2_2656_napstore_insights'
...
with DAG(
    ...
    ecf_salesreporting_ecf_salesreporting_ecf_salesreporting_load_v2_2656_napstore_insights_m_ecf_salesreporting_load_fact_v2 = open( os.path.join(sql_path, 'ecf_salesreporting/ecf_salesreporting/ecf_salesreporting_load_v2_2656_napstore_insights_m_ecf_salesreporting_load_fact_v2.sql'),"r").read()

    launch_m_load_fact = BigQueryInsertJobOperator(
        task_id = "m_load_fact",
        configuration = 
        {
            "query": 
            {
                "query": ecf_salesreporting_ecf_salesreporting_ecf_salesreporting_load_v2_2656_napstore_insights_m_ecf_salesreporting_load_fact_v2,
                "useLegacySql": False
            }
        },
...
session_name=get_batch_id(dag_id=dag_id,task_id="m_load_postgres")   
    m_load_postgres = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_ecf_salesreporting_load_v2_2656_napstore_insights_m_load_postgres.json",
...
creds_setup >> fetch_batch_run_id_task >> launch_m_load_fact >>[m_load_postgres]
    m_load_postgres >> pelican_validator >> pelican_sensor