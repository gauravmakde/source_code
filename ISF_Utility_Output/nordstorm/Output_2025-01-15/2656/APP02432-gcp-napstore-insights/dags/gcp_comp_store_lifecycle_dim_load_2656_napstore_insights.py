...
dag_id = 'gcp_comp_store_lifecycle_dim_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="s3_json_load_0_stg_table")   
    s3_json_load_0_stg_table = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_comp_store_lifecycle_dim_load_2656_napstore_insights_s3_json_load_0_stg_table.json",
...
comp_store_status_lifecycle_dim_load = open(
    os.path.join(sql_path, 'comp_store_status_lifecycle_dim_load.sql'),
    "r").read()

    launch_s3_json_load_fct_table = BigQueryInsertJobOperator(
        task_id = "s3_json_load_fct_table",
        configuration = 
        {
            "query": 
            {
                "query": comp_store_status_lifecycle_dim_load,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
session_name=get_batch_id(dag_id=dag_id,task_id="s3_json_load_orc_table")   
    s3_json_load_orc_table = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_comp_store_lifecycle_dim_load_2656_napstore_insights_s3_json_load_orc_table.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
creds_setup >> fetch_batch_run_id_task >>[s3_json_load_0_stg_table]
    s3_json_load_0_stg_table >>[launch_s3_json_load_fct_table]
    launch_s3_json_load_fct_table >>[s3_json_load_orc_table]
    s3_json_load_orc_table >> pelican_validator >> pelican_sensor