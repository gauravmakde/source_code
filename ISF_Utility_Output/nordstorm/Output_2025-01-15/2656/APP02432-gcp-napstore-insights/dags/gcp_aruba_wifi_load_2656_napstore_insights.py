...
dag_id = 'gcp_aruba_wifi_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="s3_avro_to_orc_load_0")   
    s3_avro_to_orc_load_0 = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_aruba_wifi_load_2656_napstore_insights_s3_avro_to_orc_load_0.json",
...
creds_setup >> fetch_batch_run_id_task >>[s3_avro_to_orc_load_0]
    s3_avro_to_orc_load_0 >> pelican_validator >> pelican_sensor