...
session_name=get_batch_id(dag_id=dag_id,task_id="hr_loc_events_load_0_stg_tables")   
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_hr_location_events_load_2656_napstore_insights_hr_loc_events_load_0_stg_tables.json",
...
hr_location_load_dim = open(
    os.path.join(sql_path, 'hr_location_load_dim.sql'),
    "r").read()
