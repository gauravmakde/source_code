...
with DAG(
    ...
    hr_details_stg_to_dim_on_demand_2656_napstore_insights_hr_details_events_hr_employee_status_details_load_dim.sql,apps_hr_employee_status_details_load_dim,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/ = open( os.path.join(sql_path, 'hr_details_stg_to_dim_on_demand_2656_napstore_insights_hr_details_events_hr_employee_status_details_load_dim.sql,apps/hr_employee_status_details_load_dim.sql,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/'),"r").read()
    ...
    launch_hr_details_events_load_1_details_dim_tables = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": hr_details_stg_to_dim_on_demand_2656_napstore_insights_hr_details_events_hr_employee_status_details_load_dim.sql,apps_hr_employee_status_details_load_dim,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/,
                "useLegacySql": False
            }
        },
...
creds_setup >> fetch_batch_run_id_task >> launch_hr_details_events_load_1_details_dim_tables >> pelican_validator >> pelican_sensor