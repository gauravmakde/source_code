...
dag_id = 'gcp_appointment_cart_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="appointment_cart_v1_load_orc_td_stg")   
    appointment_cart_v1_load_orc_td_stg = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_appointment_cart_load_2656_napstore_insights_appointment_cart_v1_load_orc_td_stg.json",
...
appointment_cart_load_2656_napstore_insights_appointment_cart_v1_appointment_cart_load_teradata_stg_to_dim.sql,apps_appointment_cart_load_teradata_stg_to_dim,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/ = open( os.path.join(sql_path, 'appointment_cart_load_2656_napstore_insights_appointment_cart_v1_appointment_cart_load_teradata_stg_to_dim.sql,apps/appointment_cart_load_teradata_stg_to_dim.sql,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/'),"r").read()

    launch_appointment_cart_v1_load_td_stg_to_dims = BigQueryInsertJobOperator(
        task_id = "appointment_cart_v1_load_td_stg_to_dims",
        configuration = 
        {
            "query": 
            {
                "query": appointment_cart_load_2656_napstore_insights_appointment_cart_v1_appointment_cart_load_teradata_stg_to_dim.sql,apps_appointment_cart_load_teradata_stg_to_dim,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[appointment_cart_v1_load_orc_td_stg]
    appointment_cart_v1_load_orc_td_stg >>[launch_appointment_cart_v1_load_td_stg_to_dims]
    launch_appointment_cart_v1_load_td_stg_to_dims >> pelican_validator >> pelican_sensor