...
dag_id = 'gcp_store_dim_delta_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="store_dim_delta_job_1_convert")   
    store_dim_delta_job_1_convert = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_store_dim_delta_load_2656_napstore_insights_store_dim_delta_job_1_convert.json",
...
session_name=get_batch_id(dag_id=dag_id,task_id="store_dim_delta_job_2_merge")   
    store_dim_delta_job_2_merge = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_store_dim_delta_load_2656_napstore_insights_store_dim_delta_job_2_merge.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
creds_setup >> fetch_batch_run_id_task >>[store_dim_delta_job_1_convert]
    store_dim_delta_job_1_convert >>[store_dim_delta_job_2_merge]
    store_dim_delta_job_2_merge >> pelican_validator >> pelican_sensor