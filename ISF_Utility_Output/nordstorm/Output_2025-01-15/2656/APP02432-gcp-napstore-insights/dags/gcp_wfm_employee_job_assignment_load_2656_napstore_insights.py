...
session_name=get_batch_id(dag_id=dag_id,task_id="wfm_employee_job_assignment_0_load_0_stg_table")   
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_wfm_employee_job_assignment_load_2656_napstore_insights_wfm_employee_job_assignment_0_load_0_stg_table.json",
...
wfm_employee_job_assignment_load_fact = open(
    os.path.join(sql_path, 'wfm_employee_job_assignment_load_fact.sql'),
    "r").read()
...
creds_setup >> fetch_batch_run_id_task >>[wfm_employee_job_assignment_0_load_0_stg_table]
    wfm_employee_job_assignment_0_load_0_stg_table >>[launch_wfm_employee_job_assignment_0_load_1_fct_table]
    launch_wfm_employee_job_assignment_0_load_1_fct_table >> pelican_validator >> pelican_sensor