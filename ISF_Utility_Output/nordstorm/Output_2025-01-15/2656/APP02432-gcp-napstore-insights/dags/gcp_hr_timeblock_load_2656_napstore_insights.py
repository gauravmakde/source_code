...
dag_id = 'gcp_hr_timeblock_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="hr_timeblock_load_v1_load_0_stg_table")   
    hr_timeblock_load_v1_load_0_stg_table = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_hr_timeblock_load_2656_napstore_insights_hr_timeblock_load_v1_load_0_stg_table.json",
...
hr_timeblock_load_2656_napstore_insights_hr_timeblock_load_v1_hr_timeblock_load_fact = open(
    os.path.join(sql_path, 'hr_timeblock_load_2656_napstore_insights_hr_timeblock_load_v1_hr_timeblock_load_fact.sql'),
    "r").read()

    launch_hr_timeblock_load_v1_load_1_fct_table = BigQueryInsertJobOperator(
        task_id = "hr_timeblock_load_v1_load_1_fct_table",
        configuration = 
        {
            "query": 
            {
                "query": hr_timeblock_load_2656_napstore_insights_hr_timeblock_load_v1_hr_timeblock_load_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[hr_timeblock_load_v1_load_0_stg_table]
    hr_timeblock_load_v1_load_0_stg_table >>[launch_hr_timeblock_load_v1_load_1_fct_table]
    launch_hr_timeblock_load_v1_load_1_fct_table >> pelican_validator >> pelican_sensor