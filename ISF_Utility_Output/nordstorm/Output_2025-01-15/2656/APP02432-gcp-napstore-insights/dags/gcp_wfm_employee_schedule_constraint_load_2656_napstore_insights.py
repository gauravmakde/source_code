...
dag_id = 'gcp_wfm_employee_schedule_constraint_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="wfm_employee_schedule_constraint_load_0_stg_table")   
    wfm_employee_schedule_constraint_load_0_stg_table = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_wfm_employee_schedule_constraint_load_2656_napstore_insights_wfm_employee_schedule_constraint_load_0_stg_table.json",
...
wfm_employee_schedule_constraint_load_fact = open(
    os.path.join(sql_path, 'wfm_employee_schedule_constraint_load_fact.sql'),
    "r").read()

    launch_wfm_employee_schedule_constraint_load_1_fct_table = BigQueryInsertJobOperator(
        task_id = "wfm_employee_schedule_constraint_load_1_fct_table",
        configuration = 
        {
            "query": 
            {
                "query": wfm_employee_schedule_constraint_load_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[wfm_employee_schedule_constraint_load_0_stg_table]
    wfm_employee_schedule_constraint_load_0_stg_table >>[launch_wfm_employee_schedule_constraint_load_1_fct_table]
    launch_wfm_employee_schedule_constraint_load_1_fct_table >> pelican_validator >> pelican_sensor