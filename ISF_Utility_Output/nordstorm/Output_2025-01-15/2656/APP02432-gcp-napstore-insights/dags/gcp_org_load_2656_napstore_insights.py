...
dag_id = 'gcp_org_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="org_store_dim_2_load_0_stg_table")   
    org_store_dim_2_load_0_stg_table = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_org_load_2656_napstore_insights_org_store_dim_2_load_0_stg_table.json",
...
org_store_etl_control_start_macro = open(
    os.path.join(sql_path, 'org_store_etl_control_start_macro.sql'),
    "r").read()

    launch_org_store_dim_2_update_start_batch_date = BigQueryInsertJobOperator(
        task_id = "org_store_dim_2_update_start_batch_date",
        configuration = 
        {
            "query": 
            {
                "query": org_store_etl_control_start_macro,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
org_store_dim_load_fact = open(
    os.path.join(sql_path, 'org_store_dim_load_fact.sql'),
    "r").read()

    launch_org_store_dim_2_load_1_fct_table = BigQueryInsertJobOperator(
        task_id = "org_store_dim_2_load_1_fct_table",
        configuration = 
        {
            "query": 
            {
                "query": org_store_dim_load_fact,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
org_store_etl_control_end_macro = open(
    os.path.join(sql_path, 'org_store_etl_control_end_macro.sql'),
    "r").read()

    launch_org_store_dim_2_update_end_batch_date = BigQueryInsertJobOperator(
        task_id = "org_store_dim_2_update_end_batch_date",
        configuration = 
        {
            "query": 
            {
                "query": org_store_etl_control_end_macro,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[org_store_dim_2_load_0_stg_table]
    org_store_dim_2_load_0_stg_table >>[launch_org_store_dim_2_update_start_batch_date]
    launch_org_store_dim_2_update_start_batch_date >>[launch_org_store_dim_2_load_1_fct_table]
    launch_org_store_dim_2_load_1_fct_table >>[launch_org_store_dim_2_update_end_batch_date]
    launch_org_store_dim_2_update_end_batch_date >> pelican_validator >> pelican_sensor