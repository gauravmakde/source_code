# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        c9b93ffe8b888eb69b2ad377b3a00c87ee7b805c
# CI pipeline URL:      https://git.jwn.app/TM00787/app02432-store-analytics/APP02432-gcp-napstore-insights/-/pipelines/7503594
# CI commit timestamp:  2024-11-13T18:42:33+00:00
...
dag_id = 'gcp_hr_worker_load_v1_2656_napstore_insights'
...
default_args = {
    ...
    'description': 'hr_worker_load_v1_2656_napstore_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="hr_worker_v2_load_orc_td_stg")   
    hr_worker_v2_load_orc_td_stg = DataprocCreateBatchOperator(
            task_id = "hr_worker_v2_load_orc_td_stg",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_hr_worker_load_v1_2656_napstore_insights_hr_worker_v2_load_orc_td_stg.json",
...
hr_worker_load_v1_2656_napstore_insights_hr_worker_v2_hr_worker_load_teradata_stg_to_dim.sql,apps_hr_worker_load_teradata_stg_to_dim,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/ = open( os.path.join(sql_path, 'hr_worker_load_v1_2656_napstore_insights_hr_worker_v2_hr_worker_load_teradata_stg_to_dim.sql,apps/hr_worker_load_teradata_stg_to_dim.sql,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/'),"r").read()

    launch_hr_worker_v2_load_td_stg_to_dims = BigQueryInsertJobOperator(
        task_id = "hr_worker_v2_load_td_stg_to_dims",
        configuration = 
        {
            "query": 
            {
                "query": hr_worker_load_v1_2656_napstore_insights_hr_worker_v2_hr_worker_load_teradata_stg_to_dim.sql,apps_hr_worker_load_teradata_stg_to_dim,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[hr_worker_v2_load_orc_td_stg]
    hr_worker_v2_load_orc_td_stg >>[launch_hr_worker_v2_load_td_stg_to_dims]
    launch_hr_worker_v2_load_td_stg_to_dims >> pelican_validator >> pelican_sensor