...
# CI pipeline URL:      https://git.jwn.app/TM00787/app02432-store-analytics/APP02432-gcp-napstore-insights/-/pipelines/6915791
...
dag_id = 'gcp_ecf_salesreporting_to_postgres_extract_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="ecf_salesreporting_load_teradata_to_postgres")   
    ecf_salesreporting_load_teradata_to_postgres = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_ecf_salesreporting_to_postgres_extract_2656_napstore_insights_ecf_salesreporting_load_teradata_to_postgres.json",
...
creds_setup >> fetch_batch_run_id_task >>[ecf_salesreporting_load_teradata_to_postgres]
    ecf_salesreporting_load_teradata_to_postgres >> pelican_validator >> pelican_sensor