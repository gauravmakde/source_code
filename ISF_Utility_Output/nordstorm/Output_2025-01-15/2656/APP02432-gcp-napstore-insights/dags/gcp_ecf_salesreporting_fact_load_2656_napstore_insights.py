...
# CI pipeline URL:      https://git.jwn.app/TM00787/app02432-store-analytics/APP02432-gcp-napstore-insights/-/pipelines/6728624
...
dag_id = 'gcp_ecf_salesreporting_fact_load_2656_napstore_insights'
...
with DAG(
    ...
    ecf_salesreporting_ecf_salesreporting_ecf_salesreporting_fact_load_2656_napstore_insights_m_ecf_salesreporting_load_fact = open( os.path.join(sql_path, 'ecf_salesreporting/ecf_salesreporting/ecf_salesreporting_fact_load_2656_napstore_insights_m_ecf_salesreporting_load_fact.sql'),"r").read()
    ...
    launch_m_load_fact = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": ecf_salesreporting_ecf_salesreporting_ecf_salesreporting_fact_load_2656_napstore_insights_m_ecf_salesreporting_load_fact,
                "useLegacySql": False
            }
        },
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_ecf_salesreporting_fact_load_2656_napstore_insights_m_load_postgres.json",
