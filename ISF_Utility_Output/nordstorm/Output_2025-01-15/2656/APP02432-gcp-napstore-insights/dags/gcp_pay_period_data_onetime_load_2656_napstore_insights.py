...
dag_id = 'gcp_pay_period_data_onetime_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="s3_csv_pay_period_data_load_load_0_pay_period_stg_tables")   
    s3_csv_pay_period_data_load_load_0_pay_period_stg_tables = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_pay_period_data_onetime_load_2656_napstore_insights_s3_csv_pay_period_data_load_load_0_pay_period_stg_tables.json",
...
pay_period_data_onetime_load_2656_napstore_insights_s3_csv_pay_period_data_load_pay_period_load_stg_to_dim = open(
    os.path.join(sql_path, 'pay_period_data_onetime_load_2656_napstore_insights_s3_csv_pay_period_data_load_pay_period_load_stg_to_dim.sql'),
    "r").read()

    launch_s3_csv_pay_period_data_load_load_td_stg_to_dims = BigQueryInsertJobOperator(
        task_id = "s3_csv_pay_period_data_load_load_td_stg_to_dims",
        configuration = 
        {
            "query": 
            {
                "query": pay_period_data_onetime_load_2656_napstore_insights_s3_csv_pay_period_data_load_pay_period_load_stg_to_dim,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[s3_csv_pay_period_data_load_load_0_pay_period_stg_tables]
    s3_csv_pay_period_data_load_load_0_pay_period_stg_tables >>[launch_s3_csv_pay_period_data_load_load_td_stg_to_dims]
    launch_s3_csv_pay_period_data_load_load_td_stg_to_dims >> pelican_validator >> pelican_sensor