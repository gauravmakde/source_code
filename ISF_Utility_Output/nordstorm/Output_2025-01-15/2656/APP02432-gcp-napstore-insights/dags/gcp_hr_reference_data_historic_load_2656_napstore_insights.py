...
dag_id = 'gcp_hr_reference_data_historic_load_2656_napstore_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="s3_csv_load_0_stg_tables")   
    s3_csv_load_0_stg_tables = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_hr_reference_data_historic_load_2656_napstore_insights_s3_csv_load_0_stg_tables.json",
...
hr_reference_data_historic_load_2656_napstore_insights_s3_csv_hr_organization_load_dim.sql,apps_hr_organization_load_dim,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/ = open( os.path.join(sql_path, 'hr_reference_data_historic_load_2656_napstore_insights_s3_csv_hr_organization_load_dim.sql,apps/hr_organization_load_dim.sql,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/'),"r").read()

    launch_s3_csv_load_1_dim_tables = BigQueryInsertJobOperator(
        task_id = "s3_csv_load_1_dim_tables",
        configuration = 
        {
            "query": 
            {
                "query": hr_reference_data_historic_load_2656_napstore_insights_s3_csv_hr_organization_load_dim.sql,apps_hr_organization_load_dim,apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/2656/napstore/insights/sql/,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[s3_csv_load_0_stg_tables]
    s3_csv_load_0_stg_tables >>[launch_s3_csv_load_1_dim_tables]
    launch_s3_csv_load_1_dim_tables >> pelican_validator >> pelican_sensor