...
Task_Name=work_contact_details_stage_load_8_workcontact_details_stg_tables;'
FOR SESSION VOLATILE;

-- load out of order workcontact worker data from S3 location in AVRO format to Teradata sink:
CREATE OR REPLACE TEMPORARY VIEW hr_workcontact_details_input 
AS select * from s3_avro_input_for_workcontact_details;
