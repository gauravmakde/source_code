...
dag_id = 'gcp_credit_application_pre_adjudication_3678_credit_insights'
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_credit_application_pre_adjudication_3678_credit_insights_s3_csv_to_teradata_stage_s3_csv_to_teradata_stg_job.json",
...
teradata_credit_application_pre_adjudication_teradata_stg_to_teradata = open( os.path.join(sql_path, 'teradata/credit_application_pre_adjudication_teradata_stg_to_teradata.sql'),"r").read()
    ...
    launch_s3_csv_to_teradata_stage_teradata_stg_to_teradata_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_credit_application_pre_adjudication_teradata_stg_to_teradata,
                "useLegacySql": False
            }
        },
        project_id = project_id,
