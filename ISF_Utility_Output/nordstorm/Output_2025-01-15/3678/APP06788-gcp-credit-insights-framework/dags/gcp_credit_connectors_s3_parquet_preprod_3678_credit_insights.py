...
dag_id = 'gcp_credit_connectors_s3_parquet_preprod_3678_credit_insights'
...
default_args = {
    ...
    'description': 'credit_connectors_s3_parquet_preprod_3678_credit_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="credit_connectors_s3_parquet_stage_0_kafka_to_s3_parquet_job")   
    credit_connectors_s3_parquet_stage_0_kafka_to_s3_parquet_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_credit_connectors_s3_parquet_preprod_3678_credit_insights_credit_connectors_s3_parquet_stage_0_kafka_to_s3_parquet_job.json",
...
creds_setup >> fetch_batch_run_id_task >>[credit_connectors_s3_parquet_stage_0_kafka_to_s3_parquet_job]
    credit_connectors_s3_parquet_stage_0_kafka_to_s3_parquet_job >> pelican_validator >> pelican_sensor