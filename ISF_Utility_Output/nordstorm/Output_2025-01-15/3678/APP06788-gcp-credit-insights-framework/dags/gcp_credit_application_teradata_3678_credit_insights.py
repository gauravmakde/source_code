...
dag_id = 'gcp_credit_application_teradata_3678_credit_insights'
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_credit_application_teradata_3678_credit_insights_credit_application_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job.json",
...
teradata_credit_application_teradata_stg_to_teradata_fct = open( os.path.join(sql_path, 'teradata/credit_application_teradata_stg_to_teradata_fct.sql'),"r").read()
    ...
    launch_credit_application_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_credit_application_teradata_stg_to_teradata_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
