...
dag_id = 'gcp_credit_application_pre_adjudication_preprod_3678_credit_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="s3_csv_to_teradata_stage_s3_csv_to_teradata_stg_job")   
    s3_csv_to_teradata_stage_s3_csv_to_teradata_stg_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_credit_application_pre_adjudication_preprod_3678_credit_insights_s3_csv_to_teradata_stage_s3_csv_to_teradata_stg_job.json",
...
teradata_teradata_credit_application_pre_adjudication_preprod_3678_credit_insights_s3_csv_to_teradata_stage_credit_application_pre_adjudication_teradata_stg_to_teradata_preprod = open( os.path.join(sql_path, 'teradata/teradata/credit_application_pre_adjudication_preprod_3678_credit_insights_s3_csv_to_teradata_stage_credit_application_pre_adjudication_teradata_stg_to_teradata_preprod.sql'),"r").read()

    launch_s3_csv_to_teradata_stage_teradata_stg_to_teradata_job = BigQueryInsertJobOperator(
        task_id = "s3_csv_to_teradata_stage_teradata_stg_to_teradata_job",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_credit_application_pre_adjudication_preprod_3678_credit_insights_s3_csv_to_teradata_stage_credit_application_pre_adjudication_teradata_stg_to_teradata_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[s3_csv_to_teradata_stage_s3_csv_to_teradata_stg_job]
    s3_csv_to_teradata_stage_s3_csv_to_teradata_stg_job >>[launch_s3_csv_to_teradata_stage_teradata_stg_to_teradata_job]
    launch_s3_csv_to_teradata_stage_teradata_stg_to_teradata_job >> pelican_validator >> pelican_sensor