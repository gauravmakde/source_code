...
dag_id = 'gcp_afterpay_auth_details_update_teradata_preprod_4638_payments_insights'
...
with DAG(
    ...
    external_dag_id='gcp_payment_auth_result_teradata_4638_payments_insights',
    timeout=7200,
    ...
    teradata_teradata_afterpay_auth_details_update_teradata_preprod_4638_payments_insights_afterpay_auth_update_teradata_stg_stage_0_afterpay_auth_details_update_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/afterpay_auth_details_update_teradata_preprod_4638_payments_insights_afterpay_auth_update_teradata_stg_stage_0_afterpay_auth_details_update_teradata_fct_preprod.sql'),"r").read()

    launch_afterpay_auth_update_teradata_stg_stage_0_job_insert_update = BigQueryInsertJobOperator(
        task_id = "afterpay_auth_update_teradata_stg_stage_0_job_insert_update",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_afterpay_auth_details_update_teradata_preprod_4638_payments_insights_afterpay_auth_update_teradata_stg_stage_0_afterpay_auth_details_update_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
...
creds_setup >> fetch_batch_run_id_task >> launch_check_external_upstream_dependencies_sensor_0 >>[launch_afterpay_auth_update_teradata_stg_stage_0_job_insert_update]
    launch_check_external_upstream_dependencies_sensor_1 >>[launch_afterpay_auth_update_teradata_stg_stage_0_job_insert_update]
    launch_afterpay_auth_update_teradata_stg_stage_0_job_insert_update >> pelican_validator >> pelican_sensor