...
dag_id = 'gcp_payment_bin_v2_redemption_service_tpt_load_preprod_4638_payments_insights'
...
with DAG(
    ...
    teradata_teradata_payment_bin_v2_redemption_service_tpt_load_preprod_4638_payments_insights_read_from_s3_write_td_stage_0_payment_bin_v2_teradata_stg_to_teradata_fct_historical_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_bin_v2_redemption_service_tpt_load_preprod_4638_payments_insights_read_from_s3_write_td_stage_0_payment_bin_v2_teradata_stg_to_teradata_fct_historical_preprod.sql'),"r").read()
    ...
    launch_read_from_s3_write_td_stage_0_teradata_stg_to_teradata_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_bin_v2_redemption_service_tpt_load_preprod_4638_payments_insights_read_from_s3_write_td_stage_0_payment_bin_v2_teradata_stg_to_teradata_fct_historical_preprod,
                "useLegacySql": False
            }
        },
