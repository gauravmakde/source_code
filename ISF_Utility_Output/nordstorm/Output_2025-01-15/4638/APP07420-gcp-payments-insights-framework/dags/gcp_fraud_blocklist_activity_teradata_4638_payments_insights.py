...
dag_id = 'gcp_fraud_blocklist_activity_teradata_4638_payments_insights'
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_fraud_blocklist_activity_teradata_4638_payments_insights_fraud_blocklist_activity_kafka_to_teradata_stg_stage_0_added_to_fraud_blocklist_kafka_to_teradata_stg_job.json",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_fraud_blocklist_activity_teradata_4638_payments_insights_fraud_blocklist_activity_kafka_to_teradata_stg_stage_0_removed_from_fraud_blocklist_kafka_to_teradata_stg_job.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
teradata_teradata_fraud_blocklist_activity_teradata_4638_payments_insights_fraud_blocklist_activity_td_stg_to_td_fct_stage_1_fraud_blocklist_activity_stg_to_teradata_fct = open( os.path.join(sql_path, 'teradata/teradata/fraud_blocklist_activity_teradata_4638_payments_insights_fraud_blocklist_activity_td_stg_to_td_fct_stage_1_fraud_blocklist_activity_stg_to_teradata_fct.sql'),"r").read()
    ...
    launch_fraud_blocklist_activity_td_stg_to_td_fct_stage_1_fraud_blocklist_activity_td_stg_to_td_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_fraud_blocklist_activity_teradata_4638_payments_insights_fraud_blocklist_activity_td_stg_to_td_fct_stage_1_fraud_blocklist_activity_stg_to_teradata_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
