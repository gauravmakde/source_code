...
dag_id = 'gcp_payment_cancel_teradata_preprod_4638_payments_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_cancel_kafka_to_teradata_stg_stage_1_cancel_success_kafka_to_teradata_stg_job")   
    payment_cancel_kafka_to_teradata_stg_stage_1_cancel_success_kafka_to_teradata_stg_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_cancel_teradata_preprod_4638_payments_insights_payment_cancel_kafka_to_teradata_stg_stage_1_cancel_success_kafka_to_teradata_stg_job.json",
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_cancel_kafka_to_teradata_stg_stage_1_cancel_failed_kafka_to_teradata_stg_job")   
    payment_cancel_kafka_to_teradata_stg_stage_1_cancel_failed_kafka_to_teradata_stg_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_payment_cancel_teradata_preprod_4638_payments_insights_payment_cancel_kafka_to_teradata_stg_stage_1_cancel_failed_kafka_to_teradata_stg_job.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
teradata_teradata_payment_cancel_teradata_preprod_4638_payments_insights_payment_cancel_hdr_td_stg_to_td_fct_stage_2_payment_cancel_hdr_stg_to_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_cancel_teradata_preprod_4638_payments_insights_payment_cancel_hdr_td_stg_to_td_fct_stage_2_payment_cancel_hdr_stg_to_teradata_fct_preprod.sql'),"r").read()

    launch_payment_cancel_hdr_td_stg_to_td_fct_stage_2_payment_cancel_hdr_td_stg_to_td_fct_job = BigQueryInsertJobOperator(
        task_id = "payment_cancel_hdr_td_stg_to_td_fct_stage_2_payment_cancel_hdr_td_stg_to_td_fct_job",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_cancel_teradata_preprod_4638_payments_insights_payment_cancel_hdr_td_stg_to_td_fct_stage_2_payment_cancel_hdr_stg_to_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
teradata_teradata_payment_cancel_teradata_preprod_4638_payments_insights_payment_cancel_dtl_td_stg_to_td_fct_stage_3_payment_cancel_dtl_stg_to_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_cancel_teradata_preprod_4638_payments_insights_payment_cancel_dtl_td_stg_to_td_fct_stage_3_payment_cancel_dtl_stg_to_teradata_fct_preprod.sql'),"r").read()

    launch_payment_cancel_dtl_td_stg_to_td_fct_stage_3_payment_cancel_dtl_td_stg_to_td_fct_job = BigQueryInsertJobOperator(
        task_id = "payment_cancel_dtl_td_stg_to_td_fct_stage_3_payment_cancel_dtl_td_stg_to_td_fct_job",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_cancel_teradata_preprod_4638_payments_insights_payment_cancel_dtl_td_stg_to_td_fct_stage_3_payment_cancel_dtl_stg_to_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
teradata_teradata_payment_cancel_teradata_preprod_4638_payments_insights_payment_cancel_tender_td_stg_to_td_fct_stage_4_payment_cancel_tender_stg_to_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_cancel_teradata_preprod_4638_payments_insights_payment_cancel_tender_td_stg_to_td_fct_stage_4_payment_cancel_tender_stg_to_teradata_fct_preprod.sql'),"r").read()

    launch_payment_cancel_tender_td_stg_to_td_fct_stage_4_payment_cancel_tender_td_stg_to_td_fct_job = BigQueryInsertJobOperator(
        task_id = "payment_cancel_tender_td_stg_to_td_fct_stage_4_payment_cancel_tender_td_stg_to_td_fct_job",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_cancel_teradata_preprod_4638_payments_insights_payment_cancel_tender_td_stg_to_td_fct_stage_4_payment_cancel_tender_stg_to_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[payment_cancel_kafka_to_teradata_stg_stage_1_cancel_success_kafka_to_teradata_stg_job]
    payment_cancel_kafka_to_teradata_stg_stage_1_cancel_success_kafka_to_teradata_stg_job >>[payment_cancel_kafka_to_teradata_stg_stage_1_cancel_failed_kafka_to_teradata_stg_job]
    payment_cancel_kafka_to_teradata_stg_stage_1_cancel_failed_kafka_to_teradata_stg_job >>[launch_payment_cancel_dtl_td_stg_to_td_fct_stage_3_payment_cancel_dtl_td_stg_to_td_fct_job, launch_payment_cancel_hdr_td_stg_to_td_fct_stage_2_payment_cancel_hdr_td_stg_to_td_fct_job, launch_payment_cancel_tender_td_stg_to_td_fct_stage_4_payment_cancel_tender_td_stg_to_td_fct_job]
