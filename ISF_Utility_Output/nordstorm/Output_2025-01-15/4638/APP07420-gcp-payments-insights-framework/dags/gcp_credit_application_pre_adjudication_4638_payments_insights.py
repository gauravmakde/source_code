...
# CI pipeline URL:      https://git.jwn.app/TM01164/nap-payments/APP07420-gcp-payments-insights-framework/-/pipelines/6461177
...
dag_id = 'gcp_credit_application_pre_adjudication_4638_payments_insights'
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_credit_application_pre_adjudication_4638_payments_insights_s3_csv_to_teradata_stage_s3_csv_to_teradata_stg_job.json",
...
teradata_teradata_credit_application_pre_adjudication_4638_payments_insights_s3_csv_to_teradata_stage_credit_application_pre_adjudication_teradata_stg_to_teradata = open( os.path.join(sql_path, 'teradata/teradata/credit_application_pre_adjudication_4638_payments_insights_s3_csv_to_teradata_stage_credit_application_pre_adjudication_teradata_stg_to_teradata.sql'),"r").read()
    ...
    launch_s3_csv_to_teradata_stage_teradata_stg_to_teradata_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_credit_application_pre_adjudication_4638_payments_insights_s3_csv_to_teradata_stage_credit_application_pre_adjudication_teradata_stg_to_teradata,
                "useLegacySql": False
            }
        },
        project_id = project_id,
