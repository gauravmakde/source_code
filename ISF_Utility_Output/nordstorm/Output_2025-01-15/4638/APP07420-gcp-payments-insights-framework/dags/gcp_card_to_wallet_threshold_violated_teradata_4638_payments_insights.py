...
dag_id = 'gcp_card_to_wallet_threshold_violated_teradata_4638_payments_insights'
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_card_to_wallet_threshold_violated_teradata_4638_payments_insights_card_to_wallet_threshold_violated_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job.json",
...
teradata_teradata_card_to_wallet_threshold_violated_teradata_4638_payments_insights_card_to_wallet_threshold_violated_td_stg_to_td_fct_stage_1_card_to_wallet_threshold_violated_stg_to_teradata_fct = open( os.path.join(sql_path, 'teradata/teradata/card_to_wallet_threshold_violated_teradata_4638_payments_insights_card_to_wallet_threshold_violated_td_stg_to_td_fct_stage_1_card_to_wallet_threshold_violated_stg_to_teradata_fct.sql'),"r").read()
    ...
    launch_card_to_wallet_threshold_violated_td_stg_to_td_fct_stage_1_card_to_wallet_threshold_violated_td_stg_to_td_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_card_to_wallet_threshold_violated_teradata_4638_payments_insights_card_to_wallet_threshold_violated_td_stg_to_td_fct_stage_1_card_to_wallet_threshold_violated_stg_to_teradata_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
