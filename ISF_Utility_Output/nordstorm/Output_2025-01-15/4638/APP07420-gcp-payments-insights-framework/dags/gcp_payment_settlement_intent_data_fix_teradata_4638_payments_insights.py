...
dag_id = 'gcp_payment_settlement_intent_data_fix_teradata_4638_payments_insights'
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_settlement_intent_data_fix_teradata_4638_payments_insights_payment_settlement_intent_data_fix_hive_to_teradata_stage_0_hive_to_teradata_stg_job.json",
...
teradata_teradata_payment_settlement_intent_data_fix_teradata_4638_payments_insights_payment_settlement_intent_data_fix_hive_to_teradata_stage_0_payment_settlement_intent_data_fix_teradata_stg_to_teradata_fct = open( os.path.join(sql_path, 'teradata/teradata/payment_settlement_intent_data_fix_teradata_4638_payments_insights_payment_settlement_intent_data_fix_hive_to_teradata_stage_0_payment_settlement_intent_data_fix_teradata_stg_to_teradata_fct.sql'),"r").read()
    ...
    launch_payment_settlement_intent_data_fix_hive_to_teradata_stage_0_teradata_stg_to_teradata_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_settlement_intent_data_fix_teradata_4638_payments_insights_payment_settlement_intent_data_fix_hive_to_teradata_stage_0_payment_settlement_intent_data_fix_teradata_stg_to_teradata_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
