...
dag_id = 'gcp_payment_reset_teradata_preprod_4638_payments_insights'
...
with DAG(
    ...
    macros=None,
    container_image='artifactory.nordstrom.com/docker/app07420/tm01164-nap-payments-APP07420-gcp-payments-insights-framework/prod/python/s3_reset_preprocessor:1.0.1',
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_reset_s3_avro_to_teradata_stage_0_s3_avro_to_teradata_stg_job")   
    payment_reset_s3_avro_to_teradata_stage_0_s3_avro_to_teradata_stg_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_reset_teradata_preprod_4638_payments_insights_payment_reset_s3_avro_to_teradata_stage_0_s3_avro_to_teradata_stg_job.json",
...
teradata_teradata_payment_reset_teradata_preprod_4638_payments_insights_payment_reset_s3_avro_to_teradata_stage_0_payment_reset_teradata_stg_to_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_reset_teradata_preprod_4638_payments_insights_payment_reset_s3_avro_to_teradata_stage_0_payment_reset_teradata_stg_to_teradata_fct_preprod.sql'),"r").read()

    launch_payment_reset_s3_avro_to_teradata_stage_0_teradata_stg_to_teradata_fct_job = BigQueryInsertJobOperator(
        task_id = "payment_reset_s3_avro_to_teradata_stage_0_teradata_stg_to_teradata_fct_job",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_reset_teradata_preprod_4638_payments_insights_payment_reset_s3_avro_to_teradata_stage_0_payment_reset_teradata_stg_to_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
launch_payment_reset_s3_avro_to_teradata_stage_0_python_delete = launch_k8s_api_job_operator(
    ...
    macros=None,
    container_image='artifactory.nordstrom.com/docker/app07420/tm01164-nap-payments-APP07420-gcp-payments-insights-framework/prod/python/s3_reset_postprocessor:1.0.9',
...
creds_setup >> fetch_batch_run_id_task >> launch_payment_reset_s3_avro_to_teradata_stage_0_python_tag >>[payment_reset_s3_avro_to_teradata_stage_0_s3_avro_to_teradata_stg_job]
    payment_reset_s3_avro_to_teradata_stage_0_s3_avro_to_teradata_stg_job >>[launch_payment_reset_s3_avro_to_teradata_stage_0_teradata_stg_to_teradata_fct_job]
    launch_payment_reset_s3_avro_to_teradata_stage_0_teradata_stg_to_teradata_fct_job >>[launch_payment_reset_s3_avro_to_teradata_stage_0_python_delete]
    launch_payment_reset_s3_avro_to_teradata_stage_0_python_delete >> pelican_validator >> pelican_sensor