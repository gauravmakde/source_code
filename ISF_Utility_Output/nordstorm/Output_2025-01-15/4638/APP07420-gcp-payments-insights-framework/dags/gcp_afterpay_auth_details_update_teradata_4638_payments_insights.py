...
dag_id = 'gcp_afterpay_auth_details_update_teradata_4638_payments_insights'
...
with DAG(
    ...
    teradata_afterpay_auth_details_update_teradata_fct = open( os.path.join(sql_path, 'teradata/afterpay_auth_details_update_teradata_fct.sql'),"r").read()
    ...
    launch_afterpay_auth_update_teradata_stg_stage_0_job_insert_update = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_afterpay_auth_details_update_teradata_fct,
                "useLegacySql": False
            }
        },
