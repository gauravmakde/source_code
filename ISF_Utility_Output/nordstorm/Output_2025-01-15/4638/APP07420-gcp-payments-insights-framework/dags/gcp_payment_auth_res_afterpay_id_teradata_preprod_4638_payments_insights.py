...
dag_id = 'gcp_payment_auth_res_afterpay_id_teradata_preprod_4638_payments_insights'
...
with DAG(
    ...
    teradata_teradata_payment_auth_res_afterpay_id_teradata_preprod_4638_payments_insights_payment_auth_res_afterpay_id_teradata_stg_to_teradata_fct_stage_0_payment_auth_result_afterpay_id_teradata_stg_to_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_res_afterpay_id_teradata_preprod_4638_payments_insights_payment_auth_res_afterpay_id_teradata_stg_to_teradata_fct_stage_0_payment_auth_result_afterpay_id_teradata_stg_to_teradata_fct_preprod.sql'),"r").read()

    launch_payment_auth_res_afterpay_id_teradata_stg_to_teradata_fct_stage_0_teradata_stg_to_teradata_fct_job = BigQueryInsertJobOperator(
        task_id = "payment_auth_res_afterpay_id_teradata_stg_to_teradata_fct_stage_0_teradata_stg_to_teradata_fct_job",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_auth_res_afterpay_id_teradata_preprod_4638_payments_insights_payment_auth_res_afterpay_id_teradata_stg_to_teradata_fct_stage_0_payment_auth_result_afterpay_id_teradata_stg_to_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
...
creds_setup >> fetch_batch_run_id_task >> launch_payment_auth_res_afterpay_id_teradata_stg_to_teradata_fct_stage_0_teradata_stg_to_teradata_fct_job >> pelican_validator >> pelican_sensor