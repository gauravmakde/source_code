...
dag_id = 'gcp_settlement_result_hashkey_backfill_teradata_4638_payments_insights'
...
with DAG(
    ...
    teradata_teradata_settlement_result_hashkey_backfill_teradata_4638_payments_insights_settlement_result_hashkey_backfill_teradata_stage_0_settlement_result_hashkey_backfill_teradata_fct = open( os.path.join(sql_path, 'teradata/teradata/settlement_result_hashkey_backfill_teradata_4638_payments_insights_settlement_result_hashkey_backfill_teradata_stage_0_settlement_result_hashkey_backfill_teradata_fct.sql'),"r").read()
    ...
    launch_settlement_result_hashkey_backfill_teradata_stage_0_job_insert_update = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_settlement_result_hashkey_backfill_teradata_4638_payments_insights_settlement_result_hashkey_backfill_teradata_stage_0_settlement_result_hashkey_backfill_teradata_fct,
                "useLegacySql": False
            }
        },
