...
dag_id = 'gcp_payment_settlement_intent_teradata_v2_4638_payments_insights'
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_settlement_intent_teradata_v2_4638_payments_insights_payment_settlement_intent_kafka_to_teradata_stg_stage_1_settlement_intent_kafka_to_teradata_stg_job.json",
...
teradata_teradata/payment_settlement_intent_teradata_v2_4638_payments_insights_payment_settlement_intent_hdr_td_stg_to_td_fct_stage_2_payment_settlement_intent_hdr_stg_to_teradata_fct = open( os.path.join(sql_path, 'teradata/teradata/payment_settlement_intent_teradata_v2_4638_payments_insights_payment_settlement_intent_hdr_td_stg_to_td_fct_stage_2_payment_settlement_intent_hdr_stg_to_teradata_fct.sql'),"r").read()
    ...
    launch_payment_settlement_intent_hdr_td_stg_to_td_fct_stage_2_payment_settlement_intent_hdr_td_stg_to_td_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata/payment_settlement_intent_teradata_v2_4638_payments_insights_payment_settlement_intent_hdr_td_stg_to_td_fct_stage_2_payment_settlement_intent_hdr_stg_to_teradata_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
teradata_teradata/payment_settlement_intent_teradata_v2_4638_payments_insights_payment_settlement_intent_tender_td_stg_to_td_fct_stage_3_payment_settlement_intent_tender_stg_to_teradata_fct = open( os.path.join(sql_path, 'teradata/teradata/payment_settlement_intent_teradata_v2_4638_payments_insights_payment_settlement_intent_tender_td_stg_to_td_fct_stage_3_payment_settlement_intent_tender_stg_to_teradata_fct.sql'),"r").read()
    ...
    launch_payment_settlement_intent_tender_td_stg_to_td_fct_stage_3_payment_settlement_intent_tender_td_stg_to_td_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata/payment_settlement_intent_teradata_v2_4638_payments_insights_payment_settlement_intent_tender_td_stg_to_td_fct_stage_3_payment_settlement_intent_tender_stg_to_teradata_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
teradata_teradata/payment_settlement_intent_teradata_v2_4638_payments_insights_payment_settlement_intent_teradata_hdr_fct_update_payment_id_stage_payment_settlement_intent_teradata_hdr_fct_update_payment_id = open( os.path.join(sql_path, 'teradata/teradata/payment_settlement_intent_teradata_v2_4638_payments_insights_payment_settlement_intent_teradata_hdr_fct_update_payment_id_stage_payment_settlement_intent_teradata_hdr_fct_update_payment_id.sql'),"r").read()
    ...
    launch_payment_settlement_intent_teradata_hdr_fct_update_payment_id_stage_teradata_hdr_fct_update_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata/payment_settlement_intent_teradata_v2_4638_payments_insights_payment_settlement_intent_teradata_hdr_fct_update_payment_id_stage_payment_settlement_intent_teradata_hdr_fct_update_payment_id,
                "useLegacySql": False
            }
        },
        project_id = project_id,
