...
dag_id = 'gcp_payment_refund_and_cancel_s3_parquet_preprod_4638_payments_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_cancel_success_kafka_to_s3_parquet_job")   
    payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_cancel_success_kafka_to_s3_parquet_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_refund_and_cancel_s3_parquet_preprod_4638_payments_insights_payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_cancel_success_kafka_to_s3_parquet_job.json",
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_cancel_failed_kafka_to_s3_parquet_job")   
    payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_cancel_failed_kafka_to_s3_parquet_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_payment_refund_and_cancel_s3_parquet_preprod_4638_payments_insights_payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_cancel_failed_kafka_to_s3_parquet_job.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_refund_succeeded_kafka_to_s3_parquet_job")   
    payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_refund_succeeded_kafka_to_s3_parquet_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_payment_refund_and_cancel_s3_parquet_preprod_4638_payments_insights_payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_refund_succeeded_kafka_to_s3_parquet_job.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_refund_failed_kafka_to_s3_parquet_job")   
    payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_refund_failed_kafka_to_s3_parquet_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_payment_refund_and_cancel_s3_parquet_preprod_4638_payments_insights_payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_refund_failed_kafka_to_s3_parquet_job.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
creds_setup >> fetch_batch_run_id_task >>[payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_cancel_success_kafka_to_s3_parquet_job]
    payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_cancel_success_kafka_to_s3_parquet_job >>[payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_cancel_failed_kafka_to_s3_parquet_job]
    payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_cancel_failed_kafka_to_s3_parquet_job >>[payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_refund_succeeded_kafka_to_s3_parquet_job]
    payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_refund_succeeded_kafka_to_s3_parquet_job >>[payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_refund_failed_kafka_to_s3_parquet_job]
    payment_refund_and_cancel_kafka_to_s3_parquet_stage_0_refund_failed_kafka_to_s3_parquet_job >> pelican_validator >> pelican_sensor