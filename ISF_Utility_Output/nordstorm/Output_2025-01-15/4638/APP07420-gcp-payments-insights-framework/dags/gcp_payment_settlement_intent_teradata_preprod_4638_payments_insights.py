...
dag_id = 'gcp_payment_settlement_intent_teradata_preprod_4638_payments_insights'
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_settlement_intent_teradata_preprod_4638_payments_insights_payment_settlement_intent_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job.json",
...
teradata_teradata_payment_settlement_intent_teradata_preprod_4638_payments_insights_payment_settlement_intent_kafka_to_teradata_stg_stage_0_payment_settlement_intent_teradata_stg_to_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_settlement_intent_teradata_preprod_4638_payments_insights_payment_settlement_intent_kafka_to_teradata_stg_stage_0_payment_settlement_intent_teradata_stg_to_teradata_fct_preprod.sql'),"r").read()
    ...
    launch_payment_settlement_intent_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_settlement_intent_teradata_preprod_4638_payments_insights_payment_settlement_intent_kafka_to_teradata_stg_stage_0_payment_settlement_intent_teradata_stg_to_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
