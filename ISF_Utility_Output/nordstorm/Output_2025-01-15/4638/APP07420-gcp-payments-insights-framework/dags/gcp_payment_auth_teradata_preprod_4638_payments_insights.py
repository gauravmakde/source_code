...
dag_id = 'gcp_payment_auth_teradata_preprod_4638_payments_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_auth_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job")   
    payment_auth_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_auth_teradata_preprod_4638_payments_insights_payment_auth_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job.json",
...
teradata_teradata_payment_auth_teradata_preprod_4638_payments_insights_payment_auth_kafka_to_teradata_stg_stage_0_payment_auth_teradata_stg_to_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_teradata_preprod_4638_payments_insights_payment_auth_kafka_to_teradata_stg_stage_0_payment_auth_teradata_stg_to_teradata_fct_preprod.sql'),"r").read()

    launch_payment_auth_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job = BigQueryInsertJobOperator(
        task_id = "payment_auth_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_auth_teradata_preprod_4638_payments_insights_payment_auth_kafka_to_teradata_stg_stage_0_payment_auth_teradata_stg_to_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[payment_auth_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job]
    payment_auth_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job >>[launch_payment_auth_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job]
    launch_payment_auth_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job >> pelican_validator >> pelican_sensor