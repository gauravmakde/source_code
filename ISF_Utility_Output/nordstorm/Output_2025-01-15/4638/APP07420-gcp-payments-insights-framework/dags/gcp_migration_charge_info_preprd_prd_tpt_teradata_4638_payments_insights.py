...
dag_id = 'gcp_migration_charge_info_preprd_prd_tpt_teradata_4638_payments_insights'
...
with DAG(
    ...
    teradata_teradata_migration_charge_info_preprd_prd_tpt_teradata_4638_payments_insights_migrate_chargeback_info_data_preprd_to_prd_stage_chargeback_information_insert_from_stg_to_fct_teradata = open( os.path.join(sql_path, 'teradata/teradata/migration_charge_info_preprd_prd_tpt_teradata_4638_payments_insights_migrate_chargeback_info_data_preprd_to_prd_stage_chargeback_information_insert_from_stg_to_fct_teradata.sql'),"r").read()
    ...
    launch_migrate_chargeback_info_data_preprd_to_prd_stage_insert_from_stg_to_fct_teradata_stage_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_migration_charge_info_preprd_prd_tpt_teradata_4638_payments_insights_migrate_chargeback_info_data_preprd_to_prd_stage_chargeback_information_insert_from_stg_to_fct_teradata,
                "useLegacySql": False
            }
        },
