...
dag_id = 'gcp_payment_authorization_result_s3_parquet_preprod_4638_payments_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_authorization_s3_avro_to_s3_parquet_stage_0_kafka_to_s3_parquet_job")   
    payment_authorization_s3_avro_to_s3_parquet_stage_0_kafka_to_s3_parquet_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_authorization_result_s3_parquet_preprod_4638_payments_insights_payment_authorization_s3_avro_to_s3_parquet_stage_0_kafka_to_s3_parquet_job.json",
...
creds_setup >> fetch_batch_run_id_task >>[payment_authorization_s3_avro_to_s3_parquet_stage_0_kafka_to_s3_parquet_job]
    payment_authorization_s3_avro_to_s3_parquet_stage_0_kafka_to_s3_parquet_job >> pelican_validator >> pelican_sensor