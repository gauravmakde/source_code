...
dag_id = 'gcp_fraud_worldpay_bin_4638_payments_insights'
...
with DAG(
    ...
    teradata_fraud_worldpay_bin_dim = open( os.path.join(sql_path, 'teradata/fraud_worldpay_bin_dim.sql'),"r").read()
    ...
    launch_read_s3_write_td_stage_td_stg_to_td_dim_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_fraud_worldpay_bin_dim,
                "useLegacySql": False
            }
        },
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_fraud_worldpay_bin_4638_payments_insights_read_td_write_td_stage_td_dim_to_td_stg_job.json",
...
teradata_teradata/fraud_worldpay_bin_4638_payments_insights_read_td_write_td_stage_fraud_worldpay_rollup_dim = open( os.path.join(sql_path, 'teradata/teradata/fraud_worldpay_bin_4638_payments_insights_read_td_write_td_stage_fraud_worldpay_rollup_dim.sql'),"r").read()
    ...
    launch_read_td_write_td_stage_td_stg_to_td_dim_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata/fraud_worldpay_bin_4638_payments_insights_read_td_write_td_stage_fraud_worldpay_rollup_dim,
                "useLegacySql": False
            }
        },
        project_id = project_id,
