...
dag_id = 'gcp_payment_auth_teradata_v2_historical_preprod_4638_payments_insights'
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_auth_teradata_v2_historical_preprod_4638_payments_insights_payment_auth_kafka_to_teradata_stg_historical_stage_hive_to_s3_csv_job.json",
...
tpt_jdbc_insert_payment_auth_kafka_to_teradata_stg_historical_stage_s3_csv_to_teradata_hdr_job_control_tbl = BashOperator(
    ...
    teradata_teradata_payment_auth_teradata_v2_historical_preprod_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_teradata_v2_historical_preprod_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2_preprod.sql'),"r").read()
    ...
    launch_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_teradata_hdr_stg_to_teradata_hdr_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_auth_teradata_v2_historical_preprod_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
teradata_teradata_payment_auth_teradata_v2_historical_preprod_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_teradata_v2_historical_preprod_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2_preprod.sql'),"r").read()
    ...
    launch_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_teradata_tender_stg_to_teradata_tender_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_auth_teradata_v2_historical_preprod_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
