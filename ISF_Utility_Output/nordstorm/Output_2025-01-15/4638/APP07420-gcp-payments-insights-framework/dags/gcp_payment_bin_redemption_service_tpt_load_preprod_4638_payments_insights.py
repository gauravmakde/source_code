...
dag_id = 'gcp_payment_bin_redemption_service_tpt_load_preprod_4638_payments_insights'
...
with DAG(
    ...
    creds_setup >> fetch_batch_run_id_task >> tpt_jdbc_insert_read_from_s3_write_td_stage_0_job_load_control_tbl >>[tpt_read_from_s3_write_td_stage_0_job_load_load_tbl] >> pelican_validator >> pelican_sensor