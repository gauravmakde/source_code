...
dag_id = 'gcp_card_to_wallet_threshold_violated_teradata_preprod_4638_payments_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="card_to_wallet_threshold_violated_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job")   
    card_to_wallet_threshold_violated_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_card_to_wallet_threshold_violated_teradata_preprod_4638_payments_insights_card_to_wallet_threshold_violated_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job.json",
...
teradata_teradata_card_to_wallet_threshold_violated_teradata_preprod_4638_payments_insights_card_to_wallet_threshold_violated_td_stg_to_td_fct_stage_1_card_to_wallet_threshold_violated_stg_to_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/card_to_wallet_threshold_violated_teradata_preprod_4638_payments_insights_card_to_wallet_threshold_violated_td_stg_to_td_fct_stage_1_card_to_wallet_threshold_violated_stg_to_teradata_fct_preprod.sql'),"r").read()

    launch_card_to_wallet_threshold_violated_td_stg_to_td_fct_stage_1_card_to_wallet_threshold_violated_td_stg_to_td_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_card_to_wallet_threshold_violated_teradata_preprod_4638_payments_insights_card_to_wallet_threshold_violated_td_stg_to_td_fct_stage_1_card_to_wallet_threshold_violated_stg_to_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[card_to_wallet_threshold_violated_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job]
    card_to_wallet_threshold_violated_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job >>[launch_card_to_wallet_threshold_violated_td_stg_to_td_fct_stage_1_card_to_wallet_threshold_violated_td_stg_to_td_fct_job]
    launch_card_to_wallet_threshold_violated_td_stg_to_td_fct_stage_1_card_to_wallet_threshold_violated_td_stg_to_td_fct_job >> pelican_validator >> pelican_sensor