...
dag_id = 'gcp_payment_auth_teradata_v2_preprod_4638_payments_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_auth_kafka_to_teradata_stg_stage_kafka_to_teradata_stg_job")   
    payment_auth_kafka_to_teradata_stg_stage_kafka_to_teradata_stg_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_auth_teradata_v2_preprod_4638_payments_insights_payment_auth_kafka_to_teradata_stg_stage_kafka_to_teradata_stg_job.json",
...
teradata_teradata_payment_auth_teradata_v2_preprod_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_teradata_v2_preprod_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2_preprod.sql'),"r").read()

    launch_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_teradata_hdr_stg_to_teradata_hdr_fct_job = BigQueryInsertJobOperator(
        task_id = "payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_teradata_hdr_stg_to_teradata_hdr_fct_job",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_auth_teradata_v2_preprod_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
teradata_teradata_payment_auth_teradata_v2_preprod_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_teradata_v2_preprod_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2_preprod.sql'),"r").read()

    launch_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_teradata_tender_stg_to_teradata_tender_fct_job = BigQueryInsertJobOperator(
        task_id = "payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_teradata_tender_stg_to_teradata_tender_fct_job",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_auth_teradata_v2_preprod_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
teradata_teradata_payment_auth_teradata_v2_preprod_4638_payments_insights_payment_auth_teradata_hdr_fct_update_payment_id_stage_payment_auth_teradata_hdr_fct_update_payment_id_preprod = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_teradata_v2_preprod_4638_payments_insights_payment_auth_teradata_hdr_fct_update_payment_id_stage_payment_auth_teradata_hdr_fct_update_payment_id_preprod.sql'),"r").read()

    launch_payment_auth_teradata_hdr_fct_update_payment_id_stage_teradata_hdr_fct_update_job = BigQueryInsertJobOperator(
        task_id = "payment_auth_teradata_hdr_fct_update_payment_id_stage_teradata_hdr_fct_update_job",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_auth_teradata_v2_preprod_4638_payments_insights_payment_auth_teradata_hdr_fct_update_payment_id_stage_payment_auth_teradata_hdr_fct_update_payment_id_preprod,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[payment_auth_kafka_to_teradata_stg_stage_kafka_to_teradata_stg_job]
    payment_auth_kafka_to_teradata_stg_stage_kafka_to_teradata_stg_job >>[launch_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_teradata_hdr_stg_to_teradata_hdr_fct_job, launch_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_teradata_tender_stg_to_teradata_tender_fct_job]
    launch_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_teradata_hdr_stg_to_teradata_hdr_fct_job >>[launch_payment_auth_teradata_hdr_fct_update_payment_id_stage_teradata_hdr_fct_update_job]
    launch_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_teradata_tender_stg_to_teradata_tender_fct_job >>[launch_payment_auth_teradata_hdr_fct_update_payment_id_stage_teradata_hdr_fct_update_job]
    launch_payment_auth_teradata_hdr_fct_update_payment_id_stage_teradata_hdr_fct_update_job >> pelican_validator >> pelican_sensor