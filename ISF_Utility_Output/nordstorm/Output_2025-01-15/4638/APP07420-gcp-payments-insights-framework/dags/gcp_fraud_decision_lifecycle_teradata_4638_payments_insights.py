           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_fraud_decision_lifecycle_teradata_4638_payments_insights_fraud_decision_lifecycle_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job.json",
...
teradata_fraud_decision_lifecycle_teradata_stg_to_teradata_fct = open( os.path.join(sql_path, 'teradata/fraud_decision_lifecycle_teradata_stg_to_teradata_fct.sql'),"r").read()
    ...
    launch_fraud_decision_lifecycle_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_fraud_decision_lifecycle_teradata_stg_to_teradata_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
