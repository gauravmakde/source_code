...
dag_id = 'gcp_settlement_result_hashkey_backfill_teradata_preprod_4638_payments_insights'
...
default_args = {
    ...
    'description': 'settlement_result_hashkey_backfill_teradata_preprod_4638_payments_insights DAG Description',
...
with DAG(
    ...
    teradata_teradata_settlement_result_hashkey_backfill_teradata_preprod_4638_payments_insights_settlement_result_hashkey_backfill_teradata_stage_0_settlement_result_hashkey_backfill_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/settlement_result_hashkey_backfill_teradata_preprod_4638_payments_insights_settlement_result_hashkey_backfill_teradata_stage_0_settlement_result_hashkey_backfill_teradata_fct_preprod.sql'),"r").read()

    launch_settlement_result_hashkey_backfill_teradata_stage_0_job_insert_update = BigQueryInsertJobOperator(
        task_id = "settlement_result_hashkey_backfill_teradata_stage_0_job_insert_update",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_settlement_result_hashkey_backfill_teradata_preprod_4638_payments_insights_settlement_result_hashkey_backfill_teradata_stage_0_settlement_result_hashkey_backfill_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
...
creds_setup >> fetch_batch_run_id_task >> launch_settlement_result_hashkey_backfill_teradata_stage_0_job_insert_update >> pelican_validator >> pelican_sensor