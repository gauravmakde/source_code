...
dag_id = 'gcp_payment_redemption_service_tpt_export_preprod_4638_payments_insights'
...
with DAG(
    ...
    creds_setup >> fetch_batch_run_id_task >> tpt_jdbc_export_read_from_td_write_s3_stage_0_job_export_control_tbl >>[tpt_read_from_td_write_s3_stage_0_job_export_export_tbl] >> pelican_validator >> pelican_sensor