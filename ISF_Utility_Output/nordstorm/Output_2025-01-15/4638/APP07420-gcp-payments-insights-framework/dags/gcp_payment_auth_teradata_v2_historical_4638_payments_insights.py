...
dag_id = 'gcp_payment_auth_teradata_v2_historical_4638_payments_insights'
...
default_args = {
    ...
    'description': 'payment_auth_teradata_v2_historical_4638_payments_insights DAG Description',
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_auth_kafka_to_teradata_stg_historical_stage_hive_to_s3_csv_job")   
    payment_auth_kafka_to_teradata_stg_historical_stage_hive_to_s3_csv_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_auth_teradata_v2_historical_4638_payments_insights_payment_auth_kafka_to_teradata_stg_historical_stage_hive_to_s3_csv_job.json",
...
tpt_jdbc_insert_payment_auth_kafka_to_teradata_stg_historical_stage_s3_csv_to_teradata_hdr_job_control_tbl = BashOperator(
    ...
    command="/db/teradata/bin/tpt_load.sh  -e PRD_NAP_UTL -j PAYMENT_AUTHORIZATION_HDR_V2_LDG_TPT_ENGINE_JOB -h tdnapprod.nordstrom.net -l 'N' -u SCH_NAP_CUSTPAYMNT_BATCH -p \"\$tdwallet(SCH_NAP_CUSTPAYMNT_BATCH_PWD)\" -f s3://tf-nap-prod-payments-object-model-presentation/data/csv/customer-payment-authorization-analytical-avro/PAYMENT_AUTHORIZATION_HDR_V2_LDG/*.csv -o UPDATE -r TD-UTILITIES-EC2",
    timeout=1800,
    ...
    command="/db/teradata/bin/tpt_load.sh  -e PRD_NAP_UTL -j PAYMENT_AUTHORIZATION_TENDER_V2_LDG_TPT_ENGINE_JOB -h tdnapprod.nordstrom.net -l 'N' -u SCH_NAP_CUSTPAYMNT_BATCH -p \"\$tdwallet(SCH_NAP_CUSTPAYMNT_BATCH_PWD)\" -f s3://tf-nap-prod-payments-object-model-presentation/data/csv/customer-payment-authorization-analytical-avro/PAYMENT_AUTHORIZATION_TENDER_V2_LDG/*.csv -o UPDATE -r TD-UTILITIES-EC2",
    timeout=1800,
    ssh_hook=TeraDataSSHHook(ssh_conn_id='TECH_ISF_NAP_CREDIT_PAYMENTS_TDUTIL_SERVER_S3EXT'),
    retries=2)
    ...
    teradata_teradata_payment_auth_teradata_v2_historical_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2 = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_teradata_v2_historical_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2.sql'),"r").read()
    ...
    launch_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_teradata_hdr_stg_to_teradata_hdr_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_auth_teradata_v2_historical_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
teradata_teradata_payment_auth_teradata_v2_historical_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2 = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_teradata_v2_historical_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2.sql'),"r").read()
    ...
    launch_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_teradata_tender_stg_to_teradata_tender_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_auth_teradata_v2_historical_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
creds_setup >> fetch_batch_run_id_task >>[payment_auth_kafka_to_teradata_stg_historical_stage_hive_to_s3_csv_job]
    payment_auth_kafka_to_teradata_stg_historical_stage_hive_to_s3_csv_job >>[tpt_jdbc_insert_payment_auth_kafka_to_teradata_stg_historical_stage_s3_csv_to_teradata_hdr_job_control_tbl]
    ...
    launch_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_teradata_hdr_stg_to_teradata_hdr_fct_job >>    launch_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_teradata_tender_stg_to_teradata_tender_fct_job >> pelican_validator >> pelican_sensor