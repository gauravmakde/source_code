...
dag_id = 'gcp_payment_dp495_ent_paypal_transaction_dtl_rpt_s3_parquet_preprod_4638_payments_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="s3_csv_to_s3_parquet_stage_0_s3_csv_to_s3_parquet_job")   
    s3_csv_to_s3_parquet_stage_0_s3_csv_to_s3_parquet_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_dp495_ent_paypal_transaction_dtl_rpt_s3_parquet_preprod_4638_payments_insights_s3_csv_to_s3_parquet_stage_0_s3_csv_to_s3_parquet_job.json",
...
creds_setup >> fetch_batch_run_id_task >>[s3_csv_to_s3_parquet_stage_0_s3_csv_to_s3_parquet_job]
    s3_csv_to_s3_parquet_stage_0_s3_csv_to_s3_parquet_job >> pelican_validator >> pelican_sensor