...
dag_id = 'gcp_payment_auth_res_afterpay_id_teradata_4638_payments_insights'
...
with DAG(
    ...
    teradata_payment_auth_result_afterpay_id_teradata_stg_to_teradata_fct = open( os.path.join(sql_path, 'teradata/payment_auth_result_afterpay_id_teradata_stg_to_teradata_fct.sql'),"r").read()
    ...
    launch_payment_auth_res_afterpay_id_teradata_stg_to_teradata_fct_stage_0_teradata_stg_to_teradata_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_payment_auth_result_afterpay_id_teradata_stg_to_teradata_fct,
                "useLegacySql": False
            }
        },
