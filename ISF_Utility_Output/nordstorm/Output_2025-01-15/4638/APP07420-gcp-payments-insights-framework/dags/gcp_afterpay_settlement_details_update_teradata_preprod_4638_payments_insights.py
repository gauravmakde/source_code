...
dag_id = 'gcp_afterpay_settlement_details_update_teradata_preprod_4638_payments_insights'
...
with DAG(
    ...
    external_dag_id='gcp_payment_settlement_result_teradata_4638_payments_insights',
    timeout=7200,
    ...
    external_dag_id='gcp_payment_bin_teradata_4638_payments_insights',
    timeout=7200,
    allowed_states=['success'],
    failed_states=['failed'],
    execution_delta=timedelta(hours=1))
    ...
    teradata_teradata_afterpay_settlement_details_update_teradata_preprod_4638_payments_insights_afterpay_settlement_update_teradata_stg_stage_0_afterpay_settlement_details_update_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/afterpay_settlement_details_update_teradata_preprod_4638_payments_insights_afterpay_settlement_update_teradata_stg_stage_0_afterpay_settlement_details_update_teradata_fct_preprod.sql'),"r").read()

    launch_afterpay_settlement_update_teradata_stg_stage_0_job_insert_update = BigQueryInsertJobOperator(
        task_id = "afterpay_settlement_update_teradata_stg_stage_0_job_insert_update",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_afterpay_settlement_details_update_teradata_preprod_4638_payments_insights_afterpay_settlement_update_teradata_stg_stage_0_afterpay_settlement_details_update_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
...
creds_setup >> fetch_batch_run_id_task >> launch_check_external_upstream_dependencies_sensor_0 >>[launch_afterpay_settlement_update_teradata_stg_stage_0_job_insert_update]
    ...
    launch_afterpay_settlement_update_teradata_stg_stage_0_job_insert_update >> pelican_validator >> pelican_sensor