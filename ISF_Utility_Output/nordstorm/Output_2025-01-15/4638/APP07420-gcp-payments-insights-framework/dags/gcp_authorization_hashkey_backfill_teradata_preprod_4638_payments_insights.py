...
dag_id = 'gcp_authorization_hashkey_backfill_teradata_preprod_4638_payments_insights'
...
with DAG(
    ...
    teradata_teradata_authorization_hashkey_backfill_teradata_preprod_4638_payments_insights_authorization_hashkey_backfill_teradata_stage_0_authorization_hashkey_backfill_teradata_fct_preprod = open( os.path.join(sql_path, 'teradata/teradata/authorization_hashkey_backfill_teradata_preprod_4638_payments_insights_authorization_hashkey_backfill_teradata_stage_0_authorization_hashkey_backfill_teradata_fct_preprod.sql'),"r").read()

    launch_authorization_hashkey_backfill_teradata_stage_0_job_insert_update = BigQueryInsertJobOperator(
        task_id = "authorization_hashkey_backfill_teradata_stage_0_job_insert_update",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_authorization_hashkey_backfill_teradata_preprod_4638_payments_insights_authorization_hashkey_backfill_teradata_stage_0_authorization_hashkey_backfill_teradata_fct_preprod,
                "useLegacySql": False
            }
        },
...
creds_setup >> fetch_batch_run_id_task >> launch_authorization_hashkey_backfill_teradata_stage_0_job_insert_update >> pelican_validator >> pelican_sensor