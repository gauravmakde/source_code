...
dag_id = 'gcp_payment_bin_v2_redemption_service_tpt_load_4638_payments_insights'
...
default_args = {
    ...
    'description': 'payment_bin_v2_redemption_service_tpt_load_4638_payments_insights DAG Description',
...
with DAG(
    ...
    command="/db/teradata/bin/tpt_load.sh  -e PRD_NAP_PYMNT_FRAUD_UTL -j PAYMENT_RESULT_BIN_V2_LDG_JOB -h tdnapprod.nordstrom.net -l 'N' -u SCH_NAP_PYMNT_FRAUD_BATCH -p \"\$tdwallet(SCH_NAP_PYMNT_FRAUD_BATCH_PWD)\" -f s3://tf-nap-prod-chargeback-migration-out/bin_v2_redemption/year=2024/month=08/day=02/hour=10/*.csv -o UPDATE -r TD-UTILITIES-EC2",
    timeout=1800,
    ...
    teradata_teradata_payment_bin_v2_redemption_service_tpt_load_4638_payments_insights_read_from_s3_write_td_stage_0_payment_bin_v2_teradata_stg_to_teradata_fct_historical = open( os.path.join(sql_path, 'teradata/teradata/payment_bin_v2_redemption_service_tpt_load_4638_payments_insights_read_from_s3_write_td_stage_0_payment_bin_v2_teradata_stg_to_teradata_fct_historical.sql'),"r").read()

    launch_read_from_s3_write_td_stage_0_teradata_stg_to_teradata_fct_job = BigQueryInsertJobOperator(
        task_id = "read_from_s3_write_td_stage_0_teradata_stg_to_teradata_fct_job",
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata_payment_bin_v2_redemption_service_tpt_load_4638_payments_insights_read_from_s3_write_td_stage_0_payment_bin_v2_teradata_stg_to_teradata_fct_historical,
                "useLegacySql": False
            }
        },
...
creds_setup >> fetch_batch_run_id_task >> tpt_jdbc_insert_read_from_s3_write_td_stage_0_job_load_control_tbl >>[tpt_read_from_s3_write_td_stage_0_job_load_load_tbl]
    ...
    launch_read_from_s3_write_td_stage_0_teradata_stg_to_teradata_fct_job >> pelican_validator >> pelican_sensor