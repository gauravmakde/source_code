...
dag_id = 'gcp_payment_bin_v2_teradata_4638_payments_insights'
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_bin_v2_teradata_4638_payments_insights_payment_bin_v2_kafka_to_teradata_stg_stage_0_kafka_to_teradata_stg_job.json",
...
teradata_payment_bin_v2_teradata_stg_to_teradata_fct = open( os.path.join(sql_path, 'teradata/payment_bin_v2_teradata_stg_to_teradata_fct.sql'),"r").read()
    ...
    launch_payment_bin_v2_kafka_to_teradata_stg_stage_0_teradata_stg_to_teradata_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_payment_bin_v2_teradata_stg_to_teradata_fct,
                "useLegacySql": False
            }
        },
        project_id = project_id,
