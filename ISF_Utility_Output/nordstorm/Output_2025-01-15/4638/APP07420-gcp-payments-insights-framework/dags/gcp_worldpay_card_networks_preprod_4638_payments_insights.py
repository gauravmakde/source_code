...
dag_id = 'gcp_worldpay_card_networks_preprod_4638_payments_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="worldpay_card_networks_s3_to_teradata_stage_worldpay_card_networks_s3_to_teradata_job")   
    worldpay_card_networks_s3_to_teradata_stage_worldpay_card_networks_s3_to_teradata_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_worldpay_card_networks_preprod_4638_payments_insights_worldpay_card_networks_s3_to_teradata_stage_worldpay_card_networks_s3_to_teradata_job.json",
...
creds_setup >> fetch_batch_run_id_task >>[worldpay_card_networks_s3_to_teradata_stage_worldpay_card_networks_s3_to_teradata_job]
    worldpay_card_networks_s3_to_teradata_stage_worldpay_card_networks_s3_to_teradata_job >> pelican_validator >> pelican_sensor