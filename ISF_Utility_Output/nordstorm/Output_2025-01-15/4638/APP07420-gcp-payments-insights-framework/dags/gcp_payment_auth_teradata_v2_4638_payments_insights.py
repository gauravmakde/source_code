...
dag_id = 'gcp_payment_auth_teradata_v2_4638_payments_insights'
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_auth_teradata_v2_4638_payments_insights_payment_auth_kafka_to_teradata_stg_stage_kafka_to_teradata_stg_job.json",
...
teradata_teradata/payment_auth_teradata_v2_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2 = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_teradata_v2_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2.sql'),"r").read()
    ...
    launch_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_teradata_hdr_stg_to_teradata_hdr_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata/payment_auth_teradata_v2_4638_payments_insights_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_stage_payment_auth_teradata_hdr_stg_to_teradata_hdr_fct_v2,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
teradata_teradata/payment_auth_teradata_v2_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2 = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_teradata_v2_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2.sql'),"r").read()
    ...
    launch_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_teradata_tender_stg_to_teradata_tender_fct_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata/payment_auth_teradata_v2_4638_payments_insights_payment_auth_teradata_tender_stg_to_teradata_tender_fct_stage_payment_auth_teradata_tender_stg_to_teradata_tender_fct_v2,
                "useLegacySql": False
            }
        },
        project_id = project_id,
...
teradata_teradata/payment_auth_teradata_v2_4638_payments_insights_payment_auth_teradata_hdr_fct_update_payment_id_stage_payment_auth_teradata_hdr_fct_update_payment_id = open( os.path.join(sql_path, 'teradata/teradata/payment_auth_teradata_v2_4638_payments_insights_payment_auth_teradata_hdr_fct_update_payment_id_stage_payment_auth_teradata_hdr_fct_update_payment_id.sql'),"r").read()
    ...
    launch_payment_auth_teradata_hdr_fct_update_payment_id_stage_teradata_hdr_fct_update_job = BigQueryInsertJobOperator(
        ...
        configuration = 
        {
            "query": 
            {
                "query": teradata_teradata/payment_auth_teradata_v2_4638_payments_insights_payment_auth_teradata_hdr_fct_update_payment_id_stage_payment_auth_teradata_hdr_fct_update_payment_id,
                "useLegacySql": False
            }
        },
        project_id = project_id,
