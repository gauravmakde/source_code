...
dag_id = 'gcp_payment_settlement_result_s3_parquet_preprod_4638_payments_insights'
...
session_name=get_batch_id(dag_id=dag_id,task_id="payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job")   
    payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job = DataprocCreateBatchOperator(
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_payment_settlement_result_s3_parquet_preprod_4638_payments_insights_payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job.json",
...
creds_setup >> fetch_batch_run_id_task >>[payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job]
    payment_settlement_s3_avro_to_s3_parquet_stage_0_s3_to_s3_job >> pelican_validator >> pelican_sensor