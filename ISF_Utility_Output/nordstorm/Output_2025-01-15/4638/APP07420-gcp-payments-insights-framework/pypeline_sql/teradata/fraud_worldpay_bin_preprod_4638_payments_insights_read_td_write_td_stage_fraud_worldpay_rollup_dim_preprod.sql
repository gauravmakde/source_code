...
MERGE INTO PREPROD_NAP_PYMNT_FRAUD_BASE_VWS.WORLDPAY_BIN_ROLLUP_DIM AS T
    USING PREPROD_NAP_PYMNT_FRAUD_BASE_VWS.WORLDPAY_BIN_ROLLUP_LDG AS S
...
DELETE FROM PREPROD_NAP_PYMNT_FRAUD_BASE_VWS.WORLDPAY_BIN_ROLLUP_LDG;
