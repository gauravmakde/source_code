...
UPDATE PREPROD_NAP_BASE_VWS.PAYMENT_AUTHORIZATION_HDR_V2_FACT
FROM (
SELECT
    A.EVENT_ID,
    ...
    A.TOTAL_AMT
FROM PREPROD_NAP_BASE_VWS.PAYMENT_AUTHORIZATION_HDR_V2_FACT A
INNER JOIN PREPROD_NAP_BASE_VWS.PAYMENT_AUTHORIZATION_TENDER_V2_FACT B
...
WHERE PREPROD_NAP_BASE_VWS.PAYMENT_AUTHORIZATION_HDR_V2_FACT.EVENT_ID = C.EVENT_ID;
