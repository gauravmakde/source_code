...
CREATE MULTISET VOLATILE TABLE PAYMENT_RESULT_BIN_LDG_TEMP AS (
    SELECT DISTINCT *
    FROM {db_env}_NAP_STG.PAYMENT_RESULT_BIN_LDG
...
MERGE INTO {db_env}_NAP_BASE_VWS.PAYMENT_RESULT_BIN_FACT AS PRB
...
DELETE FROM {db_env}_NAP_STG.PAYMENT_RESULT_BIN_LDG;
