...
SELECT
    ...
    ' ' AS customer_field_2,
    ' ' AS customer_field_3
FROM {db_env}_nap_usr_vws.payment_settlement_result_no_transaction_fact_vw AS psrntfv
INNER JOIN {db_env}_nap_usr_vws.payment_bank_card_settlement_result_fact AS psbc
