# -*- coding: utf-8 -*-
# DAG version:          default
# CI commit sha:        dd961550df698323cbbc3d03393d3fa9c61d9fb2
# CI pipeline URL:      https://git.jwn.app/TM01439/app08849-brazos-insights/-/pipelines/7193303
# CI commit timestamp:  2024-10-10T13:50:06+00:00
...
root_path = path.dirname(__file__).split('APP08849-gcp-gcp-brazos-insights')[0] + 'APP08849-gcp-gcp-brazos-insights/'
...
dag_id = 'gcp_nap_to_allocation_product_location_calender_extracts_14363_prod_brazos_brazos_dags'
...
from modules import upstream_dependency
...
default_args = {
    ...
    'description': 'nap_to_allocation_product_location_calender_extracts_14363_prod_brazos_brazos_dags DAG Description',
...
with DAG(
    ...
    external_dag_id='gcp_org_object_model_to_orc_load',
...
session_name=get_batch_id(dag_id=dag_id,task_id="nap_to_allocation_1_calendar_extracts")   
    nap_to_allocation_1_calendar_extracts = DataprocCreateBatchOperator(
            task_id = "nap_to_allocation_1_calendar_extracts",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_nap_to_allocation_product_location_calender_extracts_14363_prod_brazos_brazos_dags_nap_to_allocation_1_calendar_extracts.json",
...
session_name=get_batch_id(dag_id=dag_id,task_id="nap_to_allocation_1_location_extracts")   
    nap_to_allocation_1_location_extracts = DataprocCreateBatchOperator(
            task_id = "nap_to_allocation_1_location_extracts",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_nap_to_allocation_product_location_calender_extracts_14363_prod_brazos_brazos_dags_nap_to_allocation_1_location_extracts.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
tpt_jdbc_export_nap_to_allocation_1_export_department_class_subclass_dim_control_tbl = BashOperator(
    task_id='tpt_jdbc_export_nap_to_allocation_1_export_department_class_subclass_dim_control_tbl',
    bash_command=f'echo "Skipping Control Table Entry"')

    tpt_nap_to_allocation_1_export_department_class_subclass_dim_export_tbl = SSHOperator(
    task_id='tpt_nap_to_allocation_1_export_department_class_subclass_dim_export_tbl',
    command="/db/teradata/bin/tpt_export.sh  -e PRD_NAP_UTL -s s3://tf-idp-isf-prod-common-etl/apps/etl_framework/airflow_nsk_dag_job_artifacts/prod/14363/prod_brazos/brazos_dags/sql/nap_to_allocation_product_location_calender_extracts_14363_prod_brazos_brazos_dags_nap_to_allocation_1_department_class_subclass_dim_export.sql -h tdnapprod.nordstrom.net -l 'N' -u SCH_NAP_IDP_BATCH -p \"\$tdwallet(SCH_NAP_IDP_BATCH_PWD)\"  -t s3://allocation-by-prod-lambda/table_extracts/department_class_subclass_dim/department_class_subclass_dim.csv -a 'Y' -d 01 -c 1 -q N -f '' -j PRD_NAP_USR_VWS_DEPARTMENT_CLASS_SUBCLASS_DIM_JOB",
    timeout=1800,
    ssh_conn_id="TECH_ISF_TEAM_BRAZOS_TDUTIL_SERVER_S3EXT_PROD")

    
            
        session_name=get_batch_id(dag_id=dag_id,task_id="nap_to_allocation_2_dept_extract")   
    nap_to_allocation_2_dept_extract = DataprocCreateBatchOperator(
            task_id = "nap_to_allocation_2_dept_extract",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_nap_to_allocation_product_location_calender_extracts_14363_prod_brazos_brazos_dags_nap_to_allocation_2_dept_extract.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
session_name=get_batch_id(dag_id=dag_id,task_id="nap_to_allocation_3_class_extract")   
    nap_to_allocation_3_class_extract = DataprocCreateBatchOperator(
            task_id = "nap_to_allocation_3_class_extract",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_nap_to_allocation_product_location_calender_extracts_14363_prod_brazos_brazos_dags_nap_to_allocation_3_class_extract.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
session_name=get_batch_id(dag_id=dag_id,task_id="nap_to_allocation_4_sbclass_extract")   
    nap_to_allocation_4_sbclass_extract = DataprocCreateBatchOperator(
            task_id = "nap_to_allocation_4_sbclass_extract",
            project_id = project_id,
            region = region,
            gcp_conn_id = gcp_conn,
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_nap_to_allocation_product_location_calender_extracts_14363_prod_brazos_brazos_dags_nap_to_allocation_4_sbclass_extract.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
creds_setup >> fetch_batch_run_id_task >> launch_other_appId_upstream_dependencies_sensor_0 >>    launch_other_appId_upstream_dependencies_sensor_1 >>[nap_to_allocation_1_calendar_extracts, nap_to_allocation_2_dept_extract, nap_to_allocation_3_class_extract, nap_to_allocation_4_sbclass_extract]
    nap_to_allocation_1_calendar_extracts >>[nap_to_allocation_1_location_extracts]
    nap_to_allocation_1_location_extracts >>[tpt_jdbc_export_nap_to_allocation_1_export_department_class_subclass_dim_control_tbl]
    tpt_jdbc_export_nap_to_allocation_1_export_department_class_subclass_dim_control_tbl >>[tpt_nap_to_allocation_1_export_department_class_subclass_dim_export_tbl]
    tpt_nap_to_allocation_1_export_department_class_subclass_dim_export_tbl >>[nap_to_allocation_2_dept_extract, nap_to_allocation_3_class_extract, nap_to_allocation_4_sbclass_extract]
    nap_to_allocation_2_dept_extract >>    nap_to_allocation_3_class_extract >>    nap_to_allocation_4_sbclass_extract >> pelican_validator >> pelican_sensor