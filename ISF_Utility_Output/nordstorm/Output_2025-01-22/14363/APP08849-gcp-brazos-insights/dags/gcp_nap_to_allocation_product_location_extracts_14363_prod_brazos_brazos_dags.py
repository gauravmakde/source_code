...
dag_id = 'gcp_nap_to_allocation_product_location_extracts_14363_prod_brazos_brazos_dags'
...
default_args = {
    ...
    'description': 'nap_to_allocation_product_location_extracts_14363_prod_brazos_brazos_dags DAG Description',
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "args": [f"{user_config_path}/argument_nap_to_allocation_product_location_extracts_14363_prod_brazos_brazos_dags_nap_to_allocation_1_location_extracts.json",
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_nap_to_allocation_product_location_extracts_14363_prod_brazos_brazos_dags_nap_to_allocation_2_dept_extract.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_nap_to_allocation_product_location_extracts_14363_prod_brazos_brazos_dags_nap_to_allocation_3_class_extract.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
           ...
           #op_args = { "version":"1.1"},
            ...
            {    
                ...
                "spark_batch": 
                    ...
                    "main_class": "com.nordstrom.nap.onehop.etl.app.ExecSQLWrapper",
                    "jar_file_uris": [f"{spark_jar_path}/{delta_core_jar}",f"{spark_jar_path}/uber-onehop-etl-pipeline-{etl_jar_version}.jar"],
                    "args": [f"{user_config_path}/argument_nap_to_allocation_product_location_extracts_14363_prod_brazos_brazos_dags_nap_to_allocation_4_sbclass_extract.json",
                    '--aws_user_role_external_id', Variable.get('aws_role_externalid')],
                    },
                    "environment_config": 
                                        {
...
creds_setup >> fetch_batch_run_id_task >> launch_other_appId_upstream_dependencies_sensor_0 >>    launch_other_appId_upstream_dependencies_sensor_1 >>[nap_to_allocation_1_location_extracts, nap_to_allocation_2_dept_extract, nap_to_allocation_3_class_extract, nap_to_allocation_4_sbclass_extract]
