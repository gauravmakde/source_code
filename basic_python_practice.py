...
# https://tableauuat.nordstrom.com/#/site/OnixStaging/workbooks/36585/views



debug_enable = False

USERNAME="Sample-workbook"
PASSWORD="jnqa0l3ZQiK9KNH7M0XA4g==:TwV90SmNP2uR9O7jCAsWewRuvHxOsZjr"
...
for workbook in workbooks:
    print(f"workbook remaining: {count}")
    count = count - 1
    # print(workbook)
    ...
    # print(workbook_id,workbook_name,workbook_details,workbook_owner)
    # print("View are:", views)
...
df.to_csv(directory+'\\sample_1_tableau_queries.csv', index=False)
