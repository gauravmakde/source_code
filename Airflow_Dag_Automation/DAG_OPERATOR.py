...
def main():
    ...
    root_directory = r"D:\Airflow_Dag_Automation\Input_Code"  # Replace with your root directory
    Output_directory = r"D:\Airflow_Dag_Automation\Output_Code"
    ...
    if task_details:
        ...
        result_df.to_csv(os.path.join(Output_directory,"ISF_analysis.csv"), index=False)
