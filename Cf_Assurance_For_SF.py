...
def fun_sf_match_schema_table_case(log_result,filename,result_sf_match_schema_table_case):
...
def fun_sf_project_id(log_result,filename,result_sf_project_id):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def fun_sf_check_datatype(log_result,filename,result_sf_check_datatype):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def fun_sf_check_no_of_statements_in_script(log_result,filename,result_sf_check_no_of_statements_in_script):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def fun_sf_Match_join_count(log_result,filename,result_sf_Match_join_count):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
...
def fun_sf_check_join_count(log_result,filename,result_sf_check_join_count):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
    log_result.append(Common("Match Join Count"))
...
def fun_sf_check_TRY_TO_functions(log_result,filename,result_sf_check_TRY_TO_functions):
    same_file,OutputFolderPath,inputFolderPath,Append_project_id,inputFile,outputFile,cred_ValidateQueryOnBQ=Config_Setup()
